...
# 32 "./src/main/vcpf4/usbd_desc.c" 2
...
# 33 "./src/main/vcpf4/usbd_desc.c" 2
# 108 "./src/main/vcpf4/usbd_desc.c"
...
# 127 "./src/main/vcpf4/usbd_desc.c"
 uint8_t USBD_DeviceDesc_Composite[18] =
  {
    0x12,
    0x01,
    0x00, 0x02,
    ...
    ((uint8_t)((0x3256) & 0x00FF)),
    ((uint8_t)(((0x3256) & 0xFF00) >>8)),
    0x00, 0x02,
    0x01,
    0x02,
    0x03,
...
# 222 "./src/main/vcpf4/usbd_desc.c"
uint8_t * USBD_USR_DeviceDescriptor( uint8_t speed , uint16_t *length)
{
    (void)speed;
...
# 242 "./src/main/vcpf4/usbd_desc.c"
uint8_t * USBD_USR_LangIDStrDescriptor( uint8_t speed , uint16_t *length)
{
    (void)speed;
...
uint8_t * USBD_USR_ProductStrDescriptor( uint8_t speed , uint16_t *length)
{
  ...
  if (speed == 0)
    USBD_GetString ((uint8_t*)"OmnibusF4", USBD_StrDesc, length);
  else
    USBD_GetString ((uint8_t*)"OmnibusF4", USBD_StrDesc, length);

  return USBD_StrDesc;
}
# 276 "./src/main/vcpf4/usbd_desc.c"
uint8_t * USBD_USR_ManufacturerStrDescriptor( uint8_t speed , uint16_t *length)
{
    (void)speed;
  USBD_GetString ((uint8_t*)"Betaflight", USBD_StrDesc, length);
  return USBD_StrDesc;
}
# 290 "./src/main/vcpf4/usbd_desc.c"
uint8_t * USBD_USR_SerialStrDescriptor( uint8_t speed , uint16_t *length)
{
  if (speed == 0)
...
# 307 "./src/main/vcpf4/usbd_desc.c"
uint8_t * USBD_USR_ConfigStrDescriptor( uint8_t speed , uint16_t *length)
{
  if (speed == 0)
...
# 325 "./src/main/vcpf4/usbd_desc.c"
uint8_t * USBD_USR_InterfaceStrDescriptor( uint8_t speed , uint16_t *length)
{
  if (speed == 0)
