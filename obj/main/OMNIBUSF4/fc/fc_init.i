...
# 10 "/home/jiahao/betaflight/tools/gcc-arm-none-eabi-7-2017-q4-major/arm-none-eabi/include/string.h" 3
...
# 11 "/home/jiahao/betaflight/tools/gcc-arm-none-eabi-7-2017-q4-major/arm-none-eabi/include/string.h" 2 3
...
# 12 "/home/jiahao/betaflight/tools/gcc-arm-none-eabi-7-2017-q4-major/arm-none-eabi/include/string.h" 2 3
...
# 13 "/home/jiahao/betaflight/tools/gcc-arm-none-eabi-7-2017-q4-major/arm-none-eabi/include/string.h" 2 3
...
# 21 "/home/jiahao/betaflight/tools/gcc-arm-none-eabi-7-2017-q4-major/arm-none-eabi/include/string.h" 2 3
...
# 84 "./src/main/cms/cms_types.h"
typedef long (*CMSMenuFuncPtr)(void);
# 96 "./src/main/cms/cms_types.h"
...
# 21 "./src/main/drivers/pwm_esc_detect.h"
...
# 27 "./src/main/drivers/pwm_output.h" 2
...
# 21 "./src/main/drivers/buttons.h"
       

void buttonsInit(void);


# 25 "./src/main/drivers/buttons.h" 3 4
_Bool 
# 25 "./src/main/drivers/buttons.h"
    buttonAPressed(void);

# 26 "./src/main/drivers/buttons.h" 3 4
_Bool 
# 26 "./src/main/drivers/buttons.h"
    buttonBPressed(void);
...
# 21 "./src/main/drivers/serial_softserial.h"
...
# 38 "./src/main/drivers/serial_softserial.h" 3 4
_Bool 
# 38 "./src/main/drivers/serial_softserial.h"
    isSoftSerialTransmitBufferEmpty(const serialPort_t *s);
# 66 "./src/main/fc/fc_init.c" 2
# 1 "./src/main/drivers/serial_uart.h" 1
# 21 "./src/main/drivers/serial_uart.h"
       
# 34 "./src/main/drivers/serial_uart.h"
typedef enum {
    UARTDEV_1 = 0,
    UARTDEV_2 = 1,
    UARTDEV_3 = 2,
...
# 27 "./src/main/drivers/usb_io.h" 3 4
_Bool 
# 27 "./src/main/drivers/usb_io.h"
    usbCableIsInserted(void);
# 75 "./src/main/fc/fc_init.c" 2
# 1 "./src/main/drivers/vtx_rtc6705.h" 1
# 28 "./src/main/drivers/vtx_rtc6705.h"
       
# 48 "./src/main/drivers/vtx_rtc6705.h"
...
# 111 "./src/main/msp/msp_serial.h" 3 4
   _Bool 
# 111 "./src/main/msp/msp_serial.h"
        sharedWithTelemetry;
} mspPort_t;

void mspSerialInit(void);

# 115 "./src/main/msp/msp_serial.h" 3 4
_Bool 
# 115 "./src/main/msp/msp_serial.h"
...
# 21 "./src/main/io/displayport_max7456.h"
...
# 21 "./src/main/io/displayport_srxl.h"
...
# 21 "./src/main/io/osd_slave.h"
       
# 127 "./src/main/fc/fc_init.c" 2
# 1 "./src/main/io/pidaudio.h" 1
# 21 "./src/main/io/pidaudio.h"
...
# 21 "./src/main/io/displayport_msp.h"
...
# 65 "./src/main/io/vtx_smartaudio.h"
...
# 134 "./src/main/fc/fc_init.c" 2
# 1 "./src/main/io/vtx_tramp.h" 1
# 21 "./src/main/io/vtx_tramp.h"
       
# 39 "./src/main/io/vtx_tramp.h"
...
# 50 "./src/main/io/vtx_tramp.h" 3 4
_Bool 
# 50 "./src/main/io/vtx_tramp.h"
    vtxTrampInit(void);

# 51 "./src/main/io/vtx_tramp.h" 3 4
_Bool 
# 51 "./src/main/io/vtx_tramp.h"
...
# 21 "./src/main/sensors/initialisation.h"
       


# 23 "./src/main/sensors/initialisation.h" 3 4
_Bool 
# 23 "./src/main/sensors/initialisation.h"
    sensorsAutodetect(void);
# 146 "./src/main/fc/fc_init.c" 2
...
# 155 "./src/main/fc/fc_init.c" 2

# 1 "./src/main/io/rcdevice_cam.h" 1
# 21 "./src/main/io/rcdevice_cam.h"
...
# 21 "./src/main/io/rcdevice.h"
       
# 43 "./src/main/io/rcdevice.h"
typedef enum {
...
# 110 "./src/main/io/rcdevice.h" 3 4
   _Bool 
# 110 "./src/main/io/rcdevice.h"
        isReady;
} runcamDevice_t;
...
struct rcdeviceResponseParseContext_s {
    uint8_t command;
    uint8_t expectedRespLen;
    uint8_t recvRespLen;
    uint8_t *recvBuf;
    timeMs_t timeout;
    timeMs_t timeoutTimestamp;
    rcdeviceRespParseFunc parserFunc;
    runcamDevice_t *device;
    uint8_t paramData[62];
...
typedef struct {
    ...
    uint8_t tailPos;
    uint8_t itemCount;
    rcdeviceResponseParseContext_t buffer[5];
...
# 152 "./src/main/io/rcdevice.h" 3 4
_Bool 
# 152 "./src/main/io/rcdevice.h"
...
extern 
# 40 "./src/main/io/rcdevice_cam.h" 3 4
      _Bool 
# 40 "./src/main/io/rcdevice_cam.h"
           rcdeviceInMenu;
...
# 45 "./src/main/io/rcdevice_cam.h" 3 4
_Bool 
# 45 "./src/main/io/rcdevice_cam.h"
...
# 164 "./src/main/fc/fc_init.c" 2
# 173 "./src/main/fc/fc_init.c"
uint8_t systemState = SYSTEM_STATE_INITIALISING;

void processLoopback(void)
{
# 186 "./src/main/fc/fc_init.c"
}
# 202 "./src/main/fc/fc_init.c"
void init(void)
{
# 214 "./src/main/fc/fc_init.c"
...
# 243 "./src/main/fc/fc_init.c" 3 4
   _Bool 
# 243 "./src/main/fc/fc_init.c"
        readSuccess = readEEPROM();


    initBoardInformation();


    if (!readSuccess || !isEEPROMVersionValid() || strncasecmp(systemConfig()->boardIdentifier, "OBF4", sizeof("OBF4"))) {
        resetEEPROM();
    }
    ...
    ledSet(2, 
# 269 "./src/main/fc/fc_init.c" 3 4
   1
# 269 "./src/main/fc/fc_init.c"
   );


    EXTIInit();
# 303 "./src/main/fc/fc_init.c"
...
# 429 "./src/main/fc/fc_init.c"
    i2cInit(I2CDEV_2);


    i2cInit(I2CDEV_3);
# 450 "./src/main/fc/fc_init.c"
    cameraControlInit();
# 468 "./src/main/fc/fc_init.c"
    ...
    ledSet(1, 
# 517 "./src/main/fc/fc_init.c" 3 4
   1
# 517 "./src/main/fc/fc_init.c"
   );
    ledSet(0, 
# 518 "./src/main/fc/fc_init.c" 3 4
   0
# 518 "./src/main/fc/fc_init.c"
   );
    ledSet(2, 
# 519 "./src/main/fc/fc_init.c" 3 4
   0
# 519 "./src/main/fc/fc_init.c"
   );
    ...
    for (int i = 0; i < 10; i++) {
        ...
        delay(25);
        if (!(beeperConfig()->beeper_off_flags & (1 << (BEEPER_SYSTEM_INIT - 1)))) {
            systemBeep(
# 527 "./src/main/fc/fc_init.c" 3 4
           1
# 527 "./src/main/fc/fc_init.c"
           );
        }
        delay(25);
        systemBeep(
# 530 "./src/main/fc/fc_init.c" 3 4
       0
# 530 "./src/main/fc/fc_init.c"
       );
    ...
    ledSet(0, 
# 535 "./src/main/fc/fc_init.c" 3 4
   0
# 535 "./src/main/fc/fc_init.c"
   );
    ledSet(1, 
...
# 559 "./src/main/fc/fc_init.c" 3 4
                                   ((void *)0)
# 559 "./src/main/fc/fc_init.c"
                                       ;
...
# 668 "./src/main/fc/fc_init.c" 3 4
                        0
# 668 "./src/main/fc/fc_init.c"
                             );
    ...
    vtxTrampInit();
# 702 "./src/main/fc/fc_init.c"
    timerStart();

    (stateFlags |= (SMALL_ANGLE));
# 715 "./src/main/fc/fc_init.c"
    batteryInit();
