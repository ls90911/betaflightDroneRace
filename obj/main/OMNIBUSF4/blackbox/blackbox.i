...
const blackboxConfig_t pgResetTemplate_blackboxConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .p_ratio = 32, .device = BLACKBOX_DEVICE_FLASH, .record_acc = 1, .mode = BLACKBOX_MODE_NORMAL }
