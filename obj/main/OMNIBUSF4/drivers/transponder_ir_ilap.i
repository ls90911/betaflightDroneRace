...
# 1 "<command-line>"
# 1 "./src/main/drivers/transponder_ir_ilap.c"
# 21 "./src/main/drivers/transponder_ir_ilap.c"
...
# 24 "./src/main/drivers/transponder_ir_ilap.c" 2
...
# 25 "./src/main/drivers/transponder_ir_ilap.c" 2
...
# 29 "./src/main/drivers/transponder_ir_ilap.c" 2
...
# 30 "./src/main/drivers/transponder_ir_ilap.c" 2
...
void transponderIrInitIlap(transponder_t *transponder){
    ...
    transponder->gap_toggles = 1;
    transponder->dma_buffer_size = ((11 + 1) * 10 * 6);
    transponder->vTable = &ilapTansponderVTable;
    transponder->timer_hz = 24;
    transponder->timer_carrier_hz = 460750;
...
# 57 "./src/main/drivers/transponder_ir_ilap.c" 3 4
               _Bool 
# 57 "./src/main/drivers/transponder_ir_ilap.c"
                    doToggles = 
# 57 "./src/main/drivers/transponder_ir_ilap.c" 3 4
                                0
# 57 "./src/main/drivers/transponder_ir_ilap.c"
                ...
                if (bitIndex == 0) {
                    doToggles = 
# 59 "./src/main/drivers/transponder_ir_ilap.c" 3 4
                               1
# 59 "./src/main/drivers/transponder_ir_ilap.c"
                                   ;
                }
                else if (bitIndex == 10 - 1) {
                    doToggles = 
# 62 "./src/main/drivers/transponder_ir_ilap.c" 3 4
                               0
# 62 "./src/main/drivers/transponder_ir_ilap.c"
                                    ;
                }
                else {
                    doToggles = byteToSend & (1 << (bitIndex - 1));
                }
                for (toggleIndex = 0; toggleIndex < 11; toggleIndex++)
                {
                    if (doToggles) {
