...
# 29 "./src/main/drivers/system_stm32f4xx.c" 2
...
# 30 "./src/main/drivers/system_stm32f4xx.c" 2
...
__attribute__ ((section(".persistent_data"), aligned(4))) uint32_t bootloaderRequest = 0;
...
typedef struct isrVector_s {
    volatile const uint32_t stackEnd;
...
# 181 "./src/main/drivers/system_stm32f4xx.c" 3 4
_Bool 
# 181 "./src/main/drivers/system_stm32f4xx.c"
    isMPUSoftReset(void)
{
    if (cachedRccCsrValue & ((uint32_t)0x10000000))
        return 
# 184 "./src/main/drivers/system_stm32f4xx.c" 3 4
              1
# 184 "./src/main/drivers/system_stm32f4xx.c"
                  ;
    else
        return 
# 186 "./src/main/drivers/system_stm32f4xx.c" 3 4
              0
# 186 "./src/main/drivers/system_stm32f4xx.c"
                   ;
}
