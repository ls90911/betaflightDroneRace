...
# 1 "<command-line>"
# 1 "./src/main/drivers/accgyro/accgyro_mpu.c"
# 21 "./src/main/drivers/accgyro/accgyro_mpu.c"
...
# 23 "./src/main/drivers/accgyro/accgyro_mpu.c" 2
...
# 25 "./src/main/drivers/accgyro/accgyro_mpu.c" 2
...
# 29 "./src/main/drivers/accgyro/accgyro_mpu.c" 2
...
# 29 "./src/main/drivers/bus_spi.h" 2
...
# 42 "./src/main/drivers/accgyro/accgyro_mpu.c" 2
...
# 53 "./src/main/drivers/accgyro/accgyro_mpu.c" 2
...
# 54 "./src/main/drivers/accgyro/accgyro_mpu.c" 2
...
# 55 "./src/main/drivers/accgyro/accgyro_mpu.c" 2


mpuResetFnPtr mpuResetFn;
# 70 "./src/main/drivers/accgyro/accgyro_mpu.c"
...
# 77 "./src/main/drivers/accgyro/accgyro_mpu.c"
        ack = busReadRegisterBuffer(&gyro->bus, 0x06, readBuffer, 6);
    ...
    if (ack && revision) {
        ...
        uint8_t productId;
        ack = busReadRegisterBuffer(&gyro->bus, 0x0C, &productId, 1);
...
# 117 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
                     __builtin_offsetof (
# 117 "./src/main/drivers/accgyro/accgyro_mpu.c"
                     gyroDev_t
# 117 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
                     , 
# 117 "./src/main/drivers/accgyro/accgyro_mpu.c"
...
# 145 "./src/main/drivers/accgyro/accgyro_mpu.c"
    ...
    EXTIEnable(mpuIntIO, 
# 151 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
                        1
# 151 "./src/main/drivers/accgyro/accgyro_mpu.c"
                            );
}



# 155 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
_Bool 
# 155 "./src/main/drivers/accgyro/accgyro_mpu.c"
    mpuAccRead(accDev_t *acc)
{
    uint8_t data[6];

    const 
# 159 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
         _Bool 
# 159 "./src/main/drivers/accgyro/accgyro_mpu.c"
              ack = busReadRegisterBuffer(&acc->bus, 0x3B, data, 6);
    if (!ack) {
        return 
# 161 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
              0
# 161 "./src/main/drivers/accgyro/accgyro_mpu.c"
                   ;
    }
...
# 171 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
_Bool 
# 171 "./src/main/drivers/accgyro/accgyro_mpu.c"
...
# 175 "./src/main/drivers/accgyro/accgyro_mpu.c"
    ...
    if (!ack) {
        return 
# 177 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
              0
# 177 "./src/main/drivers/accgyro/accgyro_mpu.c"
                   ;
    }
    ...
    return 
# 184 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
          1
# 184 "./src/main/drivers/accgyro/accgyro_mpu.c"
              ;
}


# 187 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
_Bool 
# 187 "./src/main/drivers/accgyro/accgyro_mpu.c"
...
# 192 "./src/main/drivers/accgyro/accgyro_mpu.c"
    ...
    if (!ack) {
        return 
# 194 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
              0
# 194 "./src/main/drivers/accgyro/accgyro_mpu.c"
                   ;
    }
    ...
    return 
# 201 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
          1
# 201 "./src/main/drivers/accgyro/accgyro_mpu.c"
              ;
}


static 
# 205 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
      _Bool 
# 205 "./src/main/drivers/accgyro/accgyro_mpu.c"
           detectSPISensorsAndUpdateDetectionResult(gyroDev_t *gyro)
{
    ...
    spiBusSetInstance(&gyro->bus, ((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3000)));


    gyro->bus.busdev_u.spi.csnPin = gyro->bus.busdev_u.spi.csnPin == ((IO_t)0) ? IOGetByTag(((ioTag_t)((((0) + 1) << 4) | (4)))) : gyro->bus.busdev_u.spi.csnPin;

    sensor = mpu6000SpiDetect(&gyro->bus);
    if (sensor != MPU_NONE) {
        gyro->mpuDetectionResult.sensor = sensor;
        return 
# 224 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
              1
# 224 "./src/main/drivers/accgyro/accgyro_mpu.c"
                  ;
    }
    ...
    if (sensor != MPU_NONE) {
        gyro->mpuDetectionResult.sensor = sensor;
        return 
# 239 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
              1
# 239 "./src/main/drivers/accgyro/accgyro_mpu.c"
                  ;
    }
# 301 "./src/main/drivers/accgyro/accgyro_mpu.c"
    return 
# 301 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
          0
# 301 "./src/main/drivers/accgyro/accgyro_mpu.c"
               ;
}
...
void mpuDetect(gyroDev_t *gyro)
{
    ...
    if (gyro->bus.bustype == BUSTYPE_I2C) {
        gyro->bus.busdev_u.i2c.device = (I2CDEV_2);
        gyro->bus.busdev_u.i2c.address = 0x68;

        uint8_t sig = 0;
        
# 321 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
       _Bool 
# 321 "./src/main/drivers/accgyro/accgyro_mpu.c"
            ack = busReadRegisterBuffer(&gyro->bus, 0x75, &sig, 1);

        if (ack) {

            uint8_t inquiryResult;
            ack = busReadRegisterBuffer(&gyro->bus, 0x00, &inquiryResult, 1);
            inquiryResult &= 0x7E;
...
uint8_t mpuGyroReadRegister(const busDevice_t *bus, uint8_t reg)
{
    uint8_t data;
    const 
# 401 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
         _Bool 
# 401 "./src/main/drivers/accgyro/accgyro_mpu.c"
              ack = busReadRegisterBuffer(bus, reg, &data, 1);
    if (ack) {
        return data;
    } else {
        return 0;
