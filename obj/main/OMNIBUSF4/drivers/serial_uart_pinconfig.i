...
# 1 "<command-line>"
# 1 "./src/main/drivers/serial_uart_pinconfig.c"
# 30 "./src/main/drivers/serial_uart_pinconfig.c"
...
# 32 "./src/main/drivers/serial_uart_pinconfig.c" 2
...
# 34 "./src/main/drivers/serial_uart_pinconfig.c" 2
...
# 39 "./src/main/drivers/serial_uart_pinconfig.c" 2
...
# 40 "./src/main/drivers/serial_uart_pinconfig.c" 2
...
# 41 "./src/main/drivers/serial_uart_pinconfig.c" 2

__attribute__ ((section(".fastram_bss"), aligned(4))) uartDevice_t uartDevice[(1 + 0 + 1 + 0 + 0 + 1 + 0 + 0)];
__attribute__ ((section(".fastram_bss"), aligned(4))) uartDevice_t *uartDevmap[6];

void uartPinConfigure(const serialPinConfig_t *pSerialPinConfig)
{
    uartDevice_t *uartdev = uartDevice;

    for (size_t hindex = 0; hindex < (1 + 0 + 1 + 0 + 0 + 1 + 0 + 0); hindex++) {
