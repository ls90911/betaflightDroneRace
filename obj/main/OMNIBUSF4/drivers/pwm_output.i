...
# 1 "<command-line>"
# 1 "./src/main/drivers/pwm_output.c"
# 21 "./src/main/drivers/pwm_output.c"
...
static __attribute__ ((section(".fastram_bss"), aligned(4))) pwmWriteFn *pwmWrite;
static __attribute__ ((section(".fastram_bss"), aligned(4))) pwmOutputPort_t motors[8];
static __attribute__ ((section(".fastram_bss"), aligned(4))) pwmCompleteWriteFn *pwmCompleteWrite = 
# 36 "./src/main/drivers/pwm_output.c" 3 4
                                                                ((void *)0)
# 36 "./src/main/drivers/pwm_output.c"
                                                                    ;


__attribute__ ((section(".fastram_bss"), aligned(4))) loadDmaBufferFn *loadDmaBuffer;
...
# 65 "./src/main/drivers/pwm_output.c"
                                   ;
static 
# 66 "./src/main/drivers/pwm_output.c" 3 4
      _Bool 
# 66 "./src/main/drivers/pwm_output.c"
           isDshot = 
# 66 "./src/main/drivers/pwm_output.c" 3 4
                     0
# 66 "./src/main/drivers/pwm_output.c"
...
__attribute__ ((section(".fastram_bss"), aligned(4))) 
# 68 "./src/main/drivers/pwm_output.c" 3 4
                  _Bool 
# 68 "./src/main/drivers/pwm_output.c"
                       useBurstDshot = 
# 68 "./src/main/drivers/pwm_output.c" 3 4
                                       0
# 68 "./src/main/drivers/pwm_output.c"
...
{
# 89 "./src/main/drivers/pwm_output.c"
...
# 131 "./src/main/drivers/pwm_output.c"
...
void pwmDisableMotors(void)
{
    ...
    pwmMotorsEnabled = 
# 199 "./src/main/drivers/pwm_output.c" 3 4
                      0
# 199 "./src/main/drivers/pwm_output.c"
                           ;
}
...
# 208 "./src/main/drivers/pwm_output.c" 3 4
_Bool 
# 208 "./src/main/drivers/pwm_output.c"
    pwmAreMotorsEnabled(void)
{
...
# 239 "./src/main/drivers/pwm_output.c"
    ...
    case PWM_TYPE_BRUSHED:
        sMin = 0;
        useUnsyncedPwm = 
# 259 "./src/main/drivers/pwm_output.c" 3 4
                        1
# 259 "./src/main/drivers/pwm_output.c"
                            ;
        idlePulse = 0;
        break;
    case PWM_TYPE_STANDARD:
        ...
        sLen = 1e-3f;
        useUnsyncedPwm = 
# 265 "./src/main/drivers/pwm_output.c" 3 4
                        1
# 265 "./src/main/drivers/pwm_output.c"
                            ;
        idlePulse = 0;
        break;
    ...
    case PWM_TYPE_PROSHOT1000:
        ...
        isDshot = 
# 273 "./src/main/drivers/pwm_output.c" 3 4
                 1
# 273 "./src/main/drivers/pwm_output.c"
                     ;
        break;
    ...
    case PWM_TYPE_DSHOT150:
        ...
        pwmCompleteWrite = &pwmCompleteDshotMotorUpdate;
        isDshot = 
# 282 "./src/main/drivers/pwm_output.c" 3 4
                 1
# 282 "./src/main/drivers/pwm_output.c"
                     ;
...
# 318 "./src/main/drivers/pwm_output.c" 3 4
                                        1
# 318 "./src/main/drivers/pwm_output.c"
                                            ;
            continue;
        }
        ...
        IOConfigGPIOAF(motors[motorIndex].io, ((GPIO_Mode_AF) | ((0) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)), timerHardware->alternateFunction);
...
# 349 "./src/main/drivers/pwm_output.c" 3 4
       _Bool 
# 349 "./src/main/drivers/pwm_output.c"
            timerAlreadyUsed = 
# 349 "./src/main/drivers/pwm_output.c" 3 4
                               0
# 349 "./src/main/drivers/pwm_output.c"
...
# 352 "./src/main/drivers/pwm_output.c"
        ...
        motors[motorIndex].enabled = 
# 357 "./src/main/drivers/pwm_output.c" 3 4
                                    1
# 357 "./src/main/drivers/pwm_output.c"
                                        ;
    }

    pwmMotorsEnabled = 
# 360 "./src/main/drivers/pwm_output.c" 3 4
                      1
# 360 "./src/main/drivers/pwm_output.c"
                          ;
}
...
# 368 "./src/main/drivers/pwm_output.c" 3 4
_Bool 
# 368 "./src/main/drivers/pwm_output.c"
    isMotorProtocolDshot(void)
{
    return isDshot;
}
...
# 391 "./src/main/drivers/pwm_output.c" 3 4
_Bool 
# 391 "./src/main/drivers/pwm_output.c"
    allMotorsAreIdle(uint8_t motorCount)
{
    
# 393 "./src/main/drivers/pwm_output.c" 3 4
   _Bool 
# 393 "./src/main/drivers/pwm_output.c"
        allMotorsIdle = 
# 393 "./src/main/drivers/pwm_output.c" 3 4
                        1
# 393 "./src/main/drivers/pwm_output.c"
    ...
    for (unsigned i = 0; i < motorCount; i++) {
        ...
        if (motor->value) {
            allMotorsIdle = 
# 397 "./src/main/drivers/pwm_output.c" 3 4
                           0
# 397 "./src/main/drivers/pwm_output.c"
                                ;
        }
    }
...
# 404 "./src/main/drivers/pwm_output.c" 3 4
         _Bool 
# 404 "./src/main/drivers/pwm_output.c"
              pwmDshotCommandIsQueued(void)
{
...
# 409 "./src/main/drivers/pwm_output.c" 3 4
         _Bool 
# 409 "./src/main/drivers/pwm_output.c"
              pwmDshotCommandIsProcessing(void)
{
...
void pwmWriteDshotCommand(uint8_t index, uint8_t motorCount, uint8_t command, 
# 414 "./src/main/drivers/pwm_output.c" 3 4
                                                                             _Bool 
# 414 "./src/main/drivers/pwm_output.c"
                                                                                  blocking)
{
    timeUs_t timeNowUs = micros();

    if (!isMotorProtocolDshot() || (command > 47) || pwmDshotCommandIsQueued()) {
        return;
    }
...
# 454 "./src/main/drivers/pwm_output.c" 3 4
                                             1
# 454 "./src/main/drivers/pwm_output.c"
                                                 ;
        ...
        dshotCommandControl.nextCommandAtUs = timeNowUs + 10000;
...
# 483 "./src/main/drivers/pwm_output.c" 3 4
                  _Bool 
# 483 "./src/main/drivers/pwm_output.c"
                       pwmDshotCommandOutputIsEnabled(uint8_t motorCount)
{
    timeUs_t timeNowUs = micros();
...
# 490 "./src/main/drivers/pwm_output.c" 3 4
                                                0
# 490 "./src/main/drivers/pwm_output.c"
                                                     ;
        }


        return 
# 494 "./src/main/drivers/pwm_output.c" 3 4
              1
# 494 "./src/main/drivers/pwm_output.c"
                  ;
    }
    ...
    if (cmpTimeUs(timeNowUs, dshotCommandControl.nextCommandAtUs) < 0) {
        ...
        return 
# 499 "./src/main/drivers/pwm_output.c" 3 4
              0
# 499 "./src/main/drivers/pwm_output.c"
                   ;
    }
    ...
    if (dshotCommandControl.repeats > 0) {
        ...
        if (dshotCommandControl.repeats > 0) {
            dshotCommandControl.nextCommandAtUs = timeNowUs + 1000;
        } else {
    ...
    return 
# 515 "./src/main/drivers/pwm_output.c" 3 4
          1
# 515 "./src/main/drivers/pwm_output.c"
              ;
}
 ...
 uint16_t prepareDshotPacket(motorDmaOutput_t *const motor)
{
    ...
    motor->requestTelemetry = 
# 521 "./src/main/drivers/pwm_output.c" 3 4
                             0
# 521 "./src/main/drivers/pwm_output.c"
                                  ;
...
void servoDevInit(const servoDevConfig_t *servoConfig)
{
    for (uint8_t servoIndex = 0; servoIndex < 8; servoIndex++) {
        ...
        if (timer == 
# 566 "./src/main/drivers/pwm_output.c" 3 4
                    ((void *)0)
# 566 "./src/main/drivers/pwm_output.c"
                        ) {
...
# 571 "./src/main/drivers/pwm_output.c" 3 4
                                    1
# 571 "./src/main/drivers/pwm_output.c"
                                        ;
    }
}
...
void pwmWriteBeeper(
# 578 "./src/main/drivers/pwm_output.c" 3 4
                   _Bool 
# 578 "./src/main/drivers/pwm_output.c"
                        onoffBeep)
{
    if (!beeperPwm.io) {
        return;
    ...
    if (onoffBeep == 
# 584 "./src/main/drivers/pwm_output.c" 3 4
                    1
# 584 "./src/main/drivers/pwm_output.c"
                        ) {
        *beeperPwm.channel.ccr = (((1) * 1000000) / freqBeep) / 2;
        beeperPwm.enabled = 
# 586 "./src/main/drivers/pwm_output.c" 3 4
                           1
# 586 "./src/main/drivers/pwm_output.c"
                               ;
    } else {
        *beeperPwm.channel.ccr = 0;
        beeperPwm.enabled = 
# 589 "./src/main/drivers/pwm_output.c" 3 4
                           0
# 589 "./src/main/drivers/pwm_output.c"
                                ;
    }
}
...
void beeperPwmInit(const ioTag_t tag, uint16_t frequency)
{
    ...
    if (beeperIO && timer) {
        ...
        *beeperPwm.channel.ccr = 0;
        beeperPwm.enabled = 
# 615 "./src/main/drivers/pwm_output.c" 3 4
                           0
# 615 "./src/main/drivers/pwm_output.c"
                                ;
    }
}
