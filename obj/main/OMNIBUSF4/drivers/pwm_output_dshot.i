...
# 40 "./src/main/drivers/pwm_output_dshot.c" 2
...
# 41 "./src/main/drivers/pwm_output_dshot.c" 2
...
# 42 "./src/main/drivers/pwm_output_dshot.c" 2
...
# 43 "./src/main/drivers/pwm_output_dshot.c" 2
...
# 76 "./src/main/drivers/pwm_output_dshot.c" 3 4
                                     1
# 76 "./src/main/drivers/pwm_output_dshot.c"
                                         ;
        }
    }
...
void pwmDshotMotorHardwareConfig(const timerHardware_t *timerHardware, uint8_t motorIndex, motorPwmProtocolTypes_e pwmProtocolType, uint8_t output)
{
    ...
    if (dmaRef == 
# 166 "./src/main/drivers/pwm_output_dshot.c" 3 4
                 ((void *)0)
# 166 "./src/main/drivers/pwm_output_dshot.c"
                     ) {
        return;
    }
    ...
    const 
# 184 "./src/main/drivers/pwm_output_dshot.c" 3 4
         _Bool 
# 184 "./src/main/drivers/pwm_output_dshot.c"
              configureTimer = (timerIndex == dmaMotorTimerCount-1);

    IOConfigGPIOAF(motorIO, ((GPIO_Mode_AF) | ((GPIO_Fast_Speed) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_UP) << 5)), timerHardware->alternateFunction);
    ...
    if (useBurstDshot) {
        ...
        if (!configureTimer) {
            motor->configured = 
# 238 "./src/main/drivers/pwm_output_dshot.c" 3 4
                               1
# 238 "./src/main/drivers/pwm_output_dshot.c"
                                   ;
            return;
        }
    } else
    ...
    {
        dmaInit(timerHardware->dmaIrqHandler, OWNER_MOTOR, (motorIndex + 1));
        dmaSetHandler(timerHardware->dmaIrqHandler, motor_DMA_IRQHandler, (((((1)<<(4-(7-(((uint32_t)0x500)>>8))))|((2)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0), motorIndex);
    ...
    motor->configured = 
# 311 "./src/main/drivers/pwm_output_dshot.c" 3 4
                       1
# 311 "./src/main/drivers/pwm_output_dshot.c"
                           ;
}
