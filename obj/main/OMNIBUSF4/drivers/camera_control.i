...
# 1 "<command-line>"
# 1 "./src/main/drivers/camera_control.c"
# 21 "./src/main/drivers/camera_control.c"
...
# 23 "./src/main/drivers/rcc_types.h"
...
# 32 "./src/main/drivers/camera_control.c" 2
# 52 "./src/main/drivers/camera_control.c"
...
# 53 "./src/main/drivers/camera_control.c" 2
# 63 "./src/main/drivers/camera_control.c"
...
# 64 "./src/main/drivers/camera_control.c" 2
...
const cameraControlConfig_t pgResetTemplate_cameraControlConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .mode = CAMERA_CONTROL_MODE_HARDWARE_PWM, .refVoltage = 330, .keyDelayMs = 180, .internalResistance = 470, .ioTag = 0, .inverted = 0, }
...
# 78 "./src/main/drivers/camera_control.c" 3 4
   _Bool 
# 78 "./src/main/drivers/camera_control.c"
        enabled;
    IO_t io;
    timerChannel_t channel;
    uint32_t period;
...
void TIM6_DAC_IRQHandler(void)
{
    ...
    ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1000))->SR = 0;
}
...
void TIM7_IRQHandler(void)
{
    ...
    ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1400))->SR = 0;
}
...
void cameraControlInit(void)
{
    ...
    if (CAMERA_CONTROL_MODE_HARDWARE_PWM == cameraControlConfig()->mode) {
        ...
        pwmOutConfig(&cameraControlRuntime.channel, timerHardware, ((84) * 1000000), 128, 0, cameraControlRuntime.inverted);

        cameraControlRuntime.period = 128;
        *cameraControlRuntime.channel.ccr = cameraControlRuntime.period;
        cameraControlRuntime.enabled = 
# 148 "./src/main/drivers/camera_control.c" 3 4
                                      1
# 148 "./src/main/drivers/camera_control.c"
                                          ;
        ...
        cameraControlRuntime.enabled = 
# 157 "./src/main/drivers/camera_control.c" 3 4
                                      1
# 157 "./src/main/drivers/camera_control.c"
                                          ;
        ...
        ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->APB1ENR |= ((uint32_t)0x00000010) | ((uint32_t)0x00000020);
        ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1000))->PSC = 0;
        ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1400))->PSC = 0;
    ...
    if (CAMERA_CONTROL_MODE_HARDWARE_PWM == cameraControlConfig()->mode) {
        ...
        *cameraControlRuntime.channel.ccr = lrintf(dutyCycle * cameraControlRuntime.period);
        ...
        if (0 == hiTime) {
            ...
            ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1000))->CNT = hiTime;
            ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1000))->ARR = cameraControlRuntime.period;

            ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1400))->CNT = 0;
            ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1400))->ARR = cameraControlRuntime.period;
            ...
            for ( uint8_t __basepri_save __attribute__ ((__cleanup__ (__basepriRestoreMem), __unused__)) = __get_BASEPRI(), __ToDo = __basepriSetMemRetVal((((((1)<<(4-(7-(((uint32_t)0x500)>>8))))|((1)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0)); __ToDo ; __ToDo = 0 ) {
                ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1000))->CR1 = ((uint16_t)0x0001);
                ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1400))->CR1 = ((uint16_t)0x0001);
            }


            ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1000))->DIER = ((uint16_t)0x0001);
            ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1400))->DIER = ((uint16_t)0x0001);
            ...
            ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1000))->CR1 &= ~((uint16_t)0x0001);
            ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1400))->CR1 &= ~((uint16_t)0x0001);
            ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1000))->DIER = 0;
            ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1400))->DIER = 0;
