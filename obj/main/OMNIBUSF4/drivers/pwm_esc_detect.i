...
# 1 "<command-line>"
# 1 "./src/main/drivers/pwm_esc_detect.c"
# 21 "./src/main/drivers/pwm_esc_detect.c"
...
# 23 "./src/main/drivers/pwm_esc_detect.c" 2
...
{
    int i = 0;
    while (!(timerHardware[i].usageFlags & TIM_USE_MOTOR) && (i < 14)) {
        i++;
    }

    IO_t MotorDetectPin = IOGetByTag(timerHardware[i].tag);
    IOInit(MotorDetectPin, OWNER_SYSTEM, 0);
    IOConfigGPIO(MotorDetectPin, ((GPIO_Mode_IN) | ((0) << 2) | ((0) << 4) | ((GPIO_PuPd_UP) << 5)));
