...
# 23 "./src/main/drivers/transponder_ir_arcitimer.c" 2
...
# 24 "./src/main/drivers/transponder_ir_arcitimer.c" 2
...
# 25 "./src/main/drivers/transponder_ir_arcitimer.c" 2
...
# 24 "./src/main/drivers/transponder_ir.h" 2
...
# 29 "./src/main/drivers/transponder_ir_arcitimer.c" 2
...
# 30 "./src/main/drivers/transponder_ir_arcitimer.c" 2
...
void transponderIrInitArcitimer(transponder_t *transponder){
    ...
    transponder->gap_toggles = 0;
    transponder->dma_buffer_size = 155 * 4;
    transponder->vTable = &arcitimerTansponderVTable;
    transponder->timer_hz = 24;
    transponder->timer_carrier_hz = 41886;
...
# 56 "./src/main/drivers/transponder_ir_arcitimer.c" 3 4
           _Bool 
# 56 "./src/main/drivers/transponder_ir_arcitimer.c"
                isHightState = byteToSend & (1 << (bitIndex));
            for (hightStateIndex = 0; hightStateIndex < 4; hightStateIndex++)
            {
