...
# 23 "./src/main/drivers/usb_io.c" 2
...
# 30 "./src/main/drivers/usb_io.c" 2
...
# 32 "./src/main/drivers/usb_io.c" 2



static IO_t usbDetectPin = ((IO_t)0);
...
void usbCableDetectDeinit(void)
{
    ...
    IOConfigGPIO(usbDetectPin, ((GPIO_Mode_IN) | ((0) << 2) | ((0) << 4) | ((GPIO_PuPd_NOPULL) << 5)));
    usbDetectPin = ((IO_t)0);
...
void usbCableDetectInit(void)
{
    ...
    usbDetectPin = IOGetByTag(((ioTag_t)((((2) + 1) << 4) | (5))));

    IOInit(usbDetectPin, OWNER_USB_DETECT, 0);
    IOConfigGPIO(usbDetectPin, ((GPIO_Mode_OUT) | ((0) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)));

}


# 60 "./src/main/drivers/usb_io.c" 3 4
_Bool 
# 60 "./src/main/drivers/usb_io.c"
    usbCableIsInserted(void)
{
    
# 62 "./src/main/drivers/usb_io.c" 3 4
   _Bool 
# 62 "./src/main/drivers/usb_io.c"
        result = 
# 62 "./src/main/drivers/usb_io.c" 3 4
                 0
# 62 "./src/main/drivers/usb_io.c"
