...
# 1 "<command-line>"
# 1 "./src/main/drivers/bus_i2c_stm32f10x.c"
# 21 "./src/main/drivers/bus_i2c_stm32f10x.c"
...
# 33 "./src/main/drivers/bus_i2c_stm32f10x.c" 2
...
# 34 "./src/main/drivers/bus_i2c_stm32f10x.c" 2
...
# 36 "./src/main/drivers/bus_i2c_stm32f10x.c" 2
# 1 "./src/main/drivers/bus_i2c_impl.h" 1
# 21 "./src/main/drivers/bus_i2c_impl.h"
       
# 34 "./src/main/drivers/bus_i2c_impl.h"
...
# 49 "./src/main/drivers/bus_i2c_impl.h"
typedef struct i2cHardware_s {
    I2CDevice device;
    I2C_TypeDef *reg;
    i2cPinDef_t sclPins[4];
    i2cPinDef_t sdaPins[4];
    rccPeriphTag_t rcc;
...
# 65 "./src/main/drivers/bus_i2c_impl.h"
                 error;
    volatile 
# 66 "./src/main/drivers/bus_i2c_impl.h" 3 4
            _Bool 
# 66 "./src/main/drivers/bus_i2c_impl.h"
                 busy;
...
# 86 "./src/main/drivers/bus_i2c_impl.h" 3 4
   _Bool 
# 86 "./src/main/drivers/bus_i2c_impl.h"
        overClock;
    
# 87 "./src/main/drivers/bus_i2c_impl.h" 3 4
   _Bool 
# 87 "./src/main/drivers/bus_i2c_impl.h"
        pullUp;
...
# 37 "./src/main/drivers/bus_i2c_stm32f10x.c" 2
# 51 "./src/main/drivers/bus_i2c_stm32f10x.c"
static void i2c_er_handler(I2CDevice device);
static void i2c_ev_handler(I2CDevice device);
static void i2cUnstick(IO_t scl, IO_t sda);
# 62 "./src/main/drivers/bus_i2c_stm32f10x.c"
const i2cHardware_t i2cHardware[3] = {
# 81 "./src/main/drivers/bus_i2c_stm32f10x.c"
    {
        .device = I2CDEV_2,
        .reg = ((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5800)),
        .sclPins = {
            { ((ioTag_t)((((1) + 1) << 4) | (10))), ((uint8_t)0x04) },
            { 0, ((uint8_t)0x04) },
        },
        .sdaPins = {
            { ((ioTag_t)((((1) + 1) << 4) | (11))), ((uint8_t)0x04) },
            { 0, ((uint8_t)0x04) },



            { ((ioTag_t)((((1) + 1) << 4) | (3))), ((uint8_t)0x09) },
            { ((ioTag_t)((((1) + 1) << 4) | (9))), ((uint8_t)0x09) },
    ...
    {
        .device = I2CDEV_3,
        .reg = ((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5C00)),
        .sclPins = {
            { ((ioTag_t)((((0) + 1) << 4) | (8))), ((uint8_t)0x04) },
        },
        .sdaPins = {
            { ((ioTag_t)((((2) + 1) << 4) | (9))), ((uint8_t)0x04) },



            { ((ioTag_t)((((1) + 1) << 4) | (4))), ((uint8_t)0x09) },
            { ((ioTag_t)((((1) + 1) << 4) | (8))), ((uint8_t)0x09) },

        },
        .rcc = (((RCC_APB1) << 5) | (16*((((uint32_t)0x00800000))>65535L) + (8*(((((uint32_t)0x00800000))*1L >>16*((((uint32_t)0x00800000))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00800000))*1L >>16*((((uint32_t)0x00800000))>65535L)) >>8*(((((uint32_t)0x00800000))*1L >>16*((((uint32_t)0x00800000))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00800000))*1L >>16*((((uint32_t)0x00800000))>65535L)) >>8*(((((uint32_t)0x00800000))*1L >>16*((((uint32_t)0x00800000))>65535L))>255))/2+1))))),
        .ev_irq = I2C3_EV_IRQn,
        .er_irq = I2C3_ER_IRQn,
    },
...
static 
# 156 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
      _Bool 
# 156 "./src/main/drivers/bus_i2c_stm32f10x.c"
           i2cHandleHardwareFailure(I2CDevice device)
{
    ...
    i2cInit(device);
    return 
# 161 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
          0
# 161 "./src/main/drivers/bus_i2c_stm32f10x.c"
               ;
}


# 164 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
_Bool 
# 164 "./src/main/drivers/bus_i2c_stm32f10x.c"
    i2cWriteBuffer(I2CDevice device, uint8_t addr_, uint8_t reg_, uint8_t len_, uint8_t *data)
{
    if (device == I2CINVALID || device > 3) {
        return 
...
# 167 "./src/main/drivers/bus_i2c_stm32f10x.c"
    ...
    if (!I2Cx) {
        return 
# 173 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
              0
# 173 "./src/main/drivers/bus_i2c_stm32f10x.c"
                   ;
    }
    ...
    state->busy = 1;
    state->error = 
# 187 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
                  0
# 187 "./src/main/drivers/bus_i2c_stm32f10x.c"
                       ;
...
# 207 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
_Bool 
# 207 "./src/main/drivers/bus_i2c_stm32f10x.c"
...
# 212 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
_Bool 
# 212 "./src/main/drivers/bus_i2c_stm32f10x.c"
    i2cRead(I2CDevice device, uint8_t addr_, uint8_t reg_, uint8_t len, uint8_t* buf)
{
    if (device == I2CINVALID || device > 3) {
        return 
# 215 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
              0
# 215 "./src/main/drivers/bus_i2c_stm32f10x.c"
                   ;
    }
    ...
    if (!I2Cx) {
        return 
# 221 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
              0
# 221 "./src/main/drivers/bus_i2c_stm32f10x.c"
                   ;
    }
    ...
    state->busy = 1;
    state->error = 
# 235 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
                  0
# 235 "./src/main/drivers/bus_i2c_stm32f10x.c"
                       ;
...
static void i2c_er_handler(I2CDevice device) {
    ...
    if (SR1Register & (((uint16_t)0x0100) | ((uint16_t)0x0200) | ((uint16_t)0x0400) | ((uint16_t)0x0800)))
        state->error = 
# 265 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
                      1
# 265 "./src/main/drivers/bus_i2c_stm32f10x.c"
                          ;


    if (SR1Register & (((uint16_t)0x0100) | ((uint16_t)0x0200) | ((uint16_t)0x0400))) {
        (void)I2Cx->SR2;
    ...
    I2Cx->SR1 &= ~(((uint16_t)0x0100) | ((uint16_t)0x0200) | ((uint16_t)0x0400) | ((uint16_t)0x0800));
    state->busy = 0;
}
...
void i2cInit(I2CDevice device)
{
    ...
    IOConfigGPIOAF(scl, pDev->pullUp ? ((GPIO_Mode_AF) | ((0) << 2) | ((GPIO_OType_OD) << 4) | ((GPIO_PuPd_UP) << 5)) : ((GPIO_Mode_AF) | ((0) << 2) | ((GPIO_OType_OD) << 4) | ((GPIO_PuPd_NOPULL) << 5)), pDev->sclAF);
    IOConfigGPIOAF(sda, pDev->pullUp ? ((GPIO_Mode_AF) | ((0) << 2) | ((GPIO_OType_OD) << 4) | ((GPIO_PuPd_UP) << 5)) : ((GPIO_Mode_AF) | ((0) << 2) | ((GPIO_OType_OD) << 4) | ((GPIO_PuPd_NOPULL) << 5)), pDev->sdaAF);
...
static void i2cUnstick(IO_t scl, IO_t sda)
{
    ...
    IOConfigGPIO(scl, ((GPIO_Mode_OUT) | ((0) << 2) | ((GPIO_OType_OD) << 4) | ((GPIO_PuPd_NOPULL) << 5)));
    IOConfigGPIO(sda, ((GPIO_Mode_OUT) | ((0) << 2) | ((GPIO_OType_OD) << 4) | ((GPIO_PuPd_NOPULL) << 5)));
