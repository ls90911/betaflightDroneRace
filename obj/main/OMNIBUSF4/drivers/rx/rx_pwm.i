...
# 1 "<command-line>"
# 1 "./src/main/drivers/rx/rx_pwm.c"
# 21 "./src/main/drivers/rx/rx_pwm.c"
...
# 23 "./src/main/drivers/rx/rx_pwm.c" 2
...
# 25 "./src/main/drivers/rx/rx_pwm.c" 2
...
# 29 "./src/main/drivers/rx/rx_pwm.c" 2
...
# 30 "./src/main/drivers/rx/rx_pwm.c" 2
...
# 34 "./src/main/drivers/rx/rx_pwm.c" 2
# 1 "./src/main/drivers/nvic.h" 1
# 21 "./src/main/drivers/nvic.h"
       
# 35 "./src/main/drivers/rx/rx_pwm.c" 2
...
# 39 "./src/main/drivers/rx/rx_pwm.c" 2
# 55 "./src/main/drivers/rx/rx_pwm.c"
...
# 103 "./src/main/drivers/rx/rx_pwm.c" 3 4
   _Bool 
# 103 "./src/main/drivers/rx/rx_pwm.c"
            tracking;
    
# 104 "./src/main/drivers/rx/rx_pwm.c" 3 4
   _Bool 
# 104 "./src/main/drivers/rx/rx_pwm.c"
            overflowed;
} ppmDevice_t;

static ppmDevice_t ppmDev;
# 116 "./src/main/drivers/rx/rx_pwm.c"

# 116 "./src/main/drivers/rx/rx_pwm.c" 3 4
_Bool 
# 116 "./src/main/drivers/rx/rx_pwm.c"
    isPPMDataBeingReceived(void)
{
...
static void ppmResetDevice(void)
{
    ...
    ppmDev.tracking = 
# 163 "./src/main/drivers/rx/rx_pwm.c" 3 4
                         0
# 163 "./src/main/drivers/rx/rx_pwm.c"
                              ;
    ppmDev.overflowed = 
# 164 "./src/main/drivers/rx/rx_pwm.c" 3 4
                         0
# 164 "./src/main/drivers/rx/rx_pwm.c"
                              ;
}
...
static void ppmOverflowCallback(timerOvrHandlerRec_t* cbRec, captureCompare_t capture)
{
    ...
    if (capture == 0x10000 - 1) {
        ppmDev.overflowed = 
# 174 "./src/main/drivers/rx/rx_pwm.c" 3 4
                           1
# 174 "./src/main/drivers/rx/rx_pwm.c"
                               ;
    }
}
...
static void ppmEdgeCallback(timerCCHandlerRec_t* cbRec, captureCompare_t capture)
{
    ...
    ppmDev.overflowed = 
# 210 "./src/main/drivers/rx/rx_pwm.c" 3 4
                       0
# 210 "./src/main/drivers/rx/rx_pwm.c"
                            ;
    ...
    if (ppmDev.deltaTime > 2700) {
        ...
        ppmDev.tracking = 
# 245 "./src/main/drivers/rx/rx_pwm.c" 3 4
                           1
# 245 "./src/main/drivers/rx/rx_pwm.c"
                               ;
        ...
        if (ppmDev.deltaTime > 750
            ...
            ppmDev.tracking = 
# 260 "./src/main/drivers/rx/rx_pwm.c" 3 4
                             0
# 260 "./src/main/drivers/rx/rx_pwm.c"
                                  ;
            for (i = 0; i < 12; i++) {
                ppmDev.captures[i] = 0;
            }
...
# 270 "./src/main/drivers/rx/rx_pwm.c" 3 4
_Bool 
# 270 "./src/main/drivers/rx/rx_pwm.c"
    isPWMDataBeingReceived(void)
{
    int channel;
...
# 275 "./src/main/drivers/rx/rx_pwm.c"
    ...
    return 
# 278 "./src/main/drivers/rx/rx_pwm.c" 3 4
          0
# 278 "./src/main/drivers/rx/rx_pwm.c"
               ;
}
...
# 284 "./src/main/drivers/rx/rx_pwm.c" 3 4
                                  __builtin_offsetof (
# 284 "./src/main/drivers/rx/rx_pwm.c"
                                  pwmInputPort_t
# 284 "./src/main/drivers/rx/rx_pwm.c" 3 4
                                  , 
# 284 "./src/main/drivers/rx/rx_pwm.c"
...
# 294 "./src/main/drivers/rx/rx_pwm.c" 3 4
                                  __builtin_offsetof (
# 294 "./src/main/drivers/rx/rx_pwm.c"
                                  pwmInputPort_t
# 294 "./src/main/drivers/rx/rx_pwm.c" 3 4
                                  , 
# 294 "./src/main/drivers/rx/rx_pwm.c"
...
# 346 "./src/main/drivers/rx/rx_pwm.c"
void pwmICConfig(TIM_TypeDef *tim, uint8_t channel, uint16_t polarity)
{
