...
# 1 "<command-line>"
# 1 "./src/main/drivers/serial_usb_vcp.c"
# 21 "./src/main/drivers/serial_usb_vcp.c"
...
# 23 "./src/main/drivers/serial_usb_vcp.c" 2
...
# 25 "./src/main/drivers/serial_usb_vcp.c" 2
...
# 37 "./src/main/drivers/serial_usb_vcp.c" 2

# 1 "./lib/main/STM32_USB_Device_Library/Class/hid_cdc_wrapper/inc/usbd_hid_cdc_wrapper.h" 1
# 78 "./lib/main/STM32_USB_Device_Library/Class/hid_cdc_wrapper/inc/usbd_hid_cdc_wrapper.h"
extern USBD_Class_cb_TypeDef USBD_HID_CDC_cb;
# 39 "./src/main/drivers/serial_usb_vcp.c" 2
...
# 43 "./src/main/drivers/serial_usb_vcp.c" 2
# 58 "./src/main/drivers/serial_usb_vcp.c"
...
# 59 "./src/main/drivers/serial_usb_vcp.c" 2
...
# 61 "./src/main/drivers/serial_usb_vcp.c" 2
...
# 62 "./src/main/drivers/serial_usb_vcp.c" 2
...
static 
# 100 "./src/main/drivers/serial_usb_vcp.c" 3 4
      _Bool 
# 100 "./src/main/drivers/serial_usb_vcp.c"
           isUsbVcpTransmitBufferEmpty(const serialPort_t *instance)
{
    (void)(instance);
    return 
# 103 "./src/main/drivers/serial_usb_vcp.c" 3 4
          1
# 103 "./src/main/drivers/serial_usb_vcp.c"
              ;
}
...
static uint8_t usbVcpRead(serialPort_t *instance)
{
    ...
    while (
# 119 "./src/main/drivers/serial_usb_vcp.c" 3 4
          1
# 119 "./src/main/drivers/serial_usb_vcp.c"
              ) {
...
static 
# 146 "./src/main/drivers/serial_usb_vcp.c" 3 4
      _Bool 
# 146 "./src/main/drivers/serial_usb_vcp.c"
           usbVcpFlush(vcpPort_t *port)
{
    ...
    if (count == 0) {
        return 
# 152 "./src/main/drivers/serial_usb_vcp.c" 3 4
              1
# 152 "./src/main/drivers/serial_usb_vcp.c"
                  ;
    }
...
# 175 "./src/main/drivers/serial_usb_vcp.c" 3 4
                     __builtin_offsetof (
# 175 "./src/main/drivers/serial_usb_vcp.c"
                     vcpPort_t
# 175 "./src/main/drivers/serial_usb_vcp.c" 3 4
                     , 
# 175 "./src/main/drivers/serial_usb_vcp.c"
...
{
    vcpPort_t *port = ( __extension__ ({ const typeof( ((vcpPort_t *)0)->port ) *__mptr = (instance); (vcpPort_t *)( (char *)__mptr - 
# 185 "./src/main/drivers/serial_usb_vcp.c" 3 4
                     __builtin_offsetof (
# 185 "./src/main/drivers/serial_usb_vcp.c"
                     vcpPort_t
# 185 "./src/main/drivers/serial_usb_vcp.c" 3 4
                     , 
# 185 "./src/main/drivers/serial_usb_vcp.c"
...
# 185 "./src/main/drivers/serial_usb_vcp.c"
    ...
    port->buffering = 
# 186 "./src/main/drivers/serial_usb_vcp.c" 3 4
                     1
# 186 "./src/main/drivers/serial_usb_vcp.c"
                         ;
}
...
{
    vcpPort_t *port = ( __extension__ ({ const typeof( ((vcpPort_t *)0)->port ) *__mptr = (instance); (vcpPort_t *)( (char *)__mptr - 
# 197 "./src/main/drivers/serial_usb_vcp.c" 3 4
                     __builtin_offsetof (
# 197 "./src/main/drivers/serial_usb_vcp.c"
                     vcpPort_t
# 197 "./src/main/drivers/serial_usb_vcp.c" 3 4
                     , 
# 197 "./src/main/drivers/serial_usb_vcp.c"
...
# 197 "./src/main/drivers/serial_usb_vcp.c"
    ...
    port->buffering = 
# 198 "./src/main/drivers/serial_usb_vcp.c" 3 4
                     0
# 198 "./src/main/drivers/serial_usb_vcp.c"
                          ;
    usbVcpFlush(port);
}
...
# 268 "./src/main/drivers/serial_usb_vcp.c"
    s = &vcpPort;
