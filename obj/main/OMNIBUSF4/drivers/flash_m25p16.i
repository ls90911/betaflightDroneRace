...
# 1 "<command-line>"
# 1 "./src/main/drivers/flash_m25p16.c"
# 21 "./src/main/drivers/flash_m25p16.c"
...
# 25 "./src/main/drivers/flash_m25p16.c" 2
...
# 1 "./src/main/drivers/flash_impl.h" 1
# 25 "./src/main/drivers/flash_impl.h"
...
# 36 "./src/main/drivers/flash_impl.h" 3 4
   _Bool 
# 36 "./src/main/drivers/flash_impl.h"
        isLargeFlash;



    
# 40 "./src/main/drivers/flash_impl.h" 3 4
   _Bool 
# 40 "./src/main/drivers/flash_impl.h"
        couldBeBusy;
} flashDevice_t;

typedef struct flashVTable_s {
    
# 44 "./src/main/drivers/flash_impl.h" 3 4
   _Bool 
# 44 "./src/main/drivers/flash_impl.h"
        (*isReady)(flashDevice_t *fdevice);
    
# 45 "./src/main/drivers/flash_impl.h" 3 4
   _Bool 
# 45 "./src/main/drivers/flash_impl.h"
        (*waitForReady)(flashDevice_t *fdevice, uint32_t timeoutMillis);
...
# 35 "./src/main/drivers/flash_m25p16.c" 2



# 1 "./src/main/drivers/flash_m25p16.h" 1
# 21 "./src/main/drivers/flash_m25p16.h"
...
# 27 "./src/main/drivers/flash_m25p16.h" 3 4
_Bool 
# 27 "./src/main/drivers/flash_m25p16.h"
    m25p16_detect(flashDevice_t *fdevice, uint32_t chipID);
# 39 "./src/main/drivers/flash_m25p16.c" 2
# 78 "./src/main/drivers/flash_m25p16.c"
typedef char assert_failed_M25P16_PAGESIZE_too_small [(256 < 2048) ? 1 : -1 ] __attribute__((unused));
...
{
    m25p16_performOneByteCommand(fdevice->busdev, 0x06);
...
static 
# 135 "./src/main/drivers/flash_m25p16.c" 3 4
      _Bool 
# 135 "./src/main/drivers/flash_m25p16.c"
           m25p16_isReady(flashDevice_t *fdevice)
{

    fdevice->couldBeBusy = fdevice->couldBeBusy && ((m25p16_readStatus(fdevice->busdev) & 0x01) != 0);

    return !fdevice->couldBeBusy;
}

static 
# 143 "./src/main/drivers/flash_m25p16.c" 3 4
      _Bool 
# 143 "./src/main/drivers/flash_m25p16.c"
           m25p16_waitForReady(flashDevice_t *fdevice, uint32_t timeoutMillis)
{
    uint32_t time = millis();
    while (!m25p16_isReady(fdevice)) {
        if (millis() - time > timeoutMillis) {
            return 
# 148 "./src/main/drivers/flash_m25p16.c" 3 4
                  0
# 148 "./src/main/drivers/flash_m25p16.c"
                       ;
        }
    }

    return 
# 152 "./src/main/drivers/flash_m25p16.c" 3 4
          1
# 152 "./src/main/drivers/flash_m25p16.c"
              ;
}
...
# 161 "./src/main/drivers/flash_m25p16.c" 3 4
_Bool 
# 161 "./src/main/drivers/flash_m25p16.c"
    m25p16_detect(flashDevice_t *fdevice, uint32_t chipID)
{
    switch (chipID) {
    case 0xEF4015:
    ...
    default:
        ...
        return 
# 197 "./src/main/drivers/flash_m25p16.c" 3 4
              0
# 197 "./src/main/drivers/flash_m25p16.c"
                   ;
    }
...
# 206 "./src/main/drivers/flash_m25p16.c"
                                   ;
        m25p16_performOneByteCommand(fdevice->busdev, 0xB7);
    }

    fdevice->couldBeBusy = 
# 210 "./src/main/drivers/flash_m25p16.c" 3 4
                          1
# 210 "./src/main/drivers/flash_m25p16.c"
                              ;
    fdevice->vTable = &m25p16_vTable;
    return 
# 212 "./src/main/drivers/flash_m25p16.c" 3 4
          1
# 212 "./src/main/drivers/flash_m25p16.c"
              ;
}

static void m25p16_setCommandAddress(uint8_t *buf, uint32_t address, 
# 215 "./src/main/drivers/flash_m25p16.c" 3 4
                                                                    _Bool 
# 215 "./src/main/drivers/flash_m25p16.c"
                                                                         useLongAddress)
{
    if (useLongAddress) {
        *buf++ = (address >> 24) & 0xff;
...
static void m25p16_eraseSector(flashDevice_t *fdevice, uint32_t address)
{
    ...
    m25p16_waitForReady(fdevice, 5000);

    m25p16_writeEnable(fdevice);

    m25p16_transfer(fdevice->busdev, out, 
# 238 "./src/main/drivers/flash_m25p16.c" 3 4
                                         ((void *)0)
# 238 "./src/main/drivers/flash_m25p16.c"
                                             , sizeof(out));
}

static void m25p16_eraseCompletely(flashDevice_t *fdevice)
{
    m25p16_waitForReady(fdevice, 21000);

    m25p16_writeEnable(fdevice);

    m25p16_performOneByteCommand(fdevice->busdev, 0xC7);
}
...
static void m25p16_pageProgramContinue(flashDevice_t *fdevice, const uint8_t *data, int length)
{
    ...
    m25p16_waitForReady(fdevice, 6);

    m25p16_writeEnable(fdevice);

    m25p16_enable(fdevice->busdev);

    spiTransfer(fdevice->busdev->busdev_u.spi.instance, command, 
# 269 "./src/main/drivers/flash_m25p16.c" 3 4
                                                                ((void *)0)
# 269 "./src/main/drivers/flash_m25p16.c"
                                                                    , fdevice->isLargeFlash ? 5 : 4);

    spiTransfer(fdevice->busdev->busdev_u.spi.instance, data, 
# 271 "./src/main/drivers/flash_m25p16.c" 3 4
                                                             ((void *)0)
# 271 "./src/main/drivers/flash_m25p16.c"
                                                                 , length);
...
# 298 "./src/main/drivers/flash_m25p16.c"
...
# 315 "./src/main/drivers/flash_m25p16.c"
static int m25p16_readBytes(flashDevice_t *fdevice, uint32_t address, uint8_t *buffer, int length)
{
    ...
    if (!m25p16_waitForReady(fdevice, 6)) {
        return 0;
    }
    ...
    spiTransfer(fdevice->busdev->busdev_u.spi.instance, command, 
# 327 "./src/main/drivers/flash_m25p16.c" 3 4
                                                                ((void *)0)
# 327 "./src/main/drivers/flash_m25p16.c"
                                                                    , fdevice->isLargeFlash ? 5 : 4);
    spiTransfer(fdevice->busdev->busdev_u.spi.instance, 
# 328 "./src/main/drivers/flash_m25p16.c" 3 4
                                                       ((void *)0)
# 328 "./src/main/drivers/flash_m25p16.c"
                                                           , buffer, length);
