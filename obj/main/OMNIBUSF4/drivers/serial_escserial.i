...
# 24 "./src/main/drivers/serial_escserial.c" 2
...
# 26 "./src/main/drivers/serial_escserial.c" 2
...
# 30 "./src/main/drivers/serial_escserial.c" 2
...
# 31 "./src/main/drivers/serial_escserial.c" 2
...
# 42 "./src/main/drivers/serial_escserial.c" 2
...
# 43 "./src/main/drivers/serial_escserial.c" 2
...
# 49 "./src/main/drivers/serial_escserial.c" 2
...
# 61 "./src/main/drivers/serial_escserial.c" 3 4
                              ((void *)0)
# 61 "./src/main/drivers/serial_escserial.c"
                                  ;
static serialPort_t *passPort = 
# 62 "./src/main/drivers/serial_escserial.c" 3 4
                               ((void *)0)
# 62 "./src/main/drivers/serial_escserial.c"
                                   ;
...
const escSerialConfig_t pgResetTemplate_escSerialConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .ioTag = ((ioTag_t)((((1) + 1) << 4) | (14))), }
...
# 146 "./src/main/drivers/serial_escserial.c"
...
static 
# 205 "./src/main/drivers/serial_escserial.c" 3 4
      _Bool 
# 205 "./src/main/drivers/serial_escserial.c"
...
static 
# 210 "./src/main/drivers/serial_escserial.c" 3 4
      _Bool 
# 210 "./src/main/drivers/serial_escserial.c"
...
# 245 "./src/main/drivers/serial_escserial.c" 3 4
                                       1
# 245 "./src/main/drivers/serial_escserial.c"
                                           ;
    ...
    escSerial->isTransmittingData = 
# 264 "./src/main/drivers/serial_escserial.c" 3 4
                                   0
# 264 "./src/main/drivers/serial_escserial.c"
                                        ;
    if (isEscSerialTransmitBufferEmpty((serialPort_t *)escSerial)) {
        if (escSerial->mode==PROTOCOL_BLHELI || escSerial->mode==PROTOCOL_CASTLE)
        {
...
# 301 "./src/main/drivers/serial_escserial.c" 3 4
                                       1
# 301 "./src/main/drivers/serial_escserial.c"
                                           ;
...
# 306 "./src/main/drivers/serial_escserial.c" 3 4
                                                         1 
# 306 "./src/main/drivers/serial_escserial.c"
                                                                           : 
# 306 "./src/main/drivers/serial_escserial.c" 3 4
                                                                             0
# 306 "./src/main/drivers/serial_escserial.c"
...
# 348 "./src/main/drivers/serial_escserial.c" 3 4
                            __builtin_offsetof (
# 348 "./src/main/drivers/serial_escserial.c"
                            escSerial_t
# 348 "./src/main/drivers/serial_escserial.c" 3 4
                            , 
# 348 "./src/main/drivers/serial_escserial.c"
...
# 373 "./src/main/drivers/serial_escserial.c" 3 4
                                                                                ((void *)0)
# 373 "./src/main/drivers/serial_escserial.c"
                                                                                    );
}
...
# 380 "./src/main/drivers/serial_escserial.c" 3 4
                            __builtin_offsetof (
# 380 "./src/main/drivers/serial_escserial.c"
                            escSerial_t
# 380 "./src/main/drivers/serial_escserial.c" 3 4
                            , 
# 380 "./src/main/drivers/serial_escserial.c"
...
# 381 "./src/main/drivers/serial_escserial.c" 3 4
   _Bool 
# 381 "./src/main/drivers/serial_escserial.c"
...
# 400 "./src/main/drivers/serial_escserial.c" 3 4
                                                              0 
# 400 "./src/main/drivers/serial_escserial.c"
                                                                                 : 
# 400 "./src/main/drivers/serial_escserial.c" 3 4
                                                                                   1
# 400 "./src/main/drivers/serial_escserial.c"
        ...
        escSerial->isSearchingForStartBit = 
# 406 "./src/main/drivers/serial_escserial.c" 3 4
                                           0
# 406 "./src/main/drivers/serial_escserial.c"
                                                ;
        return;
    }
...
# 418 "./src/main/drivers/serial_escserial.c"
        ...
        escSerial->rxEdge = TRAILING;
        timerChConfigIC(escSerial->rxTimerHardware, inverted ? 
# 421 "./src/main/drivers/serial_escserial.c" 3 4
                                                              1 
# 421 "./src/main/drivers/serial_escserial.c"
                                                                                : 
# 421 "./src/main/drivers/serial_escserial.c" 3 4
                                                                                  0
# 421 "./src/main/drivers/serial_escserial.c"
...
# 430 "./src/main/drivers/serial_escserial.c" 3 4
                                                                   1 
# 430 "./src/main/drivers/serial_escserial.c"
                                                                                     : 
# 430 "./src/main/drivers/serial_escserial.c" 3 4
                                                                                       0
# 430 "./src/main/drivers/serial_escserial.c"
...
# 432 "./src/main/drivers/serial_escserial.c" 3 4
                                                                               ((void *)0)
# 432 "./src/main/drivers/serial_escserial.c"
                                                                                   );
}
...
reload:
        ...
        escSerial->isTransmittingData = 
# 478 "./src/main/drivers/serial_escserial.c" 3 4
                                       1
# 478 "./src/main/drivers/serial_escserial.c"
                                           ;
    ...
    if (isEscSerialTransmitBufferEmpty((serialPort_t *)escSerial)) {
        escSerial->isTransmittingData = 
# 524 "./src/main/drivers/serial_escserial.c" 3 4
                                       0
# 524 "./src/main/drivers/serial_escserial.c"
                                            ;
        escSerialInputPortConfig(escSerial->rxTimerHardware);
    }
}
...
static void onSerialTimerEsc(timerCCHandlerRec_t *cbRec, captureCompare_t capture)
{
    (void)(capture);
    escSerial_t *escSerial = ( __extension__ ({ const typeof( ((escSerial_t *)0)->timerCb ) *__mptr = (cbRec); (escSerial_t *)( (char *)__mptr - 
# 532 "./src/main/drivers/serial_escserial.c" 3 4
                            __builtin_offsetof (
# 532 "./src/main/drivers/serial_escserial.c"
                            escSerial_t
# 532 "./src/main/drivers/serial_escserial.c" 3 4
                            , 
# 532 "./src/main/drivers/serial_escserial.c"
...
# 541 "./src/main/drivers/serial_escserial.c" 3 4
                                                       0
# 541 "./src/main/drivers/serial_escserial.c"
                                                                         , 0);
        }
    }
...
static void escSerialTimerTxConfig(const timerHardware_t *timerHardwarePtr, uint8_t reference)
{
    ...
    timerChConfigCallbacks(timerHardwarePtr, &escSerialPorts[reference].timerCb, 
# 554 "./src/main/drivers/serial_escserial.c" 3 4
                                                                                ((void *)0)
# 554 "./src/main/drivers/serial_escserial.c"
                                                                                    );
}
...
static void onSerialRxPinChangeEsc(timerCCHandlerRec_t *cbRec, captureCompare_t capture)
{
    ...
    escSerial_t *escSerial = ( __extension__ ({ const typeof( ((escSerial_t *)0)->edgeCb ) *__mptr = (cbRec); (escSerial_t *)( (char *)__mptr - 
# 580 "./src/main/drivers/serial_escserial.c" 3 4
                            __builtin_offsetof (
# 580 "./src/main/drivers/serial_escserial.c"
                            escSerial_t
# 580 "./src/main/drivers/serial_escserial.c" 3 4
                            , 
# 580 "./src/main/drivers/serial_escserial.c"
...
# 580 "./src/main/drivers/serial_escserial.c"
    ...
    else
    {
        if (!escSerial->isReceivingData)
        {
            ...
            timerChConfigIC(escSerial->rxTimerHardware, 
# 619 "./src/main/drivers/serial_escserial.c" 3 4
                                                       1
# 619 "./src/main/drivers/serial_escserial.c"
                                                                        , 0);
        }
    }
    escSerial->receiveTimeout = 0;
...
# 642 "./src/main/drivers/serial_escserial.c" 3 4
                                     0
# 642 "./src/main/drivers/serial_escserial.c"
                                                       , 0);
    timerChCCHandlerInit(&escSerialPorts[reference].edgeCb, onSerialRxPinChangeEsc);
    timerChConfigCallbacks(timerHardwarePtr, &escSerialPorts[reference].edgeCb, 
# 644 "./src/main/drivers/serial_escserial.c" 3 4
                                                                               ((void *)0)
# 644 "./src/main/drivers/serial_escserial.c"
                                                                                   );
}
...
static serialPort_t *openEscSerial(escSerialPortIndex_e portIndex, serialReceiveCallbackPtr callback, uint16_t output, uint32_t baud, portOptions_e options, uint8_t mode)
{
    ...
    if (mode != PROTOCOL_KISSALL) {
        ...
        if (escSerial->rxTimerHardware->output & TIMER_OUTPUT_N_CHANNEL) {
            return 
# 668 "./src/main/drivers/serial_escserial.c" 3 4
                  ((void *)0)
# 668 "./src/main/drivers/serial_escserial.c"
                      ;
        }
    ...
    escSerial->isTransmittingData = 
# 690 "./src/main/drivers/serial_escserial.c" 3 4
                                   0
# 690 "./src/main/drivers/serial_escserial.c"
                                        ;

    escSerial->isSearchingForStartBit = 
# 692 "./src/main/drivers/serial_escserial.c" 3 4
                                       1
# 692 "./src/main/drivers/serial_escserial.c"
                                           ;
    escSerial->rxBitIndex = 0;
        ...
        for (volatile uint8_t i = 0; i < 8; i++) {
            if (pwmMotors[i].enabled) {
                if (pwmMotors[i].io != ((IO_t)0)) {
                    for (volatile uint8_t j = 0; j < 14; j++) {
...
# 769 "./src/main/drivers/serial_escserial.c" 3 4
                                                         ((void *)0)
# 769 "./src/main/drivers/serial_escserial.c"
                                                             ,
# 769 "./src/main/drivers/serial_escserial.c" 3 4
                                                              ((void *)0)
# 769 "./src/main/drivers/serial_escserial.c"
...
# 773 "./src/main/drivers/serial_escserial.c" 3 4
                                                     ((void *)0)
# 773 "./src/main/drivers/serial_escserial.c"
                                                         ,
# 773 "./src/main/drivers/serial_escserial.c" 3 4
                                                          ((void *)0)
# 773 "./src/main/drivers/serial_escserial.c"
...
const struct serialPortVTable escSerialVTable[] = {
    {
        ...
        .setCtrlLineStateCb = 
# 848 "./src/main/drivers/serial_escserial.c" 3 4
                             ((void *)0)
# 848 "./src/main/drivers/serial_escserial.c"
                                 ,
        .setBaudRateCb = 
# 849 "./src/main/drivers/serial_escserial.c" 3 4
                        ((void *)0)
# 849 "./src/main/drivers/serial_escserial.c"
                            ,
        .writeBuf = 
# 850 "./src/main/drivers/serial_escserial.c" 3 4
                   ((void *)0)
# 850 "./src/main/drivers/serial_escserial.c"
                       ,
        .beginWrite = 
# 851 "./src/main/drivers/serial_escserial.c" 3 4
                     ((void *)0)
# 851 "./src/main/drivers/serial_escserial.c"
                         ,
        .endWrite = 
# 852 "./src/main/drivers/serial_escserial.c" 3 4
                   ((void *)0)
    
# 853 "./src/main/drivers/serial_escserial.c"
   }
};
...
static 
# 878 "./src/main/drivers/serial_escserial.c" 3 4
      _Bool 
# 878 "./src/main/drivers/serial_escserial.c"
           processExitCommand(uint8_t c)
{
    if (currentPort.c_state == IDLE) {
        if (c == '$') {
            ...
            return 
# 884 "./src/main/drivers/serial_escserial.c" 3 4
                  0
# 884 "./src/main/drivers/serial_escserial.c"
                       ;
        }
        ...
        if (currentPort.checksum == c) {
            ...
            if ((currentPort.cmdMSP == 0xF4) && (currentPort.dataSize==0))
            {
                currentPort.c_state = IDLE;
                return 
# 916 "./src/main/drivers/serial_escserial.c" 3 4
                      1
# 916 "./src/main/drivers/serial_escserial.c"
                          ;
            }
        } else {
            currentPort.c_state = IDLE;
    ...
    return 
# 922 "./src/main/drivers/serial_escserial.c" 3 4
          0
# 922 "./src/main/drivers/serial_escserial.c"
               ;
}
...
# 928 "./src/main/drivers/serial_escserial.c" 3 4
   _Bool 
# 928 "./src/main/drivers/serial_escserial.c"
        exitEsc = 
# 928 "./src/main/drivers/serial_escserial.c" 3 4
                  0
# 928 "./src/main/drivers/serial_escserial.c"
    ...
    ledSet(0, 
# 930 "./src/main/drivers/serial_escserial.c" 3 4
   0
# 930 "./src/main/drivers/serial_escserial.c"
   );
    ledSet(1, 
# 931 "./src/main/drivers/serial_escserial.c" 3 4
   0
# 931 "./src/main/drivers/serial_escserial.c"
   );
...
# 969 "./src/main/drivers/serial_escserial.c" 3 4
                                       ((void *)0)
# 969 "./src/main/drivers/serial_escserial.c"
    ...
    while (1) {
        if (mode!=2)
        {
            if (serialRxBytesWaiting(escPort)) {
                ledSet(0, 
# 980 "./src/main/drivers/serial_escserial.c" 3 4
               1
# 980 "./src/main/drivers/serial_escserial.c"
               );
                ...
                ledSet(0, 
# 986 "./src/main/drivers/serial_escserial.c" 3 4
               0
# 986 "./src/main/drivers/serial_escserial.c"
               );
            }
        }
        if (serialRxBytesWaiting(escPassthroughPort)) {
            ledSet(1, 
# 990 "./src/main/drivers/serial_escserial.c" 3 4
           1
# 990 "./src/main/drivers/serial_escserial.c"
           );
            ...
            ledSet(1, 
# 1011 "./src/main/drivers/serial_escserial.c" 3 4
           0
# 1011 "./src/main/drivers/serial_escserial.c"
           );
        }
