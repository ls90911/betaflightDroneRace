...
# 1 "<command-line>"
# 1 "./src/main/drivers/display_ug2864hsweg01.c"
# 21 "./src/main/drivers/display_ug2864hsweg01.c"
...
# 29 "./src/main/drivers/display_ug2864hsweg01.c" 2
...
# 24 "./src/main/drivers/display_ug2864hsweg01.h" 2
...
# 31 "./src/main/drivers/display_ug2864hsweg01.c" 2
...
static 
# 176 "./src/main/drivers/display_ug2864hsweg01.c" 3 4
      _Bool 
# 176 "./src/main/drivers/display_ug2864hsweg01.c"
           i2c_OLED_send_cmd(busDevice_t *bus, uint8_t command)
{
    return i2cWrite(bus->busdev_u.i2c.device, bus->busdev_u.i2c.address, 0x80, command);
}

static 
# 181 "./src/main/drivers/display_ug2864hsweg01.c" 3 4
      _Bool 
# 181 "./src/main/drivers/display_ug2864hsweg01.c"
           i2c_OLED_send_cmdarray(busDevice_t *bus, const uint8_t *commands, size_t len)
{
    for (size_t i = 0 ; i < len ; i++) {
        if (!i2c_OLED_send_cmd(bus, commands[i])) {
            return 
# 185 "./src/main/drivers/display_ug2864hsweg01.c" 3 4
                  0
# 185 "./src/main/drivers/display_ug2864hsweg01.c"
                       ;
        }
    }

    return 
# 189 "./src/main/drivers/display_ug2864hsweg01.c" 3 4
          1
# 189 "./src/main/drivers/display_ug2864hsweg01.c"
              ;
}

static 
# 192 "./src/main/drivers/display_ug2864hsweg01.c" 3 4
      _Bool 
# 192 "./src/main/drivers/display_ug2864hsweg01.c"
           i2c_OLED_send_byte(busDevice_t *bus, uint8_t val)
{
...
void i2c_OLED_clear_display_quick(busDevice_t *bus)
{
    ...
    i2c_OLED_send_cmdarray(bus, i2c_OLED_cmd_clear_display_quick, (sizeof(i2c_OLED_cmd_clear_display_quick) / sizeof((i2c_OLED_cmd_clear_display_quick)[0])));

    for (uint16_t i = 0; i < 1024; i++) {
        i2c_OLED_send_byte(bus, 0x00);
    }
}
...
void i2c_OLED_clear_display(busDevice_t *bus)
{
    ...
    i2c_OLED_send_cmdarray(bus, i2c_OLED_cmd_clear_display_pre, (sizeof(i2c_OLED_cmd_clear_display_pre) / sizeof((i2c_OLED_cmd_clear_display_pre)[0])));
    ...
    i2c_OLED_send_cmdarray(bus, i2c_OLED_cmd_clear_display_post, (sizeof(i2c_OLED_cmd_clear_display_post) / sizeof((i2c_OLED_cmd_clear_display_post)[0])));
}
...
void i2c_OLED_set_xy(busDevice_t *bus, uint8_t col, uint8_t row)
{
    ...
    i2c_OLED_send_cmdarray(bus, i2c_OLED_cmd_set_xy, (sizeof(i2c_OLED_cmd_set_xy) / sizeof((i2c_OLED_cmd_set_xy)[0])));
}
...
# 276 "./src/main/drivers/display_ug2864hsweg01.c" 3 4
_Bool 
# 276 "./src/main/drivers/display_ug2864hsweg01.c"
    ug2864hsweg01InitI2C(busDevice_t *bus)
{
    ...
    if (!i2c_OLED_send_cmd(bus, 0xAE)) {
        return 
# 281 "./src/main/drivers/display_ug2864hsweg01.c" 3 4
              0
# 281 "./src/main/drivers/display_ug2864hsweg01.c"
                   ;
    }
    ...
    i2c_OLED_send_cmdarray(bus, i2c_OLED_cmd_init, (sizeof(i2c_OLED_cmd_init) / sizeof((i2c_OLED_cmd_init)[0])));

    i2c_OLED_clear_display(bus);

    return 
# 313 "./src/main/drivers/display_ug2864hsweg01.c" 3 4
          1
# 313 "./src/main/drivers/display_ug2864hsweg01.c"
              ;
}
