# 1 "./src/main/drivers/transponder_ir_io_stdperiph.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/drivers/transponder_ir_io_stdperiph.c"
# 21 "./src/main/drivers/transponder_ir_io_stdperiph.c"
# 1 "/home/jiahao/betaflight/tools/gcc-arm-none-eabi-7-2017-q4-major/lib/gcc/arm-none-eabi/7.2.1/include/stdbool.h" 1 3 4
# 22 "./src/main/drivers/transponder_ir_io_stdperiph.c" 2
...
# 23 "./src/main/drivers/transponder_ir_io_stdperiph.c" 2
...
# 24 "./src/main/drivers/transponder_ir_io_stdperiph.c" 2
...
# 26 "./src/main/drivers/transponder_ir_io_stdperiph.c" 2
...
# 30 "./src/main/drivers/transponder_ir_io_stdperiph.c" 2
# 1 "./src/main/drivers/nvic.h" 1
# 21 "./src/main/drivers/nvic.h"
       
# 31 "./src/main/drivers/transponder_ir_io_stdperiph.c" 2
# 1 "./src/main/drivers/io.h" 1
# 21 "./src/main/drivers/io.h"
       
# 30 "./src/main/drivers/io.h"
...
# 32 "./src/main/drivers/transponder_ir_io_stdperiph.c" 2
...
# 33 "./src/main/drivers/transponder_ir_io_stdperiph.c" 2
...
# 34 "./src/main/drivers/transponder_ir_io_stdperiph.c" 2
...
# 36 "./src/main/drivers/transponder_ir_io_stdperiph.c" 2
# 1 "./src/main/drivers/transponder_ir_arcitimer.h" 1
# 21 "./src/main/drivers/transponder_ir_arcitimer.h"
       
# 37 "./src/main/drivers/transponder_ir_arcitimer.h"
...
# 37 "./src/main/drivers/transponder_ir_io_stdperiph.c" 2
# 1 "./src/main/drivers/transponder_ir_ilap.h" 1
# 21 "./src/main/drivers/transponder_ir_ilap.h"
...
# 38 "./src/main/drivers/transponder_ir_io_stdperiph.c" 2
# 1 "./src/main/drivers/transponder_ir_erlt.h" 1
# 21 "./src/main/drivers/transponder_ir_erlt.h"
...
# 39 "./src/main/drivers/transponder_ir_io_stdperiph.c" 2

volatile uint8_t transponderIrDataTransferInProgress = 0;


static IO_t transponderIO = ((IO_t)0);
static TIM_TypeDef *timer = 
# 44 "./src/main/drivers/transponder_ir_io_stdperiph.c" 3 4
                           ((void *)0)
# 44 "./src/main/drivers/transponder_ir_io_stdperiph.c"
                               ;



static DMA_Stream_TypeDef *dmaRef = 
# 48 "./src/main/drivers/transponder_ir_io_stdperiph.c" 3 4
                                   ((void *)0)
# 48 "./src/main/drivers/transponder_ir_io_stdperiph.c"
                                       ;
...
# 78 "./src/main/drivers/transponder_ir_io_stdperiph.c" 3 4
                                ((void *)0)
# 78 "./src/main/drivers/transponder_ir_io_stdperiph.c"
                                    ) {
        return;
    }
    ...
    IOConfigGPIOAF(transponderIO, ((GPIO_Mode_AF) | ((GPIO_Fast_Speed) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_DOWN) << 5)), timerHardware->alternateFunction);

    dmaInit(timerHardware->dmaIrqHandler, OWNER_TRANSPONDER, 0);
    dmaSetHandler(timerHardware->dmaIrqHandler, TRANSPONDER_DMA_IRQHandler, (((((3)<<(4-(7-(((uint32_t)0x500)>>8))))|((0)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0), 0);
...
# 158 "./src/main/drivers/transponder_ir_io_stdperiph.c" 3 4
_Bool 
# 158 "./src/main/drivers/transponder_ir_io_stdperiph.c"
    transponderIrInit(const ioTag_t ioTag, const transponderProvider_e provider)
{
    if (!ioTag) {
        return 
# 161 "./src/main/drivers/transponder_ir_io_stdperiph.c" 3 4
              0
# 161 "./src/main/drivers/transponder_ir_io_stdperiph.c"
                   ;
    }
    ...
    switch (provider) {
        ...
        default:
            return 
# 175 "./src/main/drivers/transponder_ir_io_stdperiph.c" 3 4
                  0
# 175 "./src/main/drivers/transponder_ir_io_stdperiph.c"
                       ;
    }
    ...
    return 
# 180 "./src/main/drivers/transponder_ir_io_stdperiph.c" 3 4
          1
# 180 "./src/main/drivers/transponder_ir_io_stdperiph.c"
              ;
}


# 183 "./src/main/drivers/transponder_ir_io_stdperiph.c" 3 4
_Bool 
# 183 "./src/main/drivers/transponder_ir_io_stdperiph.c"
    isTransponderIrReady(void)
{
...
void transponderIrDMAEnable(transponder_t *transponder)
{
    DMA_SetCurrDataCounter(dmaRef, transponder->dma_buffer_size);
