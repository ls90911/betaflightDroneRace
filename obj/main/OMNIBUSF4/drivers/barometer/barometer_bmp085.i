...
# 1 "<command-line>"
# 1 "./src/main/drivers/barometer/barometer_bmp085.c"
# 21 "./src/main/drivers/barometer/barometer_bmp085.c"
...
# 23 "./src/main/drivers/barometer/barometer_bmp085.c" 2
...
# 37 "./src/main/drivers/barometer/barometer_bmp085.c" 2
...
# 39 "./src/main/drivers/barometer/barometer_bmp085.c" 2
# 59 "./src/main/drivers/barometer/barometer_bmp085.c"
typedef struct {
    int16_t ac1;
    int16_t ac2;
    int16_t ac3;
...
# 117 "./src/main/drivers/barometer/barometer_bmp085.c"
...
static 
# 122 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
      _Bool 
# 122 "./src/main/drivers/barometer/barometer_bmp085.c"
           bmp085InitDone = 
# 122 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
                            0
# 122 "./src/main/drivers/barometer/barometer_bmp085.c"
...
static IO_t xclrIO;
# 146 "./src/main/drivers/barometer/barometer_bmp085.c"
...
# 161 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
_Bool 
# 161 "./src/main/drivers/barometer/barometer_bmp085.c"
    bmp085Detect(const bmp085Config_t *config, baroDev_t *baro)
{
    uint8_t data;
    
# 164 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
   _Bool 
# 164 "./src/main/drivers/barometer/barometer_bmp085.c"
        ack;
    
# 165 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
   _Bool 
# 165 "./src/main/drivers/barometer/barometer_bmp085.c"
...
# 172 "./src/main/drivers/barometer/barometer_bmp085.c"
    ...
    bmp085InitXclrIO(config);
    ;
# 188 "./src/main/drivers/barometer/barometer_bmp085.c"
    (void)(config);
...
# 198 "./src/main/drivers/barometer/barometer_bmp085.c"
    ...
    ack = busReadRegisterBuffer(busdev, 0xD0, &data, 1);
    if (ack) {
        bmp085.chip_id = (data & 0xFF) >> 0;
        bmp085.oversampling_setting = 3;

        if (bmp085.chip_id == 0x55) {
            busReadRegisterBuffer(busdev, 0xD1, &data, 1);
            ...
            bmp085InitDone = 
# 221 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
                            1
# 221 "./src/main/drivers/barometer/barometer_bmp085.c"
                                ;
            return 
# 222 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
                  1
# 222 "./src/main/drivers/barometer/barometer_bmp085.c"
                      ;
        }
    }
    ...
    return 
# 237 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
          0
# 237 "./src/main/drivers/barometer/barometer_bmp085.c"
               ;
}
...
static void bmp085_start_ut(baroDev_t *baro)
{
    ...
    busWriteRegister(&baro->busdev, 0xF4, 0x2E);
}

static void bmp085_get_ut(baroDev_t *baro)
{
    uint8_t data[2];
# 312 "./src/main/drivers/barometer/barometer_bmp085.c"
    busReadRegisterBuffer(&baro->busdev, 0xF6, data, 2);
...
static void bmp085_start_up(baroDev_t *baro)
{
    ...
    busWriteRegister(&baro->busdev, 0xF4, ctrl_reg_data);
}
...
{
    uint8_t data[3];
# 344 "./src/main/drivers/barometer/barometer_bmp085.c"
    busReadRegisterBuffer(&baro->busdev, 0xF6, data, 3);
...
{
    uint8_t data[22];
    busReadRegisterBuffer(busdev, 0xaa, data, 22);
