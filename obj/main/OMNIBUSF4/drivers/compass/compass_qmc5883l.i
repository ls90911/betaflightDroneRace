...
# 23 "./src/main/drivers/compass/compass_qmc5883l.c" 2
...
# 25 "./src/main/drivers/compass/compass_qmc5883l.c" 2
...
# 32 "./src/main/drivers/compass/compass_qmc5883l.c" 2
...
# 21 "./src/main/drivers/compass/compass_qmc5883l.h"
       




# 25 "./src/main/drivers/compass/compass_qmc5883l.h" 3 4
_Bool 
# 25 "./src/main/drivers/compass/compass_qmc5883l.h"
    qmc5883lDetect(magDev_t *magDev);
# 42 "./src/main/drivers/compass/compass_qmc5883l.c" 2
# 75 "./src/main/drivers/compass/compass_qmc5883l.c"
static 
# 75 "./src/main/drivers/compass/compass_qmc5883l.c" 3 4
      _Bool 
# 75 "./src/main/drivers/compass/compass_qmc5883l.c"
           qmc5883lInit(magDev_t *magDev)
{
    (void)(magDev);

    
# 79 "./src/main/drivers/compass/compass_qmc5883l.c" 3 4
   _Bool 
# 79 "./src/main/drivers/compass/compass_qmc5883l.c"
        ack = 
# 79 "./src/main/drivers/compass/compass_qmc5883l.c" 3 4
              1
# 79 "./src/main/drivers/compass/compass_qmc5883l.c"
    ...
    ack = ack && busWriteRegister(busdev, 0x09, 0x01 | (0x03 << 2) | (0x00 << 6) | (0x01 << 4));

    if (!ack) {
        return 
# 86 "./src/main/drivers/compass/compass_qmc5883l.c" 3 4
              0
# 86 "./src/main/drivers/compass/compass_qmc5883l.c"
                   ;
    }

    return 
# 89 "./src/main/drivers/compass/compass_qmc5883l.c" 3 4
          1
# 89 "./src/main/drivers/compass/compass_qmc5883l.c"
              ;
}

static 
# 92 "./src/main/drivers/compass/compass_qmc5883l.c" 3 4
      _Bool 
# 92 "./src/main/drivers/compass/compass_qmc5883l.c"
           qmc5883lRead(magDev_t *magDev, int16_t *magData)
{
    uint8_t status;
    uint8_t buf[6];
...
# 104 "./src/main/drivers/compass/compass_qmc5883l.c" 3 4
   _Bool 
# 104 "./src/main/drivers/compass/compass_qmc5883l.c"
        ack = busReadRegisterBuffer(busdev, 0x06, &status, 1);
...
# 107 "./src/main/drivers/compass/compass_qmc5883l.c"
    ...
    ack = busReadRegisterBuffer(busdev, 0x00, buf, 6);
    if (!ack) {
        return 
...
# 122 "./src/main/drivers/compass/compass_qmc5883l.c" 3 4
_Bool 
# 122 "./src/main/drivers/compass/compass_qmc5883l.c"
    qmc5883lDetect(magDev_t *magDev)
{
    ...
    if (busdev->bustype == BUSTYPE_I2C && busdev->busdev_u.i2c.address == 0) {
        busdev->busdev_u.i2c.address = 0x0D;
    }


    busWriteRegister(busdev, 0x0A, 0x80);
    delay(20);

    uint8_t sig = 0;
    
# 136 "./src/main/drivers/compass/compass_qmc5883l.c" 3 4
   _Bool 
# 136 "./src/main/drivers/compass/compass_qmc5883l.c"
        ack = busReadRegisterBuffer(busdev, 0x0D, &sig, 1);
    if (ack && sig == 0xFF) {


        ack = busReadRegisterBuffer(busdev, 0x09, &sig, 1);
        if (ack && sig != 0x00) {
            return 
# 142 "./src/main/drivers/compass/compass_qmc5883l.c" 3 4
                  0
# 142 "./src/main/drivers/compass/compass_qmc5883l.c"
                       ;
        }
        magDev->init = qmc5883lInit;
        magDev->read = qmc5883lRead;
        return 
# 146 "./src/main/drivers/compass/compass_qmc5883l.c" 3 4
              1
# 146 "./src/main/drivers/compass/compass_qmc5883l.c"
                  ;
    }

    return 
# 149 "./src/main/drivers/compass/compass_qmc5883l.c" 3 4
          0
# 149 "./src/main/drivers/compass/compass_qmc5883l.c"
               ;
}
