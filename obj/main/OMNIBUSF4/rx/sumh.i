...
# 49 "./src/main/rx/sumh.c" 2
# 57 "./src/main/rx/sumh.c"
static 
# 57 "./src/main/rx/sumh.c" 3 4
      _Bool 
# 57 "./src/main/rx/sumh.c"
           sumhFrameDone = 
# 57 "./src/main/rx/sumh.c" 3 4
...
static void sumhDataReceive(uint16_t c, void *data)
{
    ...
    if (sumhFramePosition == 21 - 1) {
        ...
        sumhFrameDone = 
# 84 "./src/main/rx/sumh.c" 3 4
                       1
# 84 "./src/main/rx/sumh.c"
                           ;
    } else {
        sumhFramePosition++;
    }
...
static uint8_t sumhFrameStatus(rxRuntimeConfig_t *rxRuntimeConfig)
{
    ...
    sumhFrameDone = 
# 100 "./src/main/rx/sumh.c" 3 4
                   0
# 100 "./src/main/rx/sumh.c"
                        ;
...
# 124 "./src/main/rx/sumh.c" 3 4
_Bool 
# 124 "./src/main/rx/sumh.c"
    sumhInit(const rxConfig_t *rxConfig, rxRuntimeConfig_t *rxRuntimeConfig)
{
    (void)(rxConfig);
    ...
    if (!portConfig) {
        return 
# 136 "./src/main/rx/sumh.c" 3 4
              0
# 136 "./src/main/rx/sumh.c"
                   ;
    }
...
# 145 "./src/main/rx/sumh.c" 3 4
                                                                                          ((void *)0)
# 145 "./src/main/rx/sumh.c"
    ...
    return sumhPort != 
# 153 "./src/main/rx/sumh.c" 3 4
                      ((void *)0)
# 153 "./src/main/rx/sumh.c"
                          ;
}
