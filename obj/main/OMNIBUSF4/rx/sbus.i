...
# 46 "./src/main/rx/sbus.c" 2
# 77 "./src/main/rx/sbus.c"
enum {
...
# 107 "./src/main/rx/sbus.c" 3 4
   _Bool 
# 107 "./src/main/rx/sbus.c"
        done;
} sbusFrameData_t;
...
# 134 "./src/main/rx/sbus.c"
            ...
            sbusFrameData->done = 
# 136 "./src/main/rx/sbus.c" 3 4
                                 1
# 136 "./src/main/rx/sbus.c"
                                     ;
...
static uint8_t sbusFrameStatus(rxRuntimeConfig_t *rxRuntimeConfig)
{
    ...
    sbusFrameData->done = 
# 148 "./src/main/rx/sbus.c" 3 4
                         0
# 148 "./src/main/rx/sbus.c"
                              ;
...
# 166 "./src/main/rx/sbus.c" 3 4
_Bool 
# 166 "./src/main/rx/sbus.c"
...
# 186 "./src/main/rx/sbus.c" 3 4
   _Bool 
# 186 "./src/main/rx/sbus.c"
    ...
    return sBusPort != 
# 210 "./src/main/rx/sbus.c" 3 4
                      ((void *)0)
# 210 "./src/main/rx/sbus.c"
                          ;
}
