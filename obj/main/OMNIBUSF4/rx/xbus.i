...
# 43 "./src/main/rx/xbus.c" 2
# 83 "./src/main/rx/xbus.c"
static 
# 83 "./src/main/rx/xbus.c" 3 4
      _Bool 
# 83 "./src/main/rx/xbus.c"
           xBusFrameReceived = 
# 83 "./src/main/rx/xbus.c" 3 4
...
# 83 "./src/main/rx/xbus.c"
                                    ;
static 
# 84 "./src/main/rx/xbus.c" 3 4
      _Bool 
# 84 "./src/main/rx/xbus.c"
           xBusDataIncoming = 
# 84 "./src/main/rx/xbus.c" 3 4
                              0
# 84 "./src/main/rx/xbus.c"
...
static void xBusUnpackModeBFrame(uint8_t offsetBytes)
{
    ...
    if (crc == inCrc) {
        ...
        xBusFrameReceived = 
# 137 "./src/main/rx/xbus.c" 3 4
                           1
# 137 "./src/main/rx/xbus.c"
                               ;
    }
}
...
static void xBusDataReceive(uint16_t c, void *data)
{
    ...
    if (xBusTimeInterval > 8000) {
        xBusFramePosition = 0;
        xBusDataIncoming = 
# 202 "./src/main/rx/xbus.c" 3 4
                          0
# 202 "./src/main/rx/xbus.c"
                               ;
    }
    ...
    if (xBusFramePosition == 0) {
        if (c == (0xA1)) {
            xBusDataIncoming = 
# 208 "./src/main/rx/xbus.c" 3 4
                              1
# 208 "./src/main/rx/xbus.c"
                                  ;
            xBusFrameLength = 27;
        } else if (c == (0xA2)) {
            xBusDataIncoming = 
# 211 "./src/main/rx/xbus.c" 3 4
                              1
# 211 "./src/main/rx/xbus.c"
                                  ;
            xBusFrameLength = 35;
        }
    }
    ...
    if (xBusDataIncoming == 
# 217 "./src/main/rx/xbus.c" 3 4
                           1
# 217 "./src/main/rx/xbus.c"
                               ) {
...
static uint8_t xBusFrameStatus(rxRuntimeConfig_t *rxRuntimeConfig)
{
    ...
    xBusFrameReceived = 
# 246 "./src/main/rx/xbus.c" 3 4
                       0
# 246 "./src/main/rx/xbus.c"
                            ;
...
# 265 "./src/main/rx/xbus.c" 3 4
_Bool 
# 265 "./src/main/rx/xbus.c"
    xBusInit(const rxConfig_t *rxConfig, rxRuntimeConfig_t *rxRuntimeConfig)
{
    uint32_t baudRate;
    ...
    case SERIALRX_XBUS_MODE_B:
        ...
        xBusFrameReceived = 
# 272 "./src/main/rx/xbus.c" 3 4
                           0
# 272 "./src/main/rx/xbus.c"
                                ;
        xBusDataIncoming = 
# 273 "./src/main/rx/xbus.c" 3 4
                          0
# 273 "./src/main/rx/xbus.c"
                               ;
        xBusFramePosition = 0;
        baudRate = 115200;
        xBusFrameLength = 27;
    ...
    case SERIALRX_XBUS_MODE_B_RJ01:
        rxRuntimeConfig->channelCount = 12;
        xBusFrameReceived = 
# 282 "./src/main/rx/xbus.c" 3 4
                           0
# 282 "./src/main/rx/xbus.c"
                                ;
        xBusDataIncoming = 
# 283 "./src/main/rx/xbus.c" 3 4
                          0
# 283 "./src/main/rx/xbus.c"
                               ;
        xBusFramePosition = 0;
        baudRate = 250000;
        xBusFrameLength = 33;
    ...
    default:
        return 
# 291 "./src/main/rx/xbus.c" 3 4
              0
# 291 "./src/main/rx/xbus.c"
                   ;
        break;
    }
...
# 306 "./src/main/rx/xbus.c" 3 4
   _Bool 
# 306 "./src/main/rx/xbus.c"
...
# 314 "./src/main/rx/xbus.c" 3 4
       ((void *)0)
# 314 "./src/main/rx/xbus.c"
           ,
        baudRate,
