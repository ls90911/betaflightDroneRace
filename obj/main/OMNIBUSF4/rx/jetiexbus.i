...
# 257 "./src/main/rx/jetiexbus.c" 3 4
_Bool 
# 257 "./src/main/rx/jetiexbus.c"
    jetiExBusInit(const rxConfig_t *rxConfig, rxRuntimeConfig_t *rxRuntimeConfig)
{
    (void)(rxConfig);
    ...
    if (!portConfig) {
        return 
# 272 "./src/main/rx/jetiexbus.c" 3 4
              0
# 272 "./src/main/rx/jetiexbus.c"
                   ;
    }
...
# 278 "./src/main/rx/jetiexbus.c" 3 4
       ((void *)0)
# 278 "./src/main/rx/jetiexbus.c"
           ,
        125000,
        MODE_RXTX,
...
# 284 "./src/main/rx/jetiexbus.c" 3 4
                           ((void *)0)
# 284 "./src/main/rx/jetiexbus.c"
                               ;
}
