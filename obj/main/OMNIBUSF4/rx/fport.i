...
# 47 "./src/main/rx/fport.c" 2
# 1 "./src/main/rx/sbus_channels.h" 1
# 21 "./src/main/rx/sbus_channels.h"
       
# 30 "./src/main/rx/sbus_channels.h"
...
# 49 "./src/main/rx/fport.c" 2
# 70 "./src/main/rx/fport.c"
enum {
...
static 
# 150 "./src/main/rx/fport.c" 3 4
      _Bool 
# 150 "./src/main/rx/fport.c"
           telemetryEnabled = 
# 150 "./src/main/rx/fport.c" 3 4
                              0
# 150 "./src/main/rx/fport.c"
...
static void fportDataReceive(uint16_t c, void *data)
{
    ...
    static 
# 168 "./src/main/rx/fport.c" 3 4
          _Bool 
# 168 "./src/main/rx/fport.c"
               escapedCharacter = 
# 168 "./src/main/rx/fport.c" 3 4
                                  0
# 168 "./src/main/rx/fport.c"
    ...
    static 
# 170 "./src/main/rx/fport.c" 3 4
          _Bool 
# 170 "./src/main/rx/fport.c"
               telemetryFrame = 
# 170 "./src/main/rx/fport.c" 3 4
                                0
# 170 "./src/main/rx/fport.c"
    ...
    clearToSend = 
# 174 "./src/main/rx/fport.c" 3 4
                 0
# 174 "./src/main/rx/fport.c"
                      ;
    ...
    if (val == 0x7E) {
        if (framePosition > 1) {
            ...
            if (telemetryFrame) {
                clearToSend = 
# 193 "./src/main/rx/fport.c" 3 4
                             1
# 193 "./src/main/rx/fport.c"
                                 ;
                lastTelemetryFrameReceivedUs = currentTimeUs;
                telemetryFrame = 
# 195 "./src/main/rx/fport.c" 3 4
                                0
# 195 "./src/main/rx/fport.c"
                                     ;
            }
...
# 201 "./src/main/rx/fport.c"
        ...
        if (framePosition >= (sizeof(fportFrame_t) + 2 * sizeof(uint8_t)) + 1) {
            ...
            if (escapedCharacter) {
                val = val ^ 0x20;
                escapedCharacter = 
# 214 "./src/main/rx/fport.c" 3 4
                                  0
# 214 "./src/main/rx/fport.c"
                                       ;
            } else if (val == 0x7D) {
                escapedCharacter = 
# 216 "./src/main/rx/fport.c" 3 4
                                  1
# 216 "./src/main/rx/fport.c"
                                      ;
            ...
            if (framePosition == 2 && val == FPORT_FRAME_TYPE_TELEMETRY_REQUEST) {
                telemetryFrame = 
# 222 "./src/main/rx/fport.c" 3 4
                                1
# 222 "./src/main/rx/fport.c"
                                    ;
            }
...
static 
# 243 "./src/main/rx/fport.c" 3 4
      _Bool 
# 243 "./src/main/rx/fport.c"
...
static uint8_t fportFrameStatus(rxRuntimeConfig_t *rxRuntimeConfig)
{
    ...
    static 
# 260 "./src/main/rx/fport.c" 3 4
          _Bool 
# 260 "./src/main/rx/fport.c"
               hasTelemetryRequest = 
# 260 "./src/main/rx/fport.c" 3 4
                                     0
# 260 "./src/main/rx/fport.c"
    ...
    static 
# 264 "./src/main/rx/fport.c" 3 4
          _Bool 
# 264 "./src/main/rx/fport.c"
               rxDrivenFrameRate = 
# 264 "./src/main/rx/fport.c" 3 4
                                   0
# 264 "./src/main/rx/fport.c"
                    ...
                    if (frameLength != (sizeof(uint8_t) + sizeof(smartPortPayload_t))) {
                        ...
                        case FPORT_FRAME_ID_DATA:
                            if (!rxDrivenFrameRate) {
                                rxDrivenFrameRate = 
# 303 "./src/main/rx/fport.c" 3 4
                                                   1
# 303 "./src/main/rx/fport.c"
                                                       ;
                            }

                            hasTelemetryRequest = 
# 306 "./src/main/rx/fport.c" 3 4
                                                 1
# 306 "./src/main/rx/fport.c"
                                                     ;

                            break;
                        case FPORT_FRAME_ID_NULL:
                            if (!rxDrivenFrameRate) {
                                if (consecutiveTelemetryFrameCount >= 2 && !(mspPayload && smartPortPayloadContainsMSP(mspPayload))) {
                                    consecutiveTelemetryFrameCount = 0;
                                } else {
                                    hasTelemetryRequest = 
# 314 "./src/main/rx/fport.c" 3 4
                                                         1
# 314 "./src/main/rx/fport.c"
                                                             ;
...
static 
# 361 "./src/main/rx/fport.c" 3 4
      _Bool 
# 361 "./src/main/rx/fport.c"
...
# 374 "./src/main/rx/fport.c" 3 4
                                                           ((void *)0)
# 374 "./src/main/rx/fport.c"
                                                               );
        ...
        if (clearToSend) {
            ...
            clearToSend = 
# 379 "./src/main/rx/fport.c" 3 4
                         0
# 379 "./src/main/rx/fport.c"
                              ;
        }

        {if (debugMode == (DEBUG_FPORT)) {debug[(DEBUG_FPORT_TELEMETRY_INTERVAL)] = (currentTimeUs - lastTelemetryFrameSentUs);}};
        lastTelemetryFrameSentUs = currentTimeUs;
    }

    mspPayload = 
# 386 "./src/main/rx/fport.c" 3 4
                ((void *)0)
# 386 "./src/main/rx/fport.c"
                    ;


    return 
# 389 "./src/main/rx/fport.c" 3 4
          1
# 389 "./src/main/rx/fport.c"
              ;
}
    ...
    fportRxInit(const rxConfig_t *rxConfig, rxRuntimeConfig_t *rxRuntimeConfig)
{
    ...
    if (!portConfig) {
        return 
# 406 "./src/main/rx/fport.c" 3 4
              0
# 406 "./src/main/rx/fport.c"
                   ;
    }
...
# 412 "./src/main/rx/fport.c" 3 4
       ((void *)0)
# 412 "./src/main/rx/fport.c"
           ,
        115200,
        MODE_RXTX,
    ...
    return fportPort != 
# 428 "./src/main/rx/fport.c" 3 4
                       ((void *)0)
# 428 "./src/main/rx/fport.c"
                           ;
}
