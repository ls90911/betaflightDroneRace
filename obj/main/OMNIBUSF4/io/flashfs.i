...
# 27 "./src/main/drivers/io_types.h"
...
static 
# 62 "./src/main/io/flashfs.c" 3 4
      _Bool 
# 62 "./src/main/io/flashfs.c"
...
# 111 "./src/main/io/flashfs.c" 3 4
_Bool 
# 111 "./src/main/io/flashfs.c"
    flashfsIsReady(void)
{
    return flashIsReady();
}
...
# 116 "./src/main/io/flashfs.c" 3 4
_Bool 
# 116 "./src/main/io/flashfs.c"
    flashfsIsSupported(void)
{
...
# 317 "./src/main/io/flashfs.c" 3 4
_Bool 
# 317 "./src/main/io/flashfs.c"
    flashfsFlushAsync(void)
{
    if (flashfsBufferIsEmpty()) {
        return 
# 320 "./src/main/io/flashfs.c" 3 4
              1
# 320 "./src/main/io/flashfs.c"
                  ;
    }
...
# 328 "./src/main/io/flashfs.c" 3 4
                                                               0
# 328 "./src/main/io/flashfs.c"
                                                                    );
...
# 350 "./src/main/io/flashfs.c" 3 4
                                                1
# 350 "./src/main/io/flashfs.c"
                                                    );
...
void flashfsWrite(const uint8_t *data, unsigned int len, 
# 392 "./src/main/io/flashfs.c" 3 4
                                                        _Bool 
# 392 "./src/main/io/flashfs.c"
                                                             sync)
{
...
# 412 "./src/main/io/flashfs.c" 3 4
                                                                   0
# 412 "./src/main/io/flashfs.c"
                                                                        );
...
# 431 "./src/main/io/flashfs.c" 3 4
                                                            1
# 431 "./src/main/io/flashfs.c"
                                                                );
                flashfsClearBuffer();
            } else {
...
# 507 "./src/main/io/flashfs.c"
    ...
    typedef char assert_failed_FREE_BLOCK_SIZE_too_small [(FREE_BLOCK_SIZE >= 2048) ? 1 : -1 ] __attribute__((unused));
...
# 530 "./src/main/io/flashfs.c" 3 4
   _Bool 
# 530 "./src/main/io/flashfs.c"
        blockErased;
    ...
    while (left < right) {
        ...
        blockErased = 
# 541 "./src/main/io/flashfs.c" 3 4
                     1
# 541 "./src/main/io/flashfs.c"
                         ;
        for (i = 0; i < FREE_BLOCK_TEST_SIZE_INTS; i++) {
            if (testBuffer.ints[i] != 0xFFFFFFFF) {
                blockErased = 
# 544 "./src/main/io/flashfs.c" 3 4
                             0
# 544 "./src/main/io/flashfs.c"
                                  ;
                break;
            }
        }
...
# 567 "./src/main/io/flashfs.c" 3 4
_Bool 
# 567 "./src/main/io/flashfs.c"
    flashfsIsEOF(void)
{
