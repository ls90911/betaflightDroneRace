...
# 21 "./src/main/blackbox/blackbox_io.h"
...
# 41 "./src/main/blackbox/blackbox_io.h"
...
# 48 "./src/main/blackbox/blackbox_io.h" 3 4
_Bool 
# 48 "./src/main/blackbox/blackbox_io.h"
    blackboxDeviceFlushForce(void);

# 49 "./src/main/blackbox/blackbox_io.h" 3 4
_Bool 
# 49 "./src/main/blackbox/blackbox_io.h"
...
# 56 "./src/main/blackbox/blackbox_io.h" 3 4
_Bool 
# 56 "./src/main/blackbox/blackbox_io.h"
...
# 58 "./src/main/blackbox/blackbox_io.h" 3 4
_Bool 
# 58 "./src/main/blackbox/blackbox_io.h"
...
# 96 "./src/main/io/osd.c" 2
# 105 "./src/main/io/osd.c"
...
static 
# 113 "./src/main/io/osd.c" 3 4
      _Bool 
# 113 "./src/main/io/osd.c"
           blinkState = 
# 113 "./src/main/io/osd.c" 3 4
                        1
# 113 "./src/main/io/osd.c"
                            ;
static 
# 114 "./src/main/io/osd.c" 3 4
      _Bool 
# 114 "./src/main/io/osd.c"
           showVisualBeeper = 
# 114 "./src/main/io/osd.c" 3 4
                              0
# 114 "./src/main/io/osd.c"
...
static 
# 146 "./src/main/io/osd.c" 3 4
      _Bool 
# 146 "./src/main/io/osd.c"
           lastArmState;
...
# 364 "./src/main/io/osd.c" 3 4
                                                  _Bool 
# 364 "./src/main/io/osd.c"
                                                       showSymbol, 
# 364 "./src/main/io/osd.c" 3 4
                                                                   _Bool 
# 364 "./src/main/io/osd.c"
                                                                        usePrecision, int timerIndex)
{
    ...
    osdFormatTime(buff, (usePrecision ? ((timer >> 4) & 0x0F) : OSD_TIMER_PREC_SECOND), osdGetTimerValue(src));
}
...
static void osdFormatCoordinate(char *buff, char sym, int32_t val)
{
    ...
    static const int coordinateMaxLength = 13;

    buff[0] = sym;
    const int32_t integerPart = val / 10000000L;
    const int32_t decimalPart = labs(val % 10000000L);
...
static 
# 399 "./src/main/io/osd.c" 3 4
      _Bool 
# 399 "./src/main/io/osd.c"
           osdFormatRtcDateTime(char *buffer)
{
    ...
    if (!rtcGetDateTime(&dateTime)) {
        ...
        return 
# 405 "./src/main/io/osd.c" 3 4
              0
# 405 "./src/main/io/osd.c"
                   ;
    }
    ...
    return 
# 410 "./src/main/io/osd.c" 3 4
          1
# 410 "./src/main/io/osd.c"
              ;
}
...
void osdStatSetState(uint8_t statIndex, 
# 424 "./src/main/io/osd.c" 3 4
                                       _Bool 
# 424 "./src/main/io/osd.c"
                                            enabled)
{
    if (enabled) {
...
# 433 "./src/main/io/osd.c" 3 4
_Bool 
# 433 "./src/main/io/osd.c"
    osdStatGetState(uint8_t statIndex)
{
...
void osdWarnSetState(uint8_t warningIndex, 
# 438 "./src/main/io/osd.c" 3 4
                                          _Bool 
# 438 "./src/main/io/osd.c"
                                               enabled)
{
    if (enabled) {
...
# 447 "./src/main/io/osd.c" 3 4
_Bool 
# 447 "./src/main/io/osd.c"
    osdWarnGetState(uint8_t warningIndex)
{
...
# 455 "./src/main/io/osd.c"
    ...
    case OSD_GPS_SATS:
        tfp_sprintf(buff, "%c%c%2d", 0x1E, 0x1F, gpsSol.numSat);
        break;
    ...
    case OSD_GPS_SPEED:
        ...
        switch (osdConfig()->units) {
        case OSD_UNIT_IMPERIAL:
            tfp_sprintf(buff, "%3dM", ((gpsSol.groundSpeed) * 10000 / 5080 / 88));
            break;
        default:
            tfp_sprintf(buff, "%3dK", ((gpsSol.groundSpeed) * 36 / 1000));
            break;
        }
        break;
    ...
    case OSD_GPS_LAT:
        ...
        osdFormatCoordinate(buff, 0x68, gpsSol.llh.lat);
        break;

    case OSD_GPS_LON:

        osdFormatCoordinate(buff, 0x64, gpsSol.llh.lon);
        break;
    ...
    case OSD_ITEM_TIMER_2:
        osdFormatTimer(buff, 
# 561 "./src/main/io/osd.c" 3 4
                            1
# 561 "./src/main/io/osd.c"
                                , 
# 561 "./src/main/io/osd.c" 3 4
                                  1
# 561 "./src/main/io/osd.c"
    ...
    case OSD_FLYMODE:
        {
            if ((flightModeFlags & (FAILSAFE_MODE))) {
                ...
                strcpy(buff, "HOR ");
            } else if ((flightModeFlags & (GPS_RESCUE_MODE))) {
                strcpy(buff, "RESC");
    ...
    case OSD_ARTIFICIAL_HORIZON:
        {
            ...
            return 
# 675 "./src/main/io/osd.c" 3 4
                  1
# 675 "./src/main/io/osd.c"
                      ;
        }
    ...
    case OSD_HORIZON_SIDEBARS:
        {
            ...
            return 
# 692 "./src/main/io/osd.c" 3 4
                  1
# 692 "./src/main/io/osd.c"
                      ;
        }
    ...
    case OSD_WARNINGS:
        {
            ...
            typedef char assert_failed_osd_warnings_size_exceeds_buffer_size [((11 + 1) <= sizeof(buff)) ? 1 : -1 ] __attribute__((unused));

            const batteryState_e batteryState = getBatteryState();


            if (isTryingToArm() && !(armingFlags & (ARMED))) {
                int armingDelayTime = (getLastDshotBeaconCommandTimeUs() + 1200000 - micros()) / 1e5;
                if (armingDelayTime < 0) {
                    armingDelayTime = 0;
                }
                if (armingDelayTime >= (1200000 / 1e5 - 5)) {
                    osdFormatMessage(buff, (11 + 1), " BEACON ON");
                } else {
                    char armingDelayMessage[(11 + 1)];
                    tfp_sprintf(armingDelayMessage, "ARM IN %d.%d", armingDelayTime / 10, armingDelayTime % 10);
                    osdFormatMessage(buff, (11 + 1), armingDelayMessage);
                }
                break;
            }
            ...
            if (osdWarnGetState(OSD_WARNING_BATTERY_CRITICAL) && batteryState == BATTERY_CRITICAL) {
                osdFormatMessage(buff, (11 + 1), " LAND NOW");
                break;
            }
            ...
            if (osdWarnGetState(OSD_WARNING_CORE_TEMPERATURE) && coreTemperature >= osdConfig()->core_temp_alarm) {
                char coreTemperatureWarningMsg[(11 + 1)];
                ...
                osdFormatMessage(buff, (11 + 1), coreTemperatureWarningMsg);
            ...
            if (feature(FEATURE_ESC_SENSOR) && osdWarnGetState(OSD_WARNING_ESC_FAIL)) {
                char escWarningMsg[(11 + 1)];
                unsigned pos = 0;

                const char *title = "ESC";


                while (pos < (11 - (strlen(title) + getMotorCount())) / 2) {
                    escWarningMsg[pos++] = ' ';
                }
                ...
                while (i < getMotorCount() && pos < (11 + 1) - 1) {
...
# 797 "./src/main/io/osd.c" 3 4
                                                      (-0x7f - 1) 
# 797 "./src/main/io/osd.c"
                ...
                if (escWarningCount > 0) {
                    osdFormatMessage(buff, (11 + 1), escWarningMsg);
                    break;
                }
            }
            ...
            if (osdWarnGetState(OSD_WARNING_CRASH_FLIP) && isFlipOverAfterCrashMode()) {
                osdFormatMessage(buff, (11 + 1), "CRASH FLIP");
                break;
            }
            ...
            if (osdWarnGetState(OSD_WARNING_ARMING_DISABLE) && IS_RC_MODE_ACTIVE(BOXARM) && isArmingDisabled()) {
                ...
                for (int i = 0; i < 20; i++) {
                    if (flags & (1 << i)) {
                        osdFormatMessage(buff, (11 + 1), armingDisableFlagNames[i]);
                        break;
                    }
                }
                break;
            ...
            if (osdWarnGetState(OSD_WARNING_BATTERY_WARNING) && batteryState == BATTERY_WARNING) {
                osdFormatMessage(buff, (11 + 1), "LOW BATTERY");
                break;
            }
            ...
            if (osdWarnGetState(OSD_WARNING_RC_SMOOTHING) && (armingFlags & (ARMED)) && !rcSmoothingInitializationComplete()) {
                osdFormatMessage(buff, (11 + 1), "RCSMOOTHING");
                break;
            }



            if (osdWarnGetState(OSD_WARNING_BATTERY_NOT_FULL) && !(armingFlags & (WAS_EVER_ARMED)) && (getBatteryState() == BATTERY_OK)
                  && getBatteryAverageCellVoltage() < batteryConfig()->vbatfullcellvoltage) {
                osdFormatMessage(buff, (11 + 1), "BATT < FULL");
                break;
            }


            if (osdWarnGetState(OSD_WARNING_VISUAL_BEEPER) && showVisualBeeper) {
                osdFormatMessage(buff, (11 + 1), "  * * * *");
                break;
            }

            osdFormatMessage(buff, (11 + 1), 
# 866 "./src/main/io/osd.c" 3 4
                                                                  ((void *)0)
# 866 "./src/main/io/osd.c"
                                                                      );
            break;
        }
    ...
    case OSD_MAIN_BATT_USAGE:
        {
            ...
            const uint8_t mAhUsedProgress = ceilf((value / (batteryConfig()->batteryCapacity / 11)));
    ...
    case OSD_ESC_RPM:
        if (feature(FEATURE_ESC_SENSOR)) {
            tfp_sprintf(buff, "%5d", escDataCombined == 
# 948 "./src/main/io/osd.c" 3 4
                                                       ((void *)0) 
# 948 "./src/main/io/osd.c"
                                                            ? 0 : calcEscRpm(escDataCombined->rpm));
        }
        break;
    ...
    default:
        return 
# 974 "./src/main/io/osd.c" 3 4
              0
# 974 "./src/main/io/osd.c"
                   ;
    }
    ...
    return 
# 979 "./src/main/io/osd.c" 3 4
          1
# 979 "./src/main/io/osd.c"
              ;
}
...
void pgResetFn_osdConfig(osdConfig_t *osdConfig)
{
    ...
    osdConfig->item_pos[OSD_CROSSHAIRS] = ((13 & ((1 << 5) - 1)) | ((6 & ((1 << 5) - 1)) << 5));
    osdConfig->item_pos[OSD_ARTIFICIAL_HORIZON] = ((14 & ((1 << 5) - 1)) | ((2 & ((1 << 5) - 1)) << 5));
    osdConfig->item_pos[OSD_HORIZON_SIDEBARS] = ((14 & ((1 << 5) - 1)) | ((6 & ((1 << 5) - 1)) << 5));


    osdConfig->enabled_stats = 0;
    osdStatSetState(OSD_STAT_MAX_SPEED, 
# 1049 "./src/main/io/osd.c" 3 4
                                       1
# 1049 "./src/main/io/osd.c"
                                           );
    osdStatSetState(OSD_STAT_MIN_BATTERY, 
# 1050 "./src/main/io/osd.c" 3 4
                                         1
# 1050 "./src/main/io/osd.c"
                                             );
    osdStatSetState(OSD_STAT_MIN_RSSI, 
# 1051 "./src/main/io/osd.c" 3 4
                                      1
# 1051 "./src/main/io/osd.c"
                                          );
    osdStatSetState(OSD_STAT_MAX_CURRENT, 
# 1052 "./src/main/io/osd.c" 3 4
                                         1
# 1052 "./src/main/io/osd.c"
                                             );
    osdStatSetState(OSD_STAT_USED_MAH, 
# 1053 "./src/main/io/osd.c" 3 4
                                      1
# 1053 "./src/main/io/osd.c"
                                          );
    osdStatSetState(OSD_STAT_BLACKBOX, 
# 1054 "./src/main/io/osd.c" 3 4
                                      1
# 1054 "./src/main/io/osd.c"
                                          );
    osdStatSetState(OSD_STAT_BLACKBOX_NUMBER, 
# 1055 "./src/main/io/osd.c" 3 4
                                             1
# 1055 "./src/main/io/osd.c"
                                                 );
    osdStatSetState(OSD_STAT_TIMER_2, 
# 1056 "./src/main/io/osd.c" 3 4
                                     1
# 1056 "./src/main/io/osd.c"
                                         );
    ...
    for (int i=0; i < OSD_WARNING_COUNT; i++) {
        osdWarnSetState(i, 
# 1062 "./src/main/io/osd.c" 3 4
                          1
# 1062 "./src/main/io/osd.c"
                              );
    }
...
# 1071 "./src/main/io/osd.c" 3 4
                               (-0x7f - 1)
# 1071 "./src/main/io/osd.c"
                                                 ;
    osdConfig->esc_rpm_alarm = -1;
    osdConfig->esc_current_alarm = -1;
    osdConfig->core_temp_alarm = 70;
...
void osdInit(displayPort_t *osdDisplayPortToUse)
{
    ...
    tfp_sprintf(string_buffer, "V%s", "3" "." "5" "." "0");
...
# 1134 "./src/main/io/osd.c" 3 4
_Bool 
# 1134 "./src/main/io/osd.c"
    osdInitialized(void)
{
...
void osdUpdateAlarms(void)
{
    ...
    if (feature(FEATURE_ESC_SENSOR)) {
        ...
        if (osdConfig()->esc_temp_alarm != 
# 1207 "./src/main/io/osd.c" 3 4
                                          (-0x7f - 1) 
# 1207 "./src/main/io/osd.c"
                                                             && escDataCombined->temperature >= osdConfig()->esc_temp_alarm) {
...
static void osdUpdateStats(void)
{
    ...
    switch (osdConfig()->units) {
    case OSD_UNIT_IMPERIAL:
        value = ((gpsSol.groundSpeed) * 10000 / 5080 / 88);
        break;
    default:
...
# 1294 "./src/main/io/osd.c" 3 4
   _Bool 
# 1294 "./src/main/io/osd.c"
...
# 1365 "./src/main/io/osd.c" 3 4
       _Bool 
# 1365 "./src/main/io/osd.c"
            success = 
# 1365 "./src/main/io/osd.c" 3 4
                      0
# 1365 "./src/main/io/osd.c"
    ...
    if (osdStatGetState(OSD_STAT_TIMER_1)) {
        osdFormatTimer(buff, 
# 1377 "./src/main/io/osd.c" 3 4
                            0
# 1377 "./src/main/io/osd.c"
                                 , ((osdConfig()->timers[OSD_TIMER_1] & 0x0F) == OSD_TIMER_SRC_ON ? 
# 1377 "./src/main/io/osd.c" 3 4
                                                                                                          0 
# 1377 "./src/main/io/osd.c"
                                                                                                                : 
...
# 1377 "./src/main/io/osd.c"
    ...
    if (osdStatGetState(OSD_STAT_TIMER_2)) {
        osdFormatTimer(buff, 
# 1382 "./src/main/io/osd.c" 3 4
                            0
# 1382 "./src/main/io/osd.c"
                                 , ((osdConfig()->timers[OSD_TIMER_2] & 0x0F) == OSD_TIMER_SRC_ON ? 
# 1382 "./src/main/io/osd.c" 3 4
                                                                                                          0 
# 1382 "./src/main/io/osd.c"
                                                                                                                : 
...
# 1382 "./src/main/io/osd.c"
    ...
    if (osdStatGetState(OSD_STAT_MAX_SPEED) && (stateFlags & (GPS_FIX))) {
    ...
    if (osdStatGetState(OSD_STAT_END_BATTERY)) {
        tfp_sprintf(buff, "%d.%1d%c", endBatteryVoltage / 10, endBatteryVoltage % 10, 0x06);
...
static void osdRefresh(timeUs_t currentTimeUs)
{
    ...
    static 
# 1458 "./src/main/io/osd.c" 3 4
          _Bool 
# 1458 "./src/main/io/osd.c"
               osdStatsEnabled = 
# 1458 "./src/main/io/osd.c" 3 4
                                 0
# 1458 "./src/main/io/osd.c"
                                      ;
    static 
# 1459 "./src/main/io/osd.c" 3 4
          _Bool 
# 1459 "./src/main/io/osd.c"
               osdStatsVisible = 
# 1459 "./src/main/io/osd.c" 3 4
                                 0
# 1459 "./src/main/io/osd.c"
    ...
    if (armState != (armingFlags & (ARMED))) {
        if ((armingFlags & (ARMED))) {
            osdStatsEnabled = 
# 1466 "./src/main/io/osd.c" 3 4
                             0
# 1466 "./src/main/io/osd.c"
                                  ;
            osdStatsVisible = 
# 1467 "./src/main/io/osd.c" 3 4
                             0
# 1467 "./src/main/io/osd.c"
                                  ;
            osdResetStats();
            osdShowArmed();
            resumeRefreshAt = currentTimeUs + (1000 * 1000 / 2);
                   ...
                   && (!(getArmingDisableFlags() & ARMING_DISABLED_RUNAWAY_TAKEOFF)
                       || !(osdConfig()->item_pos[OSD_WARNINGS] & 0x0800))) {
            osdStatsEnabled = 
# 1474 "./src/main/io/osd.c" 3 4
                             1
# 1474 "./src/main/io/osd.c"
                                 ;
    ...
    if ((armingFlags & (ARMED))) {
        ...
        if (displayIsGrabbed(osdDisplayPort)) {
            osdStatsEnabled = 
# 1490 "./src/main/io/osd.c" 3 4
                             0
# 1490 "./src/main/io/osd.c"
                                  ;
            resumeRefreshAt = 0;
            stats.armed_time = 0;
        } else {
            if (IS_RC_MODE_ACTIVE(BOXOSD) && osdStatsVisible) {
                osdStatsVisible = 
# 1495 "./src/main/io/osd.c" 3 4
                                 0
# 1495 "./src/main/io/osd.c"
                                      ;
                displayClearScreen(osdDisplayPort);
            } else if (!IS_RC_MODE_ACTIVE(BOXOSD)) {
                if (!osdStatsVisible) {
                    osdStatsVisible = 
# 1499 "./src/main/io/osd.c" 3 4
                                     1
# 1499 "./src/main/io/osd.c"
                                         ;
                    osdStatsRefreshTimeUs = 0;
                }
                if (currentTimeUs >= osdStatsRefreshTimeUs) {
                    osdStatsRefreshTimeUs = currentTimeUs + 1000 * 1000;
    ...
    if (resumeRefreshAt) {
        if (cmp32(currentTimeUs, resumeRefreshAt) < 0) {
            ...
            resumeRefreshAt = 0;
            osdStatsEnabled = 
# 1522 "./src/main/io/osd.c" 3 4
                             0
# 1522 "./src/main/io/osd.c"
                                  ;
            stats.armed_time = 0;
        }
    }
    ...
    if (feature(FEATURE_ESC_SENSOR)) {
        escDataCombined = getEscSensorData(255);
    }
    ...
    lastArmState = (armingFlags & (ARMED));
}
...
void osdUpdate(timeUs_t currentTimeUs)
{
    ...
    if (isBeeperOn()) {
        showVisualBeeper = 
# 1557 "./src/main/io/osd.c" 3 4
                          1
# 1557 "./src/main/io/osd.c"
                              ;
    }
# 1584 "./src/main/io/osd.c"
    if (counter % 5 == 0) {
        ...
        showVisualBeeper = 
# 1586 "./src/main/io/osd.c" 3 4
                          0
# 1586 "./src/main/io/osd.c"
                               ;
    } else {
