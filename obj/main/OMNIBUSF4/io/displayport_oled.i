...
# 1 "<command-line>"
# 1 "./src/main/io/displayport_oled.c"
# 21 "./src/main/io/displayport_oled.c"
...
# 23 "./src/main/io/displayport_oled.c" 2
...
# 25 "./src/main/io/displayport_oled.c" 2
...
# 29 "./src/main/io/displayport_oled.c" 2
...
# 30 "./src/main/io/displayport_oled.c" 2
           ...
           oledIsTransferInProgress(const displayPort_t *displayPort)
{
    (void)(displayPort);
    return 
# 79 "./src/main/io/displayport_oled.c" 3 4
          0
# 79 "./src/main/io/displayport_oled.c"
               ;
}

static 
# 82 "./src/main/io/displayport_oled.c" 3 4
      _Bool 
# 82 "./src/main/io/displayport_oled.c"
           oledIsSynced(const displayPort_t *displayPort)
{
    (void)(displayPort);
    return 
# 85 "./src/main/io/displayport_oled.c" 3 4
          1
# 85 "./src/main/io/displayport_oled.c"
              ;
}
...
static uint32_t oledTxBytesFree(const displayPort_t *displayPort)
{
    (void)(displayPort);
    return 
# 102 "./src/main/io/displayport_oled.c" 3 4
          (0xffffffffUL)
# 102 "./src/main/io/displayport_oled.c"
                    ;
}
