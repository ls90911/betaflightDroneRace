...
# 55 "./src/main/io/beeper.c" 2
# 83 "./src/main/io/beeper.c"
static timeUs_t lastDshotBeaconCommandTimeUs;
# 96 "./src/main/io/beeper.c"
...
static const uint8_t beep_rcSmoothingInitFail[] = {
    10, 10, 10, 10, 10, 10, 50, 25, 0xFF
};


static uint8_t beep_multiBeeps[64 + 1];
# 181 "./src/main/io/beeper.c"
...
# 224 "./src/main/io/beeper.c" 3 4
     ((void *)0)
# 224 "./src/main/io/beeper.c"
     ,"SYSTEM_INIT" },
    { BEEPER_USB,17,
# 225 "./src/main/io/beeper.c" 3 4
     ((void *)0)
# 225 "./src/main/io/beeper.c"
     ,"ON_USB" },
    ...
    { BEEPER_RC_SMOOTHING_INIT_FAIL,22,beep_rcSmoothingInitFail,"RC_SMOOTHING_INIT_FAIL" },
    { BEEPER_ALL,23,
# 231 "./src/main/io/beeper.c" 3 4
     ((void *)0)
# 231 "./src/main/io/beeper.c"
     ,"ALL" },
};

static const beeperTableEntry_t *currentBeeperEntry = 
# 234 "./src/main/io/beeper.c" 3 4
                                                     ((void *)0)
# 234 "./src/main/io/beeper.c"
                                                         ;
...
void beeper(beeperMode_e mode)
{
    if (
        mode == BEEPER_SILENCE || (
            (beeperConfigMutable()->beeper_off_flags & (1 << (BEEPER_USB - 1)))
...
# 254 "./src/main/io/beeper.c" 3 4
                                                 ((void *)0)
# 254 "./src/main/io/beeper.c"
                                                     ;
...
{
    systemBeep(
# 285 "./src/main/io/beeper.c" 3 4
   0
# 285 "./src/main/io/beeper.c"
   );
    warningLedDisable();
    warningLedRefresh();
    ...
    currentBeeperEntry = 
# 295 "./src/main/io/beeper.c" 3 4
                        ((void *)0)
# 295 "./src/main/io/beeper.c"
                            ;
}
...
{
    if (!(beeperConfigMutable()->beeper_off_flags & (1 << (BEEPER_GPS_STATUS - 1)))) {
...
void beeperUpdate(timeUs_t currentTimeUs)
{
    ...
    if (currentBeeperEntry == 
# 393 "./src/main/io/beeper.c" 3 4
                             ((void *)0)
# 393 "./src/main/io/beeper.c"
                                 ) {
        return;
    }
...
# 411 "./src/main/io/beeper.c" 3 4
                                                                                                  0
# 411 "./src/main/io/beeper.c"
                                                                                                       );
            }
        }
        ...
        if (currentBeeperEntry->sequence[beeperPos] != 0) {
            if (!(beeperConfigMutable()->beeper_off_flags & (1 << (currentBeeperEntry->mode - 1))))
                systemBeep(
# 418 "./src/main/io/beeper.c" 3 4
               1
# 418 "./src/main/io/beeper.c"
               );
            warningLedEnable();
            warningLedRefresh();
        ...
        if (currentBeeperEntry->sequence[beeperPos] != 0) {
            systemBeep(
# 432 "./src/main/io/beeper.c" 3 4
           0
# 432 "./src/main/io/beeper.c"
           );
            warningLedDisable();
            warningLedRefresh();
        }
...
# 496 "./src/main/io/beeper.c" 3 4
                                                                                      ((void *)0)
# 496 "./src/main/io/beeper.c"
                                                                                          ;
...
# 511 "./src/main/io/beeper.c" 3 4
_Bool 
# 511 "./src/main/io/beeper.c"
    isBeeperOn(void)
{
    return beeperIsOn;
}
# 534 "./src/main/io/beeper.c"
timeUs_t getLastDshotBeaconCommandTimeUs(void)
{
