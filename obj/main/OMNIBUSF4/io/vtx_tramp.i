...
# 21 "./src/main/cms/cms_menu_vtx_tramp.h"
...
# 24 "./src/main/cms/cms_menu_vtx_tramp.h" 2
...
# 25 "./src/main/cms/cms_menu_vtx_tramp.h" 2
...
# 89 "./src/main/io/vtx_tramp.c" 3 4
_Bool 
# 89 "./src/main/io/vtx_tramp.c"
    trampSetByFreqFlag = 
# 89 "./src/main/io/vtx_tramp.c" 3 4
                         0
# 89 "./src/main/io/vtx_tramp.c"
...
static 
# 138 "./src/main/io/vtx_tramp.c" 3 4
      _Bool 
# 138 "./src/main/io/vtx_tramp.c"
...
{
    trampSetByFreqFlag = 
# 153 "./src/main/io/vtx_tramp.c" 3 4
                        1
# 153 "./src/main/io/vtx_tramp.c"
                            ;
...
static 
# 162 "./src/main/io/vtx_tramp.c" 3 4
      _Bool 
# 162 "./src/main/io/vtx_tramp.c"
...
{
    trampSetByFreqFlag = 
# 175 "./src/main/io/vtx_tramp.c" 3 4
                        0
# 175 "./src/main/io/vtx_tramp.c"
                             ;
    ...
    trampCommitChanges(void)
{
    if (trampStatus != TRAMP_STATUS_ONLINE) {
        return 
# 196 "./src/main/io/vtx_tramp.c" 3 4
              0
# 196 "./src/main/io/vtx_tramp.c"
                   ;
    }

    trampStatus = TRAMP_STATUS_SET_FREQ_PW;
    return 
# 200 "./src/main/io/vtx_tramp.c" 3 4
          1
# 200 "./src/main/io/vtx_tramp.c"
              ;
}
           ...
           trampDevSetPowerByIndex(uint8_t index)
{
    if (index > 0 && index <= sizeof(trampPowerTable)) {
        ...
        trampCommitChanges();
        return 
# 209 "./src/main/io/vtx_tramp.c" 3 4
              1
# 209 "./src/main/io/vtx_tramp.c"
                  ;
    }
    return 
# 211 "./src/main/io/vtx_tramp.c" 3 4
          0
# 211 "./src/main/io/vtx_tramp.c"
               ;
}
    ...
    case 'v':
        {
            ...
            if (freq != 0) {
                ...
                if (!vtx58_Freq2Bandchan(trampCurFreq, &trampBand, &trampChannel)) {
                    trampSetByFreqFlag = 
# 250 "./src/main/io/vtx_tramp.c" 3 4
                                        1
# 250 "./src/main/io/vtx_tramp.c"
                                            ;
                }
           ...
           trampIsValidResponseCode(uint8_t code)
{
    if (code == 'r' || code == 'v' || code == 's') {
        return 
# 294 "./src/main/io/vtx_tramp.c" 3 4
              1
# 294 "./src/main/io/vtx_tramp.c"
                  ;
    } else {
        return 
# 296 "./src/main/io/vtx_tramp.c" 3 4
              0
# 296 "./src/main/io/vtx_tramp.c"
                   ;
    }
}
...
static void vtxTrampProcess(vtxDevice_t *vtxDevice, timeUs_t currentTimeUs)
{
    ...
    static 
# 377 "./src/main/io/vtx_tramp.c" 3 4
          _Bool 
# 377 "./src/main/io/vtx_tramp.c"
    ...
    case 'r':
        if (trampStatus <= TRAMP_STATUS_OFFLINE) {
            ...
            if (!initSettingsDoneFlag) {
                initSettingsDoneFlag = 
# 401 "./src/main/io/vtx_tramp.c" 3 4
                                      1
# 401 "./src/main/io/vtx_tramp.c"
                                          ;
...
# 451 "./src/main/io/vtx_tramp.c" 3 4
                      0
# 451 "./src/main/io/vtx_tramp.c"
                           ;
            }
...
static 
# 503 "./src/main/io/vtx_tramp.c" 3 4
      _Bool 
# 503 "./src/main/io/vtx_tramp.c"
           vtxTrampIsReady(const vtxDevice_t *vtxDevice)
{
    return vtxDevice!=
# 505 "./src/main/io/vtx_tramp.c" 3 4
                     ((void *)0) 
# 505 "./src/main/io/vtx_tramp.c"
...
static 
# 538 "./src/main/io/vtx_tramp.c" 3 4
      _Bool 
# 538 "./src/main/io/vtx_tramp.c"
           vtxTrampGetBandAndChannel(const vtxDevice_t *vtxDevice, uint8_t *pBand, uint8_t *pChannel)
{
    if (!vtxTrampIsReady(vtxDevice)) {
        return 
# 541 "./src/main/io/vtx_tramp.c" 3 4
              0
# 541 "./src/main/io/vtx_tramp.c"
                   ;
    }
    ...
    *pChannel = trampChannel;
    return 
# 547 "./src/main/io/vtx_tramp.c" 3 4
          1
# 547 "./src/main/io/vtx_tramp.c"
              ;
}

static 
# 550 "./src/main/io/vtx_tramp.c" 3 4
      _Bool 
# 550 "./src/main/io/vtx_tramp.c"
           vtxTrampGetPowerIndex(const vtxDevice_t *vtxDevice, uint8_t *pIndex)
{
    if (!vtxTrampIsReady(vtxDevice)) {
        return 
# 553 "./src/main/io/vtx_tramp.c" 3 4
              0
# 553 "./src/main/io/vtx_tramp.c"
                   ;
    }
...
static 
# 578 "./src/main/io/vtx_tramp.c" 3 4
      _Bool 
# 578 "./src/main/io/vtx_tramp.c"
           vtxTrampGetFreq(const vtxDevice_t *vtxDevice, uint16_t *pFreq)
{
    if (!vtxTrampIsReady(vtxDevice)) {
        return 
# 581 "./src/main/io/vtx_tramp.c" 3 4
              0
# 581 "./src/main/io/vtx_tramp.c"
                   ;
    }

    *pFreq = trampCurFreq;
    return 
# 585 "./src/main/io/vtx_tramp.c" 3 4
          1
# 585 "./src/main/io/vtx_tramp.c"
              ;
}
...
# 604 "./src/main/io/vtx_tramp.c" 3 4
_Bool 
# 604 "./src/main/io/vtx_tramp.c"
    vtxTrampInit(void)
{
...
# 616 "./src/main/io/vtx_tramp.c"
    ...
    if (!trampSerialPort) {
        return 
# 620 "./src/main/io/vtx_tramp.c" 3 4
              0
# 620 "./src/main/io/vtx_tramp.c"
                   ;
    }
    ...
    return 
# 627 "./src/main/io/vtx_tramp.c" 3 4
          1
# 627 "./src/main/io/vtx_tramp.c"
              ;
}
