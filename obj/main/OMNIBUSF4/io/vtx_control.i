...
# 44 "./src/main/io/vtx_control.c" 2


# 1 "./src/main/pg/pg_ids.h" 1
# 21 "./src/main/pg/pg_ids.h"
       
# 47 "./src/main/io/vtx_control.c" 2
...
# 51 "./src/main/io/vtx_control.c" 3 4
1 
# 51 "./src/main/io/vtx_control.c"
}
...
void vtxCyclePower(const uint8_t powerStep)
{
    ...
    if (vtxDevice) {
        ...
        vtxDeviceCapability_t capability;
        const 
# 166 "./src/main/io/vtx_control.c" 3 4
             _Bool 
# 166 "./src/main/io/vtx_control.c"
...
# 198 "./src/main/io/vtx_control.c"
void handleVTXControlButton(void)
{
# 271 "./src/main/io/vtx_control.c"
}
