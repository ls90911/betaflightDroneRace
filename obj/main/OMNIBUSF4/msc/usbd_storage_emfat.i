...
# 32 "./src/main/msc/usbd_storage_emfat.c" 2
...
# 67 "./src/main/drivers/light_led.h"
                         state);
# 36 "./src/main/msc/usbd_storage_emfat.c" 2
...
# 37 "./src/main/msc/usbd_storage_emfat.c" 2
...
# 38 "./src/main/msc/usbd_storage_emfat.c" 2
...
# 56 "./src/main/io/flashfs.h"
    flashfsIsEOF(void);
# 40 "./src/main/msc/usbd_storage_emfat.c" 2
...
# 44 "./src/main/msc/usbd_storage_emfat.c" 2
# 1 "./src/main/msc/usbd_storage_emfat.h" 1
# 21 "./src/main/msc/usbd_storage_emfat.h"
       

# 1 "./src/main/msc/emfat.h" 1
# 31 "./src/main/msc/emfat.h"
       

# 1 "/home/jiahao/betaflight/tools/gcc-arm-none-eabi-7-2017-q4-major/lib/gcc/arm-none-eabi/7.2.1/include/stddef.h" 1 3 4
# 34 "./src/main/msc/emfat.h" 2
...
# 48 "./src/main/msc/emfat.h" 3 4
   _Bool 
# 48 "./src/main/msc/emfat.h"
                   dir;
    uint8_t attr;
    int level;
    uint32_t offset;
...
# 88 "./src/main/msc/emfat.h" 3 4
_Bool 
# 88 "./src/main/msc/emfat.h"
    emfat_init(emfat_t *emfat, const char *label, emfat_entry_t *entries);
...
{
    return ((((((Y)-1980) << 9) | ((M) << 5) | (D)) << 16) | (((h) << 11) | ((m) << 5) | (s >> 1)));
}

uint32_t emfat_cma_time_from_unix(uint32_t unix_time);
# 24 "./src/main/msc/usbd_storage_emfat.h" 2

extern emfat_t emfat;
# 45 "./src/main/msc/usbd_storage_emfat.c" 2
# 1 "./src/main/msc/emfat_file.h" 1
# 21 "./src/main/msc/emfat_file.h"
       

void emfat_init_files(void);
# 46 "./src/main/msc/usbd_storage_emfat.c" 2
...
static int8_t STORAGE_Init(uint8_t lun)
{
    ...
    ledSet(0, 
# 69 "./src/main/msc/usbd_storage_emfat.c" 3 4
   1
# 69 "./src/main/msc/usbd_storage_emfat.c"
   );
    ...
    ledSet(0, 
# 81 "./src/main/msc/usbd_storage_emfat.c" 3 4
   0
# 81 "./src/main/msc/usbd_storage_emfat.c"
   );
    ...
    uint16_t blk_len)
{
    (void)(lun);
    ledSet(0, 
# 117 "./src/main/msc/usbd_storage_emfat.c" 3 4
   1
# 117 "./src/main/msc/usbd_storage_emfat.c"
   );
    emfat_read(&emfat, buf, blk_addr, blk_len);
    ledSet(0, 
# 119 "./src/main/msc/usbd_storage_emfat.c" 3 4
   0
# 119 "./src/main/msc/usbd_storage_emfat.c"
   );
    return 0;
}
