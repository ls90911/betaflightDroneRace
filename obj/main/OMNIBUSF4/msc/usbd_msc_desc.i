# 1 "./src/main/msc/usbd_msc_desc.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/msc/usbd_msc_desc.c"
# 29 "./src/main/msc/usbd_msc_desc.c"
...
# 30 "./src/main/msc/usbd_msc_desc.c" 2
...
# 31 "./src/main/msc/usbd_msc_desc.c" 2
# 1 "./lib/main/STM32_USB_Device_Library/Core/inc/usbd_req.h" 1
# 35 "./lib/main/STM32_USB_Device_Library/Core/inc/usbd_req.h"
# 1 "./lib/main/STM32_USB_Device_Library/Core/inc/usbd_core.h" 1
...
# 32 "./src/main/msc/usbd_msc_desc.c" 2

# 1 "./lib/main/STM32_USB_OTG_Driver/inc/usb_regs.h" 1
# 34 "./src/main/msc/usbd_msc_desc.c" 2
...
# 35 "./src/main/msc/usbd_msc_desc.c" 2
# 91 "./src/main/msc/usbd_msc_desc.c"
USBD_DEVICE MSC_desc =
{
 ...
 uint8_t USBD_DeviceDesc_MSC[18] =
{
  0x12,
  0x01,
  0x00,
  ...
  ((uint8_t)((0x5720) & 0x00FF)),
  ((uint8_t)(((0x5720) & 0xFF00) >>8)),
  0x00,
  0x02,
  0x01,
  0x02,
 ...
 uint8_t USBD_DeviceQualifierDesc_MSC[0x0A] =
{
  0x0A,
  6,
  0x00,
...
uint8_t USBD_StringSerial_MSC[0x1A] =
{
  0x1A,
  3,
};
 ...
 uint8_t USBD_StrDesc_MSC[255] ;
# 185 "./src/main/msc/usbd_msc_desc.c"
static void IntToUnicode (uint32_t value , uint8_t *pbuf , uint8_t len);
static void Get_SerialNum(void);
# 203 "./src/main/msc/usbd_msc_desc.c"
uint8_t * USBD_MSC_DeviceDescriptor( uint8_t speed , uint16_t *length)
{
  (void)(speed);
...
# 217 "./src/main/msc/usbd_msc_desc.c"
uint8_t * USBD_MSC_LangIDStrDescriptor( uint8_t speed , uint16_t *length)
{
  (void)(speed);
...
# 232 "./src/main/msc/usbd_msc_desc.c"
uint8_t * USBD_MSC_ProductStrDescriptor( uint8_t speed , uint16_t *length)
{
  if(speed == 0)
  {
    USBD_GetString((uint8_t *)(uint8_t *)"Mass Storage in HS Mode", USBD_StrDesc_MSC, length);
  }
  else
  {
    USBD_GetString((uint8_t *)(uint8_t *)"Mass Storage in FS Mode", USBD_StrDesc_MSC, length);
  }
  return USBD_StrDesc_MSC;
}
# 252 "./src/main/msc/usbd_msc_desc.c"
uint8_t * USBD_MSC_ManufacturerStrDescriptor( uint8_t speed , uint16_t *length)
{
  (void)(speed);
  USBD_GetString((uint8_t *)(uint8_t *)"STMicroelectronics", USBD_StrDesc_MSC, length);
  return USBD_StrDesc_MSC;
}
# 266 "./src/main/msc/usbd_msc_desc.c"
uint8_t * USBD_MSC_SerialStrDescriptor( uint8_t speed , uint16_t *length)
{
  (void)(speed);
  *length = 0x1A;
...
# 284 "./src/main/msc/usbd_msc_desc.c"
uint8_t * USBD_MSC_ConfigStrDescriptor( uint8_t speed , uint16_t *length)
{
  if(speed == 0)
  {
    USBD_GetString((uint8_t *)(uint8_t *)"MSC Config", USBD_StrDesc_MSC, length);
  }
  else
  {
    USBD_GetString((uint8_t *)(uint8_t *)"MSC Config", USBD_StrDesc_MSC, length);
...
# 305 "./src/main/msc/usbd_msc_desc.c"
uint8_t * USBD_MSC_InterfaceStrDescriptor( uint8_t speed , uint16_t *length)
{
  if(speed == 0)
  {
    USBD_GetString((uint8_t *)(uint8_t *)"MSC Interface", USBD_StrDesc_MSC, length);
  }
  else
  {
    USBD_GetString((uint8_t *)(uint8_t *)"MSC Interface", USBD_StrDesc_MSC, length);
...
static void Get_SerialNum(void)
{
  ...
  deviceserial0 = *(uint32_t*)(0x1FFFF7E8);
  deviceserial1 = *(uint32_t*)(0x1FFFF7EA);
  deviceserial2 = *(uint32_t*)(0x1FFFF7EC);
...
# 347 "./src/main/msc/usbd_msc_desc.c"
static void IntToUnicode (uint32_t value , uint8_t *pbuf , uint8_t len)
{
  uint8_t idx = 0;
