...
void pgResetFn_flashConfig(flashConfig_t *flashConfig)
{
    ...
    flashConfig->csTag = ((ioTag_t)((((1) + 1) << 4) | (3)));



    flashConfig->spiDevice = ((spiDeviceByInstance(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)))) + 1);
}
