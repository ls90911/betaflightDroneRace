    ...
    pgResetCopy(void *copy, pgn_t pgn)
{
    ...
    if (reg) {
        ...
        return 
# 70 "./src/main/pg/pg.c" 3 4
              1
# 70 "./src/main/pg/pg.c"
                  ;
    }
    return 
# 72 "./src/main/pg/pg.c" 3 4
          0
# 72 "./src/main/pg/pg.c"
               ;
}
