...
# 29 "./src/main/pg/usb.c" 2
# 40 "./src/main/pg/usb.c"
extern const usbDev_t pgResetTemplate_usbDevConfig; usbDev_t usbDevConfig_System; usbDev_t usbDevConfig_Copy; extern const pgRegistry_t usbDevConfig_Registry; const pgRegistry_t usbDevConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 531 | (0 << 12), .size = sizeof(usbDev_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&usbDevConfig_System, .copy = (uint8_t*)&usbDevConfig_Copy, .ptr = 0, .reset = {.ptr = (void*)&pgResetTemplate_usbDevConfig}, };

const usbDev_t pgResetTemplate_usbDevConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .type = DEFAULT, .mscButtonPin = 0, .mscButtonUsePullup = 
# 42 "./src/main/pg/usb.c" 3 4
0
# 42 "./src/main/pg/usb.c"
, }
