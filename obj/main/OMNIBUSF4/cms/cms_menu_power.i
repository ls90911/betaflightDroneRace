...
# 23 "./src/main/cms/cms_menu_power.c" 2
...
# 24 "./src/main/cms/cms_menu_power.c" 2
...
int toupper (int __c);
int isblank (int __c);
# 25 "./src/main/cms/cms_menu_power.c" 2
...
# 27 "./src/main/cms/cms_menu_power.c" 2
...
# 31 "./src/main/cms/cms_menu_power.c" 2
...
# 35 "./src/main/cms/cms_menu_power.c" 2
...
# 37 "./src/main/cms/cms_menu_power.c" 2
...
# 41 "./src/main/cms/cms_menu_power.c" 2
...
{
    { "-- POWER --", OME_Label, 
# 101 "./src/main/cms/cms_menu_power.c" 3 4
                               ((void *)0)
# 101 "./src/main/cms/cms_menu_power.c"
                                   , 
# 101 "./src/main/cms/cms_menu_power.c" 3 4
                                     ((void *)0)
# 101 "./src/main/cms/cms_menu_power.c"
    ...
    { "V METER", OME_TAB, 
# 103 "./src/main/cms/cms_menu_power.c" 3 4
                         ((void *)0)
# 103 "./src/main/cms/cms_menu_power.c"
                             , &(OSD_TAB_t){ &batteryConfig_voltageMeterSource, VOLTAGE_METER_COUNT - 1, voltageMeterSourceNames }, 0 },
    { "I METER", OME_TAB, 
# 104 "./src/main/cms/cms_menu_power.c" 3 4
                         ((void *)0)
# 104 "./src/main/cms/cms_menu_power.c"
                             , &(OSD_TAB_t){ &batteryConfig_currentMeterSource, CURRENT_METER_COUNT - 1, currentMeterSourceNames }, 0 },

    { "VBAT CLMAX", OME_UINT8, 
# 106 "./src/main/cms/cms_menu_power.c" 3 4
                              ((void *)0)
# 106 "./src/main/cms/cms_menu_power.c"
                                  , &(OSD_UINT8_t) { &batteryConfig_vbatmaxcellvoltage, 10, 50, 1 }, 0 },

    { "VBAT SCALE", OME_UINT8, 
# 108 "./src/main/cms/cms_menu_power.c" 3 4
                              ((void *)0)
# 108 "./src/main/cms/cms_menu_power.c"
                                  , &(OSD_UINT8_t){ &voltageSensorADCConfig_vbatscale, 0, 255, 1 }, 0 },

    { "IBAT SCALE", OME_INT16, 
# 110 "./src/main/cms/cms_menu_power.c" 3 4
                              ((void *)0)
# 110 "./src/main/cms/cms_menu_power.c"
                                  , &(OSD_INT16_t){ &currentSensorADCConfig_scale, -16000, 16000, 5 }, 0 },
    { "IBAT OFFSET", OME_INT16, 
# 111 "./src/main/cms/cms_menu_power.c" 3 4
                               ((void *)0)
# 111 "./src/main/cms/cms_menu_power.c"
                                   , &(OSD_INT16_t){ &currentSensorADCConfig_offset, -16000, 16000, 5 }, 0 },


    { "IBAT VIRT SCALE", OME_INT16, 
# 114 "./src/main/cms/cms_menu_power.c" 3 4
                                   ((void *)0)
# 114 "./src/main/cms/cms_menu_power.c"
                                       , &(OSD_INT16_t){ &currentSensorVirtualConfig_scale, -16000, 16000, 5 }, 0 },
    { "IBAT VIRT OFFSET", OME_INT16, 
# 115 "./src/main/cms/cms_menu_power.c" 3 4
                                    ((void *)0)
# 115 "./src/main/cms/cms_menu_power.c"
                                        , &(OSD_INT16_t){ &currentSensorVirtualConfig_offset, -16000, 16000, 5 }, 0 },


    { "BACK", OME_Back, 
# 118 "./src/main/cms/cms_menu_power.c" 3 4
                       ((void *)0)
# 118 "./src/main/cms/cms_menu_power.c"
                           , 
# 118 "./src/main/cms/cms_menu_power.c" 3 4
                             ((void *)0)
# 118 "./src/main/cms/cms_menu_power.c"
                                 , 0 },
    { 
# 119 "./src/main/cms/cms_menu_power.c" 3 4
     ((void *)0)
# 119 "./src/main/cms/cms_menu_power.c"
         , OME_END, 
# 119 "./src/main/cms/cms_menu_power.c" 3 4
                    ((void *)0)
# 119 "./src/main/cms/cms_menu_power.c"
