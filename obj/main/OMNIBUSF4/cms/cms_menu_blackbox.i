...
# 1 "<command-line>"
# 1 "./src/main/cms/cms_menu_blackbox.c"
# 25 "./src/main/cms/cms_menu_blackbox.c"
...
# 27 "./src/main/cms/cms_menu_blackbox.c" 2
...
int toupper (int __c);
int isblank (int __c);
# 29 "./src/main/cms/cms_menu_blackbox.c" 2
...
# 31 "./src/main/cms/cms_menu_blackbox.c" 2
...
# 49 "./src/main/cms/cms_menu_blackbox.c" 2
...
# 51 "./src/main/cms/cms_menu_blackbox.c" 2
...
# 55 "./src/main/cms/cms_menu_blackbox.c" 2
...
# 56 "./src/main/io/flashfs.h"
    flashfsIsEOF(void);
# 56 "./src/main/cms/cms_menu_blackbox.c" 2
...
# 57 "./src/main/cms/cms_menu_blackbox.c" 2
...
# 81 "./src/main/cms/cms_menu_blackbox.c"
    ...
    {
# 122 "./src/main/cms/cms_menu_blackbox.c"
...
{
    { "-- BLACKBOX --", OME_Label, 
# 200 "./src/main/cms/cms_menu_blackbox.c" 3 4
                                  ((void *)0)
# 200 "./src/main/cms/cms_menu_blackbox.c"
                                      , 
# 200 "./src/main/cms/cms_menu_blackbox.c" 3 4
                                        ((void *)0)
# 200 "./src/main/cms/cms_menu_blackbox.c"
                                            , 0},
    { "DEVICE", OME_TAB, 
# 201 "./src/main/cms/cms_menu_blackbox.c" 3 4
                                 ((void *)0)
# 201 "./src/main/cms/cms_menu_blackbox.c"
                                     , &cmsx_BlackboxDeviceTable, 0 },
    { "(STATUS)", OME_String, 
# 202 "./src/main/cms/cms_menu_blackbox.c" 3 4
                                 ((void *)0)
# 202 "./src/main/cms/cms_menu_blackbox.c"
                                     , &cmsx_BlackboxStatus, 0 },
    { "(USED)", OME_String, 
# 203 "./src/main/cms/cms_menu_blackbox.c" 3 4
                                 ((void *)0)
# 203 "./src/main/cms/cms_menu_blackbox.c"
...
# 205 "./src/main/cms/cms_menu_blackbox.c"
                                     , &(OSD_UINT16_t){ &blackboxConfig_p_ratio, 1, 
# 205 "./src/main/cms/cms_menu_blackbox.c" 3 4
                                                                                               (0x7fff)
# 205 "./src/main/cms/cms_menu_blackbox.c"
                                                                                                        , 1 },0 },
    ...
    { "ERASE FLASH", OME_Funcall, cmsx_EraseFlash, 
# 208 "./src/main/cms/cms_menu_blackbox.c" 3 4
                                                  ((void *)0)
# 208 "./src/main/cms/cms_menu_blackbox.c"
                                                      , 0 },


    { "BACK", OME_Back, 
# 211 "./src/main/cms/cms_menu_blackbox.c" 3 4
                       ((void *)0)
# 211 "./src/main/cms/cms_menu_blackbox.c"
                           , 
# 211 "./src/main/cms/cms_menu_blackbox.c" 3 4
                             ((void *)0)
# 211 "./src/main/cms/cms_menu_blackbox.c"
                                 , 0 },
    { 
# 212 "./src/main/cms/cms_menu_blackbox.c" 3 4
     ((void *)0)
# 212 "./src/main/cms/cms_menu_blackbox.c"
         , OME_END, 
# 212 "./src/main/cms/cms_menu_blackbox.c" 3 4
                    ((void *)0)
# 212 "./src/main/cms/cms_menu_blackbox.c"
