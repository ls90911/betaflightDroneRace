...
# 24 "./src/main/telemetry/crsf.c" 2
...
# 26 "./src/main/telemetry/crsf.c" 2
...
# 30 "./src/main/telemetry/crsf.c" 2
...
# 39 "./src/main/telemetry/crsf.c" 2
...
# 48 "./src/main/telemetry/crsf.c" 2
...
# 1 "./src/main/io/displayport_crsf.h" 1
# 21 "./src/main/io/displayport_crsf.h"
...
# 31 "./src/main/io/displayport_crsf.h" 3 4
   _Bool 
# 31 "./src/main/io/displayport_crsf.h"
        pendingTransport[9];
    uint8_t rows;
    uint8_t cols;
    
# 34 "./src/main/io/displayport_crsf.h" 3 4
   _Bool 
# 34 "./src/main/io/displayport_crsf.h"
        reset;
...
# 58 "./src/main/telemetry/crsf.c" 2

# 1 "./src/main/rx/crsf.h" 1
# 21 "./src/main/rx/crsf.h"
       
# 31 "./src/main/rx/crsf.h"
...
# 62 "./src/main/telemetry/crsf.c" 2
...
# 63 "./src/main/telemetry/crsf.c" 2
...
# 65 "./src/main/telemetry/crsf.c" 2
# 1 "./src/main/telemetry/crsf.h" 1
# 21 "./src/main/telemetry/crsf.h"
       
# 32 "./src/main/telemetry/crsf.h"
...
# 66 "./src/main/telemetry/crsf.c" 2
...
# 67 "./src/main/telemetry/crsf.c" 2
# 75 "./src/main/telemetry/crsf.c"
static 
# 75 "./src/main/telemetry/crsf.c" 3 4
      _Bool 
# 75 "./src/main/telemetry/crsf.c"
           crsfTelemetryEnabled;
static 
# 76 "./src/main/telemetry/crsf.c" 3 4
      _Bool 
# 76 "./src/main/telemetry/crsf.c"
...
# 92 "./src/main/telemetry/crsf.c" 3 4
_Bool 
# 92 "./src/main/telemetry/crsf.c"
    bufferCrsfMspFrame(uint8_t *frameStart, int frameLength)
{
    if (mspRxBuffer.len + 1 + frameLength > 96) {
        return 
# 95 "./src/main/telemetry/crsf.c" 3 4
              0
# 95 "./src/main/telemetry/crsf.c"
                   ;
    } else {
        ...
        *p++ = frameLength;
        ...
        return 
# 101 "./src/main/telemetry/crsf.c" 3 4
              1
# 101 "./src/main/telemetry/crsf.c"
                  ;
    }
}


# 105 "./src/main/telemetry/crsf.c" 3 4
_Bool 
# 105 "./src/main/telemetry/crsf.c"
...
# 107 "./src/main/telemetry/crsf.c"
    ...
    if (!mspRxBuffer.len) {
        return 
# 109 "./src/main/telemetry/crsf.c" 3 4
              0
# 109 "./src/main/telemetry/crsf.c"
                   ;
    }
    int pos = 0;
    while (
# 112 "./src/main/telemetry/crsf.c" 3 4
          1
# 112 "./src/main/telemetry/crsf.c"
              ) {
...
# 295 "./src/main/telemetry/crsf.c"
void crsfFrameDeviceInfo(sbuf_t *dst) {

    char buff[30];
    tfp_sprintf(buff, "%s %s: %s", "Betaflight", "3" "." "5" "." "0", systemConfig()->boardIdentifier);
...
{
    uint8_t *lengthPtr = sbufPtr(dst);
    sbufWriteU8(dst, 32 + CRSF_FRAME_LENGTH_EXT_TYPE_CRC);
    sbufWriteU8(dst, CRSF_FRAMETYPE_DISPLAYPORT_CMD);
    sbufWriteU8(dst, CRSF_ADDRESS_RADIO_TRANSMITTER);
    sbufWriteU8(dst, CRSF_ADDRESS_FLIGHT_CONTROLLER);
...
static 
# 362 "./src/main/telemetry/crsf.c" 3 4
      _Bool 
# 362 "./src/main/telemetry/crsf.c"
           mspReplyPending;

void crsfScheduleMspResponse(void)
{
    mspReplyPending = 
# 366 "./src/main/telemetry/crsf.c" 3 4
                     1
# 366 "./src/main/telemetry/crsf.c"
                         ;
}
...
static void processCrsf(void)
{
    ...
    if (currentSchedule & (1 << (CRSF_FRAME_GPS_INDEX))) {
        crsfInitializeFrame(dst);
        crsfFrameGps(dst);
        crsfFinalize(dst);
    }
...
{
    deviceInfoReplyPending = 
# 421 "./src/main/telemetry/crsf.c" 3 4
                            1
# 421 "./src/main/telemetry/crsf.c"
                                ;
}
...
void initCrsfTelemetry(void)
{
    ...
    deviceInfoReplyPending = 
# 431 "./src/main/telemetry/crsf.c" 3 4
                            0
# 431 "./src/main/telemetry/crsf.c"
                                 ;

    mspReplyPending = 
# 433 "./src/main/telemetry/crsf.c" 3 4
                     0
# 433 "./src/main/telemetry/crsf.c"
                          ;
...
# 455 "./src/main/telemetry/crsf.c" 3 4
_Bool 
# 455 "./src/main/telemetry/crsf.c"
    checkCrsfTelemetryState(void)
{
...
void handleCrsfTelemetry(timeUs_t currentTimeUs)
{
    ...
    if (deviceInfoReplyPending) {
        ...
        crsfFinalize(dst);
        deviceInfoReplyPending = 
# 515 "./src/main/telemetry/crsf.c" 3 4
                                0
# 515 "./src/main/telemetry/crsf.c"
                                     ;
        crsfLastCycleTime = currentTimeUs;
        return;
    }
    ...
    if (crsfDisplayPortScreen()->reset) {
        crsfDisplayPortScreen()->reset = 
# 522 "./src/main/telemetry/crsf.c" 3 4
                                        0
# 522 "./src/main/telemetry/crsf.c"
                                             ;
    ...
    if (nextRow >= 0) {
        ...
        crsfFinalize(dst);
        crsfDisplayPortScreen()->pendingTransport[nextRow] = 
# 538 "./src/main/telemetry/crsf.c" 3 4
                                                            0
# 538 "./src/main/telemetry/crsf.c"
                                                                 ;
        crsfLastCycleTime = currentTimeUs;
        return;
    }
