...
# 1 "<command-line>"
# 1 "./src/main/telemetry/ibus_shared.c"
# 31 "./src/main/telemetry/ibus_shared.c"
...
# 37 "./src/main/telemetry/ibus_shared.c" 2
...
# 47 "./src/main/telemetry/ibus_shared.c" 2
...
# 27 "./src/main/sensors/battery.h" 2
...
# 49 "./src/main/telemetry/ibus_shared.c" 2
...
void mwDisarm(void);
# 53 "./src/main/telemetry/ibus_shared.c" 2
...
# 54 "./src/main/telemetry/ibus_shared.c" 2
...
# 56 "./src/main/telemetry/ibus_shared.c" 2
...
# 57 "./src/main/telemetry/ibus_shared.c" 2
...
# 58 "./src/main/telemetry/ibus_shared.c" 2
...
# 59 "./src/main/telemetry/ibus_shared.c" 2
# 68 "./src/main/telemetry/ibus_shared.c"
...
# 128 "./src/main/telemetry/ibus_shared.c" 3 4
                                     ((void *)0)
# 128 "./src/main/telemetry/ibus_shared.c"
                                         ;
static ibusAddress_t ibusBaseAddress = 0;
static uint8_t sendBuffer[33];
...
static uint8_t transmitIbusPacket()
{
    ...
    unsigned payloadLength = frameLength - (2);
...
static uint16_t getRPM()
{
    ...
    if ((armingFlags & (ARMED))) {
        ...
        rpm = rcCommand[THROTTLE];
        if (throttleStatus == THROTTLE_LOW && feature(FEATURE_MOTOR_STOP)) rpm = 0;
    } else {
        rpm = (uint16_t)(batteryConfig()->batteryCapacity);
    }
    return rpm;
}
...
static uint16_t getMode()
{
    ...
    if ((flightModeFlags & (HEADFREE_MODE)) || (flightModeFlags & (MAG_MODE))) {
        flightMode = 4;
    }
    if ((flightModeFlags & (GPS_HOLD_MODE)) && (flightModeFlags & (BARO_MODE))) {
        flightMode = 5;
    }
...
static 
# 292 "./src/main/telemetry/ibus_shared.c" 3 4
      _Bool 
# 292 "./src/main/telemetry/ibus_shared.c"
           setGPS(uint8_t sensorType, ibusTelemetry_s* value)
{
    
# 294 "./src/main/telemetry/ibus_shared.c" 3 4
   _Bool 
# 294 "./src/main/telemetry/ibus_shared.c"
        result = 
# 294 "./src/main/telemetry/ibus_shared.c" 3 4
                 0
# 294 "./src/main/telemetry/ibus_shared.c"
    ...
    for (unsigned i = 0; i < sizeof(GPS_IDS); i++) {
        if (sensorType == GPS_IDS[i]) {
            result = 
# 297 "./src/main/telemetry/ibus_shared.c" 3 4
                    1
# 297 "./src/main/telemetry/ibus_shared.c"
                        ;
            break;
        }
    }
    ...
    if (sensors(SENSOR_GPS)) {
        gpsFixType = !(stateFlags & (GPS_FIX)) ? 1 : (gpsSol.numSat < 5 ? 2 : 3);
        sats = gpsSol.numSat;
        if ((stateFlags & (GPS_FIX)) || sensorType == IBUS_SENSOR_TYPE_GPS_STATUS) {
            result = 
# 309 "./src/main/telemetry/ibus_shared.c" 3 4
                    1
# 309 "./src/main/telemetry/ibus_shared.c"
                        ;
            switch (sensorType) {
...
static void setValue(uint8_t* bufferPtr, uint8_t sensorType, uint8_t length)
{
    ...
    switch (sensorType) {
        ...
        case IBUS_SENSOR_TYPE_ARMED:
            value.uint16 = (armingFlags & (ARMED)) ? 1 : 0;
            break;

        case IBUS_SENSOR_TYPE_CMP_HEAD:
            value.uint16 = ((attitude.values.yaw) / 10);
            break;
...
static void setIbusMeasurement(ibusAddress_t address)
{
    uint8_t sensorID = getSensorID(address);
    uint8_t sensorLength = getSensorLength(sensorID);
    sendBuffer[0] = 4 + sensorLength;
    sendBuffer[1] = IBUS_COMMAND_MEASUREMENT | address;
    setValue(sendBuffer + 2, sensorID, sensorLength);
}

static 
# 449 "./src/main/telemetry/ibus_shared.c" 3 4
      _Bool 
# 449 "./src/main/telemetry/ibus_shared.c"
           isCommand(ibusCommand_e expected, const uint8_t *ibusPacket)
{
...
static 
# 467 "./src/main/telemetry/ibus_shared.c" 3 4
      _Bool 
# 467 "./src/main/telemetry/ibus_shared.c"
           theAddressIsWithinOurRange(ibusAddress_t returnAddress)
{
    return (returnAddress >= ibusBaseAddress) &&
    (ibusAddress_t)(returnAddress - ibusBaseAddress) < (sizeof(telemetryConfig()->flysky_sensors) / sizeof((telemetryConfig()->flysky_sensors)[0])) &&
...
# 515 "./src/main/telemetry/ibus_shared.c" 3 4
_Bool 
# 515 "./src/main/telemetry/ibus_shared.c"
    isChecksumOkIa6b(const uint8_t *ibusPacket, const uint8_t length)
{
