...
static 
# 88 "./src/main/telemetry/ltm.c" 3 4
      _Bool 
# 88 "./src/main/telemetry/ltm.c"
           ltmEnabled;
...
static void ltm_sframe(void)
{
    ...
    ltm_serialise_16(0);
    ltm_serialise_8(constrain(scaleRange(getRssi(), 0, 1023, 0, 255), 0, 255));
    ltm_serialise_8(0);
...
void freeLtmTelemetryPort(void)
{
    ...
    ltmPort = 
# 271 "./src/main/telemetry/ltm.c" 3 4
             ((void *)0)
# 271 "./src/main/telemetry/ltm.c"
                 ;
    ltmEnabled = 
# 272 "./src/main/telemetry/ltm.c" 3 4
                0
# 272 "./src/main/telemetry/ltm.c"
                     ;
}
...
# 290 "./src/main/telemetry/ltm.c" 3 4
                                                                            ((void *)0)
# 290 "./src/main/telemetry/ltm.c"
                                                                                , 
# 290 "./src/main/telemetry/ltm.c" 3 4
                                                                                  ((void *)0)
# 290 "./src/main/telemetry/ltm.c"
    ...
    if (!ltmPort)
        return;
    ltmEnabled = 
# 293 "./src/main/telemetry/ltm.c" 3 4
                1
# 293 "./src/main/telemetry/ltm.c"
                    ;
}
...
# 299 "./src/main/telemetry/ltm.c"
            ...
            ltmEnabled = 
# 301 "./src/main/telemetry/ltm.c" 3 4
                        1
# 301 "./src/main/telemetry/ltm.c"
                            ;
        }
    } else {
        
# 304 "./src/main/telemetry/ltm.c" 3 4
       _Bool 
# 304 "./src/main/telemetry/ltm.c"
