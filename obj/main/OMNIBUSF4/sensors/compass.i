...
# 21 "./src/main/drivers/compass/compass_ak8975.h"
       


# 23 "./src/main/drivers/compass/compass_ak8975.h" 3 4
_Bool 
# 23 "./src/main/drivers/compass/compass_ak8975.h"
    ak8975Detect(magDev_t *mag);
# 37 "./src/main/sensors/compass.c" 2
# 1 "./src/main/drivers/compass/compass_ak8963.h" 1
# 21 "./src/main/drivers/compass/compass_ak8963.h"
       


# 23 "./src/main/drivers/compass/compass_ak8963.h" 3 4
_Bool 
# 23 "./src/main/drivers/compass/compass_ak8963.h"
...
# 24 "./src/main/drivers/compass/compass_fake.h" 3 4
_Bool 
# 24 "./src/main/drivers/compass/compass_fake.h"
...
# 48 "./src/main/sensors/compass.c" 2
...
# 24 "./src/main/sensors/compass.h" 2
...
extern void pgResetFn_compassConfig(compassConfig_t *); compassConfig_t compassConfig_System; compassConfig_t compassConfig_Copy; extern const pgRegistry_t compassConfig_Registry; const pgRegistry_t compassConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 40 | (1 << 12), .size = sizeof(compassConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&compassConfig_System, .copy = (uint8_t*)&compassConfig_Copy, .ptr = 0, .reset = {.fn = (pgResetFunc*)&pgResetFn_compassConfig }, };
...
# 119 "./src/main/sensors/compass.c" 3 4
_Bool 
# 119 "./src/main/sensors/compass.c"
    compassDetect(magDev_t *dev)
{
    ...
    case BUSTYPE_I2C:
        ...
        busdev->busdev_u.i2c.device = ((compassConfig()->mag_i2c_device) - 1);
    ...
    case BUSTYPE_SPI:
        ...
        spiBusSetInstance(busdev, spiInstanceByDevice(((compassConfig()->mag_spi_device) - 1)));
        busdev->busdev_u.spi.csnPin = IOGetByTag(compassConfig()->mag_spi_csn);

        break;
# 158 "./src/main/sensors/compass.c"
        break;

    default:
        return 
# 161 "./src/main/sensors/compass.c" 3 4
              0
# 161 "./src/main/sensors/compass.c"
                   ;
    }
    ...
    case MAG_AK8975:
# 216 "./src/main/sensors/compass.c"
        __attribute__ ((fallthrough));

    case MAG_AK8963:
# 237 "./src/main/sensors/compass.c"
        __attribute__ ((fallthrough));
    ...
    if (magHardware == MAG_NONE) {
        return 
# 245 "./src/main/sensors/compass.c" 3 4
              0
# 245 "./src/main/sensors/compass.c"
                   ;
    }
    ...
    return 
# 250 "./src/main/sensors/compass.c" 3 4
          1
# 250 "./src/main/sensors/compass.c"
              ;
}
# 261 "./src/main/sensors/compass.c"

# 261 "./src/main/sensors/compass.c" 3 4
_Bool 
# 261 "./src/main/sensors/compass.c"
    compassInit(void)
{
    ...
    if (!compassDetect(&magDev)) {
        return 
# 268 "./src/main/sensors/compass.c" 3 4
              0
# 268 "./src/main/sensors/compass.c"
                   ;
    }
...
# 274 "./src/main/sensors/compass.c"
    ...
    magDev.init(&magDev);
    ledSet(1, 
# 276 "./src/main/sensors/compass.c" 3 4
   0
# 276 "./src/main/sensors/compass.c"
   );
    magInit = 1;
    ...
    return 
# 281 "./src/main/sensors/compass.c" 3 4
          1
# 281 "./src/main/sensors/compass.c"
              ;
}


# 284 "./src/main/sensors/compass.c" 3 4
_Bool 
# 284 "./src/main/sensors/compass.c"
    compassIsHealthy(void)
{
