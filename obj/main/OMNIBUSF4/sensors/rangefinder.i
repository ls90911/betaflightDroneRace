...
# 1 "<command-line>"
# 1 "./src/main/sensors/rangefinder.c"
# 21 "./src/main/sensors/rangefinder.c"
...
# 23 "./src/main/sensors/rangefinder.c" 2
...
# 25 "./src/main/sensors/rangefinder.c" 2
...
# 31 "./src/main/sensors/rangefinder.c" 2
...
# 32 "./src/main/sensors/rangefinder.c" 2
...
# 34 "./src/main/sensors/rangefinder.c" 2
...
# 36 "./src/main/sensors/rangefinder.c" 2
...
# 1 "./src/main/drivers/rangefinder/rangefinder_lidartf.h" 1
# 21 "./src/main/drivers/rangefinder/rangefinder_lidartf.h"
...
# 27 "./src/main/drivers/rangefinder/rangefinder_lidartf.h" 3 4
_Bool 
# 27 "./src/main/drivers/rangefinder/rangefinder_lidartf.h"
    lidarTFminiDetect(rangefinderDev_t *dev);

# 28 "./src/main/drivers/rangefinder/rangefinder_lidartf.h" 3 4
_Bool 
# 28 "./src/main/drivers/rangefinder/rangefinder_lidartf.h"
    lidarTF02Detect(rangefinderDev_t *dev);
# 46 "./src/main/sensors/rangefinder.c" 2
...
void mwDisarm(void);
# 49 "./src/main/sensors/rangefinder.c" 2
...
# 53 "./src/main/sensors/rangefinder.c" 2
...
extern const rangefinderConfig_t pgResetTemplate_rangefinderConfig; rangefinderConfig_t rangefinderConfig_System; rangefinderConfig_t rangefinderConfig_Copy; extern const pgRegistry_t rangefinderConfig_Registry; const pgRegistry_t rangefinderConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 527 | (0 << 12), .size = sizeof(rangefinderConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&rangefinderConfig_System, .copy = (uint8_t*)&rangefinderConfig_Copy, .ptr = 0, .reset = {.ptr = (void*)&pgResetTemplate_rangefinderConfig}, };

const rangefinderConfig_t pgResetTemplate_rangefinderConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .rangefinder_hardware = RANGEFINDER_NONE, }

 ;


extern const sonarConfig_t pgResetTemplate_sonarConfig; sonarConfig_t sonarConfig_System; sonarConfig_t sonarConfig_Copy; extern const pgRegistry_t sonarConfig_Registry; const pgRegistry_t sonarConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 516 | (1 << 12), .size = sizeof(sonarConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&sonarConfig_System, .copy = (uint8_t*)&sonarConfig_Copy, .ptr = 0, .reset = {.ptr = (void*)&pgResetTemplate_sonarConfig}, };
# 88 "./src/main/sensors/rangefinder.c"
const sonarConfig_t pgResetTemplate_sonarConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .triggerTag = ((ioTag_t)((((0) + 1) << 4) | (1))), .echoTag = ((ioTag_t)((((0) + 1) << 4) | (8))), }
...
static 
# 97 "./src/main/sensors/rangefinder.c" 3 4
      _Bool 
# 97 "./src/main/sensors/rangefinder.c"
    ...
    switch (rangefinderHardwareToUse) {
        case RANGEFINDER_HCSR04:

            {
                if (hcsr04Detect(dev, sonarConfig())) {
                    ...
                    rescheduleTask(TASK_RANGEFINDER, ((70) * 1000));
                }
            }
        ...
        case RANGEFINDER_TFMINI:
            ...
            if (lidarTFminiDetect(dev)) {
                ...
                rescheduleTask(TASK_RANGEFINDER, ((10) * 1000));
            }
...
# 175 "./src/main/sensors/rangefinder.c"
    ...
    return 
# 180 "./src/main/sensors/rangefinder.c" 3 4
          1
# 180 "./src/main/sensors/rangefinder.c"
              ;
}
...
# 185 "./src/main/sensors/rangefinder.c" 3 4
                                     0
# 185 "./src/main/sensors/rangefinder.c"
                                          ;
    rangefinder.dynamicDistanceThreshold = 0;
}


# 189 "./src/main/sensors/rangefinder.c" 3 4
_Bool 
# 189 "./src/main/sensors/rangefinder.c"
    rangefinderInit(void)
{
...
# 192 "./src/main/sensors/rangefinder.c"
    ...
    rangefinder.maxTiltCos = cos_approx(((rangefinder.dev.detectionConeExtendedDeciDegrees / 2.0f) / 10.0f * 0.0174532925f));
    ...
    rangefinderCfAltCm = rangefinder.dev.maxRangeCm / 2 ;

    return 
# 210 "./src/main/sensors/rangefinder.c" 3 4
          1
# 210 "./src/main/sensors/rangefinder.c"
              ;
}
...
static int32_t applyMedianFilter(int32_t newReading)
{
    ...
    static 
# 218 "./src/main/sensors/rangefinder.c" 3 4
          _Bool 
# 218 "./src/main/sensors/rangefinder.c"
               medianFilterReady = 
# 218 "./src/main/sensors/rangefinder.c" 3 4
                                   0
# 218 "./src/main/sensors/rangefinder.c"
    ...
    if (newReading > (-1)) {
        ...
        if (filterSampleIndex == 5) {
            filterSampleIndex = 0;
            medianFilterReady = 
# 225 "./src/main/sensors/rangefinder.c" 3 4
                               1
# 225 "./src/main/sensors/rangefinder.c"
                                   ;
        }
    }
...
static int16_t computePseudoSnr(int32_t newReading) {
    ...
    static int16_t snrSamples[5];
    static uint8_t snrSampleIndex = 0;
    static int32_t previousReading = (-1);
    static 
# 236 "./src/main/sensors/rangefinder.c" 3 4
          _Bool 
# 236 "./src/main/sensors/rangefinder.c"
               snrReady = 
# 236 "./src/main/sensors/rangefinder.c" 3 4
                          0
# 236 "./src/main/sensors/rangefinder.c"
    ...
    if (snrSampleIndex == 5) {
        snrSampleIndex = 0;
        snrReady = 
# 244 "./src/main/sensors/rangefinder.c" 3 4
                  1
# 244 "./src/main/sensors/rangefinder.c"
                      ;
    }
...
# 276 "./src/main/sensors/rangefinder.c" 3 4
_Bool 
# 276 "./src/main/sensors/rangefinder.c"
    isSurfaceAltitudeValid() {
    ...
    if (
        ...
        if (rangefinder.snrThresholdReached) {
            ...
            return 
# 295 "./src/main/sensors/rangefinder.c" 3 4
                  1
# 295 "./src/main/sensors/rangefinder.c"
                      ;
        }

    } else {
        return 
# 299 "./src/main/sensors/rangefinder.c" 3 4
              0
# 299 "./src/main/sensors/rangefinder.c"
                   ;
    }
...
# 307 "./src/main/sensors/rangefinder.c" 3 4
_Bool 
# 307 "./src/main/sensors/rangefinder.c"
    rangefinderProcess(float cosTiltAngle)
{
    if (rangefinder.dev.read) {
        ...
        if (distance == (-3)) {
            return 
# 314 "./src/main/sensors/rangefinder.c" 3 4
                  0
# 314 "./src/main/sensors/rangefinder.c"
                       ;
        }
        ...
        if (rangefinder.snrThresholdReached == 
# 332 "./src/main/sensors/rangefinder.c" 3 4
                                              0 
# 332 "./src/main/sensors/rangefinder.c"
                                                    && rangefinder.rawAltitude > 0) {

            if (rangefinder.snr < 600 && rangefinder.dynamicDistanceThreshold < rangefinder.rawAltitude) {
                rangefinder.dynamicDistanceThreshold = rangefinder.rawAltitude * 75 / 100;
            }

            if (rangefinder.snr >= 600) {
                rangefinder.snrThresholdReached = 
# 339 "./src/main/sensors/rangefinder.c" 3 4
                                                 1
# 339 "./src/main/sensors/rangefinder.c"
                                                     ;
            }

        }

        {if (debugMode == (DEBUG_RANGEFINDER)) {debug[(3)] = (rangefinder.snr);}};

        {if (debugMode == (DEBUG_RANGEFINDER_QUALITY)) {debug[(0)] = (rangefinder.rawAltitude);}};
        {if (debugMode == (DEBUG_RANGEFINDER_QUALITY)) {debug[(1)] = (rangefinder.snrThresholdReached);}};
        {if (debugMode == (DEBUG_RANGEFINDER_QUALITY)) {debug[(2)] = (rangefinder.dynamicDistanceThreshold);}};
        {if (debugMode == (DEBUG_RANGEFINDER_QUALITY)) {debug[(3)] = (isSurfaceAltitudeValid());}};
    ...
    {if (debugMode == (DEBUG_RANGEFINDER)) {debug[(1)] = (rangefinder.rawAltitude);}};
    {if (debugMode == (DEBUG_RANGEFINDER)) {debug[(2)] = (rangefinder.calculatedAltitude);}};

    return 
# 372 "./src/main/sensors/rangefinder.c" 3 4
          1
# 372 "./src/main/sensors/rangefinder.c"
              ;
}
...
# 388 "./src/main/sensors/rangefinder.c" 3 4
_Bool 
# 388 "./src/main/sensors/rangefinder.c"
    rangefinderIsHealthy(void)
{
