...
# 320 "./src/main/target/system_stm32f4xx.c" 2

uint32_t hse_value = 8000000;
# 426 "./src/main/target/system_stm32f4xx.c"
volatile const uint8_t AHBPrescTable[16] = {0, 0, 0, 0, 0, 0, 0, 0, 1, 2, 3, 4, 6, 7, 8, 9};
# 436 "./src/main/target/system_stm32f4xx.c"
void SetSysClock(void);
# 458 "./src/main/target/system_stm32f4xx.c"
uint32_t SystemCoreClock;
uint32_t pll_p = 2, pll_n = 336, pll_q = 7;
...
static __attribute__ ((section(".persistent_data"), aligned(4))) uint32_t currentOverclockLevel = 0;

void SystemInitOC(void)
{

    if (currentOverclockLevel >= (sizeof(overclockLevels) / sizeof((overclockLevels)[0]))) {
      return;
    }
...
{
  if (overclockLevel >= (sizeof(overclockLevels) / sizeof((overclockLevels)[0]))) {
    return;
  }
...
# 557 "./src/main/target/system_stm32f4xx.c"
  ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->VTOR = ((uint32_t)0x08000000) | 0x00;

}
# 597 "./src/main/target/system_stm32f4xx.c"
void SystemCoreClockUpdate(void)
{
  ...
  switch (tmp)
  {
    ...
    case 0x08:
      ...
      break;
# 657 "./src/main/target/system_stm32f4xx.c"
    default:
      SystemCoreClock = ((uint32_t)16000000);
      break;
  }
...
# 676 "./src/main/target/system_stm32f4xx.c"
void SetSysClock(void)
{
...
# 741 "./src/main/target/system_stm32f4xx.c"
    ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->PLLCFGR = 8 | (pll_n << 6) | (((pll_p >> 1) -1) << 16) |
                   (((uint32_t)0x00400000)) | (pll_q << 24);
...
# 767 "./src/main/target/system_stm32f4xx.c"
...
# 776 "./src/main/target/system_stm32f4xx.c"
...
# 826 "./src/main/target/system_stm32f4xx.c"
}
