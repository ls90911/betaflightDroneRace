...
# 24 "./src/main/drivers/light_led.h" 2
...
# 31 "./src/main/io/spektrum_rssi.h"
...
static void spektrumDataReceive(uint16_t c, void *data)
{
    ...
    if (spekFramePosition < 16) {
        ...
        if (spekFramePosition < 16) {
            rcFrameComplete = 
# 98 "./src/main/rx/spektrum.c" 3 4
                             0
# 98 "./src/main/rx/spektrum.c"
                                  ;
        } else {
            rcFrameComplete = 
# 100 "./src/main/rx/spektrum.c" 3 4
                             1
# 100 "./src/main/rx/spektrum.c"
                                 ;
        }
    }
}
...
static uint8_t spektrumFrameStatus(rxRuntimeConfig_t *rxRuntimeConfig)
{
    ...
    rcFrameComplete = 
# 116 "./src/main/rx/spektrum.c" 3 4
                     0
# 116 "./src/main/rx/spektrum.c"
                          ;
...
# 186 "./src/main/rx/spektrum.c" 3 4
_Bool 
# 186 "./src/main/rx/spektrum.c"
    spekShouldBind(uint8_t spektrum_sat_bind)
{
    ...
    if (BindPlug) {
        ...
        if (IORead(BindPlug)) {
            return 
# 198 "./src/main/rx/spektrum.c" 3 4
                  0
# 198 "./src/main/rx/spektrum.c"
                       ;
        }
    }
...
void spektrumBind(rxConfig_t *rxConfig)
{
    ...
    ledSet(1, 
# 261 "./src/main/rx/spektrum.c" 3 4
   1
# 261 "./src/main/rx/spektrum.c"
   );


    IOWrite(bindIO, 
# 264 "./src/main/rx/spektrum.c" 3 4
                   1
# 264 "./src/main/rx/spektrum.c"
                       );


    delay(60);
    ledSet(1, 
# 268 "./src/main/rx/spektrum.c" 3 4
   0
# 268 "./src/main/rx/spektrum.c"
   );
...
# 271 "./src/main/rx/spektrum.c"
        ...
        ledSet(2, 
# 272 "./src/main/rx/spektrum.c" 3 4
       0
# 272 "./src/main/rx/spektrum.c"
       );

        IOWrite(bindIO, 
# 274 "./src/main/rx/spektrum.c" 3 4
                       0
# 274 "./src/main/rx/spektrum.c"
                            );
        delayMicroseconds(120);

        ledSet(0, 
# 277 "./src/main/rx/spektrum.c" 3 4
       1
# 277 "./src/main/rx/spektrum.c"
       );
        ledSet(2, 
# 278 "./src/main/rx/spektrum.c" 3 4
       1
# 278 "./src/main/rx/spektrum.c"
       );

        IOWrite(bindIO, 
# 280 "./src/main/rx/spektrum.c" 3 4
                       1
# 280 "./src/main/rx/spektrum.c"
                           );
        delayMicroseconds(120);
    ...
    spektrumInit(const rxConfig_t *rxConfig, rxRuntimeConfig_t *rxRuntimeConfig)
{
    ...
    if (!portConfig) {
        return 
# 312 "./src/main/rx/spektrum.c" 3 4
              0
# 312 "./src/main/rx/spektrum.c"
                   ;
    }

    srxlEnabled = 
# 315 "./src/main/rx/spektrum.c" 3 4
                 0
# 315 "./src/main/rx/spektrum.c"
                      ;

    
# 317 "./src/main/rx/spektrum.c" 3 4
   _Bool 
# 317 "./src/main/rx/spektrum.c"
...
# 332 "./src/main/rx/spektrum.c"
    ...
    case SERIALRX_SPEKTRUM1024:
        ...
        spek_chan_mask = 0x03;
        spekHiRes = 
# 341 "./src/main/rx/spektrum.c" 3 4
                   0
# 341 "./src/main/rx/spektrum.c"
                        ;
        resolution = 1024;
...
# 354 "./src/main/rx/spektrum.c" 3 4
       ((void *)0)
# 354 "./src/main/rx/spektrum.c"
           ,
        115200,
    ...
    return serialPort != 
# 373 "./src/main/rx/spektrum.c" 3 4
                        ((void *)0)
# 373 "./src/main/rx/spektrum.c"
                            ;
}
...
# 395 "./src/main/rx/spektrum.c" 3 4
_Bool 
# 395 "./src/main/rx/spektrum.c"
    srxlRxIsActive(void)
{
    return serialPort != 
# 397 "./src/main/rx/spektrum.c" 3 4
                        ((void *)0)
# 397 "./src/main/rx/spektrum.c"
                            ;
}
