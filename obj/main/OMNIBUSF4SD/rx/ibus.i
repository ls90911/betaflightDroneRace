...
static 
# 78 "./src/main/rx/ibus.c" 3 4
      _Bool 
# 78 "./src/main/rx/ibus.c"
...
static void ibusDataReceive(uint16_t c, void *data)
{
    ...
    if (ibusFramePosition == ibusFrameSize - 1) {
        ibusFrameDone = 
# 126 "./src/main/rx/ibus.c" 3 4
                       1
# 126 "./src/main/rx/ibus.c"
                           ;
    } else {
        ibusFramePosition++;
    }
...
static 
# 133 "./src/main/rx/ibus.c" 3 4
      _Bool 
# 133 "./src/main/rx/ibus.c"
...
static 
# 147 "./src/main/rx/ibus.c" 3 4
      _Bool 
# 147 "./src/main/rx/ibus.c"
           checksumIsOk(void) {
    if (ibusModel == 1 ) {
...
static uint8_t ibusFrameStatus(rxRuntimeConfig_t *rxRuntimeConfig)
{
    ...
    ibusFrameDone = 
# 175 "./src/main/rx/ibus.c" 3 4
                   0
# 175 "./src/main/rx/ibus.c"
                        ;
...
# 201 "./src/main/rx/ibus.c" 3 4
_Bool 
# 201 "./src/main/rx/ibus.c"
    ibusInit(const rxConfig_t *rxConfig, rxRuntimeConfig_t *rxRuntimeConfig)
{
    (void)(rxConfig);
    ibusSyncByte = 0;
    ...
    if (!portConfig) {
        return 
# 214 "./src/main/rx/ibus.c" 3 4
              0
# 214 "./src/main/rx/ibus.c"
                   ;
    }
...
# 219 "./src/main/rx/ibus.c" 3 4
   _Bool 
# 219 "./src/main/rx/ibus.c"
...
# 229 "./src/main/rx/ibus.c" 3 4
       ((void *)0)
# 229 "./src/main/rx/ibus.c"
           ,
        115200,
    ...
    return ibusPort != 
# 241 "./src/main/rx/ibus.c" 3 4
                      ((void *)0)
# 241 "./src/main/rx/ibus.c"
                          ;
}
