...
# 55 "./src/main/rx/sumd.c"
static 
# 55 "./src/main/rx/sumd.c" 3 4
      _Bool 
# 55 "./src/main/rx/sumd.c"
           sumdFrameDone = 
# 55 "./src/main/rx/sumd.c" 3 4
...
static void sumdDataReceive(uint16_t c, void *data)
{
    ...
    if (sumdIndex == 0) {
        ...
        {
            sumdFrameDone = 
# 81 "./src/main/rx/sumd.c" 3 4
                           0
# 81 "./src/main/rx/sumd.c"
                                ;
            crc = 0;
        }
    }
    ...
    if (sumdIndex < sumdChannelCount * 2 + 4)
        ...
        if (sumdIndex == sumdChannelCount * 2 + 5) {
            sumdIndex = 0;
            sumdFrameDone = 
# 95 "./src/main/rx/sumd.c" 3 4
                           1
# 95 "./src/main/rx/sumd.c"
                               ;
        }
}
# 107 "./src/main/rx/sumd.c"
static uint8_t sumdFrameStatus(rxRuntimeConfig_t *rxRuntimeConfig)
{
    ...
    sumdFrameDone = 
# 119 "./src/main/rx/sumd.c" 3 4
                   0
# 119 "./src/main/rx/sumd.c"
                        ;
...
# 155 "./src/main/rx/sumd.c" 3 4
_Bool 
# 155 "./src/main/rx/sumd.c"
    sumdInit(const rxConfig_t *rxConfig, rxRuntimeConfig_t *rxRuntimeConfig)
{
    (void)(rxConfig);
    ...
    if (!portConfig) {
        return 
# 167 "./src/main/rx/sumd.c" 3 4
              0
# 167 "./src/main/rx/sumd.c"
                   ;
    }


    
# 171 "./src/main/rx/sumd.c" 3 4
   _Bool 
# 171 "./src/main/rx/sumd.c"
...
# 179 "./src/main/rx/sumd.c" 3 4
       ((void *)0)
# 179 "./src/main/rx/sumd.c"
           ,
        115200,
    ...
    return sumdPort != 
# 191 "./src/main/rx/sumd.c" 3 4
                      ((void *)0)
# 191 "./src/main/rx/sumd.c"
                          ;
}
