...
# 1 "<command-line>"
# 1 "./src/main/drivers/serial_softserial.c"
# 26 "./src/main/drivers/serial_softserial.c"
...
# 48 "./src/main/drivers/serial_softserial.c" 2
# 58 "./src/main/drivers/serial_softserial.c"
typedef enum {
    TIMER_MODE_SINGLE,
    TIMER_MODE_DUAL,
} timerMode_e;
...
static void serialInputPortActivate(softSerial_t *softSerial)
{
    ...
    softSerial->rxActive = 
# 150 "./src/main/drivers/serial_softserial.c" 3 4
                          1
# 150 "./src/main/drivers/serial_softserial.c"
                              ;
    softSerial->isSearchingForStartBit = 
# 151 "./src/main/drivers/serial_softserial.c" 3 4
                                        1
# 151 "./src/main/drivers/serial_softserial.c"
                                            ;
...
static void serialInputPortDeActivate(softSerial_t *softSerial)
{
    ...
    softSerial->rxActive = 
# 170 "./src/main/drivers/serial_softserial.c" 3 4
                          0
# 170 "./src/main/drivers/serial_softserial.c"
                               ;
}
...
static 
# 197 "./src/main/drivers/serial_softserial.c" 3 4
      _Bool 
# 197 "./src/main/drivers/serial_softserial.c"
...
serialPort_t *openSoftSerial(softSerialPortIndex_e portIndex, serialReceiveCallbackPtr rxCallback, void *rxCallbackData, uint32_t baud, portMode_e mode, portOptions_e options)
{
    ...
    if (options & SERIAL_BIDIR) {
        ...
        if (!timerTx || (timerTx->output & TIMER_OUTPUT_N_CHANNEL)) {
            return 
# 256 "./src/main/drivers/serial_softserial.c" 3 4
                  ((void *)0)
# 256 "./src/main/drivers/serial_softserial.c"
                      ;
        }
        ...
        if (mode & MODE_RX) {
            ...
            if (!timerRx || (timerRx->output & TIMER_OUTPUT_N_CHANNEL)) {
                return 
# 267 "./src/main/drivers/serial_softserial.c" 3 4
                      ((void *)0)
# 267 "./src/main/drivers/serial_softserial.c"
                          ;
            }
        ...
        if (mode & MODE_TX) {
            ...
            if (!tagTx)
                return 
# 278 "./src/main/drivers/serial_softserial.c" 3 4
                      ((void *)0)
# 278 "./src/main/drivers/serial_softserial.c"
                          ;
            ...
            if (!(mode & MODE_RX)) {
                ...
                if (!timerTx)
                    return 
# 285 "./src/main/drivers/serial_softserial.c" 3 4
                          ((void *)0)
# 285 "./src/main/drivers/serial_softserial.c"
                              ;
                softSerial->timerHardware = timerTx;
            } else {
    ...
    softSerial->rxActive = 
# 309 "./src/main/drivers/serial_softserial.c" 3 4
                          0
# 309 "./src/main/drivers/serial_softserial.c"
                               ;
...
# 315 "./src/main/drivers/serial_softserial.c" 3 4
                                                                            1 
# 315 "./src/main/drivers/serial_softserial.c"
                                                                                              : 
# 315 "./src/main/drivers/serial_softserial.c" 3 4
                                                                                                0
# 315 "./src/main/drivers/serial_softserial.c"
...
# 329 "./src/main/drivers/serial_softserial.c" 3 4
                                                           ((void *)0)
# 329 "./src/main/drivers/serial_softserial.c"
                                                               , &softSerial->overCb);
        timerChConfigCallbacks(softSerial->timerHardware, &softSerial->edgeCb, 
# 330 "./src/main/drivers/serial_softserial.c" 3 4
                                                                              ((void *)0)
# 330 "./src/main/drivers/serial_softserial.c"
                                                                                  );
    } else {
...
void processTxState(softSerial_t *softSerial)
{
    ...
    if (!softSerial->isTransmittingData) {
        ...
        softSerial->isTransmittingData = 
# 379 "./src/main/drivers/serial_softserial.c" 3 4
                                        1
# 379 "./src/main/drivers/serial_softserial.c"
                                            ;
    ...
    softSerial->isTransmittingData = 
# 404 "./src/main/drivers/serial_softserial.c" 3 4
                                    0
# 404 "./src/main/drivers/serial_softserial.c"
                                         ;
}
...
void prepareForNextRxByte(softSerial_t *softSerial)
{
    ...
    softSerial->rxBitIndex = 0;
    softSerial->isSearchingForStartBit = 
# 426 "./src/main/drivers/serial_softserial.c" 3 4
                                        1
# 426 "./src/main/drivers/serial_softserial.c"
                                            ;
...
# 429 "./src/main/drivers/serial_softserial.c" 3 4
                                                                                                 1 
# 429 "./src/main/drivers/serial_softserial.c"
                                                                                                                   : 
# 429 "./src/main/drivers/serial_softserial.c" 3 4
                                                                                                                     0
# 429 "./src/main/drivers/serial_softserial.c"
...
# 488 "./src/main/drivers/serial_softserial.c" 3 4
                        __builtin_offsetof (
# 488 "./src/main/drivers/serial_softserial.c"
                        softSerial_t
# 488 "./src/main/drivers/serial_softserial.c" 3 4
                        , 
# 488 "./src/main/drivers/serial_softserial.c"
...
# 501 "./src/main/drivers/serial_softserial.c" 3 4
                        __builtin_offsetof (
# 501 "./src/main/drivers/serial_softserial.c"
                        softSerial_t
# 501 "./src/main/drivers/serial_softserial.c" 3 4
                        , 
# 501 "./src/main/drivers/serial_softserial.c"
...
# 502 "./src/main/drivers/serial_softserial.c" 3 4
   _Bool 
# 502 "./src/main/drivers/serial_softserial.c"
...
# 536 "./src/main/drivers/serial_softserial.c" 3 4
                                      0
# 536 "./src/main/drivers/serial_softserial.c"
                                           ;
        return;
    }
    ...
    if (self->rxEdge == TRAILING) {
        self->rxEdge = LEADING;
        timerChConfigIC(self->timerHardware, inverted ? 
# 548 "./src/main/drivers/serial_softserial.c" 3 4
                                                       0 
# 548 "./src/main/drivers/serial_softserial.c"
                                                                          : 
# 548 "./src/main/drivers/serial_softserial.c" 3 4
                                                                            1
# 548 "./src/main/drivers/serial_softserial.c"
        ...
        timerChConfigIC(self->timerHardware, inverted ? 
# 551 "./src/main/drivers/serial_softserial.c" 3 4
                                                       1 
# 551 "./src/main/drivers/serial_softserial.c"
                                                                         : 
# 551 "./src/main/drivers/serial_softserial.c" 3 4
                                                                           0
# 551 "./src/main/drivers/serial_softserial.c"
...
# 628 "./src/main/drivers/serial_softserial.c" 3 4
_Bool 
# 628 "./src/main/drivers/serial_softserial.c"
...
static const struct serialPortVTable softSerialVTable = {
    ...
    .setCtrlLineStateCb = 
# 641 "./src/main/drivers/serial_softserial.c" 3 4
                         ((void *)0)
# 641 "./src/main/drivers/serial_softserial.c"
                             ,
    .setBaudRateCb = 
# 642 "./src/main/drivers/serial_softserial.c" 3 4
                    ((void *)0)
# 642 "./src/main/drivers/serial_softserial.c"
                        ,
    .writeBuf = 
# 643 "./src/main/drivers/serial_softserial.c" 3 4
               ((void *)0)
# 643 "./src/main/drivers/serial_softserial.c"
                   ,
    .beginWrite = 
# 644 "./src/main/drivers/serial_softserial.c" 3 4
                 ((void *)0)
# 644 "./src/main/drivers/serial_softserial.c"
                     ,
    .endWrite = 
# 645 "./src/main/drivers/serial_softserial.c" 3 4
               ((void *)0)

# 646 "./src/main/drivers/serial_softserial.c"
};
