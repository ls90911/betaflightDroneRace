...
# 1 "<command-line>"
# 1 "./src/main/drivers/rangefinder/rangefinder_lidartf.c"
# 21 "./src/main/drivers/rangefinder/rangefinder_lidartf.c"
...
# 23 "./src/main/drivers/rangefinder/rangefinder_lidartf.c" 2
...
# 25 "./src/main/drivers/rangefinder/rangefinder_lidartf.c" 2
...
# 29 "./src/main/drivers/rangefinder/rangefinder_lidartf.c" 2
# 1 "./src/main/build/build_config.h" 1
# 21 "./src/main/build/build_config.h"
       
# 30 "./src/main/drivers/rangefinder/rangefinder_lidartf.c" 2
...
# 32 "./src/main/drivers/rangefinder/rangefinder_lidartf.c" 2
...
# 34 "./src/main/drivers/rangefinder/rangefinder_lidartf.c" 2
...
# 35 "./src/main/drivers/rangefinder/rangefinder_lidartf.c" 2
...
# 36 "./src/main/drivers/rangefinder/rangefinder_lidartf.c" 2





static uint8_t tfDevtype = 0;
# 94 "./src/main/drivers/rangefinder/rangefinder_lidartf.c"
static serialPort_t *tfSerialPort = 
# 94 "./src/main/drivers/rangefinder/rangefinder_lidartf.c" 3 4
                                   ((void *)0)
# 94 "./src/main/drivers/rangefinder/rangefinder_lidartf.c"
                                       ;
...
void lidarTFUpdate(rangefinderDev_t *dev)
{
    ...
    if (tfSerialPort == 
# 145 "./src/main/drivers/rangefinder/rangefinder_lidartf.c" 3 4
                       ((void *)0)
# 145 "./src/main/drivers/rangefinder/rangefinder_lidartf.c"
                           ) {
        return;
    }
        ...
        case TF_FRAME_STATE_WAIT_CKSUM:
            {
                ...
                if (c == cksum) {
                    ...
                    {if (debugMode == (DEBUG_LIDAR_TF)) {debug[(0)] = (distance);}};
                    {if (debugMode == (DEBUG_LIDAR_TF)) {debug[(1)] = (strength);}};
                    {if (debugMode == (DEBUG_LIDAR_TF)) {debug[(2)] = (tfFrame[4]);}};
                    {if (debugMode == (DEBUG_LIDAR_TF)) {debug[(3)] = (tfFrame[5]);}};
                    ...
                    case 2:
                        if (distance >= 40 && distance < 2200 && tfFrame[4] >= 7) {
                            lidarTFValue = distance;
                        } else {
                            lidarTFValue = -1;
                        }
    ...
    if (timeNowMs - lastFrameReceivedMs > (100 * 2)) {
        lidarTFSendCommand();
    }
}
...
static 
# 242 "./src/main/drivers/rangefinder/rangefinder_lidartf.c" 3 4
      _Bool 
# 242 "./src/main/drivers/rangefinder/rangefinder_lidartf.c"
           lidarTFDetect(rangefinderDev_t *dev, uint8_t devtype)
{
    serialPortConfig_t *portConfig = findSerialPortConfig(FUNCTION_LIDAR_TF);

    if (!portConfig) {
        return 
# 247 "./src/main/drivers/rangefinder/rangefinder_lidartf.c" 3 4
              0
# 247 "./src/main/drivers/rangefinder/rangefinder_lidartf.c"
                   ;
    }

    tfSerialPort = openSerialPort(portConfig->identifier, FUNCTION_LIDAR_TF, 
# 250 "./src/main/drivers/rangefinder/rangefinder_lidartf.c" 3 4
                                                                            ((void *)0)
# 250 "./src/main/drivers/rangefinder/rangefinder_lidartf.c"
                                                                                , 
# 250 "./src/main/drivers/rangefinder/rangefinder_lidartf.c" 3 4
                                                                                  ((void *)0)
# 250 "./src/main/drivers/rangefinder/rangefinder_lidartf.c"
    ...
    if (tfSerialPort == 
# 252 "./src/main/drivers/rangefinder/rangefinder_lidartf.c" 3 4
                       ((void *)0)
# 252 "./src/main/drivers/rangefinder/rangefinder_lidartf.c"
                           ) {
        return 
# 253 "./src/main/drivers/rangefinder/rangefinder_lidartf.c" 3 4
              0
# 253 "./src/main/drivers/rangefinder/rangefinder_lidartf.c"
                   ;
    }
    ...
    dev->delayMs = 10;
    dev->maxRangeCm = (devtype == 1) ? 1200 : 2200;
    ...
    return 
# 267 "./src/main/drivers/rangefinder/rangefinder_lidartf.c" 3 4
          1
# 267 "./src/main/drivers/rangefinder/rangefinder_lidartf.c"
              ;
}


# 270 "./src/main/drivers/rangefinder/rangefinder_lidartf.c" 3 4
_Bool 
# 270 "./src/main/drivers/rangefinder/rangefinder_lidartf.c"
    lidarTFminiDetect(rangefinderDev_t *dev)
{
    return lidarTFDetect(dev, 1);
}


# 275 "./src/main/drivers/rangefinder/rangefinder_lidartf.c" 3 4
_Bool 
# 275 "./src/main/drivers/rangefinder/rangefinder_lidartf.c"
    lidarTF02Detect(rangefinderDev_t *dev)
{
    return lidarTFDetect(dev, 2);
}
