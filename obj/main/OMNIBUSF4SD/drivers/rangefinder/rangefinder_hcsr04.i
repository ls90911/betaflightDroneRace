...
# 1 "<command-line>"
# 1 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c"
# 21 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c"
...
# 23 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c" 2
...
# 25 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c" 2
...
# 29 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c" 2
...
# 30 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c" 2
...
# 32 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c" 2
...
# 34 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c" 2
...
# 43 "./src/main/drivers/exti.h"
                             enable);
# 35 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c" 2
...
# 36 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c" 2
# 1 "./src/main/drivers/nvic.h" 1
# 21 "./src/main/drivers/nvic.h"
       
# 37 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c" 2
...
# 38 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c" 2
...
# 40 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c" 2
...
# 41 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c" 2
# 56 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c"
static volatile timeDelta_t hcsr04SonarPulseTravelTime = 0;
static volatile timeMs_t lastMeasurementReceivedAt;
static volatile int32_t lastCalculatedDistance = (-1);
...
# 98 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c"
...
void hcsr04_update(rangefinderDev_t *dev)
{
    ...
    if (timeNowMs > lastMeasurementStartedAt + 60) {

        if ((lastMeasurementReceivedAt - lastMeasurementStartedAt) <= 60) {
            ...
            if (lastCalculatedDistance > 400) {
                lastCalculatedDistance = (-1);
            }
        }
        else {

            lastCalculatedDistance = (-2);
        }
...
# 153 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c" 3 4
_Bool 
# 153 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c"
    hcsr04Detect(rangefinderDev_t *dev, const sonarConfig_t * rangefinderHardwarePins)
{
    
# 155 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c" 3 4
   _Bool 
# 155 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c"
        detected = 
# 155 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c" 3 4
                   0
# 155 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c"
    ...
    RCC_ClockCmd((((RCC_APB2) << 5) | (16*((((uint32_t)0x00004000))>65535L) + (8*(((((uint32_t)0x00004000))*1L >>16*((((uint32_t)0x00004000))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00004000))*1L >>16*((((uint32_t)0x00004000))>65535L)) >>8*(((((uint32_t)0x00004000))*1L >>16*((((uint32_t)0x00004000))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00004000))*1L >>16*((((uint32_t)0x00004000))>65535L)) >>8*(((((uint32_t)0x00004000))*1L >>16*((((uint32_t)0x00004000))>65535L))>255))/2+1))))), ENABLE);
    ...
    if (IOGetOwner(triggerIO) != OWNER_FREE) {
        return 
# 170 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c" 3 4
              0
# 170 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c"
                   ;
    }

    if (IOGetOwner(echoIO) != OWNER_FREE) {
        return 
# 174 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c" 3 4
              0
# 174 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c"
                   ;
    }


    IOInit(triggerIO, OWNER_SONAR_TRIGGER, 0);
    IOConfigGPIO(triggerIO, ((GPIO_Mode_OUT) | ((0) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)));
    IOLo(triggerIO);
    delay(100);


    IOInit(echoIO, OWNER_SONAR_ECHO, 0);
    IOConfigGPIO(echoIO, ((GPIO_Mode_IN) | ((0) << 2) | ((0) << 4) | ((GPIO_PuPd_NOPULL) << 5)));


    if (IORead(echoIO) == 
# 188 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c" 3 4
                         0
# 188 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c"
                              ) {
        for (int i = 0; i < 5 && !detected; i++) {
            timeMs_t requestTime = millis();
            hcsr04_start_reading();

            while ((millis() - requestTime) < 60) {
                if (IORead(echoIO) == 
# 194 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c" 3 4
                                     1
# 194 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c"
                                         ) {
                    detected = 
# 195 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c" 3 4
                              1
# 195 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c"
                                  ;
                    break;
                }
            }
    ...
    if (detected) {
        ...
        EXTIEnable(echoIO, 
# 207 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c" 3 4
                          1
# 207 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c"
                              );


        dev->delayMs = 100;
        dev->maxRangeCm = 400;
        dev->detectionConeDeciDegrees = 300;
        dev->detectionConeExtendedDeciDegrees = 450;
        ...
        return 
# 219 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c" 3 4
              1
# 219 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c"
                  ;
    }
    else {
        ...
        IORelease(echoIO);
        return 
# 225 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c" 3 4
              0
# 225 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c"
                   ;
    }
}
