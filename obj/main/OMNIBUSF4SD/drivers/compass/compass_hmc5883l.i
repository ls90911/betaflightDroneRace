...
# 1 "<command-line>"
# 1 "./src/main/drivers/compass/compass_hmc5883l.c"
# 21 "./src/main/drivers/compass/compass_hmc5883l.c"
...
# 23 "./src/main/drivers/compass/compass_hmc5883l.c" 2
...
# 25 "./src/main/drivers/compass/compass_hmc5883l.c" 2
...
# 27 "./src/main/drivers/compass/compass_hmc5883l.c" 2
...
# 23 "./src/main/drivers/bus_i2c_busdev.h" 3 4
_Bool 
# 23 "./src/main/drivers/bus_i2c_busdev.h"
    i2cBusWriteRegister(const busDevice_t *busdev, uint8_t reg, uint8_t data);

# 24 "./src/main/drivers/bus_i2c_busdev.h" 3 4
_Bool 
# 24 "./src/main/drivers/bus_i2c_busdev.h"
...
# 39 "./src/main/drivers/compass/compass_hmc5883l.c" 2
...
# 41 "./src/main/drivers/compass/compass_hmc5883l.c" 2
...
# 44 "./src/main/drivers/compass/compass_hmc5883l.c" 2
...
# 47 "./src/main/drivers/compass/compass_hmc5883l.c" 2

# 1 "./src/main/drivers/compass/compass_hmc5883l.h" 1
# 21 "./src/main/drivers/compass/compass_hmc5883l.h"
       




# 25 "./src/main/drivers/compass/compass_hmc5883l.h" 3 4
_Bool 
# 25 "./src/main/drivers/compass/compass_hmc5883l.h"
    hmc5883lDetect(magDev_t* mag);
# 49 "./src/main/drivers/compass/compass_hmc5883l.c" 2
# 159 "./src/main/drivers/compass/compass_hmc5883l.c"
static void hmc5883lConfigureDataReadyInterruptHandling(magDev_t* mag)
{
# 188 "./src/main/drivers/compass/compass_hmc5883l.c"
    (void)(mag);

}
# 204 "./src/main/drivers/compass/compass_hmc5883l.c"
static 
# 204 "./src/main/drivers/compass/compass_hmc5883l.c" 3 4
      _Bool 
# 204 "./src/main/drivers/compass/compass_hmc5883l.c"
           hmc5883lRead(magDev_t *mag, int16_t *magData)
{
    uint8_t buf[6];
...
# 210 "./src/main/drivers/compass/compass_hmc5883l.c" 3 4
   _Bool 
# 210 "./src/main/drivers/compass/compass_hmc5883l.c"
        ack = busReadRegisterBuffer(busdev, 0x03, buf, 6);

    if (!ack) {
        return 
# 213 "./src/main/drivers/compass/compass_hmc5883l.c" 3 4
              0
# 213 "./src/main/drivers/compass/compass_hmc5883l.c"
                   ;
    }
    ...
    return 
# 220 "./src/main/drivers/compass/compass_hmc5883l.c" 3 4
          1
# 220 "./src/main/drivers/compass/compass_hmc5883l.c"
              ;
}

static 
# 223 "./src/main/drivers/compass/compass_hmc5883l.c" 3 4
      _Bool 
# 223 "./src/main/drivers/compass/compass_hmc5883l.c"
           hmc5883lInit(magDev_t *mag)
{
    ...
    busWriteRegister(busdev, 0x00, 0X60 | 0X10 | 0x00);
    busWriteRegister(busdev, 0x01, 0X20);
    busWriteRegister(busdev, 0x02, 0X00);

    delay(100);

    hmc5883lConfigureDataReadyInterruptHandling(mag);
    return 
# 237 "./src/main/drivers/compass/compass_hmc5883l.c" 3 4
          1
# 237 "./src/main/drivers/compass/compass_hmc5883l.c"
              ;
}


# 240 "./src/main/drivers/compass/compass_hmc5883l.c" 3 4
_Bool 
# 240 "./src/main/drivers/compass/compass_hmc5883l.c"
    hmc5883lDetect(magDev_t* mag)
{
    busDevice_t *busdev = &mag->busdev;

    uint8_t sig = 0;
# 253 "./src/main/drivers/compass/compass_hmc5883l.c"
    if (busdev->bustype == BUSTYPE_I2C && busdev->busdev_u.i2c.address == 0) {
        busdev->busdev_u.i2c.address = 0x1E;
    }


    
# 258 "./src/main/drivers/compass/compass_hmc5883l.c" 3 4
   _Bool 
# 258 "./src/main/drivers/compass/compass_hmc5883l.c"
        ack = busReadRegisterBuffer(&mag->busdev, 0x0A, &sig, 1);

    if (!ack || sig != 0x48) {
        return 
# 261 "./src/main/drivers/compass/compass_hmc5883l.c" 3 4
              0
# 261 "./src/main/drivers/compass/compass_hmc5883l.c"
                   ;
    }
    ...
    return 
# 267 "./src/main/drivers/compass/compass_hmc5883l.c" 3 4
          1
# 267 "./src/main/drivers/compass/compass_hmc5883l.c"
              ;
}
