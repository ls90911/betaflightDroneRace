...
# 23 "./src/main/drivers/sdcard.c" 2
...
# 25 "./src/main/drivers/sdcard.c" 2
...
# 21 "./src/main/drivers/sdcard_standard.h"
...
# 93 "./src/main/drivers/sdcard.c" 3 4
   _Bool 
# 93 "./src/main/drivers/sdcard.c"
        highCapacity;
...
# 107 "./src/main/drivers/sdcard.c" 3 4
   _Bool 
# 107 "./src/main/drivers/sdcard.c"
        enabled;
    
# 108 "./src/main/drivers/sdcard.c" 3 4
   _Bool 
# 108 "./src/main/drivers/sdcard.c"
        detectionInverted;
    
# 109 "./src/main/drivers/sdcard.c" 3 4
   _Bool 
# 109 "./src/main/drivers/sdcard.c"
        useDMAForTx;
    IO_t cardDetectPin;
    IO_t chipSelectPin;
...
# 139 "./src/main/drivers/sdcard.c" 3 4
_Bool 
# 139 "./src/main/drivers/sdcard.c"
    sdcard_isInserted(void)
{
    
# 141 "./src/main/drivers/sdcard.c" 3 4
   _Bool 
# 141 "./src/main/drivers/sdcard.c"
        result = 
# 141 "./src/main/drivers/sdcard.c" 3 4
                 1
# 141 "./src/main/drivers/sdcard.c"
...
static void sdcard_reset(void)
{
    ...
    if (sdcard.state >= SDCARD_STATE_READY) {
        spiSetDivisor(sdcard.instance, 256);
    }
...
static 
# 207 "./src/main/drivers/sdcard.c" 3 4
      _Bool 
# 207 "./src/main/drivers/sdcard.c"
           sdcard_waitForIdle(int maxBytesToWait)
{
    while (maxBytesToWait > 0) {
        ...
        if (b == 0xFF) {
            return 
# 212 "./src/main/drivers/sdcard.c" 3 4
                  1
# 212 "./src/main/drivers/sdcard.c"
                      ;
        }
        maxBytesToWait--;
    }
    ...
    return 
# 217 "./src/main/drivers/sdcard.c" 3 4
          0
# 217 "./src/main/drivers/sdcard.c"
               ;
}
...
# 263 "./src/main/drivers/sdcard.c" 3 4
                                         ((void *)0)
# 263 "./src/main/drivers/sdcard.c"
                                             , sizeof(command));
...
static 
# 283 "./src/main/drivers/sdcard.c" 3 4
      _Bool 
# 283 "./src/main/drivers/sdcard.c"
...
# 299 "./src/main/drivers/sdcard.c" 3 4
                                    ((void *)0)
# 299 "./src/main/drivers/sdcard.c"
...
static 
# 315 "./src/main/drivers/sdcard.c" 3 4
      _Bool 
# 315 "./src/main/drivers/sdcard.c"
           sdcard_readOCRRegister(uint32_t *result)
{
    ...
    spiTransfer(sdcard.instance, 
# 323 "./src/main/drivers/sdcard.c" 3 4
                                ((void *)0)
# 323 "./src/main/drivers/sdcard.c"
    ...
    if (status == 0) {
        ...
        *result = (response[0] << 24) | (response[1] << 16) | (response[2] << 8) | response[3];
        ...
        return 
# 330 "./src/main/drivers/sdcard.c" 3 4
              1
# 330 "./src/main/drivers/sdcard.c"
                  ;
    } else {
        sdcard_deselect();

        return 
# 334 "./src/main/drivers/sdcard.c" 3 4
              0
# 334 "./src/main/drivers/sdcard.c"
                   ;
    }
}
...
static sdcardReceiveBlockStatus_e sdcard_receiveDataBlock(uint8_t *buffer, int count)
{
    ...
    spiTransfer(sdcard.instance, 
# 361 "./src/main/drivers/sdcard.c" 3 4
                                ((void *)0)
# 361 "./src/main/drivers/sdcard.c"
                                    , buffer, count);
...
# 404 "./src/main/drivers/sdcard.c" 3 4
                                                            _Bool 
# 404 "./src/main/drivers/sdcard.c"
                                                                 multiBlockWrite)
{
...
# 441 "./src/main/drivers/sdcard.c"
        ...
        init.DMA_DIR = ((uint32_t)0x00000040);
        ...
        init.DMA_MemoryInc = ((uint32_t)0x00000400);
...
static 
# 477 "./src/main/drivers/sdcard.c" 3 4
      _Bool 
# 477 "./src/main/drivers/sdcard.c"
           sdcard_receiveCID(void)
{
    ...
    if (sdcard_receiveDataBlock(cid, sizeof(cid)) != SDCARD_RECEIVE_SUCCESS) {
        return 
# 482 "./src/main/drivers/sdcard.c" 3 4
              0
# 482 "./src/main/drivers/sdcard.c"
                   ;
    }
    ...
    return 
# 498 "./src/main/drivers/sdcard.c" 3 4
          1
# 498 "./src/main/drivers/sdcard.c"
              ;
}

static 
# 501 "./src/main/drivers/sdcard.c" 3 4
      _Bool 
# 501 "./src/main/drivers/sdcard.c"
...
# 511 "./src/main/drivers/sdcard.c" 3 4
   _Bool 
# 511 "./src/main/drivers/sdcard.c"
        success =
    ...
    if (success) {
        switch (readBitfield(sdcard.csd.data, 0, 2)) {
            ...
            default:
                success = 
# 534 "./src/main/drivers/sdcard.c" 3 4
                         0
# 534 "./src/main/drivers/sdcard.c"
                              ;
        }
    }
...
static 
# 548 "./src/main/drivers/sdcard.c" 3 4
      _Bool 
# 548 "./src/main/drivers/sdcard.c"
...
void sdcard_init(const sdcardConfig_t *config)
{
    ...
    if (config->chipSelectTag) {
        ...
        IOConfigGPIO(sdcard.chipSelectPin, ((GPIO_Mode_OUT) | ((GPIO_Fast_Speed) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)));
    } else {
...
# 595 "./src/main/drivers/sdcard.c" 3 4
                                  0
# 595 "./src/main/drivers/sdcard.c"
                                       ;
    }
    ...
    spiTransfer(sdcard.instance, 
# 607 "./src/main/drivers/sdcard.c" 3 4
                                ((void *)0)
# 607 "./src/main/drivers/sdcard.c"
                                    , 
# 607 "./src/main/drivers/sdcard.c" 3 4
                                      ((void *)0)
# 607 "./src/main/drivers/sdcard.c"
...
static 
# 624 "./src/main/drivers/sdcard.c" 3 4
      _Bool 
# 624 "./src/main/drivers/sdcard.c"
...
static 
# 638 "./src/main/drivers/sdcard.c" 3 4
      _Bool 
# 638 "./src/main/drivers/sdcard.c"
           sdcard_isReady(void)
{
    return sdcard.state == SDCARD_STATE_READY || sdcard.state == SDCARD_STATE_WRITING_MULTIPLE_BLOCKS;
}
# 653 "./src/main/drivers/sdcard.c"
...
# 679 "./src/main/drivers/sdcard.c" 3 4
_Bool 
# 679 "./src/main/drivers/sdcard.c"
    sdcard_poll(void)
{
    if (!sdcard.enabled) {
        sdcard.state = SDCARD_STATE_NOT_PRESENT;
        return 
# 683 "./src/main/drivers/sdcard.c" 3 4
              0
# 683 "./src/main/drivers/sdcard.c"
                   ;
    }

    uint8_t initStatus;
    
# 687 "./src/main/drivers/sdcard.c" 3 4
   _Bool 
# 687 "./src/main/drivers/sdcard.c"
        sendComplete;
        ...
        case SDCARD_STATE_CARD_INIT_IN_PROGRESS:
            if (sdcard_checkInitDone()) {
                if (sdcard.version == 2) {
                    ...
                    sdcard.highCapacity = 
# 729 "./src/main/drivers/sdcard.c" 3 4
                                         0
# 729 "./src/main/drivers/sdcard.c"
                                              ;
                }
        ...
        case SDCARD_STATE_INITIALIZATION_RECEIVE_CID:
            if (sdcard_receiveCID()) {
                ...
                spiSetDivisor(sdcard.instance, 4);
        ...
        case SDCARD_STATE_SENDING_WRITE:
            ...
            sendComplete = 
# 774 "./src/main/drivers/sdcard.c" 3 4
                          0
# 774 "./src/main/drivers/sdcard.c"
                               ;
# 796 "./src/main/drivers/sdcard.c"
            if (sdcard.useDMAForTx && DMA_GetFlagStatus(sdcard.dma->ref, sdcard.dma->completeFlag) == SET) {
                ...
                sendComplete = 
# 816 "./src/main/drivers/sdcard.c" 3 4
                              1
# 816 "./src/main/drivers/sdcard.c"
                                  ;
            }
...
# 821 "./src/main/drivers/sdcard.c" 3 4
                                                                                                                                             ((void *)0)
# 821 "./src/main/drivers/sdcard.c"
                                                                                                                                                 , 256);
...
# 847 "./src/main/drivers/sdcard.c" 3 4
                                                                                                                          ((void *)0)
# 847 "./src/main/drivers/sdcard.c"
...
# 936 "./src/main/drivers/sdcard.c" 3 4
                           ((void *)0)
# 936 "./src/main/drivers/sdcard.c"
                               ,
                            sdcard.pendingOperation.callbackData
                        );
                    }
...
# 1056 "./src/main/drivers/sdcard.c"
sdcardOperationStatus_e sdcard_beginWriteBlocks(uint32_t blockIndex, uint32_t blockCount)
{
    if (sdcard.state != SDCARD_STATE_READY) {
...
# 1104 "./src/main/drivers/sdcard.c"

# 1104 "./src/main/drivers/sdcard.c" 3 4
_Bool 
# 1104 "./src/main/drivers/sdcard.c"
    sdcard_readBlock(uint32_t blockIndex, uint8_t *buffer, sdcard_operationCompleteCallback_c callback, uint32_t callbackData)
{
    if (sdcard.state != SDCARD_STATE_READY) {
        if (sdcard.state == SDCARD_STATE_WRITING_MULTIPLE_BLOCKS) {
            if (sdcard_endWriteBlocks() != SDCARD_OPERATION_SUCCESS) {
                return 
# 1109 "./src/main/drivers/sdcard.c" 3 4
                      0
# 1109 "./src/main/drivers/sdcard.c"
                           ;
            }
        } else {
            return 
...
# 1112 "./src/main/drivers/sdcard.c"
    ...
    if (status == 0) {
        ...
        return 
# 1137 "./src/main/drivers/sdcard.c" 3 4
              1
# 1137 "./src/main/drivers/sdcard.c"
                  ;
    } else {
        sdcard_deselect();

        return 
# 1141 "./src/main/drivers/sdcard.c" 3 4
              0
# 1141 "./src/main/drivers/sdcard.c"
                   ;
    }
}
...
# 1148 "./src/main/drivers/sdcard.c" 3 4
_Bool 
# 1148 "./src/main/drivers/sdcard.c"
    sdcard_isInitialized(void)
{
