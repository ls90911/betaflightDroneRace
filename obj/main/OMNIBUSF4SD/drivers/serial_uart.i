...
# 1 "<command-line>"
# 1 "./src/main/drivers/serial_uart.c"
# 28 "./src/main/drivers/serial_uart.c"
...
# 45 "./src/main/drivers/serial_uart.c" 2
...
# 46 "./src/main/drivers/serial_uart.c" 2
...
void uartTryStartTxDMA(uartPort_t *s)
{
    ...
    for ( uint8_t __basepri_save __attribute__ ((__cleanup__ (__basepriRestoreMem), __unused__)) = __get_BASEPRI(), __ToDo = __basepriSetMemRetVal((((((1)<<(4-(7-(((uint32_t)0x500)>>8))))|((1)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0)); __ToDo ; __ToDo = 0 ) {
        ...
        if (s->port.txBufferHead == s->port.txBufferTail) {
            ...
            s->txDMAEmpty = 
# 85 "./src/main/drivers/serial_uart.c" 3 4
                           1
# 85 "./src/main/drivers/serial_uart.c"
                               ;
            return;
        }
        ...
        s->txDMAEmpty = 
# 101 "./src/main/drivers/serial_uart.c" 3 4
                       0
# 101 "./src/main/drivers/serial_uart.c"
                            ;

    reenable:
        DMA_Cmd(s->txDMAStream, ENABLE);
# 141 "./src/main/drivers/serial_uart.c"
    }
}
...
static 
# 211 "./src/main/drivers/serial_uart.c" 3 4
      _Bool 
# 211 "./src/main/drivers/serial_uart.c"
...
const struct serialPortVTable uartVTable[] = {
    {
        ...
        .setMode = uartSetMode,
        .setCtrlLineStateCb = 
# 280 "./src/main/drivers/serial_uart.c" 3 4
                             ((void *)0)
# 280 "./src/main/drivers/serial_uart.c"
                                 ,
        .setBaudRateCb = 
# 281 "./src/main/drivers/serial_uart.c" 3 4
                        ((void *)0)
# 281 "./src/main/drivers/serial_uart.c"
                            ,
        .writeBuf = 
# 282 "./src/main/drivers/serial_uart.c" 3 4
                   ((void *)0)
# 282 "./src/main/drivers/serial_uart.c"
                       ,
        .beginWrite = 
# 283 "./src/main/drivers/serial_uart.c" 3 4
                     ((void *)0)
# 283 "./src/main/drivers/serial_uart.c"
                         ,
        .endWrite = 
# 284 "./src/main/drivers/serial_uart.c" 3 4
                   ((void *)0)
# 284 "./src/main/drivers/serial_uart.c"
                       ,
    }
};
...
# 308 "./src/main/drivers/serial_uart.c"
void USART3_IRQHandler(void)
{
    uartPort_t *s = &(uartDevmap[UARTDEV_3]->port);
    uartIrqHandler(s);
}
# 335 "./src/main/drivers/serial_uart.c"
