...
# 1 "<command-line>"
# 1 "./src/main/drivers/serial_uart_init.c"
# 32 "./src/main/drivers/serial_uart_init.c"
...
# 34 "./src/main/drivers/serial_uart_init.c" 2
...
# 36 "./src/main/drivers/serial_uart_init.c" 2
...
# 31 "./src/main/drivers/inverter.h"
                                               on);
# 41 "./src/main/drivers/serial_uart_init.c" 2
...
# 45 "./src/main/drivers/serial_uart_init.c" 2
...
# 46 "./src/main/drivers/serial_uart_init.c" 2
...
# 51 "./src/main/drivers/serial_uart_init.c" 3 4
   _Bool 
# 51 "./src/main/drivers/serial_uart_init.c"
...
# 56 "./src/main/drivers/serial_uart_init.c" 3 4
                                        1
# 56 "./src/main/drivers/serial_uart_init.c"
                                            );
    }
# 73 "./src/main/drivers/serial_uart_init.c"
}
...
serialPort_t *uartOpen(UARTDevice_e device, serialReceiveCallbackPtr rxCallback, void *rxCallbackData, uint32_t baudRate, portMode_e mode, portOptions_e options)
{
    ...
    s->txDMAEmpty = 
# 124 "./src/main/drivers/serial_uart_init.c" 3 4
                   1
# 124 "./src/main/drivers/serial_uart_init.c"
                       ;
...
# 165 "./src/main/drivers/serial_uart_init.c"
...
# 187 "./src/main/drivers/serial_uart_init.c"
        } else {
    ...
    if (mode & MODE_TX) {
        ...
        if (s->txDMAStream) {
            ...
            DMA_InitStructure.DMA_MemoryBurst = ((uint32_t)0x00000000) ;
            DMA_InitStructure.DMA_PeripheralBurst = ((uint32_t)0x00000000);
# 219 "./src/main/drivers/serial_uart_init.c"
...
# 238 "./src/main/drivers/serial_uart_init.c"
