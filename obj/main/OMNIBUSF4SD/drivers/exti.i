...
# 27 "./src/main/drivers/io_impl.h" 2
...
void EXTIRelease(IO_t io)
{
    ...
    EXTIEnable(io, 
# 173 "./src/main/drivers/exti.c" 3 4
                  0
# 173 "./src/main/drivers/exti.c"
                       );
    ...
    extiChannelRec_t *rec = &extiChannelRecs[chIdx];
    rec->handler = 
# 180 "./src/main/drivers/exti.c" 3 4
                  ((void *)0)
# 180 "./src/main/drivers/exti.c"
                      ;
}

void EXTIEnable(IO_t io, 
# 183 "./src/main/drivers/exti.c" 3 4
                        _Bool 
# 183 "./src/main/drivers/exti.c"
                             enable)
{
    ...
    if (!extiLine)
        return;
    if (enable)
        ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3C00))->IMR |= extiLine;
    else
        ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3C00))->IMR &= ~extiLine;
# 205 "./src/main/drivers/exti.c"
}

void EXTI_IRQHandler(void)
{
    uint32_t exti_active = ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3C00))->IMR & ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3C00))->PR;

    while (exti_active) {
        unsigned idx = 31 - __builtin_clz(exti_active);
        uint32_t mask = 1 << idx;
        extiChannelRecs[idx].handler->fn(extiChannelRecs[idx].handler);
        ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3C00))->PR = mask;
        exti_active &= ~mask;
    }
}
# 228 "./src/main/drivers/exti.c"
