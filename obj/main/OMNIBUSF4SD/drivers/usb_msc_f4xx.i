# 1 "./src/main/drivers/usb_msc_f4xx.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/drivers/usb_msc_f4xx.c"
# 26 "./src/main/drivers/usb_msc_f4xx.c"
...
# 29 "./src/main/drivers/usb_msc_f4xx.c" 2
...
# 31 "./src/main/drivers/usb_msc_f4xx.c" 2
...
# 35 "./src/main/drivers/usb_msc_f4xx.c" 2
...
# 39 "./src/main/drivers/usb_msc_f4xx.c" 2
...
# 41 "./src/main/drivers/usb_msc_f4xx.c" 2
...
# 67 "./src/main/drivers/light_led.h"
                         state);
# 42 "./src/main/drivers/usb_msc_f4xx.c" 2
# 1 "./src/main/drivers/nvic.h" 1
# 21 "./src/main/drivers/nvic.h"
       
# 43 "./src/main/drivers/usb_msc_f4xx.c" 2
# 1 "./src/main/drivers/sdmmc_sdio.h" 1
# 77 "./src/main/drivers/sdmmc_sdio.h"
typedef enum
{
...
typedef struct
{
  volatile SD_CSD_t SD_csd;
  volatile SD_CID_t SD_cid;
...
# 226 "./src/main/drivers/sdmmc_sdio.h" 3 4
_Bool 
# 226 "./src/main/drivers/sdmmc_sdio.h"
                SD_Init (void);

# 227 "./src/main/drivers/sdmmc_sdio.h" 3 4
_Bool 
# 227 "./src/main/drivers/sdmmc_sdio.h"
                SD_IsDetected (void);

# 228 "./src/main/drivers/sdmmc_sdio.h" 3 4
_Bool 
# 228 "./src/main/drivers/sdmmc_sdio.h"
                SD_GetState (void);
...
# 44 "./src/main/drivers/usb_msc_f4xx.c" 2
...
# 45 "./src/main/drivers/usb_msc_f4xx.c" 2
...
# 46 "./src/main/drivers/usb_msc_f4xx.c" 2
...
# 24 "./src/main/drivers/accgyro/accgyro_mpu.h" 2
...
# 43 "./src/main/drivers/exti.h"
                             enable);
# 25 "./src/main/drivers/accgyro/accgyro_mpu.h" 2
...
# 26 "./src/main/drivers/accgyro/accgyro_mpu.h" 2
...
# 48 "./src/main/drivers/usb_msc_f4xx.c" 2
...
# 50 "./src/main/drivers/usb_msc_f4xx.c" 2
...
# 52 "./src/main/drivers/usb_msc_f4xx.c" 2
...
# 53 "./src/main/drivers/usb_msc_f4xx.c" 2
...
# 54 "./src/main/drivers/usb_msc_f4xx.c" 2

# 1 "./src/main/msc/usbd_storage.h" 1
# 21 "./src/main/msc/usbd_storage.h"
...
# 27 "./src/main/msc/usbd_storage.h" 2
# 1 "./lib/main/STM32_USB_Device_Library/Class/msc/inc/usbd_msc_core.h" 1
# 64 "./lib/main/STM32_USB_Device_Library/Class/msc/inc/usbd_msc_core.h"
extern USBD_Class_cb_TypeDef USBD_MSC_cb;
# 28 "./src/main/msc/usbd_storage.h" 2
# 39 "./src/main/msc/usbd_storage.h"
extern USBD_STORAGE_cb_TypeDef *USBD_STORAGE_fops;
...
# 56 "./src/main/drivers/usb_msc_f4xx.c" 2
...
void mscInit(void)
{
    if (usbDevConfig()->mscButtonPin) {
        ...
        if (usbDevConfig()->mscButtonUsePullup) {
            IOConfigGPIO(mscButton, ((GPIO_Mode_IN) | ((0) << 2) | ((0) << 4) | ((GPIO_PuPd_UP) << 5)));
        } else {
            IOConfigGPIO(mscButton, ((GPIO_Mode_IN) | ((0) << 2) | ((0) << 4) | ((GPIO_PuPd_DOWN) << 5)));
        }
    }
}
...
uint8_t mscStart(void)
{
    ...
    IOInit(IOGetByTag(((ioTag_t)((((0) + 1) << 4) | (11)))), OWNER_USB, 0);
    IOInit(IOGetByTag(((ioTag_t)((((0) + 1) << 4) | (12)))), OWNER_USB, 0);
    ...
    __NVIC_SetPriority(SysTick_IRQn, (((((0)<<(4-(7-(((uint32_t)0x500)>>8))))|((0)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0));
...
# 110 "./src/main/drivers/usb_msc_f4xx.c" 3 4
_Bool 
# 110 "./src/main/drivers/usb_msc_f4xx.c"
    mscCheckBoot(void)
{
    if (*((uint32_t *)0x2001FFF0) == 0xDDDD1010) {
        return 
# 113 "./src/main/drivers/usb_msc_f4xx.c" 3 4
              1
# 113 "./src/main/drivers/usb_msc_f4xx.c"
                  ;
    }
    return 
# 115 "./src/main/drivers/usb_msc_f4xx.c" 3 4
          0
# 115 "./src/main/drivers/usb_msc_f4xx.c"
               ;
}


# 118 "./src/main/drivers/usb_msc_f4xx.c" 3 4
_Bool 
# 118 "./src/main/drivers/usb_msc_f4xx.c"
    mscCheckButton(void)
{
    
# 120 "./src/main/drivers/usb_msc_f4xx.c" 3 4
   _Bool 
# 120 "./src/main/drivers/usb_msc_f4xx.c"
        result = 
# 120 "./src/main/drivers/usb_msc_f4xx.c" 3 4
                 0
# 120 "./src/main/drivers/usb_msc_f4xx.c"
...
void mscWaitForButton(void)
{
    ...
    delay(20);
    while (
# 138 "./src/main/drivers/usb_msc_f4xx.c" 3 4
          1
# 138 "./src/main/drivers/usb_msc_f4xx.c"
              ) {
        asm("NOP");
        if (mscCheckButton()) {
...
void systemResetToMsc(void)
{
    ...
    *((uint32_t *)0x2001FFF0) = 0xDDDD1010;
