...
# 1 "<command-line>"
# 1 "./src/main/drivers/barometer/barometer_bmp280.c"
# 21 "./src/main/drivers/barometer/barometer_bmp280.c"
...
# 35 "./src/main/drivers/barometer/barometer_bmp280.c" 2
...
# 37 "./src/main/drivers/barometer/barometer_bmp280.c" 2
...
# 39 "./src/main/drivers/barometer/barometer_bmp280.c" 2
...
void bmp280BusInit(busDevice_t *busdev)
{
    ...
    if (busdev->bustype == BUSTYPE_SPI) {
        ...
        IOConfigGPIO(busdev->busdev_u.spi.csnPin, ((GPIO_Mode_OUT) | ((0) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)));
...
# 96 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
_Bool 
# 96 "./src/main/drivers/barometer/barometer_bmp280.c"
    bmp280Detect(baroDev_t *baro)
{
    delay(20);
...
# 101 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
   _Bool 
# 101 "./src/main/drivers/barometer/barometer_bmp280.c"
...
# 101 "./src/main/drivers/barometer/barometer_bmp280.c"
    ...
    if ((busdev->bustype == BUSTYPE_I2C) && (busdev->busdev_u.i2c.address == 0)) {
        ...
        defaultAddressApplied = 
# 108 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
                               1
# 108 "./src/main/drivers/barometer/barometer_bmp280.c"
                                   ;
    }

    busReadRegisterBuffer(busdev, (0xD0), &bmp280_chip_id, 1);
    ...
    if (bmp280_chip_id != (0x58)) {
        ...
        return 
# 118 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
              0
# 118 "./src/main/drivers/barometer/barometer_bmp280.c"
                   ;
    }


    busReadRegisterBuffer(busdev, (0x88), (uint8_t *)&bmp280_cal, 24);


    busWriteRegister(busdev, (0xF4), (((0x04)) << 2 | ((0x01)) << 5 | (0x01)));
...
static void bmp280_start_up(baroDev_t *baro)
{
    ...
    busWriteRegister(&baro->busdev, (0xF4), (((0x04)) << 2 | ((0x01)) << 5 | (0x01)));
}
...
static void bmp280_get_up(baroDev_t *baro)
{
    ...
    busReadRegisterBuffer(&baro->busdev, (0xF7), data, (6));
