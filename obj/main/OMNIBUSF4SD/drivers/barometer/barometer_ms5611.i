...
# 1 "<command-line>"
# 1 "./src/main/drivers/barometer/barometer_ms5611.c"
# 21 "./src/main/drivers/barometer/barometer_ms5611.c"
...
# 23 "./src/main/drivers/barometer/barometer_ms5611.c" 2
...
# 25 "./src/main/drivers/barometer/barometer_ms5611.c" 2
...
# 29 "./src/main/drivers/barometer/barometer_ms5611.c" 2
...
# 31 "./src/main/drivers/barometer/barometer_ms5611.c" 2
...
# 32 "./src/main/drivers/barometer/barometer_ms5611.c" 2
...
# 35 "./src/main/drivers/barometer/barometer_ms5611.c" 2
...
# 36 "./src/main/drivers/barometer/barometer_ms5611.c" 2
...
# 37 "./src/main/drivers/barometer/barometer_ms5611.c" 2
...
# 38 "./src/main/drivers/barometer/barometer_ms5611.c" 2
# 52 "./src/main/drivers/barometer/barometer_ms5611.c"
...
{
# 77 "./src/main/drivers/barometer/barometer_ms5611.c"
    (void)(busdev);
...
# 92 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
_Bool 
# 92 "./src/main/drivers/barometer/barometer_ms5611.c"
    ms5611Detect(baroDev_t *baro)
{
    uint8_t sig;
    int i;
    
# 96 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
   _Bool 
# 96 "./src/main/drivers/barometer/barometer_ms5611.c"
...
# 96 "./src/main/drivers/barometer/barometer_ms5611.c"
    ...
    if ((busdev->bustype == BUSTYPE_I2C) && (busdev->busdev_u.i2c.address == 0)) {
        ...
        defaultAddressApplied = 
# 107 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
                               1
# 107 "./src/main/drivers/barometer/barometer_ms5611.c"
                                   ;
    }

    if (!busReadRegisterBuffer(busdev, 0xA0, &sig, 1) || sig == 0xFF) {
        goto fail;
    }
    ...
    return 
# 134 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
          1
# 134 "./src/main/drivers/barometer/barometer_ms5611.c"
              ;
...
fail:;
    ...
    return 
# 143 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
          0
# 143 "./src/main/drivers/barometer/barometer_ms5611.c"
               ;
}

static void ms5611_reset(busDevice_t *busdev)
{
    busWriteRegister(busdev, 0x1E, 1);
...
static uint16_t ms5611_prom(busDevice_t *busdev, int8_t coef_num)
{
    ...
    busReadRegisterBuffer(busdev, 0xA0 + coef_num * 2, rxbuf, 2);
...
# 169 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
   _Bool 
# 169 "./src/main/drivers/barometer/barometer_ms5611.c"
        blankEeprom = 
# 169 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
                      1
# 169 "./src/main/drivers/barometer/barometer_ms5611.c"
    ...
    for (i = 0; i < 16; i++) {
        if (prom[i >> 1]) {
            blankEeprom = 
# 173 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
                         0
# 173 "./src/main/drivers/barometer/barometer_ms5611.c"
                              ;
        }
        if (i & 1)
            res ^= ((prom[i >> 1]) & 0x00FF);
...
static uint32_t ms5611_read_adc(busDevice_t *busdev)
{
    ...
    busReadRegisterBuffer(busdev, 0x00, rxbuf, 3);
...
static void ms5611_start_ut(baroDev_t *baro)
{
    busWriteRegister(&baro->busdev, 0x40 + 0x10 + ms5611_osr, 1);
}
...
static void ms5611_start_up(baroDev_t *baro)
{
    busWriteRegister(&baro->busdev, 0x40 + 0x00 + ms5611_osr, 1);
}
