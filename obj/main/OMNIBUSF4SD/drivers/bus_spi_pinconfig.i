...
# 24 "./src/main/drivers/bus_spi_pinconfig.c" 2
...
# 26 "./src/main/drivers/bus_spi_pinconfig.c" 2
...
# 21 "./src/main/drivers/bus_spi_impl.h"
...
# 67 "./src/main/drivers/bus_spi_impl.h" 3 4
   _Bool 
# 67 "./src/main/drivers/bus_spi_impl.h"
        leadingEdge;
...
# 43 "./src/main/drivers/exti.h"
                             enable);
# 35 "./src/main/drivers/bus_spi_pinconfig.c" 2
...
# 39 "./src/main/drivers/bus_spi_pinconfig.c" 2

const spiHardware_t spiHardware[] = {
# 148 "./src/main/drivers/bus_spi_pinconfig.c"
    {
        .device = SPIDEV_1,
        .reg = ((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3000)),
        .sckPins = {
            { ((ioTag_t)((((0) + 1) << 4) | (5))) },
            { ((ioTag_t)((((1) + 1) << 4) | (3))) },
        },
    ...
    {
        .device = SPIDEV_2,
        .reg = ((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800)),
        .sckPins = {
            { ((ioTag_t)((((1) + 1) << 4) | (10))) },
            { ((ioTag_t)((((1) + 1) << 4) | (13))) },
        },
    ...
    {
        .device = SPIDEV_3,
        .reg = ((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)),
        .sckPins = {
            { ((ioTag_t)((((1) + 1) << 4) | (3))) },
            { ((ioTag_t)((((2) + 1) << 4) | (10))) },
        },
...
# 282 "./src/main/drivers/bus_spi_pinconfig.c"
};
...
void spiPinConfigure(const spiPinConfig_t *pConfig)
{
    for (size_t hwindex = 0 ; hwindex < (sizeof(spiHardware) / sizeof((spiHardware)[0])) ; hwindex++) {
        ...
        if (pDev->sck && pDev->miso && pDev->mosi) {
            ...
            pDev->rcc = hw->rcc;
            pDev->leadingEdge = 
# 323 "./src/main/drivers/bus_spi_pinconfig.c" 3 4
                               0
# 323 "./src/main/drivers/bus_spi_pinconfig.c"
                                    ;
