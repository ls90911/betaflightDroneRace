...
# 26 "./src/main/drivers/max7456.c" 2
...
# 42 "./src/main/drivers/max7456.c" 2
# 1 "./src/main/drivers/nvic.h" 1
# 21 "./src/main/drivers/nvic.h"
       
# 43 "./src/main/drivers/max7456.c" 2
...
# 44 "./src/main/drivers/max7456.c" 2
# 193 "./src/main/drivers/max7456.c"
...
# 214 "./src/main/drivers/max7456.c"
...
static 
# 223 "./src/main/drivers/max7456.c" 3 4
      _Bool 
# 223 "./src/main/drivers/max7456.c"
           max7456Lock = 
# 223 "./src/main/drivers/max7456.c" 3 4
                                 0
# 223 "./src/main/drivers/max7456.c"
                                      ;
static 
# 224 "./src/main/drivers/max7456.c" 3 4
      _Bool 
# 224 "./src/main/drivers/max7456.c"
           fontIsLoading = 
# 224 "./src/main/drivers/max7456.c" 3 4
                                 0
# 224 "./src/main/drivers/max7456.c"
...
# 352 "./src/main/drivers/max7456.c"
uint8_t max7456GetRowsCount(void)
{
...
void max7456ReInit(void)
{
    uint8_t srdata = 0;
    static 
# 360 "./src/main/drivers/max7456.c" 3 4
          _Bool 
# 360 "./src/main/drivers/max7456.c"
               firstInit = 
# 360 "./src/main/drivers/max7456.c" 3 4
                           1
# 360 "./src/main/drivers/max7456.c"
    ...
    {spiSetDivisor((busdev)->busdev_u.spi.instance, max7456SpiClock);IOLo((busdev)->busdev_u.spi.csnPin);};
    ...
    {IOHi((busdev)->busdev_u.spi.csnPin);spiSetDivisor((busdev)->busdev_u.spi.instance, (SPI_CLOCK_FAST));};
    ...
    if (firstInit) {
        ...
        firstInit = 
# 410 "./src/main/drivers/max7456.c" 3 4
                   0
# 410 "./src/main/drivers/max7456.c"
                        ;
    }
}
...
# 418 "./src/main/drivers/max7456.c" 3 4
_Bool 
# 418 "./src/main/drivers/max7456.c"
    max7456Init(const max7456Config_t *max7456Config, const vcdProfile_t *pVcdProfile, 
# 418 "./src/main/drivers/max7456.c" 3 4
                                                                                       _Bool 
# 418 "./src/main/drivers/max7456.c"
                                                                                            cpuOverclock)
{
    ...
    if (!max7456Config->csTag) {
        return 
# 423 "./src/main/drivers/max7456.c" 3 4
              0
# 423 "./src/main/drivers/max7456.c"
                   ;
    }
    ...
    if (!IOIsFreeOrPreinit(busdev->busdev_u.spi.csnPin)) {
        return 
# 429 "./src/main/drivers/max7456.c" 3 4
              0
# 429 "./src/main/drivers/max7456.c"
                   ;
    }

    IOInit(busdev->busdev_u.spi.csnPin, OWNER_OSD_CS, 0);
    IOConfigGPIO(busdev->busdev_u.spi.csnPin, ((GPIO_Mode_OUT) | ((GPIO_Fast_Speed) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)));
    IOHi(busdev->busdev_u.spi.csnPin);

    spiBusSetInstance(busdev, spiInstanceByDevice(((max7456Config->spiDevice) - 1)));
    ...
    case 0:
        max7456SpiClock = (SPI_CLOCK_STANDARD) * 2;
        break;

    case 1:
        max7456SpiClock = (cpuOverclock && (max7456DeviceType == 0)) ? (SPI_CLOCK_STANDARD) * 2 : (SPI_CLOCK_STANDARD);
        break;

    case 2:
        max7456SpiClock = (SPI_CLOCK_STANDARD);
        break;
    }

    {if (debugMode == (DEBUG_MAX7456_SPICLOCK)) {debug[(0)] = (cpuOverclock);}};
    {if (debugMode == (DEBUG_MAX7456_SPICLOCK)) {debug[(1)] = (max7456DeviceType);}};
    {if (debugMode == (DEBUG_MAX7456_SPICLOCK)) {debug[(2)] = (max7456SpiClock);}};
    ...
    return 
# 492 "./src/main/drivers/max7456.c" 3 4
          1
# 492 "./src/main/drivers/max7456.c"
              ;
}
...
# 553 "./src/main/drivers/max7456.c" 3 4
_Bool 
# 553 "./src/main/drivers/max7456.c"
    max7456DmaInProgress(void)
{
...
# 562 "./src/main/drivers/max7456.c" 3 4
_Bool 
# 562 "./src/main/drivers/max7456.c"
    max7456BuffersSynced(void)
{
    for (int i = 0; i < maxScreenSize; i++) {
        if (screenBuffer[i] != shadowBuffer[i]) {
            return 
# 566 "./src/main/drivers/max7456.c" 3 4
                  0
# 566 "./src/main/drivers/max7456.c"
                       ;
        }
    }
    return 
# 569 "./src/main/drivers/max7456.c" 3 4
          1
# 569 "./src/main/drivers/max7456.c"
              ;
}
...
void max7456DrawScreen(void)
{
    ...
    if (!max7456Lock && !fontIsLoading) {
        ...
        max7456Lock = 
# 630 "./src/main/drivers/max7456.c" 3 4
                     1
# 630 "./src/main/drivers/max7456.c"
                         ;
        ...
        if (buff_len) {
            ...
            {spiSetDivisor((busdev)->busdev_u.spi.instance, max7456SpiClock);IOLo((busdev)->busdev_u.spi.csnPin);};
            spiTransfer(busdev->busdev_u.spi.instance, spiBuff, 
...
# 657 "./src/main/drivers/max7456.c"
        ...
        max7456Lock = 
# 661 "./src/main/drivers/max7456.c" 3 4
                     0
# 661 "./src/main/drivers/max7456.c"
                          ;
    }
}
...
# 667 "./src/main/drivers/max7456.c"
    ...
    for (int xx = 0; xx < maxScreenSize; xx++) {
        if (screenBuffer[xx] == 0xff) {
            escapeCharFound = 
# 679 "./src/main/drivers/max7456.c" 3 4
                             1
# 679 "./src/main/drivers/max7456.c"
                                 ;
            max7456Send(0x07, ' ');
        } else {
    ...
    if (escapeCharFound) {
        for (int xx = 0; xx < maxScreenSize; xx++) {
            if (screenBuffer[xx] == 0xff) {
                max7456Send(0x05, xx >> 8);
                max7456Send(0x06, xx & 0xFF);
                max7456Send(0x07, 0xff);
            }
        }
    }
...
void max7456RefreshAll(void)
{
    if (!max7456Lock) {
        ...
        max7456Lock = 
# 713 "./src/main/drivers/max7456.c" 3 4
                     1
# 713 "./src/main/drivers/max7456.c"
                         ;
        ...
        max7456Lock = 
# 718 "./src/main/drivers/max7456.c" 3 4
                     0
...
void max7456WriteNvm(uint8_t char_address, const uint8_t *font_data)
{
    ...
    while (max7456Lock);
    max7456Lock = 
# 728 "./src/main/drivers/max7456.c" 3 4
                 1
# 728 "./src/main/drivers/max7456.c"
                     ;

    {spiSetDivisor((busdev)->busdev_u.spi.instance, max7456SpiClock);IOLo((busdev)->busdev_u.spi.csnPin);};

    fontIsLoading = 
# 732 "./src/main/drivers/max7456.c" 3 4
                   1
# 732 "./src/main/drivers/max7456.c"
                       ;
    max7456Send(0x00, 0);
    ...
    max7456Lock = 
# 757 "./src/main/drivers/max7456.c" 3 4
                 0
# 757 "./src/main/drivers/max7456.c"
                      ;
}
...
void max7456HardwareReset(void)
{
# 779 "./src/main/drivers/max7456.c"
}
