...
# 43 "./src/main/drivers/exti.h"
                             enable);
# 33 "./src/main/drivers/bus_spi.c" 2
...
# 34 "./src/main/drivers/bus_spi.c" 2
...
# 35 "./src/main/drivers/bus_spi.c" 2
...
SPI_TypeDef *spiInstanceByDevice(SPIDevice device)
{
    if (device >= 3) {
        return 
# 66 "./src/main/drivers/bus_spi.c" 3 4
              ((void *)0)
...
# 72 "./src/main/drivers/bus_spi.c" 3 4
_Bool 
# 72 "./src/main/drivers/bus_spi.c"
    spiInit(SPIDevice device)
{
    switch (device) {
    case SPIINVALID:
        return 
# 76 "./src/main/drivers/bus_spi.c" 3 4
              0
# 76 "./src/main/drivers/bus_spi.c"
                   ;
    case SPIDEV_1:

        spiInitDevice(device);
        return 
# 80 "./src/main/drivers/bus_spi.c" 3 4
              1
# 80 "./src/main/drivers/bus_spi.c"
                  ;
    ...
    case SPIDEV_2:
        ...
        spiInitDevice(device);
        return 
# 87 "./src/main/drivers/bus_spi.c" 3 4
              1
# 87 "./src/main/drivers/bus_spi.c"
                  ;
    ...
    case SPIDEV_3:
        ...
        spiInitDevice(device);
        return 
# 94 "./src/main/drivers/bus_spi.c" 3 4
              1
# 94 "./src/main/drivers/bus_spi.c"
                  ;
    ...
    return 
# 106 "./src/main/drivers/bus_spi.c" 3 4
          0
# 106 "./src/main/drivers/bus_spi.c"
               ;
}
...
# 119 "./src/main/drivers/bus_spi.c" 3 4
_Bool 
# 119 "./src/main/drivers/bus_spi.c"
    spiBusTransfer(const busDevice_t *bus, const uint8_t *txData, uint8_t *rxData, int length)
{
    ...
    return 
# 124 "./src/main/drivers/bus_spi.c" 3 4
          1
# 124 "./src/main/drivers/bus_spi.c"
              ;
}
...
# 144 "./src/main/drivers/bus_spi.c" 3 4
_Bool 
# 144 "./src/main/drivers/bus_spi.c"
    spiBusWriteRegister(const busDevice_t *bus, uint8_t reg, uint8_t data)
{
    IOLo(bus->busdev_u.spi.csnPin);
...
# 154 "./src/main/drivers/bus_spi.c" 3 4
_Bool 
# 154 "./src/main/drivers/bus_spi.c"
    spiBusReadRegisterBuffer(const busDevice_t *bus, uint8_t reg, uint8_t *data, uint8_t length)
{
    IOLo(bus->busdev_u.spi.csnPin);
...
# 158 "./src/main/drivers/bus_spi.c"
    ...
    return 
# 161 "./src/main/drivers/bus_spi.c" 3 4
          1
# 161 "./src/main/drivers/bus_spi.c"
              ;
}
...
uint8_t spiBusReadRegister(const busDevice_t *bus, uint8_t reg)
{
    ...
    spiTransferByte(bus->busdev_u.spi.instance, reg | 0x80);
    spiTransfer(bus->busdev_u.spi.instance, 
# 169 "./src/main/drivers/bus_spi.c" 3 4
                                           ((void *)0)
# 169 "./src/main/drivers/bus_spi.c"
                                               , &data, 1);
    IOHi(bus->busdev_u.spi.csnPin);
