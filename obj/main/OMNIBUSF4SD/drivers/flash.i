...
# 28 "./src/main/drivers/flash_impl.h" 2
...
# 45 "./src/main/drivers/flash.c" 3 4
_Bool 
# 45 "./src/main/drivers/flash.c"
    flashInit(const flashConfig_t *flashConfig)
{
    busdev = &busInstance;
    ...
    if (flashConfig->csTag) {
        ...
        return 
# 52 "./src/main/drivers/flash.c" 3 4
              0
# 52 "./src/main/drivers/flash.c"
                   ;
    }

    if (!IOIsFreeOrPreinit(busdev->busdev_u.spi.csnPin)) {
        return 
# 56 "./src/main/drivers/flash.c" 3 4
              0
# 56 "./src/main/drivers/flash.c"
                   ;
    }

    busdev->bustype = BUSTYPE_SPI;
    spiBusSetInstance(busdev, spiInstanceByDevice(((flashConfig->spiDevice) - 1)));
    ...
    if (m25p16_detect(&flashDevice, chipID)) {
        return 
# 92 "./src/main/drivers/flash.c" 3 4
              1
# 92 "./src/main/drivers/flash.c"
                  ;
    }
    ...
    if (w25m_detect(&flashDevice, chipID)) {
        return 
# 98 "./src/main/drivers/flash.c" 3 4
              1
# 98 "./src/main/drivers/flash.c"
                  ;
    }
    ...
    return 
# 104 "./src/main/drivers/flash.c" 3 4
          0
# 104 "./src/main/drivers/flash.c"
               ;
}


# 107 "./src/main/drivers/flash.c" 3 4
_Bool 
# 107 "./src/main/drivers/flash.c"
    flashIsReady(void)
{
...
# 112 "./src/main/drivers/flash.c" 3 4
_Bool 
# 112 "./src/main/drivers/flash.c"
    flashWaitForReady(uint32_t timeoutMillis)
{
