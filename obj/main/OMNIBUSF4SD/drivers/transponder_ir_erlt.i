...
# 1 "<command-line>"
# 1 "./src/main/drivers/transponder_ir_erlt.c"
# 21 "./src/main/drivers/transponder_ir_erlt.c"
...
# 24 "./src/main/drivers/transponder_ir_erlt.c" 2
...
# 25 "./src/main/drivers/transponder_ir_erlt.c" 2
...
# 29 "./src/main/drivers/transponder_ir_erlt.c" 2
...
# 30 "./src/main/drivers/transponder_ir_erlt.c" 2
...
void transponderIrInitERLT(transponder_t *transponder){
    transponder->dma_buffer_size = 200;
    transponder->vTable = &erltTansponderVTable;
    transponder->timer_hz = 18;
    transponder->timer_carrier_hz = 38000;
...
void updateTransponderDMABufferERLT(transponder_t *transponder, const uint8_t* transponderData)
{
    ...
    addBitToBuffer(transponder, 10, transponder->bitToggleOne);


    addBitToBuffer(transponder, 10, 0);
    ...
    for (int i = 5; i >= 0; i--)
    {
        ...
        paritysum += bv;
        addBitToBuffer(transponder, (bv ? 25 : 10), ((i % 2) ? transponder->bitToggleOne : 0));
    }


    addBitToBuffer(transponder, ((paritysum % 2) ? 25 : 10), transponder->bitToggleOne);


    transponder->transponderIrDMABuffer.erlt[dmaBufferOffset++] = 0;
