...
# 1 "<command-line>"
# 1 "./src/main/drivers/serial_uart_stm32f4xx.c"
# 25 "./src/main/drivers/serial_uart_stm32f4xx.c"
...
# 29 "./src/main/drivers/serial_uart_stm32f4xx.c" 2
...
# 33 "./src/main/drivers/serial_uart_stm32f4xx.c" 2
# 1 "./src/main/drivers/nvic.h" 1
# 21 "./src/main/drivers/nvic.h"
       
# 34 "./src/main/drivers/serial_uart_stm32f4xx.c" 2
...
# 35 "./src/main/drivers/serial_uart_stm32f4xx.c" 2
...
# 37 "./src/main/drivers/serial_uart_stm32f4xx.c" 2
...
# 38 "./src/main/drivers/serial_uart_stm32f4xx.c" 2
# 1 "./src/main/drivers/serial_uart_impl.h" 1
# 21 "./src/main/drivers/serial_uart_impl.h"
       
# 117 "./src/main/drivers/serial_uart_impl.h"
...
# 39 "./src/main/drivers/serial_uart_stm32f4xx.c" 2



const uartHardware_t uartHardware[(1 + 0 + 1 + 0 + 0 + 1 + 0 + 0)] = {

    {
        .device = UARTDEV_1,
        .reg = ((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1000)),
        ...
        .rxPins = { ((ioTag_t)((((0) + 1) << 4) | (10))), ((ioTag_t)((((1) + 1) << 4) | (7))), 0 },
        .txPins = { ((ioTag_t)((((0) + 1) << 4) | (9))), ((ioTag_t)((((1) + 1) << 4) | (6))), 0 },
        .af = ((uint8_t)0x07),
...
# 86 "./src/main/drivers/serial_uart_stm32f4xx.c"
    {
        .device = UARTDEV_3,
        .reg = ((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800)),
        .DMAChannel = ((uint32_t)0x08000000),
        ...
        .rxPins = { ((ioTag_t)((((1) + 1) << 4) | (11))), ((ioTag_t)((((2) + 1) << 4) | (11))), 0 },
        .txPins = { ((ioTag_t)((((1) + 1) << 4) | (10))), ((ioTag_t)((((2) + 1) << 4) | (10))), 0 },
        .af = ((uint8_t)0x07),
...
# 149 "./src/main/drivers/serial_uart_stm32f4xx.c"
    {
        .device = UARTDEV_6,
        .reg = ((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1400)),
        ...
        .rxPins = { ((ioTag_t)((((2) + 1) << 4) | (7))), 0, 0 },
        .txPins = { ((ioTag_t)((((2) + 1) << 4) | (6))), 0, 0 },
        .af = ((uint8_t)0x08),
...
void dmaIRQHandler(dmaChannelDescriptor_t* descriptor)
{
    ...
    if ((descriptor->flagsShift > 31 ? descriptor->dma->HISR & (((uint32_t)0x00000020) << (descriptor->flagsShift - 32)): descriptor->dma->LISR & (((uint32_t)0x00000020) << descriptor->flagsShift)))
    {
        ...
        if (descriptor->flagsShift > 31) descriptor->dma->HIFCR = (((uint32_t)0x00000010) << (descriptor->flagsShift - 32)); else descriptor->dma->LIFCR = (((uint32_t)0x00000010) << descriptor->flagsShift);
        if ((descriptor->flagsShift > 31 ? descriptor->dma->HISR & (((uint32_t)0x00000001) << (descriptor->flagsShift - 32)): descriptor->dma->LISR & (((uint32_t)0x00000001) << descriptor->flagsShift)))
        {
            if (descriptor->flagsShift > 31) descriptor->dma->HIFCR = (((uint32_t)0x00000001) << (descriptor->flagsShift - 32)); else descriptor->dma->LIFCR = (((uint32_t)0x00000001) << descriptor->flagsShift);
        }
        handleUsartTxDma(s);
    }
    if ((descriptor->flagsShift > 31 ? descriptor->dma->HISR & (((uint32_t)0x00000008) << (descriptor->flagsShift - 32)): descriptor->dma->LISR & (((uint32_t)0x00000008) << descriptor->flagsShift)))
    {
        if (descriptor->flagsShift > 31) descriptor->dma->HIFCR = (((uint32_t)0x00000008) << (descriptor->flagsShift - 32)); else descriptor->dma->LIFCR = (((uint32_t)0x00000008) << descriptor->flagsShift);
    }
    if ((descriptor->flagsShift > 31 ? descriptor->dma->HISR & (((uint32_t)0x00000004) << (descriptor->flagsShift - 32)): descriptor->dma->LISR & (((uint32_t)0x00000004) << descriptor->flagsShift)))
    {
        if (descriptor->flagsShift > 31) descriptor->dma->HIFCR = (((uint32_t)0x00000004) << (descriptor->flagsShift - 32)); else descriptor->dma->LIFCR = (((uint32_t)0x00000004) << descriptor->flagsShift);
    }
}
...
uartPort_t *serialUART(UARTDevice_e device, uint32_t baudRate, portMode_e mode, portOptions_e options)
{
    ...
    if (!uart) return 
# 203 "./src/main/drivers/serial_uart_stm32f4xx.c" 3 4
                     ((void *)0)
# 203 "./src/main/drivers/serial_uart_stm32f4xx.c"
                         ;

    const uartHardware_t *hardware = uart->hardware;

    if (!hardware) return 
# 207 "./src/main/drivers/serial_uart_stm32f4xx.c" 3 4
                         ((void *)0)
# 207 "./src/main/drivers/serial_uart_stm32f4xx.c"
                             ;
    ...
    if (hardware->rxDMAStream) {
        dmaInit(dmaGetIdentifier(hardware->rxDMAStream), OWNER_SERIAL_RX, (device + 1));
    ...
    if (options & SERIAL_BIDIR) {
        IOInit(txIO, OWNER_SERIAL_TX, (device + 1));
        IOConfigGPIOAF(txIO, (options & SERIAL_BIDIR_PP) ? ((GPIO_Mode_AF) | ((0) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)) : ((GPIO_Mode_AF) | ((0) << 2) | ((GPIO_OType_OD) << 4) | ((GPIO_PuPd_NOPULL) << 5)), hardware->af);
    } else {
        if ((mode & MODE_TX) && txIO) {
            IOInit(txIO, OWNER_SERIAL_TX, (device + 1));
            IOConfigGPIOAF(txIO, ((GPIO_Mode_AF) | ((0) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_UP) << 5)), hardware->af);
        }

        if ((mode & MODE_RX) && rxIO) {
            IOInit(rxIO, OWNER_SERIAL_RX, (device + 1));
            IOConfigGPIOAF(rxIO, ((GPIO_Mode_AF) | ((0) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_UP) << 5)), hardware->af);
        }
    }
