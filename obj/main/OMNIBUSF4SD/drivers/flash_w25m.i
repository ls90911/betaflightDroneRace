...
# 30 "./src/main/drivers/flash_w25m.c" 2
...
# 32 "./src/main/drivers/flash_w25m.c" 2
...
# 34 "./src/main/drivers/flash_w25m.c" 2
...
# 38 "./src/main/drivers/flash_w25m.c" 2
...
# 39 "./src/main/drivers/flash_w25m.c" 2
...
# 40 "./src/main/drivers/flash_w25m.c" 2
...
# 41 "./src/main/drivers/flash_w25m.c" 2
...
# 43 "./src/main/drivers/flash_w25m.c" 2
...
# 45 "./src/main/drivers/flash_w25m.c" 2
# 1 "./src/main/drivers/flash_w25m.h" 1
# 21 "./src/main/drivers/flash_w25m.h"
       




# 25 "./src/main/drivers/flash_w25m.h" 3 4
_Bool 
# 25 "./src/main/drivers/flash_w25m.h"
    w25m_detect(flashDevice_t *fdevice, uint32_t chipID);
# 46 "./src/main/drivers/flash_w25m.c" 2
...
static flashDevice_t dieDevice[2];
...
static void w25m_dieSelect(busDevice_t *busdev, int die)
{
    ...
    uint8_t command[2] = { 0xC2, die };

    spiBusTransfer(busdev, command, 
# 72 "./src/main/drivers/flash_w25m.c" 3 4
                                   ((void *)0)
# 72 "./src/main/drivers/flash_w25m.c"
                                       , 2);
...
static 
# 77 "./src/main/drivers/flash_w25m.c" 3 4
      _Bool 
# 77 "./src/main/drivers/flash_w25m.c"
           w25m_isReady(flashDevice_t *fdevice)
{
    (void)(fdevice);
    ...
    for (int die = 0 ; die < dieCount ; die++) {
        if (dieDevice[die].couldBeBusy) {
            ...
            if (!dieDevice[die].vTable->isReady(&dieDevice[die])) {
                return 
# 85 "./src/main/drivers/flash_w25m.c" 3 4
                      0
# 85 "./src/main/drivers/flash_w25m.c"
                           ;
            }
        }
    }
    ...
    return 
# 90 "./src/main/drivers/flash_w25m.c" 3 4
          1
# 90 "./src/main/drivers/flash_w25m.c"
              ;
}

static 
# 93 "./src/main/drivers/flash_w25m.c" 3 4
      _Bool 
# 93 "./src/main/drivers/flash_w25m.c"
           w25m_waitForReady(flashDevice_t *fdevice, uint32_t timeoutMillis)
{
    uint32_t time = millis();
    while (!w25m_isReady(fdevice)) {
        if (millis() - time > timeoutMillis) {
            return 
# 98 "./src/main/drivers/flash_w25m.c" 3 4
                  0
# 98 "./src/main/drivers/flash_w25m.c"
                       ;
        }
    }

    return 
# 102 "./src/main/drivers/flash_w25m.c" 3 4
          1
# 102 "./src/main/drivers/flash_w25m.c"
              ;
}


# 105 "./src/main/drivers/flash_w25m.c" 3 4
_Bool 
# 105 "./src/main/drivers/flash_w25m.c"
    w25m_detect(flashDevice_t *fdevice, uint32_t chipID)
{
    ...
    case 0xEF7119:
        ...
        for (int die = 0 ; die < dieCount ; die++) {
            ...
            m25p16_detect(&dieDevice[die], 0xEF4019);
        }
    ...
    default:
        ...
        return 
# 128 "./src/main/drivers/flash_w25m.c" 3 4
              0
# 128 "./src/main/drivers/flash_w25m.c"
                   ;
    }
    ...
    return 
# 139 "./src/main/drivers/flash_w25m.c" 3 4
          1
# 139 "./src/main/drivers/flash_w25m.c"
              ;
}
...
int w25m_readBytes(flashDevice_t *fdevice, uint32_t address, uint8_t *buffer, int length)
{
    ...
    for (rlen = length; rlen; rlen -= tlen) {
        ...
        tlen = __extension__ ({ __typeof__ (dieAddress + rlen) _a = (dieAddress + rlen); __typeof__ (dieSize) _b = (dieSize); _a < _b ? _a : _b; }) - dieAddress;
