...
# 1 "<command-line>"
# 1 "./src/main/drivers/inverter.c"
# 21 "./src/main/drivers/inverter.c"
...
# 23 "./src/main/drivers/inverter.c" 2
...
# 25 "./src/main/drivers/inverter.c" 2
...
# 27 "./src/main/drivers/inverter.c" 2
...
# 32 "./src/main/drivers/inverter.c" 2
...
# 31 "./src/main/drivers/inverter.h"
                                               on);
# 34 "./src/main/drivers/inverter.c" 2
...
# 39 "./src/main/drivers/inverter.c" 3 4
                                       _Bool 
# 39 "./src/main/drivers/inverter.c"
                                            on)
{
...
# 57 "./src/main/drivers/inverter.c" 3 4
                               0
# 57 "./src/main/drivers/inverter.c"
                                    );
    }
}
...
# 86 "./src/main/drivers/inverter.c"
    initInverter(SERIAL_PORT_USART6);

}

void enableInverter(USART_TypeDef *USARTx, 
# 90 "./src/main/drivers/inverter.c" 3 4
                                          _Bool 
# 90 "./src/main/drivers/inverter.c"
                                               on)
{
...
# 107 "./src/main/drivers/inverter.c"
    if (USARTx == ((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800))) {
        identifier = SERIAL_PORT_USART3;
    }
# 125 "./src/main/drivers/inverter.c"
