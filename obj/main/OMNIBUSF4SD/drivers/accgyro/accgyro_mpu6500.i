...
# 24 "./src/main/drivers/accgyro/accgyro_mpu6500.c" 2
...
# 37 "./src/main/drivers/accgyro/accgyro_mpu6500.c" 2
...
# 43 "./src/main/drivers/accgyro/accgyro_mpu6500.c" 3 4
_Bool 
# 43 "./src/main/drivers/accgyro/accgyro_mpu6500.c"
    mpu6500AccDetect(accDev_t *acc)
{
    if (acc->mpuDetectionResult.sensor != MPU_65xx_I2C) {
        return 
# 46 "./src/main/drivers/accgyro/accgyro_mpu6500.c" 3 4
              0
# 46 "./src/main/drivers/accgyro/accgyro_mpu6500.c"
                   ;
    }
...
void mpu6500GyroInit(gyroDev_t *gyro)
{
    ...
    busWriteRegister(&gyro->bus, 0x6B, (0x80));
    delay(100);
    busWriteRegister(&gyro->bus, 0x68, 0x07);
    delay(100);
    busWriteRegister(&gyro->bus, 0x6B, 0);
    delay(100);
    busWriteRegister(&gyro->bus, 0x6B, INV_CLK_PLL);
    delay(15);
    busWriteRegister(&gyro->bus, 0x1B, gyro_range << 3 | mpuGyroFCHOICE(gyro));
    delay(15);
    busWriteRegister(&gyro->bus, 0x1C, accel_range << 3);
    delay(15);
    busWriteRegister(&gyro->bus, 0x1A, mpuGyroDLPF(gyro));
    delay(15);
    busWriteRegister(&gyro->bus, 0x19, gyro->mpuDividerDrops);
    delay(100);
    ...
    busWriteRegister(&gyro->bus, 0x37, (1 << 4));

    delay(15);


    busWriteRegister(&gyro->bus, 0x38, (1 << 0));

    delay(15);
}


# 98 "./src/main/drivers/accgyro/accgyro_mpu6500.c" 3 4
_Bool 
# 98 "./src/main/drivers/accgyro/accgyro_mpu6500.c"
    mpu6500GyroDetect(gyroDev_t *gyro)
{
...
# 101 "./src/main/drivers/accgyro/accgyro_mpu6500.c"
    ...
    return 
# 110 "./src/main/drivers/accgyro/accgyro_mpu6500.c" 3 4
          1
# 110 "./src/main/drivers/accgyro/accgyro_mpu6500.c"
              ;
}
