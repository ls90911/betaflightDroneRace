...
ADCDevice adcDeviceByInstance(ADC_TypeDef *instance)
{
    ...
    if (instance == ((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2100))) {
        return ADCDEV_2;
    }

    if (instance == ((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2200))) {
        return ADCDEV_3;
    }
# 82 "./src/main/drivers/adc.c"
    return ADCINVALID;
}

uint16_t adcGetChannel(uint8_t channel)
{
# 101 "./src/main/drivers/adc.c"
    ...
    adcVerifyPin(ioTag_t tag, ADCDevice device)
{
    if (!tag) {
        return 
# 109 "./src/main/drivers/adc.c" 3 4
              0
# 109 "./src/main/drivers/adc.c"
                   ;
    }
    ...
    for (int map = 0 ; map < 16 ; map++) {
        ...
        if ((adcTagMap[map].tag == tag) && (adcTagMap[map].devices & (1 << device))) {
            return 
# 120 "./src/main/drivers/adc.c" 3 4
                  1
# 120 "./src/main/drivers/adc.c"
                      ;
        }
    ...
    return 
# 125 "./src/main/drivers/adc.c" 3 4
          0
# 125 "./src/main/drivers/adc.c"
               ;
}
