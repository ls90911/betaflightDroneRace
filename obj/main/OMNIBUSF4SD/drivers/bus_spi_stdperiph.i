...
# 24 "./src/main/drivers/bus_spi_stdperiph.c" 2
...
# 26 "./src/main/drivers/bus_spi_stdperiph.c" 2
...
# 43 "./src/main/drivers/exti.h"
                             enable);
# 33 "./src/main/drivers/bus_spi_stdperiph.c" 2
...
# 34 "./src/main/drivers/bus_spi_stdperiph.c" 2
...
# 35 "./src/main/drivers/bus_spi_stdperiph.c" 2
...
void spiInitDevice(SPIDevice device)
{
    ...
    if (spi->dev == ((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800))) {
        spi->leadingEdge = 
# 44 "./src/main/drivers/bus_spi_stdperiph.c" 3 4
                          1
# 44 "./src/main/drivers/bus_spi_stdperiph.c"
                              ;
    }
# 54 "./src/main/drivers/bus_spi_stdperiph.c"
...
# 74 "./src/main/drivers/bus_spi_stdperiph.c"
...
# 131 "./src/main/drivers/bus_spi_stdperiph.c" 3 4
_Bool 
# 131 "./src/main/drivers/bus_spi_stdperiph.c"
    spiIsBusBusy(SPI_TypeDef *instance)
{
...
# 141 "./src/main/drivers/bus_spi_stdperiph.c" 3 4
_Bool 
# 141 "./src/main/drivers/bus_spi_stdperiph.c"
    spiTransfer(SPI_TypeDef *instance, const uint8_t *txData, uint8_t *rxData, int len)
{
    uint16_t spiTimeout = 1000;
    ...
    return 
# 172 "./src/main/drivers/bus_spi_stdperiph.c" 3 4
          1
# 172 "./src/main/drivers/bus_spi_stdperiph.c"
              ;
}
...
void spiSetDivisor(SPI_TypeDef *instance, uint16_t divisor)
{
    ...
    if (instance == ((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800)) || instance == ((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00))) {
        divisor /= 2;
    }
