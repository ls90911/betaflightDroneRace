...
# 1 "<command-line>"
# 1 "./src/main/sensors/acceleration.c"
# 21 "./src/main/sensors/acceleration.c"
...
# 68 "./src/main/sensors/acceleration.c"
...
# 69 "./src/main/sensors/acceleration.c" 2
...
# 71 "./src/main/sensors/acceleration.c" 2
...
void mwDisarm(void);
# 72 "./src/main/sensors/acceleration.c" 2
...
# 74 "./src/main/sensors/acceleration.c" 2
...
# 76 "./src/main/sensors/acceleration.c" 2
...
# 77 "./src/main/sensors/acceleration.c" 2
...
extern 
# 93 "./src/main/sensors/acceleration.c" 3 4
      _Bool 
# 93 "./src/main/sensors/acceleration.c"
           AccInflightCalibrationMeasurementDone;
extern 
# 94 "./src/main/sensors/acceleration.c" 3 4
      _Bool 
# 94 "./src/main/sensors/acceleration.c"
...
# 131 "./src/main/sensors/acceleration.c" 3 4
   0
# 131 "./src/main/sensors/acceleration.c"
   , };
...
# 141 "./src/main/sensors/acceleration.c" 3 4
_Bool 
# 141 "./src/main/sensors/acceleration.c"
...
# 218 "./src/main/sensors/acceleration.c"
    case ACC_MPU6000:
        ...
        __attribute__ ((fallthrough));
# 241 "./src/main/sensors/acceleration.c"
    case ACC_MPU6500:
    case ACC_ICM20601:
    case ACC_ICM20602:
    case ACC_ICM20608G:
        ...
        __attribute__ ((fallthrough));
# 320 "./src/main/sensors/acceleration.c"
    default:
    case ACC_NONE:
    ...
    if (accHardware == ACC_NONE) {
        return 
# 334 "./src/main/sensors/acceleration.c" 3 4
              0
# 334 "./src/main/sensors/acceleration.c"
                   ;
    }
    ...
    return 
# 339 "./src/main/sensors/acceleration.c" 3 4
          1
# 339 "./src/main/sensors/acceleration.c"
              ;
}


# 342 "./src/main/sensors/acceleration.c" 3 4
_Bool 
# 342 "./src/main/sensors/acceleration.c"
...
# 357 "./src/main/sensors/acceleration.c"
    acc.dev.accAlign = ALIGN_DEFAULT;


    if (!accDetect(&acc.dev, accelerometerConfig()->acc_hardware)) {
        return 
# 361 "./src/main/sensors/acceleration.c" 3 4
              0
# 361 "./src/main/sensors/acceleration.c"
                   ;
    }
    acc.dev.acc_1G = 256;
    ...
    return 
# 389 "./src/main/sensors/acceleration.c" 3 4
          1
# 389 "./src/main/sensors/acceleration.c"
              ;
}
...
# 397 "./src/main/sensors/acceleration.c" 3 4
_Bool 
# 397 "./src/main/sensors/acceleration.c"
    accIsCalibrationComplete(void)
{
...
static 
# 402 "./src/main/sensors/acceleration.c" 3 4
      _Bool 
# 402 "./src/main/sensors/acceleration.c"
...
static 
# 407 "./src/main/sensors/acceleration.c" 3 4
      _Bool 
# 407 "./src/main/sensors/acceleration.c"
...
static void performInflightAccelerationCalibration(rollAndPitchTrims_t *rollAndPitchTrims)
{
    ...
    if (InflightcalibratingA > 0) {
        ...
        if (InflightcalibratingA == 1) {
            AccInflightCalibrationActive = 
# 472 "./src/main/sensors/acceleration.c" 3 4
                                          0
# 472 "./src/main/sensors/acceleration.c"
                                               ;
            AccInflightCalibrationMeasurementDone = 
# 473 "./src/main/sensors/acceleration.c" 3 4
                                                   1
# 473 "./src/main/sensors/acceleration.c"
                                                       ;
    ...
    if (AccInflightCalibrationSavetoEEProm) {
        AccInflightCalibrationSavetoEEProm = 
# 486 "./src/main/sensors/acceleration.c" 3 4
                                            0
# 486 "./src/main/sensors/acceleration.c"
                                                 ;
...
# 511 "./src/main/sensors/acceleration.c" 3 4
                                   1
# 511 "./src/main/sensors/acceleration.c"
                                       ;
...
# 542 "./src/main/sensors/acceleration.c" 3 4
_Bool 
# 542 "./src/main/sensors/acceleration.c"
    accGetAccumulationAverage(float *accumulationAverage)
{
    if (accumulatedMeasurementCount > 0) {
        ...
        return 
# 551 "./src/main/sensors/acceleration.c" 3 4
              1
# 551 "./src/main/sensors/acceleration.c"
                  ;
    } else {
        for (int axis = 0; axis < 3; axis++) {
        ...
        return 
# 556 "./src/main/sensors/acceleration.c" 3 4
              0
# 556 "./src/main/sensors/acceleration.c"
                   ;
    }
}
