...
# 24 "./src/main/sensors/esc_sensor.c" 2
...
# 26 "./src/main/sensors/esc_sensor.c" 2
...
# 30 "./src/main/sensors/esc_sensor.c" 2
...
# 32 "./src/main/sensors/esc_sensor.c" 2

# 1 "./src/main/pg/pg_ids.h" 1
# 21 "./src/main/pg/pg_ids.h"
       
# 34 "./src/main/sensors/esc_sensor.c" 2
...
# 39 "./src/main/sensors/esc_sensor.c" 2
...
# 41 "./src/main/sensors/esc_sensor.c" 2
...
# 24 "./src/main/sensors/esc_sensor.h" 2
...
# 43 "./src/main/sensors/esc_sensor.c" 2
...
# 45 "./src/main/sensors/esc_sensor.c" 2
...
# 47 "./src/main/sensors/esc_sensor.c" 2
...
# 49 "./src/main/sensors/esc_sensor.c" 2
# 69 "./src/main/sensors/esc_sensor.c"
...
const escSensorConfig_t pgResetTemplate_escSensorConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .halfDuplex = 0 }
 ...
 ;
# 83 "./src/main/sensors/esc_sensor.c"
enum {
...
# 113 "./src/main/sensors/esc_sensor.c" 3 4
                                    ((void *)0)
# 113 "./src/main/sensors/esc_sensor.c"
                                        ;
...
static 
# 122 "./src/main/sensors/esc_sensor.c" 3 4
      _Bool 
# 122 "./src/main/sensors/esc_sensor.c"
...
static 
# 139 "./src/main/sensors/esc_sensor.c" 3 4
      _Bool 
# 139 "./src/main/sensors/esc_sensor.c"
...
# 144 "./src/main/sensors/esc_sensor.c" 3 4
_Bool 
# 144 "./src/main/sensors/esc_sensor.c"
    isEscSensorActive(void)
{
    return escSensorPort != 
# 146 "./src/main/sensors/esc_sensor.c" 3 4
                           ((void *)0)
# 146 "./src/main/sensors/esc_sensor.c"
                               ;
}
...
escSensorData_t *getEscSensorData(uint8_t motorNumber)
{
    if (!feature(FEATURE_ESC_SENSOR)) {
        return 
# 152 "./src/main/sensors/esc_sensor.c" 3 4
              ((void *)0)
# 152 "./src/main/sensors/esc_sensor.c"
                  ;
    }
...
# 178 "./src/main/sensors/esc_sensor.c"
        ...
        return 
# 185 "./src/main/sensors/esc_sensor.c" 3 4
              ((void *)0)
# 185 "./src/main/sensors/esc_sensor.c"
                  ;
    }
}
...
# 204 "./src/main/sensors/esc_sensor.c" 3 4
_Bool 
# 204 "./src/main/sensors/esc_sensor.c"
    escSensorInit(void)
{
    serialPortConfig_t *portConfig = findSerialPortConfig(FUNCTION_ESC_SENSOR);
    if (!portConfig) {
        return 
# 208 "./src/main/sensors/esc_sensor.c" 3 4
              0
# 208 "./src/main/sensors/esc_sensor.c"
                   ;
    }
...
# 214 "./src/main/sensors/esc_sensor.c" 3 4
                                                                                                     ((void *)0)
# 214 "./src/main/sensors/esc_sensor.c"
    ...
    return escSensorPort != 
# 220 "./src/main/sensors/esc_sensor.c" 3 4
                           ((void *)0)
# 220 "./src/main/sensors/esc_sensor.c"
                               ;
}
...
static uint8_t decodeEscFrame(void)
{
    ...
    if (chksum == tlmsum) {
        ...
        combinedDataNeedsUpdate = 
# 263 "./src/main/sensors/esc_sensor.c" 3 4
                                 1
# 263 "./src/main/sensors/esc_sensor.c"
                                     ;

        frameStatus = ESC_SENSOR_FRAME_COMPLETE;

        {if (debugMode == (DEBUG_ESC_SENSOR_RPM)) {debug[(escSensorMotor)] = (calcEscRpm(escSensorData[escSensorMotor].rpm) / 10);}};
...
static void increaseDataAge(void)
{
    if (escSensorData[escSensorMotor].dataAge < 255) {
        ...
        combinedDataNeedsUpdate = 
# 281 "./src/main/sensors/esc_sensor.c" 3 4
                                 1
# 281 "./src/main/sensors/esc_sensor.c"
                                     ;
    }
}
...
# 314 "./src/main/sensors/esc_sensor.c" 3 4
                                     1
# 314 "./src/main/sensors/esc_sensor.c"
                                         ;
