...
# 25 "./src/main/sensors/adcinternal.c" 2
...
# 29 "./src/main/sensors/adcinternal.c" 2
...
# 33 "./src/main/sensors/adcinternal.c" 2
...
void adcInternalProcess(timeUs_t currentTimeUs)
{
    ...
    {if (debugMode == (DEBUG_CORE_TEMP)) {debug[(0)] = (coreTemperature);}};
