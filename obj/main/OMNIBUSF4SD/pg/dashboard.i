# 1 "./src/main/pg/dashboard.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/pg/dashboard.c"
# 21 "./src/main/pg/dashboard.c"
...
# 26 "./src/main/pg/dashboard.c" 2
# 1 "./src/main/pg/pg_ids.h" 1
# 21 "./src/main/pg/pg_ids.h"
       
# 27 "./src/main/pg/dashboard.c" 2
...
const dashboardConfig_t pgResetTemplate_dashboardConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .device = (((I2CDEV_2)) + 1), .address = 0x3C, }
