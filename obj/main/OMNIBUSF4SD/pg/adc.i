...
# 24 "./src/main/drivers/adc_impl.h" 2
...
# 26 "./src/main/drivers/adc_impl.h" 2
...
{
    adcConfig->device = ((adcDeviceByInstance(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2100)))) + 1);


    adcConfig->vbat.enabled = 
# 44 "./src/main/pg/adc.c" 3 4
                             1
# 44 "./src/main/pg/adc.c"
                                 ;
    adcConfig->vbat.ioTag = ((ioTag_t)((((2) + 1) << 4) | (2)));
# 54 "./src/main/pg/adc.c"
    adcConfig->current.enabled = 
# 54 "./src/main/pg/adc.c" 3 4
                                1
# 54 "./src/main/pg/adc.c"
                                    ;
    adcConfig->current.ioTag = ((ioTag_t)((((2) + 1) << 4) | (1)));



    adcConfig->rssi.enabled = 
# 59 "./src/main/pg/adc.c" 3 4
                             1
# 59 "./src/main/pg/adc.c"
                                 ;
    adcConfig->rssi.ioTag = ((ioTag_t)((((0) + 1) << 4) | (0)));
