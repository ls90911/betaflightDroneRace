...
# 38 "./src/main/pg/bus_i2c.c" 2
# 1 "./src/main/pg/pg_ids.h" 1
# 21 "./src/main/pg/pg_ids.h"
       
# 39 "./src/main/pg/bus_i2c.c" 2
...
# 41 "./src/main/pg/bus_i2c.c" 2

typedef struct i2cDefaultConfig_s {
    I2CDevice device;
    ioTag_t ioTagScl, ioTagSda;
    
# 45 "./src/main/pg/bus_i2c.c" 3 4
   _Bool 
# 45 "./src/main/pg/bus_i2c.c"
        overClock;
    
# 46 "./src/main/pg/bus_i2c.c" 3 4
   _Bool 
# 46 "./src/main/pg/bus_i2c.c"
        pullUp;
} i2cDefaultConfig_t;
...
static const i2cDefaultConfig_t i2cDefaultConfig[] = {
    ...
    { I2CDEV_2, 0, 0, 
# 54 "./src/main/pg/bus_i2c.c" 3 4
                                                   1
# 54 "./src/main/pg/bus_i2c.c"
                                                                 , 
# 54 "./src/main/pg/bus_i2c.c" 3 4
                                                                   0 
# 54 "./src/main/pg/bus_i2c.c"
    ...
    { I2CDEV_3, 0, 0, 
# 57 "./src/main/pg/bus_i2c.c" 3 4
                                                   1
# 57 "./src/main/pg/bus_i2c.c"
                                                                 , 
# 57 "./src/main/pg/bus_i2c.c" 3 4
                                                                   0 
# 57 "./src/main/pg/bus_i2c.c"
...
extern void pgResetFn_i2cConfig(i2cConfig_t *); i2cConfig_t i2cConfig_SystemArray[3]; i2cConfig_t i2cConfig_CopyArray[3]; extern const pgRegistry_t i2cConfig_Registry; const pgRegistry_t i2cConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 518 | (0 << 12), .size = (sizeof(i2cConfig_t) * 3) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&i2cConfig_SystemArray, .copy = (uint8_t*)&i2cConfig_CopyArray, .ptr = 0, .reset = {.fn = (pgResetFunc*)&pgResetFn_i2cConfig}, };
