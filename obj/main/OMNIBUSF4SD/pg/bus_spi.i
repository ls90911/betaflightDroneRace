...
const spiDefaultConfig_t spiDefaultConfig[] = {
    ...
    { SPIDEV_1, ((ioTag_t)((((0) + 1) << 4) | (5))), ((ioTag_t)((((0) + 1) << 4) | (6))), ((ioTag_t)((((0) + 1) << 4) | (7))) },


    { SPIDEV_2, ((ioTag_t)((((1) + 1) << 4) | (13))), ((ioTag_t)((((1) + 1) << 4) | (14))), ((ioTag_t)((((1) + 1) << 4) | (15))) },


    { SPIDEV_3, ((ioTag_t)((((2) + 1) << 4) | (10))), ((ioTag_t)((((2) + 1) << 4) | (11))), ((ioTag_t)((((2) + 1) << 4) | (12))) },
...
extern void pgResetFn_spiPinConfig(spiPinConfig_t *); spiPinConfig_t spiPinConfig_SystemArray[3]; spiPinConfig_t spiPinConfig_CopyArray[3]; extern const pgRegistry_t spiPinConfig_Registry; const pgRegistry_t spiPinConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 520 | (1 << 12), .size = (sizeof(spiPinConfig_t) * 3) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&spiPinConfig_SystemArray, .copy = (uint8_t*)&spiPinConfig_CopyArray, .ptr = 0, .reset = {.fn = (pgResetFunc*)&pgResetFn_spiPinConfig}, };
...
extern void pgResetFn_spiPreinitIPUConfig(spiCs_t *); spiCs_t spiPreinitIPUConfig_SystemArray[11]; spiCs_t spiPreinitIPUConfig_CopyArray[11]; extern const pgRegistry_t spiPreinitIPUConfig_Registry; const pgRegistry_t spiPreinitIPUConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 535 | (0 << 12), .size = (sizeof(spiCs_t) * 11) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&spiPreinitIPUConfig_SystemArray, .copy = (uint8_t*)&spiPreinitIPUConfig_CopyArray, .ptr = 0, .reset = {.fn = (pgResetFunc*)&pgResetFn_spiPreinitIPUConfig}, };
spiCs_t spiPreinitOPUConfig_SystemArray[2]; spiCs_t spiPreinitOPUConfig_CopyArray[2]; extern const pgRegistry_t spiPreinitOPUConfig_Registry; const pgRegistry_t spiPreinitOPUConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 536 | (0 << 12), .size = (sizeof(spiCs_t) * 2) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&spiPreinitOPUConfig_SystemArray, .copy = (uint8_t*)&spiPreinitOPUConfig_CopyArray, .ptr = 0, .reset = {.ptr = 0}, };





ioTag_t preinitIPUList[11] = {
    ...
    ((ioTag_t)((((0) + 1) << 4) | (4))),
# 102 "./src/main/pg/bus_spi.c"
    ((ioTag_t)((((1) + 1) << 4) | (12))),


    ((ioTag_t)((((1) + 1) << 4) | (3))),
# 123 "./src/main/pg/bus_spi.c"
    ((ioTag_t)((((1) + 1) << 4) | (12))),
