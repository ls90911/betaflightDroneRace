...
# 31 "./src/main/pg/beeper.c" 2

extern const beeperConfig_t pgResetTemplate_beeperConfig; beeperConfig_t beeperConfig_System; beeperConfig_t beeperConfig_Copy; extern const pgRegistry_t beeperConfig_Registry; const pgRegistry_t beeperConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 502 | (2 << 12), .size = sizeof(beeperConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&beeperConfig_System, .copy = (uint8_t*)&beeperConfig_Copy, .ptr = 0, .reset = {.ptr = (void*)&pgResetTemplate_beeperConfig}, };

const beeperConfig_t pgResetTemplate_beeperConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .dshotBeaconTone = 1, .dshotBeaconOffFlags = ( (1 << (BEEPER_RX_LOST - 1)) | (1 << (BEEPER_RX_SET - 1)) ), }
