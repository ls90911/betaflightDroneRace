...
{
    config->useDma = 
# 40 "./src/main/pg/sdcard.c" 3 4
                    0
# 40 "./src/main/pg/sdcard.c"
                         ;

    config->enabled = 1;
    config->device = spiDeviceByInstance(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800)));
    ...
    config->cardDetectTag = ((ioTag_t)((((1) + 1) << 4) | (7)));
    ...
    config->dmaIdentifier = (uint8_t)dmaGetIdentifier(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x070)));
