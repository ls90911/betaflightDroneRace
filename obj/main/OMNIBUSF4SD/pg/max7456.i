...
# 32 "./src/main/pg/max7456.c" 2

extern void pgResetFn_max7456Config(max7456Config_t *); max7456Config_t max7456Config_System; max7456Config_t max7456Config_Copy; extern const pgRegistry_t max7456Config_Registry; const pgRegistry_t max7456Config_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 524 | (0 << 12), .size = sizeof(max7456Config_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&max7456Config_System, .copy = (uint8_t*)&max7456Config_Copy, .ptr = 0, .reset = {.fn = (pgResetFunc*)&pgResetFn_max7456Config }, };

void pgResetFn_max7456Config(max7456Config_t *config)
{
    config->clockConfig = 1;
    config->csTag = ((ioTag_t)((((0) + 1) << 4) | (15)));
    config->spiDevice = ((spiDeviceByInstance(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)))) + 1);
}
