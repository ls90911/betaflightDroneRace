...
# 1 "<command-line>"
# 1 "./src/main/cms/cms_menu_builtin.c"
# 25 "./src/main/cms/cms_menu_builtin.c"
...
# 27 "./src/main/cms/cms_menu_builtin.c" 2
...
int toupper (int __c);
int isblank (int __c);
# 29 "./src/main/cms/cms_menu_builtin.c" 2
...
# 31 "./src/main/cms/cms_menu_builtin.c" 2
...
# 39 "./src/main/cms/cms_menu_builtin.c" 2
...
# 41 "./src/main/cms/cms_menu_builtin.c" 2
...
# 21 "./src/main/cms/cms_menu_vtx_rtc6705.h"
...
# 54 "./src/main/cms/cms_menu_builtin.c" 2
...
static char infoTargetName[] = "OMNIBUSF4SD";
...
static CMS_Menu menuInfo = {
    ...
    .onExit = 
# 95 "./src/main/cms/cms_menu_builtin.c" 3 4
             ((void *)0)
# 95 "./src/main/cms/cms_menu_builtin.c"
                 ,
...
{
    {"--- FEATURES ---", OME_Label, 
# 103 "./src/main/cms/cms_menu_builtin.c" 3 4
                                   ((void *)0)
# 103 "./src/main/cms/cms_menu_builtin.c"
                                       , 
# 103 "./src/main/cms/cms_menu_builtin.c" 3 4
                                         ((void *)0)
# 103 "./src/main/cms/cms_menu_builtin.c"
    ...
    {"BACK", OME_Back, 
# 123 "./src/main/cms/cms_menu_builtin.c" 3 4
                      ((void *)0)
# 123 "./src/main/cms/cms_menu_builtin.c"
                          , 
# 123 "./src/main/cms/cms_menu_builtin.c" 3 4
                            ((void *)0)
# 123 "./src/main/cms/cms_menu_builtin.c"
...
static CMS_Menu menuFeatures = {
    ...
    .onEnter = 
# 132 "./src/main/cms/cms_menu_builtin.c" 3 4
              ((void *)0)
# 132 "./src/main/cms/cms_menu_builtin.c"
                  ,
    .onExit = 
# 133 "./src/main/cms/cms_menu_builtin.c" 3 4
             ((void *)0)
# 133 "./src/main/cms/cms_menu_builtin.c"
                 ,
...
{
    {"-- MAIN --", OME_Label, 
# 141 "./src/main/cms/cms_menu_builtin.c" 3 4
                              ((void *)0)
# 141 "./src/main/cms/cms_menu_builtin.c"
                                  , 
# 141 "./src/main/cms/cms_menu_builtin.c" 3 4
                                    ((void *)0)
# 141 "./src/main/cms/cms_menu_builtin.c"
    ...
    {
# 157 "./src/main/cms/cms_menu_builtin.c" 3 4
    ((void *)0)
# 157 "./src/main/cms/cms_menu_builtin.c"
        ,OME_END, 
# 157 "./src/main/cms/cms_menu_builtin.c" 3 4
                  ((void *)0)
# 157 "./src/main/cms/cms_menu_builtin.c"
...
CMS_Menu menuMain = {
    ...
    .onEnter = 
# 165 "./src/main/cms/cms_menu_builtin.c" 3 4
              ((void *)0)
# 165 "./src/main/cms/cms_menu_builtin.c"
                  ,
    .onExit = 
# 166 "./src/main/cms/cms_menu_builtin.c" 3 4
             ((void *)0)
# 166 "./src/main/cms/cms_menu_builtin.c"
                 ,
