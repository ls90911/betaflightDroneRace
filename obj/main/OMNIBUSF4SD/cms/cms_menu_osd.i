...
# 1 "<command-line>"
# 1 "./src/main/cms/cms_menu_osd.c"
# 21 "./src/main/cms/cms_menu_osd.c"
...
int toupper (int __c);
int isblank (int __c);
# 25 "./src/main/cms/cms_menu_osd.c" 2
...
# 34 "./src/main/cms/cms_menu_osd.c" 2
...
# 39 "./src/main/cms/cms_menu_osd.c" 2
...
# 43 "./src/main/cms/cms_menu_osd.c" 2
...
# 44 "./src/main/cms/cms_menu_osd.c" 2
...
# 81 "./src/main/cms/cms_menu_osd.c" 3 4
                                       ((void *)0)
# 81 "./src/main/cms/cms_menu_osd.c"
...
# 82 "./src/main/cms/cms_menu_osd.c"
    ...
    {"GPS SPEED", OME_VISIBLE, 
# 84 "./src/main/cms/cms_menu_osd.c" 3 4
                                       ((void *)0)
# 84 "./src/main/cms/cms_menu_osd.c"
                                           , &osdConfig_item_pos[OSD_GPS_SPEED], 0},
    {"GPS SATS", OME_VISIBLE, 
# 85 "./src/main/cms/cms_menu_osd.c" 3 4
                                       ((void *)0)
# 85 "./src/main/cms/cms_menu_osd.c"
                                           , &osdConfig_item_pos[OSD_GPS_SATS], 0},
    {"GPS LAT", OME_VISIBLE, 
# 86 "./src/main/cms/cms_menu_osd.c" 3 4
                                       ((void *)0)
# 86 "./src/main/cms/cms_menu_osd.c"
                                           , &osdConfig_item_pos[OSD_GPS_LAT], 0},
    {"GPS LON", OME_VISIBLE, 
# 87 "./src/main/cms/cms_menu_osd.c" 3 4
                                       ((void *)0)
# 87 "./src/main/cms/cms_menu_osd.c"
                                           , &osdConfig_item_pos[OSD_GPS_LON], 0},
    {"HOME DIR", OME_VISIBLE, 
# 88 "./src/main/cms/cms_menu_osd.c" 3 4
                                       ((void *)0)
# 88 "./src/main/cms/cms_menu_osd.c"
                                           , &osdConfig_item_pos[OSD_HOME_DIR], 0},
    {"HOME DIST", OME_VISIBLE, 
# 89 "./src/main/cms/cms_menu_osd.c" 3 4
                                       ((void *)0)
# 89 "./src/main/cms/cms_menu_osd.c"
                                           , &osdConfig_item_pos[OSD_HOME_DIST], 0},
...
# 105 "./src/main/cms/cms_menu_osd.c"
                                           , &osdConfig_item_pos[OSD_G_FORCE], 0},
    {"BACK", OME_Back, 
...
# 147 "./src/main/cms/cms_menu_osd.c"
    ...
    {"MAIN BAT", OME_UINT16, 
# 148 "./src/main/cms/cms_menu_osd.c" 3 4
                            ((void *)0)
# 148 "./src/main/cms/cms_menu_osd.c"
...
# 150 "./src/main/cms/cms_menu_osd.c"
                                , 0},
    {
# 151 "./src/main/cms/cms_menu_osd.c" 3 4
    ((void *)0)
# 151 "./src/main/cms/cms_menu_osd.c"
        , OME_END, 
# 151 "./src/main/cms/cms_menu_osd.c" 3 4
                   ((void *)0)
# 151 "./src/main/cms/cms_menu_osd.c"
...
# 199 "./src/main/cms/cms_menu_osd.c"
    ...
    {"2 PREC", OME_TAB, 
# 200 "./src/main/cms/cms_menu_osd.c" 3 4
                                 ((void *)0)
# 200 "./src/main/cms/cms_menu_osd.c"
                                     , &(OSD_TAB_t){&timerPrecision[OSD_TIMER_2], OSD_TIMER_PREC_COUNT - 1, osdTimerPrecisionNames}, 0},
    {"2 ALARM", OME_UINT8, 
# 201 "./src/main/cms/cms_menu_osd.c" 3 4
                                 ((void *)0)
# 201 "./src/main/cms/cms_menu_osd.c"
                                     , &(OSD_UINT8_t){&timerAlarm[OSD_TIMER_2], 0, 0xFF, 1}, 0},
    {"BACK", OME_Back, 
# 202 "./src/main/cms/cms_menu_osd.c" 3 4
                      ((void *)0)
# 202 "./src/main/cms/cms_menu_osd.c"
                          , 
# 202 "./src/main/cms/cms_menu_osd.c" 3 4
                            ((void *)0)
# 202 "./src/main/cms/cms_menu_osd.c"
...
static 
# 218 "./src/main/cms/cms_menu_osd.c" 3 4
      _Bool 
# 218 "./src/main/cms/cms_menu_osd.c"
...
{
    {"---OSD---", OME_Label, 
# 249 "./src/main/cms/cms_menu_osd.c" 3 4
                                ((void *)0)
# 249 "./src/main/cms/cms_menu_osd.c"
                                    , 
# 249 "./src/main/cms/cms_menu_osd.c" 3 4
                                               ((void *)0)
# 249 "./src/main/cms/cms_menu_osd.c"
...
# 257 "./src/main/cms/cms_menu_osd.c"
    ...
    {"BRT WHITE", OME_UINT8, 
# 258 "./src/main/cms/cms_menu_osd.c" 3 4
                            ((void *)0)
# 258 "./src/main/cms/cms_menu_osd.c"
                                , &(OSD_UINT8_t){&displayPortProfileMax7456_whiteBrightness, 0, 3, 1}, 0},

    {"BACK", OME_Back, 
# 260 "./src/main/cms/cms_menu_osd.c" 3 4
                      ((void *)0)
# 260 "./src/main/cms/cms_menu_osd.c"
                          , 
# 260 "./src/main/cms/cms_menu_osd.c" 3 4
                            ((void *)0)
# 260 "./src/main/cms/cms_menu_osd.c"
