...
# 44 "./src/main/cms/cms.c" 2
# 1 "./src/main/cms/cms_menu_builtin.h" 1
# 21 "./src/main/cms/cms_menu_builtin.h"
...
# 24 "./src/main/cms/cms_menu_builtin.h" 2
...
# 29 "./src/main/io/rcdevice_cam.h" 2
...
# 89 "./src/main/cms/cms.c" 3 4
_Bool 
# 89 "./src/main/cms/cms.c"
    cmsDisplayPortRegister(displayPort_t *pDisplay)
{
    if (cmsDeviceCount == 4)
        return 
# 92 "./src/main/cms/cms.c" 3 4
              0
# 92 "./src/main/cms/cms.c"
                   ;

    cmsDisplayPorts[cmsDeviceCount++] = pDisplay;

    return 
# 96 "./src/main/cms/cms.c" 3 4
          1
# 96 "./src/main/cms/cms.c"
              ;
}
...
static displayPort_t *cmsDisplayPortSelectCurrent(void)
{
    if (cmsDeviceCount == 0)
        return 
# 102 "./src/main/cms/cms.c" 3 4
              ((void *)0)
# 102 "./src/main/cms/cms.c"
                  ;
...
static displayPort_t *cmsDisplayPortSelectNext(void)
{
    if (cmsDeviceCount == 0)
        return 
# 113 "./src/main/cms/cms.c" 3 4
              ((void *)0)
# 113 "./src/main/cms/cms.c"
                  ;
...
# 120 "./src/main/cms/cms.c" 3 4
_Bool 
# 120 "./src/main/cms/cms.c"
    cmsDisplayPortSelect(displayPort_t *instance)
{
    if (cmsDeviceCount == 0) {
        return 
# 123 "./src/main/cms/cms.c" 3 4
              0
# 123 "./src/main/cms/cms.c"
                   ;
    }
    for (int i = 0; i < cmsDeviceCount; i++) {
        if (cmsDisplayPortSelectNext() == instance) {
            return 
# 127 "./src/main/cms/cms.c" 3 4
                  1
# 127 "./src/main/cms/cms.c"
                      ;
        }
    }
    return 
# 130 "./src/main/cms/cms.c" 3 4
          0
# 130 "./src/main/cms/cms.c"
               ;
}
# 158 "./src/main/cms/cms.c"
static 
# 158 "./src/main/cms/cms.c" 3 4
      _Bool 
# 158 "./src/main/cms/cms.c"
              smallScreen;
...
# 164 "./src/main/cms/cms.c" 3 4
_Bool 
# 164 "./src/main/cms/cms.c"
    cmsInMenu = 
# 164 "./src/main/cms/cms.c" 3 4
                0
# 164 "./src/main/cms/cms.c"
...
# 513 "./src/main/cms/cms.c" 3 4
   _Bool 
# 513 "./src/main/cms/cms.c"
        drawPolled = 
# 513 "./src/main/cms/cms.c" 3 4
                     0
# 513 "./src/main/cms/cms.c"
    ...
    if (currentTimeUs > lastPolledUs + 100000) {
        drawPolled = 
# 517 "./src/main/cms/cms.c" 3 4
                    1
# 517 "./src/main/cms/cms.c"
                        ;
    ...
    if (pDisplay->cleared) {
        ...
        pDisplay->cleared = 
# 528 "./src/main/cms/cms.c" 3 4
                           0
# 528 "./src/main/cms/cms.c"
                                ;
    } else if (drawPolled) {
...
void cmsMenuOpen(void)
{
    if (!cmsInMenu) {
        ...
        if (!pCurrentDisplay)
            return;
        cmsInMenu = 
# 670 "./src/main/cms/cms.c" 3 4
                   1
# 670 "./src/main/cms/cms.c"
                       ;
    ...
    if ( pCurrentDisplay->cols < 18) {
      smallScreen = 
# 689 "./src/main/cms/cms.c" 3 4
                         1
# 689 "./src/main/cms/cms.c"
                             ;
      linesPerMenuItem = 2;
      leftMenuColumn = 0;
      ...
      smallScreen = 
# 695 "./src/main/cms/cms.c" 3 4
                         0
# 695 "./src/main/cms/cms.c"
                              ;
      linesPerMenuItem = 1;
      leftMenuColumn = 2;
...
# 729 "./src/main/cms/cms.c" 3 4
                                                ((void *)0)
# 729 "./src/main/cms/cms.c"
                                                    );
    ...
    cmsInMenu = 
# 738 "./src/main/cms/cms.c" 3 4
               0
# 738 "./src/main/cms/cms.c"
                    ;

    displayRelease(pDisplay);
    currentCtx.menu = 
# 741 "./src/main/cms/cms.c" 3 4
                     ((void *)0)
# 741 "./src/main/cms/cms.c"
                         ;
