...
# 1 "<command-line>"
# 1 "./src/main/cms/cms_menu_ledstrip.c"
# 21 "./src/main/cms/cms_menu_ledstrip.c"
...
# 23 "./src/main/cms/cms_menu_ledstrip.c" 2
...
int toupper (int __c);
int isblank (int __c);
# 25 "./src/main/cms/cms_menu_ledstrip.c" 2
...
# 27 "./src/main/cms/cms_menu_ledstrip.c" 2
...
# 37 "./src/main/cms/cms_menu_ledstrip.c" 2
...
static 
# 45 "./src/main/cms/cms_menu_ledstrip.c" 3 4
      _Bool 
# 45 "./src/main/cms/cms_menu_ledstrip.c"
           featureRead = 
# 45 "./src/main/cms/cms_menu_ledstrip.c" 3 4
                         0
# 45 "./src/main/cms/cms_menu_ledstrip.c"
...
static long cmsx_Ledstrip_FeatureRead(void)
{
    if (!featureRead) {
        ...
        featureRead = 
# 52 "./src/main/cms/cms_menu_ledstrip.c" 3 4
                     1
# 52 "./src/main/cms/cms_menu_ledstrip.c"
                         ;
    }
...
# 74 "./src/main/cms/cms_menu_ledstrip.c"
    ...
    { "BACK", OME_Back, 
# 76 "./src/main/cms/cms_menu_ledstrip.c" 3 4
                       ((void *)0)
# 76 "./src/main/cms/cms_menu_ledstrip.c"
                           , 
# 76 "./src/main/cms/cms_menu_ledstrip.c" 3 4
                             ((void *)0)
# 76 "./src/main/cms/cms_menu_ledstrip.c"
                                 , 0 },
    { 
# 77 "./src/main/cms/cms_menu_ledstrip.c" 3 4
     ((void *)0)
# 77 "./src/main/cms/cms_menu_ledstrip.c"
         , OME_END, 
# 77 "./src/main/cms/cms_menu_ledstrip.c" 3 4
                    ((void *)0)
# 77 "./src/main/cms/cms_menu_ledstrip.c"
