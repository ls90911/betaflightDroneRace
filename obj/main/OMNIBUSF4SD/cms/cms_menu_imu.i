...
# 1 "<command-line>"
# 1 "./src/main/cms/cms_menu_imu.c"
# 24 "./src/main/cms/cms_menu_imu.c"
...
int toupper (int __c);
int isblank (int __c);
# 28 "./src/main/cms/cms_menu_imu.c" 2
...
# 37 "./src/main/cms/cms_menu_imu.c" 2
...
# 46 "./src/main/cms/cms_menu_imu.c" 2
...
void mwDisarm(void);
# 48 "./src/main/cms/cms_menu_imu.c" 2
...
# 50 "./src/main/cms/cms_menu_imu.c" 2
...
# 52 "./src/main/cms/cms_menu_imu.c" 2
...
# 153 "./src/main/cms/cms_menu_imu.c"
    ...
    { "ROLL  I", OME_UINT8, 
# 154 "./src/main/cms/cms_menu_imu.c" 3 4
                           ((void *)0)
# 154 "./src/main/cms/cms_menu_imu.c"
...
# 156 "./src/main/cms/cms_menu_imu.c"
                                , &(OSD_UINT16_t){ &tempPidF[PID_ROLL], 0, 2000, 1 }, 0 },

    { "PITCH P", OME_UINT8, 
# 158 "./src/main/cms/cms_menu_imu.c" 3 4
                           ((void *)0)
# 158 "./src/main/cms/cms_menu_imu.c"
...
# 160 "./src/main/cms/cms_menu_imu.c"
    ...
    { "PITCH F", OME_UINT16, 
# 161 "./src/main/cms/cms_menu_imu.c" 3 4
                            ((void *)0)
# 161 "./src/main/cms/cms_menu_imu.c"
                                , &(OSD_UINT16_t){ &tempPidF[PID_PITCH], 0, 2000, 1 }, 0 },

    { "YAW   P", OME_UINT8, 
# 163 "./src/main/cms/cms_menu_imu.c" 3 4
                           ((void *)0)
# 163 "./src/main/cms/cms_menu_imu.c"
                               , &(OSD_UINT8_t){ &tempPid[PID_YAW][0], 0, 200, 1 }, 0 },
    { "YAW   I", OME_UINT8, 
# 164 "./src/main/cms/cms_menu_imu.c" 3 4
                           ((void *)0)
# 164 "./src/main/cms/cms_menu_imu.c"
                               , &(OSD_UINT8_t){ &tempPid[PID_YAW][1], 0, 200, 1 }, 0 },
    { "YAW   D", OME_UINT8, 
# 165 "./src/main/cms/cms_menu_imu.c" 3 4
                           ((void *)0)
# 165 "./src/main/cms/cms_menu_imu.c"
                               , &(OSD_UINT8_t){ &tempPid[PID_YAW][2], 0, 200, 1 }, 0 },
    { "YAW   F", OME_UINT16, 
# 166 "./src/main/cms/cms_menu_imu.c" 3 4
                            ((void *)0)
# 166 "./src/main/cms/cms_menu_imu.c"
                                , &(OSD_UINT16_t){ &tempPidF[PID_YAW], 0, 2000, 1 }, 0 },

    { "BACK", OME_Back, 
# 168 "./src/main/cms/cms_menu_imu.c" 3 4
                       ((void *)0)
# 168 "./src/main/cms/cms_menu_imu.c"
                           , 
# 168 "./src/main/cms/cms_menu_imu.c" 3 4
                             ((void *)0)
# 168 "./src/main/cms/cms_menu_imu.c"
                                 , 0 },
    { 
# 169 "./src/main/cms/cms_menu_imu.c" 3 4
     ((void *)0)
# 169 "./src/main/cms/cms_menu_imu.c"
         , OME_END, 
# 169 "./src/main/cms/cms_menu_imu.c" 3 4
                    ((void *)0)
# 169 "./src/main/cms/cms_menu_imu.c"
...
{
    { "-- RATE --", OME_Label, 
# 213 "./src/main/cms/cms_menu_imu.c" 3 4
                              ((void *)0)
# 213 "./src/main/cms/cms_menu_imu.c"
...
# 216 "./src/main/cms/cms_menu_imu.c"
    ...
    { "RC Y RATE", OME_FLOAT, 
# 217 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 217 "./src/main/cms/cms_menu_imu.c"
...
# 224 "./src/main/cms/cms_menu_imu.c"
    ...
    { "RC Y EXPO", OME_FLOAT, 
# 225 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 225 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_FLOAT_t) { &rateProfile.rcExpo[FD_YAW], 0, 100, 1, 10 }, 0 },

    { "THR MID", OME_UINT8, 
# 227 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 227 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_UINT8_t) { &rateProfile.thrMid8, 0, 100, 1}, 0 },
    { "THR EXPO", OME_UINT8, 
# 228 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 228 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_UINT8_t) { &rateProfile.thrExpo8, 0, 100, 1}, 0 },
    { "THRPID ATT", OME_FLOAT, 
# 229 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 229 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_FLOAT_t) { &rateProfile.dynThrPID, 0, 100, 1, 10}, 0 },
    { "TPA BRKPT", OME_UINT16, 
# 230 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 230 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_UINT16_t){ &rateProfile.tpa_breakpoint, 1000, 2000, 10}, 0 },

    { "BACK", OME_Back, 
# 232 "./src/main/cms/cms_menu_imu.c" 3 4
                       ((void *)0)
# 232 "./src/main/cms/cms_menu_imu.c"
                           , 
# 232 "./src/main/cms/cms_menu_imu.c" 3 4
                             ((void *)0)
# 232 "./src/main/cms/cms_menu_imu.c"
                                 , 0 },
    { 
# 233 "./src/main/cms/cms_menu_imu.c" 3 4
     ((void *)0)
# 233 "./src/main/cms/cms_menu_imu.c"
         , OME_END, 
# 233 "./src/main/cms/cms_menu_imu.c" 3 4
                    ((void *)0)
# 233 "./src/main/cms/cms_menu_imu.c"
...
static OSD_Entry cmsx_menuProfileOtherEntries[] = {
    { "-- OTHER PP --", OME_Label, 
# 295 "./src/main/cms/cms_menu_imu.c" 3 4
                                  ((void *)0)
# 295 "./src/main/cms/cms_menu_imu.c"
                                      , pidProfileIndexString, 0 },

    { "FF TRANS", OME_FLOAT, 
# 297 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 297 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_FLOAT_t) { &cmsx_feedForwardTransition, 0, 100, 1, 10 }, 0 },
    { "ANGLE STR", OME_UINT8, 
# 298 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 298 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_UINT8_t) { &cmsx_angleStrength, 0, 200, 1 } , 0 },
    { "HORZN STR", OME_UINT8, 
# 299 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 299 "./src/main/cms/cms_menu_imu.c"
...
# 300 "./src/main/cms/cms_menu_imu.c"
    ...
    { "AG GAIN", OME_UINT16, 
# 301 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 301 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_UINT16_t) { &cmsx_itermAcceleratorGain, 1000, 30000, 10 } , 0 },
    { "AG THR", OME_UINT16, 
# 302 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 302 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_UINT16_t) { &cmsx_itermThrottleThreshold, 20, 1000, 1 } , 0 },

    { "THR BOOST", OME_UINT8, 
# 304 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 304 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_UINT8_t) { &cmsx_throttleBoost, 0, 100, 1 } , 0 },
...
# 357 "./src/main/cms/cms_menu_imu.c" 3 4
                                     ((void *)0)
# 357 "./src/main/cms/cms_menu_imu.c"
                                         , 
# 357 "./src/main/cms/cms_menu_imu.c" 3 4
                                           ((void *)0)
# 357 "./src/main/cms/cms_menu_imu.c"
    ...
    { "GYRO LPF", OME_UINT16, 
# 359 "./src/main/cms/cms_menu_imu.c" 3 4
                               ((void *)0)
# 359 "./src/main/cms/cms_menu_imu.c"
                                   , &(OSD_UINT16_t) { &gyroConfig_gyro_lowpass_hz, 0, 16000, 1 }, 0 },

    { "GYRO LPF2", OME_UINT16, 
# 361 "./src/main/cms/cms_menu_imu.c" 3 4
                               ((void *)0)
# 361 "./src/main/cms/cms_menu_imu.c"
                                   , &(OSD_UINT16_t) { &gyroConfig_gyro_lowpass2_hz, 0, 16000, 1 }, 0 },

    { "GYRO NF1", OME_UINT16, 
# 363 "./src/main/cms/cms_menu_imu.c" 3 4
                               ((void *)0)
# 363 "./src/main/cms/cms_menu_imu.c"
                                   , &(OSD_UINT16_t) { &gyroConfig_gyro_soft_notch_hz_1, 0, 500, 1 }, 0 },
    { "GYRO NF1C", OME_UINT16, 
# 364 "./src/main/cms/cms_menu_imu.c" 3 4
                               ((void *)0)
# 364 "./src/main/cms/cms_menu_imu.c"
                                   , &(OSD_UINT16_t) { &gyroConfig_gyro_soft_notch_cutoff_1, 0, 500, 1 }, 0 },
    { "GYRO NF2", OME_UINT16, 
# 365 "./src/main/cms/cms_menu_imu.c" 3 4
                               ((void *)0)
# 365 "./src/main/cms/cms_menu_imu.c"
                                   , &(OSD_UINT16_t) { &gyroConfig_gyro_soft_notch_hz_2, 0, 500, 1 }, 0 },
    { "GYRO NF2C", OME_UINT16, 
# 366 "./src/main/cms/cms_menu_imu.c" 3 4
                               ((void *)0)
# 366 "./src/main/cms/cms_menu_imu.c"
                                   , &(OSD_UINT16_t) { &gyroConfig_gyro_soft_notch_cutoff_2, 0, 500, 1 }, 0 },

    { "BACK", OME_Back, 
# 368 "./src/main/cms/cms_menu_imu.c" 3 4
                       ((void *)0)
# 368 "./src/main/cms/cms_menu_imu.c"
                           , 
# 368 "./src/main/cms/cms_menu_imu.c" 3 4
                             ((void *)0)
# 368 "./src/main/cms/cms_menu_imu.c"
                                 , 0 },
    { 
# 369 "./src/main/cms/cms_menu_imu.c" 3 4
     ((void *)0)
# 369 "./src/main/cms/cms_menu_imu.c"
         , OME_END, 
# 369 "./src/main/cms/cms_menu_imu.c" 3 4
                    ((void *)0)
# 369 "./src/main/cms/cms_menu_imu.c"
...
# 420 "./src/main/cms/cms_menu_imu.c" 3 4
                               ((void *)0)
# 420 "./src/main/cms/cms_menu_imu.c"
                                   , &(OSD_UINT16_t){ &cmsx_dterm_lowpass_hz, 0, 500, 1 }, 0 },
    { "DTERM LPF2", OME_UINT16, 
# 421 "./src/main/cms/cms_menu_imu.c" 3 4
                               ((void *)0)
# 421 "./src/main/cms/cms_menu_imu.c"
                                   , &(OSD_UINT16_t){ &cmsx_dterm_lowpass2_hz, 0, 500, 1 }, 0 },
    { "DTERM NF", OME_UINT16, 
# 422 "./src/main/cms/cms_menu_imu.c" 3 4
                               ((void *)0)
# 422 "./src/main/cms/cms_menu_imu.c"
                                   , &(OSD_UINT16_t){ &cmsx_dterm_notch_hz, 0, 500, 1 }, 0 },
    { "DTERM NFCO", OME_UINT16, 
# 423 "./src/main/cms/cms_menu_imu.c" 3 4
                               ((void *)0)
# 423 "./src/main/cms/cms_menu_imu.c"
                                   , &(OSD_UINT16_t){ &cmsx_dterm_notch_cutoff, 0, 500, 1 }, 0 },
    { "YAW LPF", OME_UINT16, 
# 424 "./src/main/cms/cms_menu_imu.c" 3 4
                               ((void *)0)
# 424 "./src/main/cms/cms_menu_imu.c"
                                   , &(OSD_UINT16_t){ &cmsx_yaw_lowpass_hz, 0, 500, 1 }, 0 },
...
# 489 "./src/main/cms/cms_menu_imu.c" 3 4
                                      ((void *)0)
# 489 "./src/main/cms/cms_menu_imu.c"
                                          , 
# 489 "./src/main/cms/cms_menu_imu.c" 3 4
                                            ((void *)0)
# 489 "./src/main/cms/cms_menu_imu.c"
...
# 491 "./src/main/cms/cms_menu_imu.c" 3 4
                                        ((void *)0)
# 491 "./src/main/cms/cms_menu_imu.c"
                                            , &cmsx_PidProfileTable, 0 },
    { "COPY PP", OME_Funcall, cmsx_CopyPidProfile, 
# 492 "./src/main/cms/cms_menu_imu.c" 3 4
                                                                     ((void *)0)
# 492 "./src/main/cms/cms_menu_imu.c"
                                                                         , 0 },
    { "CPY RATE PROF TO", OME_TAB, 
# 493 "./src/main/cms/cms_menu_imu.c" 3 4
                                        ((void *)0)
# 493 "./src/main/cms/cms_menu_imu.c"
                                            , &cmsx_ControlRateProfileTable, 0 },
    { "COPY RP", OME_Funcall, cmsx_CopyControlRateProfile, 
# 494 "./src/main/cms/cms_menu_imu.c" 3 4
                                                                     ((void *)0)
# 494 "./src/main/cms/cms_menu_imu.c"
                                                                         , 0 },

    { "BACK", OME_Back, 
# 496 "./src/main/cms/cms_menu_imu.c" 3 4
                       ((void *)0)
# 496 "./src/main/cms/cms_menu_imu.c"
                           , 
# 496 "./src/main/cms/cms_menu_imu.c" 3 4
                             ((void *)0)
# 496 "./src/main/cms/cms_menu_imu.c"
                                 , 0 },
    { 
# 497 "./src/main/cms/cms_menu_imu.c" 3 4
     ((void *)0)
# 497 "./src/main/cms/cms_menu_imu.c"
         , OME_END, 
# 497 "./src/main/cms/cms_menu_imu.c" 3 4
                    ((void *)0)
# 497 "./src/main/cms/cms_menu_imu.c"
...
CMS_Menu cmsx_menuCopyProfile = {
    ...
    .onExit = 
# 506 "./src/main/cms/cms_menu_imu.c" 3 4
             ((void *)0)
# 506 "./src/main/cms/cms_menu_imu.c"
                 ,
...
{
    { "-- PROFILE --", OME_Label, 
# 514 "./src/main/cms/cms_menu_imu.c" 3 4
                                 ((void *)0)
# 514 "./src/main/cms/cms_menu_imu.c"
                                     , 
# 514 "./src/main/cms/cms_menu_imu.c" 3 4
                                       ((void *)0)
# 514 "./src/main/cms/cms_menu_imu.c"
    ...
    {"RATE PROF", OME_UINT8, cmsx_rateProfileIndexOnChange, &(OSD_UINT8_t){ &tmpRateProfileIndex, 1, 6, 1}, 0},
    ...
    {"BACK", OME_Back, 
# 529 "./src/main/cms/cms_menu_imu.c" 3 4
                      ((void *)0)
# 529 "./src/main/cms/cms_menu_imu.c"
                          , 
# 529 "./src/main/cms/cms_menu_imu.c" 3 4
                            ((void *)0)
# 529 "./src/main/cms/cms_menu_imu.c"
                                , 0},
    {
# 530 "./src/main/cms/cms_menu_imu.c" 3 4
    ((void *)0)
# 530 "./src/main/cms/cms_menu_imu.c"
        , OME_END, 
# 530 "./src/main/cms/cms_menu_imu.c" 3 4
                   ((void *)0)
# 530 "./src/main/cms/cms_menu_imu.c"
