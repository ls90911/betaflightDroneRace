...
# 82 "./src/main/fc/config.c" 3 4
1
# 82 "./src/main/fc/config.c"
, .cpu_overclock = 0, .powerOnArmingGraceTime = 5, .boardIdentifier = "OBSD" }
...
# 159 "./src/main/fc/config.c" 3 4
                                                                      ((void *)0)
# 159 "./src/main/fc/config.c"
                                                                          )
...
# 176 "./src/main/fc/config.c" 3 4
       1
# 176 "./src/main/fc/config.c"
           ) {
...
# 255 "./src/main/fc/config.c"
    ...
    if (rxConfigMutable()->rssi_channel
        ...
        rxConfigMutable()->rssi_src_frame_errors = 
# 263 "./src/main/fc/config.c" 3 4
                                                  0
# 263 "./src/main/fc/config.c"
                                                       ;
    }
...
# 367 "./src/main/fc/config.c"
    featureClear(FEATURE_RX_SPI);



    featureClear(FEATURE_SOFTSPI);
# 387 "./src/main/fc/config.c"
...
void validateAndFixGyroConfig(void)
{
    ...
    if (gyro.targetLooptime > (1000000 / (2000))) {
    ...
    if (gyroConfig()->gyro_hardware_lpf != 0 && gyroConfig()->gyro_hardware_lpf != 1) {
        pidConfigMutable()->pid_process_denom = 1;
        gyroConfigMutable()->gyro_sync_denom = 1;
        gyroConfigMutable()->gyro_use_32khz = 
# 433 "./src/main/fc/config.c" 3 4
                                             0
# 433 "./src/main/fc/config.c"
                                                  ;
    }
...
# 516 "./src/main/fc/config.c" 3 4
_Bool 
# 516 "./src/main/fc/config.c"
    readEEPROM(void)
{
...
# 523 "./src/main/fc/config.c" 3 4
   _Bool 
# 523 "./src/main/fc/config.c"
        success = loadEEPROM();
