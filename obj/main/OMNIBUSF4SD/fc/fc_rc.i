...
static 
# 58 "./src/main/fc/fc_rc.c" 3 4
      _Bool 
# 58 "./src/main/fc/fc_rc.c"
           reverseMotors = 
# 58 "./src/main/fc/fc_rc.c" 3 4
                           0
# 58 "./src/main/fc/fc_rc.c"
...
__attribute__ ((section(".fastram_bss"), aligned(4))) uint8_t interpolationChannels;
...
static void calculateSetpointRate(int axis)
{
    ...
    if ((axis == FD_YAW) && (flightModeFlags & (GPS_RESCUE_MODE))) {
...
{
    static __attribute__ ((section(".fastram_bss"), aligned(4))) float rcCommandInterp[4];
    static __attribute__ ((section(".fastram_bss"), aligned(4))) float rcStepSize[4];
    static __attribute__ ((section(".fastram_bss"), aligned(4))) int16_t rcInterpolationStepCount;
    ...
    if (rxConfig()->rcInterpolation) {
        ...
        if (isRXDataNew && rxRefreshRate > 0) {
            ...
            for (int channel = 0; channel < (THROTTLE + 1); channel++) {
           ...
           {if (debugMode == (DEBUG_RC_INTERPOLATION)) {debug[(0)] = (lrintf(rcCommand[0]));}};
           {if (debugMode == (DEBUG_RC_INTERPOLATION)) {debug[(1)] = (lrintf(currentRxRefreshRate / 1000));}};
        } else {
    ...
    {if (debugMode == (DEBUG_RC_INTERPOLATION)) {debug[(2)] = (rcInterpolationStepCount);}};
...
# 285 "./src/main/fc/fc_rc.c" 3 4
                                                                  _Bool 
# 285 "./src/main/fc/fc_rc.c"
                                                                       pt1)
{
...
# 302 "./src/main/fc/fc_rc.c" 3 4
         _Bool 
# 302 "./src/main/fc/fc_rc.c"
...
# 362 "./src/main/fc/fc_rc.c" 3 4
                                 (0xffff)
# 362 "./src/main/fc/fc_rc.c"
                                           ;
              ...
              rcSmoothingAccumulateSample(rcSmoothingFilter_t *smoothingData, int rxFrameTimeUs)
{
    ...
    if (smoothingData->training.count >= 50) {
        ...
        return 
# 380 "./src/main/fc/fc_rc.c" 3 4
              1
# 380 "./src/main/fc/fc_rc.c"
                  ;
    }
    return 
# 382 "./src/main/fc/fc_rc.c" 3 4
          0
# 382 "./src/main/fc/fc_rc.c"
               ;
}
...
# 387 "./src/main/fc/fc_rc.c" 3 4
                  _Bool 
# 387 "./src/main/fc/fc_rc.c"
                       rcSmoothingAutoCalculate(void)
{
    
# 389 "./src/main/fc/fc_rc.c" 3 4
   _Bool 
# 389 "./src/main/fc/fc_rc.c"
        ret = 
# 389 "./src/main/fc/fc_rc.c" 3 4
              0
# 389 "./src/main/fc/fc_rc.c"
    ...
    if (rxConfig()->rc_smoothing_input_cutoff == 0) {
        ret = 
# 393 "./src/main/fc/fc_rc.c" 3 4
             1
# 393 "./src/main/fc/fc_rc.c"
                 ;
    }
    ...
    if (rxConfig()->rc_smoothing_derivative_type != RC_SMOOTHING_DERIVATIVE_OFF) {
        if (rxConfig()->rc_smoothing_derivative_cutoff == 0) {
            ret = 
# 399 "./src/main/fc/fc_rc.c" 3 4
                 1
# 399 "./src/main/fc/fc_rc.c"
                     ;
        }
    }
    return ret;
...
# 409 "./src/main/fc/fc_rc.c" 3 4
                             _Bool 
# 409 "./src/main/fc/fc_rc.c"
                                  initialized;
    static __attribute__ ((section(".fastram_bss"), aligned(4))) timeMs_t validRxFrameTimeMs;
    static __attribute__ ((section(".fastram_bss"), aligned(4))) 
# 411 "./src/main/fc/fc_rc.c" 3 4
                             _Bool 
# 411 "./src/main/fc/fc_rc.c"
                                  calculateCutoffs;


    if (!initialized) {
        initialized = 
# 415 "./src/main/fc/fc_rc.c" 3 4
                     1
# 415 "./src/main/fc/fc_rc.c"
                         ;
        rcSmoothingData.filterInitialized = 
# 416 "./src/main/fc/fc_rc.c" 3 4
                                           0
# 416 "./src/main/fc/fc_rc.c"
                                                ;
        ...
        if (!calculateCutoffs) {
            ...
            rcSmoothingData.filterInitialized = 
# 431 "./src/main/fc/fc_rc.c" 3 4
                                               1
# 431 "./src/main/fc/fc_rc.c"
                                                   ;
        }
    }
...
# 464 "./src/main/fc/fc_rc.c" 3 4
                       _Bool 
# 464 "./src/main/fc/fc_rc.c"
                            accumulateSample = 
# 464 "./src/main/fc/fc_rc.c" 3 4
                                               1
# 464 "./src/main/fc/fc_rc.c"
                        ...
                        if (rcSmoothingData.filterInitialized) {
                            ...
                            if (percentChange < 20) {
                                ...
                                rcSmoothingResetAccumulation(&rcSmoothingData);
                                accumulateSample = 
# 474 "./src/main/fc/fc_rc.c" 3 4
                                                  0
# 474 "./src/main/fc/fc_rc.c"
                                                       ;
                            }
                        }
                        ...
                        if (accumulateSample) {
                            if (rcSmoothingAccumulateSample(&rcSmoothingData, currentRxRefreshRate)) {
                                ...
                                rcSmoothingSetFilterCutoffs(&rcSmoothingData);
                                rcSmoothingData.filterInitialized = 
# 483 "./src/main/fc/fc_rc.c" 3 4
                                                                   1
# 483 "./src/main/fc/fc_rc.c"
                                                                       ;
    ...
    if (rcSmoothingData.filterInitialized && (debugMode == DEBUG_RC_SMOOTHING)) {
        ...
        {if (debugMode == (DEBUG_RC_SMOOTHING)) {debug[(0)] = (lrintf(lastRxData[rxConfig()->rc_smoothing_debug_axis]));}};
 ...
 void processRcCommand(void)
{
    ...
    if (isRXDataNew || updatedChannel) {
        ...
        {if (debugMode == (DEBUG_RC_INTERPOLATION)) {debug[(3)] = (setpointRate[0]);}};
    ...
    if (isRXDataNew) {
        isRXDataNew = 
# 579 "./src/main/fc/fc_rc.c" 3 4
                     0
# 579 "./src/main/fc/fc_rc.c"
                          ;
    }
}
 ...
 void updateRcCommands(void)
{
    ...
    if (feature(FEATURE_3D) && !failsafeIsActive()) {
        if (!flight3DConfig()->switched_mode3d) {
            ...
            if (IS_RC_MODE_ACTIVE(BOX3D)) {
                reverseMotors = 
# 646 "./src/main/fc/fc_rc.c" 3 4
                               1
# 646 "./src/main/fc/fc_rc.c"
                                   ;
                fix12_t throttleScaler = qConstruct(rcCommand[THROTTLE] - 1000, 1000);
                rcCommand[THROTTLE] = rxConfig()->midrc + qMultiply(throttleScaler, 1000 - rxConfig()->midrc);
            } else {
                reverseMotors = 
# 650 "./src/main/fc/fc_rc.c" 3 4
                               0
# 650 "./src/main/fc/fc_rc.c"
                                    ;
                fix12_t throttleScaler = qConstruct(rcCommand[THROTTLE] - 1000, 1000);
                rcCommand[THROTTLE] = rxConfig()->midrc + qMultiply(throttleScaler, 2000 - rxConfig()->midrc);
            }
...
# 681 "./src/main/fc/fc_rc.c" 3 4
_Bool 
# 681 "./src/main/fc/fc_rc.c"
    isMotorsReversed(void)
{
...
# 736 "./src/main/fc/fc_rc.c" 3 4
_Bool 
# 736 "./src/main/fc/fc_rc.c"
    rcSmoothingIsEnabled(void)
{
    return !(
...
# 760 "./src/main/fc/fc_rc.c" 3 4
_Bool 
# 760 "./src/main/fc/fc_rc.c"
    rcSmoothingInitializationComplete(void) {
