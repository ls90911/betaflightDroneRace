...
# 25 "./src/main/msp/msp_serial.h" 2
...
# 21 "./src/main/io/statusindicator.h"
...
# 123 "./src/main/fc/fc_core.c"
int16_t magHold;


static 
# 126 "./src/main/fc/fc_core.c" 3 4
      _Bool 
# 126 "./src/main/fc/fc_core.c"
...
# 130 "./src/main/fc/fc_core.c" 3 4
_Bool 
# 130 "./src/main/fc/fc_core.c"
    isRXDataNew;
static int lastArmingDisabledReason = 0;
static timeUs_t lastDisarmTimeUs;
static 
# 133 "./src/main/fc/fc_core.c" 3 4
      _Bool 
# 133 "./src/main/fc/fc_core.c"
           tryingToArm;
...
static 
# 140 "./src/main/fc/fc_core.c" 3 4
      _Bool 
# 140 "./src/main/fc/fc_core.c"
           ...
           isCalibrating(void)
{
    ...
    if (sensors(SENSOR_BARO) && !isBaroCalibrationComplete()) {
        return 
# 162 "./src/main/fc/fc_core.c" 3 4
              1
# 162 "./src/main/fc/fc_core.c"
                  ;
    }
...
void updateArmingStatus(void)
{
    if ((armingFlags & (ARMED))) {
        ledSet(0, 
# 179 "./src/main/fc/fc_core.c" 3 4
       1
# 179 "./src/main/fc/fc_core.c"
       );
    } else {
        ...
        flipOverAfterCrashMode = 
# 188 "./src/main/fc/fc_core.c" 3 4
                                0
# 188 "./src/main/fc/fc_core.c"
                                     ;


        if (!isUsingSticksForArming()) {
            static 
# 192 "./src/main/fc/fc_core.c" 3 4
                  _Bool 
# 192 "./src/main/fc/fc_core.c"
                       hadRx = 
# 192 "./src/main/fc/fc_core.c" 3 4
                               0
# 192 "./src/main/fc/fc_core.c"
                                    ;
            const 
# 193 "./src/main/fc/fc_core.c" 3 4
                 _Bool 
# 193 "./src/main/fc/fc_core.c"
                      haveRx = rxIsReceivingSignal();

            const 
# 195 "./src/main/fc/fc_core.c" 3 4
                 _Bool 
# 195 "./src/main/fc/fc_core.c"
        ...
        if (isModeActivationConditionPresent(BOXGPSRESCUE)) {
            if (!gpsRescueConfig()->minSats || (stateFlags & (GPS_FIX_HOME)) || (armingFlags & (WAS_EVER_ARMED))) {
...
# 266 "./src/main/fc/fc_core.c" 3 4
         _Bool 
# 266 "./src/main/fc/fc_core.c"
...
void disarm(void)
{
    if ((armingFlags & (ARMED))) {
        ...
        if (blackboxConfig()->device && blackboxConfig()->mode != BLACKBOX_MODE_ALWAYS_ON) {
            blackboxFinish();
        }

        systemBeep(
# 309 "./src/main/fc/fc_core.c" 3 4
       0
# 309 "./src/main/fc/fc_core.c"
       );
...
# 312 "./src/main/fc/fc_core.c"
        ...
        flipOverAfterCrashMode = 
# 315 "./src/main/fc/fc_core.c" 3 4
                                0
# 315 "./src/main/fc/fc_core.c"
                                     ;
...
# 327 "./src/main/fc/fc_core.c"
    ...
    if (!isArmingDisabled()) {
        ...
        if (micros() - getLastDshotBeaconCommandTimeUs() < 1200000) {
            tryingToArm = 
...
# 338 "./src/main/fc/fc_core.c"
        ...
        if (isMotorProtocolDshot() && isModeActivationConditionPresent(BOXFLIPOVERAFTERCRASH)) {
            if (!IS_RC_MODE_ACTIVE(BOXFLIPOVERAFTERCRASH)) {
                flipOverAfterCrashMode = 
# 343 "./src/main/fc/fc_core.c" 3 4
                                        0
# 343 "./src/main/fc/fc_core.c"
                                             ;
                if (!feature(FEATURE_3D)) {
                    pwmWriteDshotCommand(255, getMotorCount(), DSHOT_CMD_SPIN_DIRECTION_NORMAL, 
# 345 "./src/main/fc/fc_core.c" 3 4
                                                                                                      0
# 345 "./src/main/fc/fc_core.c"
                                                                                                           );
                }
            } else {
                flipOverAfterCrashMode = 
# 348 "./src/main/fc/fc_core.c" 3 4
                                        1
# 348 "./src/main/fc/fc_core.c"
                                            ;
...
# 353 "./src/main/fc/fc_core.c"
        ...
        if (feature(FEATURE_GPS) && (stateFlags & (GPS_FIX)) && gpsSol.numSat >= 5) {
...
# 407 "./src/main/fc/fc_core.c" 3 4
_Bool 
# 407 "./src/main/fc/fc_core.c"
...
# 408 "./src/main/fc/fc_core.c" 3 4
_Bool 
# 408 "./src/main/fc/fc_core.c"
...
# 409 "./src/main/fc/fc_core.c" 3 4
_Bool 
# 409 "./src/main/fc/fc_core.c"
...
# 410 "./src/main/fc/fc_core.c" 3 4
_Bool 
# 410 "./src/main/fc/fc_core.c"
...
void handleInflightCalibrationStickPosition(void)
{
    if (AccInflightCalibrationMeasurementDone) {
        ...
        AccInflightCalibrationMeasurementDone = 
# 417 "./src/main/fc/fc_core.c" 3 4
                                               0
# 417 "./src/main/fc/fc_core.c"
                                                    ;
        AccInflightCalibrationSavetoEEProm = 
...
static void updateInflightCalibrationState(void)
{
    if (AccInflightCalibrationArmed && (armingFlags & (ARMED)) && rcData[THROTTLE] > rxConfig()->mincheck && !IS_RC_MODE_ACTIVE(BOXARM)) {
        ...
        AccInflightCalibrationArmed = 
# 433 "./src/main/fc/fc_core.c" 3 4
                                     0
# 433 "./src/main/fc/fc_core.c"
                                          ;
    }
    if (IS_RC_MODE_ACTIVE(BOXCALIB)) {
        if (!AccInflightCalibrationActive && !AccInflightCalibrationMeasurementDone)
            InflightcalibratingA = 50;
        AccInflightCalibrationActive = 
# 438 "./src/main/fc/fc_core.c" 3 4
                                      1
# 438 "./src/main/fc/fc_core.c"
                                          ;
    } else if (AccInflightCalibrationMeasurementDone && !(armingFlags & (ARMED))) {
        AccInflightCalibrationMeasurementDone = 
# 440 "./src/main/fc/fc_core.c" 3 4
                                               0
# 440 "./src/main/fc/fc_core.c"
                                                    ;
        AccInflightCalibrationSavetoEEProm = 
# 441 "./src/main/fc/fc_core.c" 3 4
                                            1
# 441 "./src/main/fc/fc_core.c"
                                                ;
    }
}
...
{
    if (__extension__ ({ __typeof__ (rcCommand[YAW]) _x = (rcCommand[YAW]); _x > 0 ? _x : -_x; }) < 15 && (flightModeFlags & (MAG_MODE))) {
...
static 
# 463 "./src/main/fc/fc_core.c" 3 4
      _Bool 
# 463 "./src/main/fc/fc_core.c"
           canUpdateVTX(void)
{
...
# 474 "./src/main/fc/fc_core.c" 3 4
_Bool 
# 474 "./src/main/fc/fc_core.c"
    areSticksActive(uint8_t stickPercentLimit)
{
    for (int axis = FD_ROLL; axis <= FD_YAW; axis ++) {
        ...
        if (stickPercent >= stickPercentLimit) {
            return 
# 489 "./src/main/fc/fc_core.c" 3 4
                  1
# 489 "./src/main/fc/fc_core.c"
                      ;
        }
    }
    return 
# 492 "./src/main/fc/fc_core.c" 3 4
          0
# 492 "./src/main/fc/fc_core.c"
               ;
}
...
uint8_t calculateThrottlePercent(void)
{
    ...
    if (feature(FEATURE_3D)
        ...
        if ((rcData[THROTTLE] >= 2000) || (rcData[THROTTLE] <= 1000)) {
            ret = 100;
        } else {
            if (rcData[THROTTLE] > (rxConfig()->midrc + flight3DConfig()->deadband3d_throttle)) {
                ret = ((rcData[THROTTLE] - rxConfig()->midrc - flight3DConfig()->deadband3d_throttle) * 100) / (2000 - rxConfig()->midrc - flight3DConfig()->deadband3d_throttle);
            } else if (rcData[THROTTLE] < (rxConfig()->midrc - flight3DConfig()->deadband3d_throttle)) {
                ret = ((rxConfig()->midrc - flight3DConfig()->deadband3d_throttle - rcData[THROTTLE]) * 100) / (rxConfig()->midrc - flight3DConfig()->deadband3d_throttle - 1000);
            }
        }
    } else {
        ret = constrain(((rcData[THROTTLE] - rxConfig()->mincheck) * 100) / (2000 - rxConfig()->mincheck), 0, 100);
    }
    return ret;
}

static 
# 528 "./src/main/fc/fc_core.c" 3 4
      _Bool 
# 528 "./src/main/fc/fc_core.c"
           airmodeIsActivated;
...
# 540 "./src/main/fc/fc_core.c" 3 4
_Bool 
# 540 "./src/main/fc/fc_core.c"
    processRx(timeUs_t currentTimeUs)
{
    static 
# 542 "./src/main/fc/fc_core.c" 3 4
          _Bool 
# 542 "./src/main/fc/fc_core.c"
               armedBeeperOn = 
# 542 "./src/main/fc/fc_core.c" 3 4
                               0
# 542 "./src/main/fc/fc_core.c"
    ...
    static 
# 544 "./src/main/fc/fc_core.c" 3 4
          _Bool 
# 544 "./src/main/fc/fc_core.c"
...
# 544 "./src/main/fc/fc_core.c"
    ...
    if (!calculateRxChannelsAndUpdateFailsafe(currentTimeUs)) {
        return 
# 548 "./src/main/fc/fc_core.c" 3 4
              0
# 548 "./src/main/fc/fc_core.c"
                   ;
    }
    ...
    if (isAirmodeActive() && (armingFlags & (ARMED))) {
        if (throttlePercent >= rxConfig()->airModeActivateThreshold) {
            airmodeIsActivated = 
# 569 "./src/main/fc/fc_core.c" 3 4
                                1
# 569 "./src/main/fc/fc_core.c"
                                    ;
        }
    } else {
        airmodeIsActivated = 
# 572 "./src/main/fc/fc_core.c" 3 4
                            0
...
# 606 "./src/main/fc/fc_core.c" 3 4
       _Bool 
# 606 "./src/main/fc/fc_core.c"
            inStableFlight = 
# 606 "./src/main/fc/fc_core.c" 3 4
                             0
# 606 "./src/main/fc/fc_core.c"
                                  ;
        if (!feature(FEATURE_MOTOR_STOP) || isAirmodeActive() || (throttleStatus != THROTTLE_LOW)) {
            ...
            if ((((throttlePercent >= lowThrottleLimit) && areSticksActive(15)) || (throttlePercent >= midThrottleLimit))
                ...
                inStableFlight = 
# 615 "./src/main/fc/fc_core.c" 3 4
                                1
# 615 "./src/main/fc/fc_core.c"
                                    ;
        ...
        if (inStableFlight) {
            ...
            if ((cmpTimeUs(currentTimeUs, runawayTakeoffDeactivateUs) + runawayTakeoffAccumulatedUs) > deactivateDelay * 1000) {
                runawayTakeoffCheckDisabled = 
# 633 "./src/main/fc/fc_core.c" 3 4
                                             1
# 633 "./src/main/fc/fc_core.c"
                                                 ;
            }
        ...
        if (isUsingSticksForArming()) {
            if (throttleStatus == THROTTLE_LOW) {
                if (armingConfig()->auto_disarm_delay != 0
                    ...
                    disarm();
                    armedBeeperOn = 
# 671 "./src/main/fc/fc_core.c" 3 4
                                   0
# 671 "./src/main/fc/fc_core.c"
                                        ;
                } else {

                    beeper(BEEPER_ARMED);
                    armedBeeperOn = 
# 675 "./src/main/fc/fc_core.c" 3 4
                                   1
# 675 "./src/main/fc/fc_core.c"
                                       ;
                }
            } else {
                ...
                if (armedBeeperOn) {
                    beeperSilence();
                    armedBeeperOn = 
# 686 "./src/main/fc/fc_core.c" 3 4
                                   0
# 686 "./src/main/fc/fc_core.c"
                                        ;
                }
            }
        } else {
            ...
            if (throttleStatus == THROTTLE_LOW) {
                beeper(BEEPER_ARMED);
                armedBeeperOn = 
# 693 "./src/main/fc/fc_core.c" 3 4
                               1
# 693 "./src/main/fc/fc_core.c"
                                   ;
            } else if (armedBeeperOn) {
                beeperSilence();
                armedBeeperOn = 
# 696 "./src/main/fc/fc_core.c" 3 4
                               0
# 696 "./src/main/fc/fc_core.c"
                                    ;
            }
        }
    }
...
# 721 "./src/main/fc/fc_core.c" 3 4
   _Bool 
# 721 "./src/main/fc/fc_core.c"
        canUseHorizonMode = 
# 721 "./src/main/fc/fc_core.c" 3 4
                            1
# 721 "./src/main/fc/fc_core.c"
    ...
    if ((IS_RC_MODE_ACTIVE(BOXANGLE) || failsafeIsActive()) && (sensors(SENSOR_ACC))) {
        ...
        canUseHorizonMode = 
# 725 "./src/main/fc/fc_core.c" 3 4
                           0
# 725 "./src/main/fc/fc_core.c"
                                ;
    ...
    if ((flightModeFlags & (ANGLE_MODE)) || (flightModeFlags & (HORIZON_MODE))) {
        ledSet(1, 
# 756 "./src/main/fc/fc_core.c" 3 4
       1
# 756 "./src/main/fc/fc_core.c"
       );

        rescheduleTask(TASK_ATTITUDE, (1000000 / (500)));
    } else {
        ledSet(1, 
...
# 760 "./src/main/fc/fc_core.c"
        ...
        rescheduleTask(TASK_ATTITUDE, (1000000 / (100)));
    }
...
# 807 "./src/main/fc/fc_core.c" 3 4
       _Bool 
# 807 "./src/main/fc/fc_core.c"
        ...
        if (enableSharedPortTelemetry && !sharedPortTelemetryEnabled) {
            ...
            sharedPortTelemetryEnabled = 
# 812 "./src/main/fc/fc_core.c" 3 4
                                        1
# 812 "./src/main/fc/fc_core.c"
                                            ;
            ...
            sharedPortTelemetryEnabled = 
# 818 "./src/main/fc/fc_core.c" 3 4
                                        0
# 818 "./src/main/fc/fc_core.c"
                                             ;
        }
    }
    ...
    return 
# 843 "./src/main/fc/fc_core.c" 3 4
          1
# 843 "./src/main/fc/fc_core.c"
              ;
}
...
static void subTaskPidController(timeUs_t currentTimeUs)
{
    ...
    if ((armingFlags & (ARMED))
        ...
        if (((fabsf(pidData[FD_PITCH].Sum) >= 600)
            ...
            && ((__extension__ ({ __typeof__ (gyroAbsRateDps(FD_PITCH)) _x = (gyroAbsRateDps(FD_PITCH)); _x > 0 ? _x : -_x; }) > 15)
                || (__extension__ ({ __typeof__ (gyroAbsRateDps(FD_ROLL)) _x = (gyroAbsRateDps(FD_ROLL)); _x > 0 ? _x : -_x; }) > 15)
                || (__extension__ ({ __typeof__ (gyroAbsRateDps(FD_YAW)) _x = (gyroAbsRateDps(FD_YAW)); _x > 0 ? _x : -_x; }) > 50))) {
...
# 1016 "./src/main/fc/fc_core.c" 3 4
_Bool 
# 1016 "./src/main/fc/fc_core.c"
    isFlipOverAfterCrashMode(void)
{
...
# 1026 "./src/main/fc/fc_core.c" 3 4
_Bool 
# 1026 "./src/main/fc/fc_core.c"
    isTryingToArm()
{
    return tryingToArm;
}
...
{
    tryingToArm = 
# 1033 "./src/main/fc/fc_core.c" 3 4
                 0
# 1033 "./src/main/fc/fc_core.c"
                      ;
}
