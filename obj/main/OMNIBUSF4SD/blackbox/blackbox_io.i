...
# 1 "<command-line>"
# 1 "./src/main/blackbox/blackbox_io.c"
# 21 "./src/main/blackbox/blackbox_io.c"
...
# 52 "./src/main/blackbox/blackbox_io.c" 3 4
                                   ((void *)0)
# 52 "./src/main/blackbox/blackbox_io.c"
                                       ;
...
# 117 "./src/main/blackbox/blackbox_io.c" 3 4
                                                0
# 117 "./src/main/blackbox/blackbox_io.c"
                                                     );
        break;
...
# 171 "./src/main/blackbox/blackbox_io.c" 3 4
_Bool 
    ...
    blackboxDeviceFlushForce(void)
{
    ...
    default:
        return 
# 192 "./src/main/blackbox/blackbox_io.c" 3 4
              0
# 192 "./src/main/blackbox/blackbox_io.c"
                   ;
    }
}
...
# 199 "./src/main/blackbox/blackbox_io.c" 3 4
_Bool 
# 199 "./src/main/blackbox/blackbox_io.c"
    blackboxDeviceOpen(void)
{
    switch (blackboxConfig()->device) {
    case BLACKBOX_DEVICE_SERIAL:
        {
            ...
            if (!portConfig) {
                return 
# 209 "./src/main/blackbox/blackbox_io.c" 3 4
                      0
# 209 "./src/main/blackbox/blackbox_io.c"
                           ;
            }
...
# 225 "./src/main/blackbox/blackbox_io.c" 3 4
                                                                                    ((void *)0)
# 225 "./src/main/blackbox/blackbox_io.c"
                                                                                        , 
# 225 "./src/main/blackbox/blackbox_io.c" 3 4
                                                                                          ((void *)0)
# 225 "./src/main/blackbox/blackbox_io.c"
...
# 244 "./src/main/blackbox/blackbox_io.c"
            ...
            return blackboxPort != 
# 257 "./src/main/blackbox/blackbox_io.c" 3 4
                                  ((void *)0)
# 257 "./src/main/blackbox/blackbox_io.c"
                                      ;
        }
        break;
...
# 263 "./src/main/blackbox/blackbox_io.c"
        ...
        return 
# 268 "./src/main/blackbox/blackbox_io.c" 3 4
              1
# 268 "./src/main/blackbox/blackbox_io.c"
    ...
    case BLACKBOX_DEVICE_SDCARD:
        if (afatfs_getFilesystemState() == AFATFS_FILESYSTEM_STATE_FATAL || afatfs_getFilesystemState() == AFATFS_FILESYSTEM_STATE_UNKNOWN || afatfs_isFull()) {
            return 
# 274 "./src/main/blackbox/blackbox_io.c" 3 4
                  0
# 274 "./src/main/blackbox/blackbox_io.c"
                       ;
        }
        ...
        return 
# 279 "./src/main/blackbox/blackbox_io.c" 3 4
              1
# 279 "./src/main/blackbox/blackbox_io.c"
                  ;
        break;

    default:
        return 
# 283 "./src/main/blackbox/blackbox_io.c" 3 4
              0
# 283 "./src/main/blackbox/blackbox_io.c"
                   ;
    }
}
...
# 306 "./src/main/blackbox/blackbox_io.c" 3 4
_Bool 
# 306 "./src/main/blackbox/blackbox_io.c"
    isBlackboxErased(void)
{
    switch (blackboxConfig()->device) {
    case BLACKBOX_DEVICE_FLASH:
    ...
    default:
        ...
        return 
# 314 "./src/main/blackbox/blackbox_io.c" 3 4
              1
# 314 "./src/main/blackbox/blackbox_io.c"
                  ;
        break;
    }
}
...
void blackboxDeviceClose(void)
{
    ...
    case BLACKBOX_DEVICE_SERIAL:
        ...
        blackboxPort = 
# 330 "./src/main/blackbox/blackbox_io.c" 3 4
                      ((void *)0)
# 330 "./src/main/blackbox/blackbox_io.c"
                          ;
...
static 
# 402 "./src/main/blackbox/blackbox_io.c" 3 4
      _Bool 
# 402 "./src/main/blackbox/blackbox_io.c"
...
# 448 "./src/main/blackbox/blackbox_io.c" 3 4
                                         ((void *)0)
# 448 "./src/main/blackbox/blackbox_io.c"
                                             ;
    ...
    case BLACKBOX_SDCARD_READY_TO_LOG:
        return 
# 460 "./src/main/blackbox/blackbox_io.c" 3 4
              1
# 460 "./src/main/blackbox/blackbox_io.c"
                  ;
    }


    return 
# 464 "./src/main/blackbox/blackbox_io.c" 3 4
          0
# 464 "./src/main/blackbox/blackbox_io.c"
               ;
}
# 474 "./src/main/blackbox/blackbox_io.c"

# 474 "./src/main/blackbox/blackbox_io.c" 3 4
_Bool 
# 474 "./src/main/blackbox/blackbox_io.c"
    blackboxDeviceBeginLog(void)
{
...
# 494 "./src/main/blackbox/blackbox_io.c"

# 494 "./src/main/blackbox/blackbox_io.c" 3 4
_Bool 
# 494 "./src/main/blackbox/blackbox_io.c"
    blackboxDeviceEndLog(
# 494 "./src/main/blackbox/blackbox_io.c" 3 4
...
# 505 "./src/main/blackbox/blackbox_io.c" 3 4
                                                               ((void *)0)
# 505 "./src/main/blackbox/blackbox_io.c"
                                                                   ))
            || (!retainLog && afatfs_funlink(blackboxSDCard.logFile, 
# 506 "./src/main/blackbox/blackbox_io.c" 3 4
                                                                    ((void *)0)
# 506 "./src/main/blackbox/blackbox_io.c"
                                                                        ))
        ) {

            blackboxSDCard.logFile = 
# 509 "./src/main/blackbox/blackbox_io.c" 3 4
                                    ((void *)0)
# 509 "./src/main/blackbox/blackbox_io.c"
                                        ;
            blackboxSDCard.state = BLACKBOX_SDCARD_READY_TO_CREATE_LOG;
            return 
# 511 "./src/main/blackbox/blackbox_io.c" 3 4
                  1
# 511 "./src/main/blackbox/blackbox_io.c"
                      ;
        }
        return 
# 513 "./src/main/blackbox/blackbox_io.c" 3 4
              0
# 513 "./src/main/blackbox/blackbox_io.c"
                   ;

    default:
        return 
# 516 "./src/main/blackbox/blackbox_io.c" 3 4
              1
# 516 "./src/main/blackbox/blackbox_io.c"
                  ;
    }
}


# 520 "./src/main/blackbox/blackbox_io.c" 3 4
_Bool 
# 520 "./src/main/blackbox/blackbox_io.c"
    isBlackboxDeviceFull(void)
{
    switch (blackboxConfig()->device) {
    case BLACKBOX_DEVICE_SERIAL:
        return 
# 524 "./src/main/blackbox/blackbox_io.c" 3 4
              0
# 524 "./src/main/blackbox/blackbox_io.c"
                   ;
    ...
    default:
        return 
# 537 "./src/main/blackbox/blackbox_io.c" 3 4
              0
# 537 "./src/main/blackbox/blackbox_io.c"
                   ;
    }
}
...
# 595 "./src/main/blackbox/blackbox_io.c"
blackboxBufferReserveStatus_e blackboxDeviceReserveBufferSpace(int32_t bytes)
{
