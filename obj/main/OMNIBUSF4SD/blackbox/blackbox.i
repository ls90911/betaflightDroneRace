...
# 1 "<command-line>"
# 1 "./src/main/blackbox/blackbox.c"
# 21 "./src/main/blackbox/blackbox.c"
...
# 25 "./src/main/blackbox/blackbox.c" 2
...
# 21 "./src/main/blackbox/blackbox_encoding.h"
...
# 21 "./src/main/blackbox/blackbox_fielddefs.h"
...
# 125 "./src/main/blackbox/blackbox_fielddefs.h" 3 4
   _Bool 
# 125 "./src/main/blackbox/blackbox_fielddefs.h"
        floatFlag;
...
# 24 "./src/main/drivers/compass/compass.h" 2
...
# 25 "./src/main/drivers/compass/compass.h" 2
...
# 43 "./src/main/drivers/exti.h"
                             enable);
# 26 "./src/main/drivers/compass/compass.h" 2
...
# 87 "./src/main/blackbox/blackbox.c"
...
const blackboxConfig_t pgResetTemplate_blackboxConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .p_ratio = 32, .device = BLACKBOX_DEVICE_SDCARD, .record_acc = 1, .mode = BLACKBOX_MODE_NORMAL }




 ;
# 106 "./src/main/blackbox/blackbox.c"
...
static const blackboxDeltaFieldDefinition_t blackboxMainFields[] = {
    ...
    {"axisF", 0, FLIGHT_LOG_FIELD_SIGNED, .Ipredict = FLIGHT_LOG_FIELD_PREDICTOR_0, .Iencode = FLIGHT_LOG_FIELD_ENCODING_SIGNED_VB, .Ppredict = FLIGHT_LOG_FIELD_PREDICTOR_PREVIOUS, .Pencode = FLIGHT_LOG_FIELD_ENCODING_SIGNED_VB, FLIGHT_LOG_FIELD_CONDITION_ALWAYS},
    {"axisF", 1, FLIGHT_LOG_FIELD_SIGNED, .Ipredict = FLIGHT_LOG_FIELD_PREDICTOR_0, .Iencode = FLIGHT_LOG_FIELD_ENCODING_SIGNED_VB, .Ppredict = FLIGHT_LOG_FIELD_PREDICTOR_PREVIOUS, .Pencode = FLIGHT_LOG_FIELD_ENCODING_SIGNED_VB, FLIGHT_LOG_FIELD_CONDITION_ALWAYS},
    {"axisF", 2, FLIGHT_LOG_FIELD_SIGNED, .Ipredict = FLIGHT_LOG_FIELD_PREDICTOR_0, .Iencode = FLIGHT_LOG_FIELD_ENCODING_SIGNED_VB, .Ppredict = FLIGHT_LOG_FIELD_PREDICTOR_PREVIOUS, .Pencode = FLIGHT_LOG_FIELD_ENCODING_SIGNED_VB, FLIGHT_LOG_FIELD_CONDITION_ALWAYS},
    ...
    {"amperageLatest",-1, FLIGHT_LOG_FIELD_SIGNED, .Ipredict = FLIGHT_LOG_FIELD_PREDICTOR_0, .Iencode = FLIGHT_LOG_FIELD_ENCODING_SIGNED_VB, .Ppredict = FLIGHT_LOG_FIELD_PREDICTOR_PREVIOUS, .Pencode = FLIGHT_LOG_FIELD_ENCODING_TAG8_8SVB, FLIGHT_LOG_FIELD_CONDITION_AMPERAGE_ADC},
    ...
    {"surfaceRaw", -1, FLIGHT_LOG_FIELD_SIGNED, .Ipredict = FLIGHT_LOG_FIELD_PREDICTOR_0, .Iencode = FLIGHT_LOG_FIELD_ENCODING_SIGNED_VB, .Ppredict = FLIGHT_LOG_FIELD_PREDICTOR_PREVIOUS, .Pencode = FLIGHT_LOG_FIELD_ENCODING_TAG8_8SVB, FLIGHT_LOG_FIELD_CONDITION_RANGEFINDER},
...
# 326 "./src/main/blackbox/blackbox.c" 3 4
   _Bool 
# 326 "./src/main/blackbox/blackbox.c"
        rxSignalReceived;
    
# 327 "./src/main/blackbox/blackbox.c" 3 4
   _Bool 
# 327 "./src/main/blackbox/blackbox.c"
...
static 
# 366 "./src/main/blackbox/blackbox.c" 3 4
      _Bool 
# 366 "./src/main/blackbox/blackbox.c"
...
static 
# 384 "./src/main/blackbox/blackbox.c" 3 4
      _Bool 
# 384 "./src/main/blackbox/blackbox.c"
...
# 389 "./src/main/blackbox/blackbox.c" 3 4
_Bool 
# 389 "./src/main/blackbox/blackbox.c"
    blackboxMayEditConfig(void)
{
...
static 
# 399 "./src/main/blackbox/blackbox.c" 3 4
      _Bool 
# 399 "./src/main/blackbox/blackbox.c"
           testBlackboxConditionUncached(FlightLogFieldCondition condition)
{
    switch (condition) {
    case FLIGHT_LOG_FIELD_CONDITION_ALWAYS:
        return 
# 403 "./src/main/blackbox/blackbox.c" 3 4
              1
# 403 "./src/main/blackbox/blackbox.c"
                  ;
...
# 463 "./src/main/blackbox/blackbox.c"
    ...
    default:
        return 
# 466 "./src/main/blackbox/blackbox.c" 3 4
              0
# 466 "./src/main/blackbox/blackbox.c"
                   ;
    }
}
...
static 
# 480 "./src/main/blackbox/blackbox.c" 3 4
      _Bool 
# 480 "./src/main/blackbox/blackbox.c"
...
static void blackboxSetState(BlackboxState newState)
{
    ...
    case BLACKBOX_STATE_PREPARE_LOG_FILE:
        blackboxLoggedAnyFrames = 
# 490 "./src/main/blackbox/blackbox.c" 3 4
                                 0
# 490 "./src/main/blackbox/blackbox.c"
                                      ;
        break;
...
static void writeIntraframe(void)
{
    ...
    blackboxLoggedAnyFrames = 
# 618 "./src/main/blackbox/blackbox.c" 3 4
                             1
# 618 "./src/main/blackbox/blackbox.c"
                                 ;
}
...
static void writeInterframe(void)
{
    ...
    arraySubInt32(deltas, blackboxCurrent->axisPID_F, blackboxLast->axisPID_F, 3);
    blackboxWriteSignedVBArray(deltas, 3);
...
# 722 "./src/main/blackbox/blackbox.c" 3 4
                                                    __builtin_offsetof (
# 722 "./src/main/blackbox/blackbox.c"
                                                    blackboxMainState_t
# 722 "./src/main/blackbox/blackbox.c" 3 4
                                                    , 
# 722 "./src/main/blackbox/blackbox.c"
...
# 722 "./src/main/blackbox/blackbox.c"
    ...
    if (testBlackboxCondition(FLIGHT_LOG_FIELD_CONDITION_ACC)) {
        blackboxWriteMainStateArrayUsingAveragePredictor(
# 724 "./src/main/blackbox/blackbox.c" 3 4
                                                        __builtin_offsetof (
# 724 "./src/main/blackbox/blackbox.c"
                                                        blackboxMainState_t
# 724 "./src/main/blackbox/blackbox.c" 3 4
                                                        , 
# 724 "./src/main/blackbox/blackbox.c"
...
# 724 "./src/main/blackbox/blackbox.c"
    ...
    if (testBlackboxCondition(FLIGHT_LOG_FIELD_CONDITION_DEBUG)) {
        blackboxWriteMainStateArrayUsingAveragePredictor(
# 727 "./src/main/blackbox/blackbox.c" 3 4
                                                        __builtin_offsetof (
# 727 "./src/main/blackbox/blackbox.c"
                                                        blackboxMainState_t
# 727 "./src/main/blackbox/blackbox.c" 3 4
                                                        , 
# 727 "./src/main/blackbox/blackbox.c"
...
# 727 "./src/main/blackbox/blackbox.c"
    ...
    blackboxWriteMainStateArrayUsingAveragePredictor(
# 729 "./src/main/blackbox/blackbox.c" 3 4
                                                    __builtin_offsetof (
# 729 "./src/main/blackbox/blackbox.c"
                                                    blackboxMainState_t
# 729 "./src/main/blackbox/blackbox.c" 3 4
                                                    , 
# 729 "./src/main/blackbox/blackbox.c"
...
# 729 "./src/main/blackbox/blackbox.c"
    ...
    blackboxLoggedAnyFrames = 
# 740 "./src/main/blackbox/blackbox.c" 3 4
                             1
# 740 "./src/main/blackbox/blackbox.c"
                                 ;
}
...
static 
# 783 "./src/main/blackbox/blackbox.c" 3 4
                  _Bool 
# 783 "./src/main/blackbox/blackbox.c"
                       writeSlowFrameIfNeeded(void)
{

    
# 786 "./src/main/blackbox/blackbox.c" 3 4
   _Bool 
# 786 "./src/main/blackbox/blackbox.c"
    ...
    if (shouldWrite) {
        ...
        if (memcmp(&newSlowState, &slowHistory, sizeof(slowHistory)) != 0) {
            ...
            shouldWrite = 
# 799 "./src/main/blackbox/blackbox.c" 3 4
                         1
...
# 864 "./src/main/blackbox/blackbox.c"
...
# 893 "./src/main/blackbox/blackbox.c" 3 4
                                                  ((void *)0)
# 893 "./src/main/blackbox/blackbox.c"
                                                      );
...
# 936 "./src/main/blackbox/blackbox.c"
static 
# 936 "./src/main/blackbox/blackbox.c" 3 4
      _Bool 
# 936 "./src/main/blackbox/blackbox.c"
    ...
    if (!(armingFlags & (ARMED)) && areMotorsRunning()) {
        ...
        return 
# 941 "./src/main/blackbox/blackbox.c" 3 4
              1
# 941 "./src/main/blackbox/blackbox.c"
    ...
    return 
# 946 "./src/main/blackbox/blackbox.c" 3 4
          0
# 946 "./src/main/blackbox/blackbox.c"
               ;
}
...
# 1067 "./src/main/blackbox/blackbox.c"
static 
# 1067 "./src/main/blackbox/blackbox.c" 3 4
      _Bool 
# 1067 "./src/main/blackbox/blackbox.c"
        ...
        const void *secondFieldDefinition, int fieldCount, const uint8_t *conditions, const uint8_t *secondCondition)
{
    ...
    static 
# 1072 "./src/main/blackbox/blackbox.c" 3 4
          _Bool 
# 1072 "./src/main/blackbox/blackbox.c"
               needComma = 
# 1072 "./src/main/blackbox/blackbox.c" 3 4
                           0
# 1072 "./src/main/blackbox/blackbox.c"
    ...
    if (xmitState.u.fieldIndex == -1) {
        if (xmitState.headerIndex >= headerCount) {
            return 
# 1090 "./src/main/blackbox/blackbox.c" 3 4
                  0
# 1090 "./src/main/blackbox/blackbox.c"
                       ;
        }
        ...
        if (blackboxDeviceReserveBufferSpace(charsToBeWritten) != BLACKBOX_RESERVE_SUCCESS) {
            return 
# 1096 "./src/main/blackbox/blackbox.c" 3 4
                  1
# 1096 "./src/main/blackbox/blackbox.c"
                      ;
        }
        ...
        needComma = 
# 1102 "./src/main/blackbox/blackbox.c" 3 4
                   0
# 1102 "./src/main/blackbox/blackbox.c"
                        ;
    }
    ...
    for (; xmitState.u.fieldIndex < fieldCount; xmitState.u.fieldIndex++) {
        ...
        if (!conditions || testBlackboxCondition(conditions[conditionsStride * xmitState.u.fieldIndex])) {
            ...
            if (blackboxDeviceReserveBufferSpace(bytesToWrite) != BLACKBOX_RESERVE_SUCCESS) {
                ...
                return 
# 1127 "./src/main/blackbox/blackbox.c" 3 4
                      1
# 1127 "./src/main/blackbox/blackbox.c"
                          ;
            }
            ...
            if (needComma) {
                ...
                needComma = 
# 1135 "./src/main/blackbox/blackbox.c" 3 4
                           1
# 1135 "./src/main/blackbox/blackbox.c"
                               ;
            }
...
# 1193 "./src/main/blackbox/blackbox.c"
static 
# 1193 "./src/main/blackbox/blackbox.c" 3 4
      _Bool 
# 1193 "./src/main/blackbox/blackbox.c"
           blackboxWriteSysinfo(void)
{
    ...
    if (blackboxDeviceReserveBufferSpace(64) != BLACKBOX_RESERVE_SUCCESS) {
        return 
# 1201 "./src/main/blackbox/blackbox.c" 3 4
              0
# 1201 "./src/main/blackbox/blackbox.c"
                   ;
    }
    ...
    switch (xmitState.headerIndex) {
        ...
        case 1: blackboxPrintfHeaderLine("Firmware revision", "%s %s (%s) %s", "Betaflight", "3" "." "5" "." "0", shortGitRevision, targetName); break;;
        ...
        case 6: blackboxPrintfHeaderLine("P interval", "%d", blackboxPInterval); break;;
        case 7: blackboxPrintfHeaderLine("P ratio", "%d", blackboxConfig()->p_ratio); break;;
        ...
        case
            ...
            13
# 1222 "./src/main/blackbox/blackbox.c"
        ...
        case
                                                                                                               ...
                                                                                                               14
# 1230 "./src/main/blackbox/blackbox.c"
...
# 1266 "./src/main/blackbox/blackbox.c"
        : blackboxPrintfHeaderLine("levelPID", "%d,%d,%d", currentPidProfile->pid[PID_LEVEL].P, currentPidProfile->pid[PID_LEVEL].I, currentPidProfile->pid[PID_LEVEL].D); break;
                                                                                                                ...
                                                                                                                ;
        case 31: blackboxPrintfHeaderLine("magPID", "%d", currentPidProfile->pid[PID_MAG].P); break;;
        case 32: blackboxPrintfHeaderLine("dterm_filter_type", "%d", currentPidProfile->dterm_filter_type); break;;
        case 33: blackboxPrintfHeaderLine("dterm_lowpass_hz", "%d", currentPidProfile->dterm_lowpass_hz); break;;
        case 34: blackboxPrintfHeaderLine("dterm_lowpass2_hz", "%d", currentPidProfile->dterm_lowpass2_hz); break;;
        case 35: blackboxPrintfHeaderLine("yaw_lowpass_hz", "%d", currentPidProfile->yaw_lowpass_hz); break;;
        case 36: blackboxPrintfHeaderLine("dterm_notch_hz", "%d", currentPidProfile->dterm_notch_hz); break;;
        case 37: blackboxPrintfHeaderLine("dterm_notch_cutoff", "%d", currentPidProfile->dterm_notch_cutoff); break;;
        case 38: blackboxPrintfHeaderLine("iterm_windup", "%d", currentPidProfile->itermWindupPointPercent); break;;
        case 39: blackboxPrintfHeaderLine("vbat_pid_gain", "%d", currentPidProfile->vbatPidCompensation); break;;
        case 40: blackboxPrintfHeaderLine("pidAtMinThrottle", "%d", currentPidProfile->pidAtMinThrottle); break;;


        case 41: blackboxPrintfHeaderLine("anti_gravity_mode", "%d", currentPidProfile->antiGravityMode); break;;
        case 42: blackboxPrintfHeaderLine("anti_gravity_threshold", "%d", currentPidProfile->itermThrottleThreshold); break;;
        case 43: blackboxPrintfHeaderLine("anti_gravity_gain", "%d", currentPidProfile->itermAcceleratorGain); break;;

        case 44: blackboxPrintfHeaderLine("feedforward_transition", "%d", currentPidProfile->feedForwardTransition); break;;
        case

                                                                                                             45
# 1286 "./src/main/blackbox/blackbox.c"
        : blackboxPrintfHeaderLine("feedforward_weight", "%d,%d,%d", currentPidProfile->pid[PID_ROLL].F, currentPidProfile->pid[PID_PITCH].F, currentPidProfile->pid[PID_YAW].F); break;

                                                                                                              ;

        case 46: blackboxPrintfHeaderLine("acc_limit_yaw", "%d", currentPidProfile->yawRateAccelLimit); break;;
        case 47: blackboxPrintfHeaderLine("acc_limit", "%d", currentPidProfile->rateAccelLimit); break;;
        case 48: blackboxPrintfHeaderLine("pidsum_limit", "%d", currentPidProfile->pidSumLimit); break;;
        case 49: blackboxPrintfHeaderLine("pidsum_limit_yaw", "%d", currentPidProfile->pidSumLimitYaw); break;;


        case 50: blackboxPrintfHeaderLine("deadband", "%d", rcControlsConfig()->deadband); break;;
        case 51: blackboxPrintfHeaderLine("yaw_deadband", "%d", rcControlsConfig()->yaw_deadband); break;;

        case 52: blackboxPrintfHeaderLine("gyro_hardware_lpf", "%d", gyroConfig()->gyro_hardware_lpf); break;;

        case 53: blackboxPrintfHeaderLine("gyro_32khz_hardware_lpf", "%d", gyroConfig()->gyro_32khz_hardware_lpf); break;;

        case 54: blackboxPrintfHeaderLine("gyro_lowpass_type", "%d", gyroConfig()->gyro_lowpass_type); break;;
        case 55: blackboxPrintfHeaderLine("gyro_lowpass_hz", "%d", gyroConfig()->gyro_lowpass_hz); break;;
        case 56: blackboxPrintfHeaderLine("gyro_lowpass2_type", "%d", gyroConfig()->gyro_lowpass2_type); break;;
        case 57: blackboxPrintfHeaderLine("gyro_lowpass2_hz", "%d", gyroConfig()->gyro_lowpass2_hz); break;;
        case
                                                                                                              58
# 1307 "./src/main/blackbox/blackbox.c"
        : blackboxPrintfHeaderLine("gyro_notch_hz", "%d,%d", gyroConfig()->gyro_soft_notch_hz_1, gyroConfig()->gyro_soft_notch_hz_2); break;
                                                                                                               ;
        case
                                                                                                                  59
# 1309 "./src/main/blackbox/blackbox.c"
        ...
        case 75: blackboxPrintfHeaderLine("rc_smoothing_type", "%d", rxConfig()->rc_smoothing_type); break;;
        case 76: blackboxPrintfHeaderLine("rc_smoothing_debug_axis", "%d", rxConfig()->rc_smoothing_debug_axis); break;;
        case
                                                                                                                      77
# 1330 "./src/main/blackbox/blackbox.c"
        : blackboxPrintfHeaderLine("rc_smoothing_cutoffs", "%d, %d", rxConfig()->rc_smoothing_input_cutoff, rxConfig()->rc_smoothing_derivative_cutoff); break;
                                                                                                                       ;
        case
                                                                                                                    78
# 1332 "./src/main/blackbox/blackbox.c"
        : blackboxPrintfHeaderLine("rc_smoothing_filter_type", "%d, %d", rxConfig()->rc_smoothing_input_type, rxConfig()->rc_smoothing_derivative_type); break;
                                                                                                                     ;
        case
                                                                                                                                     79
# 1334 "./src/main/blackbox/blackbox.c"
        : blackboxPrintfHeaderLine("rc_smoothing_active_cutoffs", "%d, %d", rcSmoothingGetValue(RC_SMOOTHING_VALUE_INPUT_ACTIVE), rcSmoothingGetValue(RC_SMOOTHING_VALUE_DERIVATIVE_ACTIVE)); break;
                                                                                                                                      ;
        case 80: blackboxPrintfHeaderLine("rc_smoothing_rx_average", "%d", rcSmoothingGetValue(RC_SMOOTHING_VALUE_AVERAGE_FRAME)); break;;



        default:
            return 
# 1341 "./src/main/blackbox/blackbox.c" 3 4
                  1
# 1341 "./src/main/blackbox/blackbox.c"
                      ;
    }
    ...
    return 
# 1346 "./src/main/blackbox/blackbox.c" 3 4
          0
# 1346 "./src/main/blackbox/blackbox.c"
               ;
}
...
static 
# 1422 "./src/main/blackbox/blackbox.c" 3 4
                  _Bool 
# 1422 "./src/main/blackbox/blackbox.c"
                       blackboxShouldLogIFrame(void)
{
    return blackboxLoopIndex == 0;
}
# 1435 "./src/main/blackbox/blackbox.c"
static 
# 1435 "./src/main/blackbox/blackbox.c" 3 4
                  _Bool 
# 1435 "./src/main/blackbox/blackbox.c"
                       blackboxShouldLogGpsHomeFrame(void)
{
    if (GPS_home[0] != gpsHistory.GPS_home[0] || GPS_home[1] != gpsHistory.GPS_home[1]
        ...
        return 
# 1439 "./src/main/blackbox/blackbox.c" 3 4
              1
# 1439 "./src/main/blackbox/blackbox.c"
                  ;
    }
    return 
# 1441 "./src/main/blackbox/blackbox.c" 3 4
          0
# 1441 "./src/main/blackbox/blackbox.c"
               ;
}
...
# 1568 "./src/main/blackbox/blackbox.c" 3 4
               ((void *)0)
...
# 1585 "./src/main/blackbox/blackbox.c" 3 4
               ((void *)0)
# 1585 "./src/main/blackbox/blackbox.c"
                   , 
# 1585 "./src/main/blackbox/blackbox.c" 3 4
                     ((void *)0)
# 1585 "./src/main/blackbox/blackbox.c"
    ...
    if (isBlackboxDeviceFull()) {
...

        {
            ...
            if (startedLoggingInTestMode) {
                startedLoggingInTestMode = 
# 1679 "./src/main/blackbox/blackbox.c" 3 4
                                          0
# 1679 "./src/main/blackbox/blackbox.c"
                                               ;
            }
        }
    } else {
...
void blackboxInit(void)
{
    ...
    if (targetPidLooptime == 31) {
        blackboxIInterval = 1024;
    } else if (targetPidLooptime == 63) {
