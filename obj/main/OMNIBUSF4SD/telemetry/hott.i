...
# 63 "./src/main/telemetry/hott.c" 2
...
# 29 "./src/main/telemetry/hott.h"
       
# 52 "./src/main/telemetry/hott.h"
typedef enum {
...
typedef struct HOTT_GAM_MSG_s {
    ...
    uint8_t warning_beeps;
# 147 "./src/main/telemetry/hott.h"
    uint8_t sensor_id;
    uint8_t alarm_invers1;
# 158 "./src/main/telemetry/hott.h"
    uint8_t alarm_invers2;
# 169 "./src/main/telemetry/hott.h"
    uint8_t cell1;
    uint8_t cell2;
    uint8_t cell3;
    uint8_t cell4;
...
typedef struct HOTT_EAM_MSG_s {
    ...
    uint8_t warning_beeps;
# 284 "./src/main/telemetry/hott.h"
    uint8_t sensor_id;
    uint8_t alarm_invers1;
# 295 "./src/main/telemetry/hott.h"
    uint8_t alarm_invers2;
# 306 "./src/main/telemetry/hott.h"
    uint8_t cell1_L;
    uint8_t cell2_L;
    uint8_t cell3_L;
    uint8_t cell4_L;
...
# 103 "./src/main/telemetry/hott.c" 3 4
                         ((void *)0)
# 103 "./src/main/telemetry/hott.c"
                             ;
...
void hottPrepareGPSResponse(HOTT_GPS_MSG_t *hottGPSMessage)
{
    ...
    const uint16_t hottGpsAltitude = (altitude / 100) + 500;
...
static 
# 223 "./src/main/telemetry/hott.c" 3 4
      _Bool 
# 223 "./src/main/telemetry/hott.c"
...
void freeHoTTTelemetryPort(void)
{
    ...
    hottPort = 
# 306 "./src/main/telemetry/hott.c" 3 4
              ((void *)0)
# 306 "./src/main/telemetry/hott.c"
                  ;
    hottTelemetryEnabled = 
# 307 "./src/main/telemetry/hott.c" 3 4
                          0
# 307 "./src/main/telemetry/hott.c"
                               ;
}
...
static 
# 338 "./src/main/telemetry/hott.c" 3 4
      _Bool 
# 338 "./src/main/telemetry/hott.c"
...
static void hottConfigurePortForTX(void)
{
    ...
    hottIsSending = 
# 351 "./src/main/telemetry/hott.c" 3 4
                   1
# 351 "./src/main/telemetry/hott.c"
                       ;
    hottMsgCrc = 0;
}
...
# 363 "./src/main/telemetry/hott.c"
                 ;
    hottIsSending = 
# 364 "./src/main/telemetry/hott.c" 3 4
                   0
# 364 "./src/main/telemetry/hott.c"
                        ;
    flushHottRxBuffer();
}
...
# 380 "./src/main/telemetry/hott.c" 3 4
                                                                              ((void *)0)
# 380 "./src/main/telemetry/hott.c"
                                                                                  , 
# 380 "./src/main/telemetry/hott.c" 3 4
                                                                                    ((void *)0)
# 380 "./src/main/telemetry/hott.c"
...
# 454 "./src/main/telemetry/hott.c"
}

static void hottCheckSerialData(uint32_t currentMicros)
{
    static 
# 458 "./src/main/telemetry/hott.c" 3 4
          _Bool 
# 458 "./src/main/telemetry/hott.c"
               lookingForRequest = 
# 458 "./src/main/telemetry/hott.c" 3 4
                                   1
# 458 "./src/main/telemetry/hott.c"
    ...
    if (bytesWaiting != 2) {
        flushHottRxBuffer();
        lookingForRequest = 
# 468 "./src/main/telemetry/hott.c" 3 4
                           1
# 468 "./src/main/telemetry/hott.c"
                               ;
        return;
    }
...
# 477 "./src/main/telemetry/hott.c" 3 4
       _Bool 
# 477 "./src/main/telemetry/hott.c"
        ...
        lookingForRequest = 
# 482 "./src/main/telemetry/hott.c" 3 4
                           1
# 482 "./src/main/telemetry/hott.c"
                               ;
    }
...
static inline 
# 522 "./src/main/telemetry/hott.c" 3 4
             _Bool 
# 522 "./src/main/telemetry/hott.c"
...
# 530 "./src/main/telemetry/hott.c"
    ...
    return 
# 532 "./src/main/telemetry/hott.c" 3 4
          1
# 532 "./src/main/telemetry/hott.c"
              ;
}
...
{
    const 
# 537 "./src/main/telemetry/hott.c" 3 4
         _Bool 
# 537 "./src/main/telemetry/hott.c"
