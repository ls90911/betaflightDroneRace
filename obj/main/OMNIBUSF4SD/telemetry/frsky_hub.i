...
# 1 "<command-line>"
# 1 "./src/main/telemetry/frsky_hub.c"
# 26 "./src/main/telemetry/frsky_hub.c"
...
# 27 "./src/main/telemetry/frsky_hub.c" 2
...
# 29 "./src/main/telemetry/frsky_hub.c" 2
...
# 31 "./src/main/telemetry/frsky_hub.c" 2
...
# 35 "./src/main/telemetry/frsky_hub.c" 2
...
# 39 "./src/main/telemetry/frsky_hub.c" 2

# 1 "./src/main/pg/pg_ids.h" 1
# 21 "./src/main/pg/pg_ids.h"
       
# 41 "./src/main/telemetry/frsky_hub.c" 2
...
#pragma GCC diagnostic pop
# 44 "./src/main/telemetry/frsky_hub.c" 2
...
# 54 "./src/main/telemetry/frsky_hub.c" 2
...
# 57 "./src/main/telemetry/frsky_hub.c" 2
...
# 62 "./src/main/telemetry/frsky_hub.c" 2
...
# 64 "./src/main/telemetry/frsky_hub.c" 2
...
# 67 "./src/main/telemetry/frsky_hub.c" 2
...
# 69 "./src/main/telemetry/frsky_hub.c" 2
...
# 72 "./src/main/telemetry/frsky_hub.c" 2
...
# 75 "./src/main/telemetry/frsky_hub.c" 2

static serialPort_t *frSkyHubPort = 
# 76 "./src/main/telemetry/frsky_hub.c" 3 4
                                   ((void *)0)
# 76 "./src/main/telemetry/frsky_hub.c"
                                       ;
static serialPortConfig_t *portConfig = 
# 77 "./src/main/telemetry/frsky_hub.c" 3 4
                                       ((void *)0)
# 77 "./src/main/telemetry/frsky_hub.c"
                                           ;
...
# 84 "./src/main/telemetry/frsky_hub.c" 3 4
                                               ((void *)0)
# 84 "./src/main/telemetry/frsky_hub.c"
                                                   ;
# 135 "./src/main/telemetry/frsky_hub.c"
enum
{
...
static void sendAccel(void)
{
    for (unsigned i = 0; i < 3; i++) {
        frSkyHubWriteFrame(0x24 + i, ((int16_t)(acc.accADC[i] / acc.dev.acc_1G) * 1000));
    }
}
...
static void sendThrottleOrBatterySizeAsRpm(void)
{
    ...
    if (escData) {
        data = escData->dataAge < 255 ? (calcEscRpm(escData->rpm) / 10) : 0;
    }
# 205 "./src/main/telemetry/frsky_hub.c"
...
static void sendLatLong(int32_t coord[2])
{
    ...
    frSkyHubWriteFrame(0x13, coordinate.dddmm);
    frSkyHubWriteFrame(0x1B, coordinate.mmmm);
    frSkyHubWriteFrame(0x23, coord[0] < 0 ? 'S' : 'N');

    GPStoDDDMM_MMMM(coord[1], &coordinate);
    frSkyHubWriteFrame(0x12, coordinate.dddmm);
    frSkyHubWriteFrame(0x1A, coordinate.mmmm);
    frSkyHubWriteFrame(0x22, coord[1] < 0 ? 'W' : 'E');
}
...
static void sendGpsAltitude(void)
{
    ...
    frSkyHubWriteFrame(0x01, altitude);
    frSkyHubWriteFrame(0x09, 0);
}
...
static void sendSatalliteSignalQualityAsTemperature2(uint8_t cycleNum)
{
    ...
    if (gpsSol.hdop > 300 && ( (cycleNum % 16 ) < 8)) {
        satellite = constrain(gpsSol.hdop, 0, 9999);
    }
    int16_t data;
...
static void sendSpeed(void)
{
    ...
    frSkyHubWriteFrame(0x11, gpsSol.groundSpeed * 1944 / 100000);
    frSkyHubWriteFrame(0x19, (gpsSol.groundSpeed * 1944 / 100) % 100);
}
...
static void sendFakeLatLong(void)
{
    ...
    coord[0] = ((0.01f * telemetryConfig()->gpsNoFixLatitude) * 10000000L);
    coord[1] = ((0.01f * telemetryConfig()->gpsNoFixLongitude) * 10000000L);
...
# 348 "./src/main/telemetry/frsky_hub.c"
static void sendVario(void)
{
    frSkyHubWriteFrame(0x30, getEstimatedVario());
}
# 360 "./src/main/telemetry/frsky_hub.c"
...
# 379 "./src/main/telemetry/frsky_hub.c"
...
{
    frSkyHubWriteFrame(0x14, ((attitude.values.yaw) / 10));
    frSkyHubWriteFrame(0x1C, 0);
}



# 459 "./src/main/telemetry/frsky_hub.c" 3 4
_Bool 
# 459 "./src/main/telemetry/frsky_hub.c"
    initFrSkyHubTelemetry(void)
{
...
# 471 "./src/main/telemetry/frsky_hub.c"
    ...
    return 
# 474 "./src/main/telemetry/frsky_hub.c" 3 4
          0
# 474 "./src/main/telemetry/frsky_hub.c"
               ;
}
    ...
    initFrSkyHubTelemetryExternal(frSkyHubWriteByteFn *frSkyHubWriteByteExternal)
{
    if (telemetryState == TELEMETRY_STATE_UNINITIALIZED) {
        ...
        return 
# 484 "./src/main/telemetry/frsky_hub.c" 3 4
              1
# 484 "./src/main/telemetry/frsky_hub.c"
                  ;
    }

    return 
# 487 "./src/main/telemetry/frsky_hub.c" 3 4
          0
# 487 "./src/main/telemetry/frsky_hub.c"
               ;
}
...
void freeFrSkyHubTelemetryPort(void)
{
    ...
    frSkyHubPort = 
# 493 "./src/main/telemetry/frsky_hub.c" 3 4
                  ((void *)0)
# 493 "./src/main/telemetry/frsky_hub.c"
                      ;
}
...
# 499 "./src/main/telemetry/frsky_hub.c" 3 4
                                                                                           ((void *)0)
# 499 "./src/main/telemetry/frsky_hub.c"
                                                                                               , 
# 499 "./src/main/telemetry/frsky_hub.c" 3 4
                                                                                                 ((void *)0)
# 499 "./src/main/telemetry/frsky_hub.c"
...
void checkFrSkyHubTelemetryState(void)
{
    if (telemetryState == TELEMETRY_STATE_INITIALIZED_SERIAL) {
        if (telemetryCheckRxPortShared(portConfig)) {
            if (frSkyHubPort == 
# 507 "./src/main/telemetry/frsky_hub.c" 3 4
                               ((void *)0) 
# 507 "./src/main/telemetry/frsky_hub.c"
                                    && telemetrySharedPort != 
# 507 "./src/main/telemetry/frsky_hub.c" 3 4
                                                              ((void *)0)
# 507 "./src/main/telemetry/frsky_hub.c"
...
# 511 "./src/main/telemetry/frsky_hub.c" 3 4
           _Bool 
# 511 "./src/main/telemetry/frsky_hub.c"
...
void processFrSkyHubTelemetry(timeUs_t currentTimeUs)
{
    ...
    if (sensors(SENSOR_BARO | SENSOR_RANGEFINDER)) {
        ...
        if ((cycleNum % 4) == 0) {
            int16_t altitude = __extension__ ({ __typeof__ (getEstimatedAltitude()) _x = (getEstimatedAltitude()); _x > 0 ? _x : -_x; });



            if (frSkyHubLastCycleTime < 5000000) {
                altitude = 0;
            }

            frSkyHubWriteFrame(0x10, altitude / 100);
            frSkyHubWriteFrame(0x21, altitude % 100);
        }
    }
