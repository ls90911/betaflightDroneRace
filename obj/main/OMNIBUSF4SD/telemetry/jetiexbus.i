...
# 1 "<command-line>"
# 1 "./src/main/telemetry/jetiexbus.c"
# 21 "./src/main/telemetry/jetiexbus.c"
...
# 23 "./src/main/telemetry/jetiexbus.c" 2
...
# 26 "./src/main/telemetry/jetiexbus.c" 2
...
# 31 "./src/main/telemetry/jetiexbus.c" 2
...
# 32 "./src/main/telemetry/jetiexbus.c" 2
...
void mwDisarm(void);
# 33 "./src/main/telemetry/jetiexbus.c" 2
...
# 39 "./src/main/telemetry/jetiexbus.c" 2
...
# 47 "./src/main/telemetry/jetiexbus.c" 2
...
# 51 "./src/main/telemetry/jetiexbus.c" 2
...
# 55 "./src/main/telemetry/jetiexbus.c" 2
# 66 "./src/main/telemetry/jetiexbus.c"
enum exTelHeader_e {
    EXTEL_HEADER_SYNC = 0,
...
const exBusSensor_t jetiExSensors[] = {
    {"BF D1", "", EX_TYPE_DES, 0 },
    {"Voltage", "V", EX_TYPE_14b, (1 << 5)},
    {"Current", "A", EX_TYPE_14b, (2 << 5)},
    {"Altitude", "m", EX_TYPE_14b, (2 << 5)},
    {"Capacity", "mAh", EX_TYPE_22b, (0 << 5)},
    {"Power", "W", EX_TYPE_22b, (1 << 5)},
    {"Roll angle", "\xB0", EX_TYPE_14b, (1 << 5)},
    {"Pitch angle", "\xB0", EX_TYPE_14b, (1 << 5)},
    {"Heading", "\xB0", EX_TYPE_14b, (1 << 5)},
    {"Vario", "m/s", EX_TYPE_22b, (2 << 5)}
};
...
void initJetiExBusTelemetry(void)
{
    ...
    firstActiveSensor = getNextActiveSensor(0);
}
...
{
    while( ++currentSensor < ((sizeof(jetiExSensors) / sizeof((jetiExSensors)[0])))) {
        if (bitArrayGet(&exSensorEnabled, currentSensor)) {
            break;
        }
    }
    if (currentSensor == ((sizeof(jetiExSensors) / sizeof((jetiExSensors)[0]))) ) {
...
uint8_t createExTelemetryValueMessage(uint8_t *exMessage, uint8_t item)
{
    ...
    while (item < sensorItemMaxGroup) {
        ...
        *p++ = (sensorValue & 0x9F) | jetiExSensors[item].decimals;
        ...
        if ((p - &exMessage[EXTEL_HEADER_ID]) + exDataTypeLen[jetiExSensors[item].exDataType] + 1 >= (28 - (1 + 6 + 1))) {
            break;
        }
    }
...
uint8_t sendJetiExBusTelemetry(uint8_t packetID, uint8_t item)
{
    ...
    if (requestLoop) {
        while( ++sensorDescriptionCounter < ((sizeof(jetiExSensors) / sizeof((jetiExSensors)[0])))) {
