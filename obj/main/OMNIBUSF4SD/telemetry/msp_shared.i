...
# 24 "./src/main/telemetry/msp_shared.c" 2
...
# 36 "./src/main/telemetry/msp_shared.c" 2
...
# 47 "./src/main/telemetry/msp_shared.c"
enum {
...
# 79 "./src/main/telemetry/msp_shared.c" 3 4
                                          ((void *)0)
# 79 "./src/main/telemetry/msp_shared.c"
                                              ;
    ...
    if (mspPostProcessFn) {
        mspPostProcessFn(
# 84 "./src/main/telemetry/msp_shared.c" 3 4
                        ((void *)0)
# 84 "./src/main/telemetry/msp_shared.c"
                            );
    }
...
# 101 "./src/main/telemetry/msp_shared.c" 3 4
_Bool 
# 101 "./src/main/telemetry/msp_shared.c"
    handleMspFrame(uint8_t *frameStart, int frameLength)
{
...
# 123 "./src/main/telemetry/msp_shared.c"
    ...
    if (header & (1 << 4)) {
        ...
        return 
# 139 "./src/main/telemetry/msp_shared.c" 3 4
              0
# 139 "./src/main/telemetry/msp_shared.c"
                   ;
    } else if (((lastSeq + 1) & 0x0F) != seqNumber) {

        mspStarted = 0;
        return 
# 143 "./src/main/telemetry/msp_shared.c" 3 4
              0
# 143 "./src/main/telemetry/msp_shared.c"
                   ;
    }
...
# 156 "./src/main/telemetry/msp_shared.c"
        ...
        if (checksum != *frameBuf->ptr) {
            ...
            return 
# 169 "./src/main/telemetry/msp_shared.c" 3 4
                  1
# 169 "./src/main/telemetry/msp_shared.c"
                      ;
        }
    }
    ...
    processMspPacket();
    return 
# 176 "./src/main/telemetry/msp_shared.c" 3 4
          1
# 176 "./src/main/telemetry/msp_shared.c"
              ;
}


# 179 "./src/main/telemetry/msp_shared.c" 3 4
_Bool 
# 179 "./src/main/telemetry/msp_shared.c"
    sendMspReply(uint8_t payloadSize, mspResponseFnPtr responseFn)
{
    static uint8_t checksum = 0;
    ...
    if (bufferBytesRemaining >= payloadBytesRemaining) {
        ...
        return 
# 217 "./src/main/telemetry/msp_shared.c" 3 4
              1
# 217 "./src/main/telemetry/msp_shared.c"
                  ;
    ...
    responseFn(payloadOut);
    return 
# 240 "./src/main/telemetry/msp_shared.c" 3 4
          0
# 240 "./src/main/telemetry/msp_shared.c"
               ;
}
