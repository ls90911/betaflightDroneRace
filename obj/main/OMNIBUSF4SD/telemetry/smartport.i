...
# 1 "<command-line>"
# 1 "./src/main/telemetry/smartport.c"
# 25 "./src/main/telemetry/smartport.c"
...
# 64 "./src/main/telemetry/smartport.c" 2
# 1 "./src/main/io/motors.h" 1
# 21 "./src/main/io/motors.h"
       
# 65 "./src/main/telemetry/smartport.c" 2
...
# 66 "./src/main/telemetry/smartport.c" 2
...
# 67 "./src/main/telemetry/smartport.c" 2
...
# 69 "./src/main/telemetry/smartport.c" 2
...
# 70 "./src/main/telemetry/smartport.c" 2
...
# 71 "./src/main/telemetry/smartport.c" 2
...
# 72 "./src/main/telemetry/smartport.c" 2
...
# 73 "./src/main/telemetry/smartport.c" 2
...
# 65 "./src/main/sensors/compass.h"
    compassInit(void);
# 74 "./src/main/telemetry/smartport.c" 2
...
# 75 "./src/main/telemetry/smartport.c" 2
...
# 78 "./src/main/telemetry/smartport.c" 2
...
# 80 "./src/main/telemetry/smartport.c" 2
...
# 81 "./src/main/telemetry/smartport.c" 2
...
# 25 "./src/main/interface/crsf_protocol.h"
...
# 28 "./src/main/telemetry/crsf.h" 2
...
# 33 "./src/main/telemetry/crsf.h" 3 4
_Bool 
# 33 "./src/main/telemetry/crsf.h"
...
# 82 "./src/main/telemetry/smartport.c" 2
...
static uint16_t frSkyDataIdTable[17];
...
# 181 "./src/main/telemetry/smartport.c" 3 4
                                          ((void *)0)
# 181 "./src/main/telemetry/smartport.c"
                                              ;
...
static 
# 206 "./src/main/telemetry/smartport.c" 3 4
      _Bool 
# 206 "./src/main/telemetry/smartport.c"
...
smartPortPayload_t *smartPortDataReceive(uint16_t c, 
# 209 "./src/main/telemetry/smartport.c" 3 4
                                                    _Bool 
# 209 "./src/main/telemetry/smartport.c"
                                                         *clearToSend, smartPortCheckQueueEmptyFn *checkQueueEmpty, 
# 209 "./src/main/telemetry/smartport.c" 3 4
                                                                                                                    _Bool 
# 209 "./src/main/telemetry/smartport.c"
                                                                                                                         useChecksum)
{
    ...
    static 
# 213 "./src/main/telemetry/smartport.c" 3 4
          _Bool 
# 213 "./src/main/telemetry/smartport.c"
               skipUntilStart = 
# 213 "./src/main/telemetry/smartport.c" 3 4
                                1
# 213 "./src/main/telemetry/smartport.c"
                                    ;
    static 
# 214 "./src/main/telemetry/smartport.c" 3 4
          _Bool 
# 214 "./src/main/telemetry/smartport.c"
               awaitingSensorId = 
# 214 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 214 "./src/main/telemetry/smartport.c"
...
# 215 "./src/main/telemetry/smartport.c"
    ...
    if (c == FSSP_START_STOP) {
        *clearToSend = 
# 219 "./src/main/telemetry/smartport.c" 3 4
                      0
# 219 "./src/main/telemetry/smartport.c"
                           ;
        smartPortRxBytes = 0;
        awaitingSensorId = 
# 221 "./src/main/telemetry/smartport.c" 3 4
                          1
# 221 "./src/main/telemetry/smartport.c"
                              ;
        skipUntilStart = 
# 222 "./src/main/telemetry/smartport.c" 3 4
                        0
# 222 "./src/main/telemetry/smartport.c"
                             ;

        return 
# 224 "./src/main/telemetry/smartport.c" 3 4
              ((void *)0)
# 224 "./src/main/telemetry/smartport.c"
                  ;
    } else if (skipUntilStart) {
        return 
# 226 "./src/main/telemetry/smartport.c" 3 4
              ((void *)0)
# 226 "./src/main/telemetry/smartport.c"
                  ;
    }

    if (awaitingSensorId) {
        awaitingSensorId = 
# 230 "./src/main/telemetry/smartport.c" 3 4
                          0
# 230 "./src/main/telemetry/smartport.c"
                               ;
        if ((c == FSSP_SENSOR_ID1) && checkQueueEmpty()) {

            *clearToSend = 
# 233 "./src/main/telemetry/smartport.c" 3 4
                          1
# 233 "./src/main/telemetry/smartport.c"
                              ;
            skipUntilStart = 
# 234 "./src/main/telemetry/smartport.c" 3 4
                            1
# 234 "./src/main/telemetry/smartport.c"
                                ;
        } else if (c == FSSP_SENSOR_ID2) {
            checksum = 0;
        } else {
            skipUntilStart = 
# 238 "./src/main/telemetry/smartport.c" 3 4
                            1
# 238 "./src/main/telemetry/smartport.c"
                                ;
        }
    } else {
        if (c == FSSP_DLE) {
            byteStuffing = 
# 242 "./src/main/telemetry/smartport.c" 3 4
                          1
# 242 "./src/main/telemetry/smartport.c"
                              ;

            return 
# 244 "./src/main/telemetry/smartport.c" 3 4
                  ((void *)0)
# 244 "./src/main/telemetry/smartport.c"
                      ;
        } else if (byteStuffing) {
            c ^= FSSP_DLE_XOR;
            byteStuffing = 
# 247 "./src/main/telemetry/smartport.c" 3 4
                          0
# 247 "./src/main/telemetry/smartport.c"
                               ;
        }
        ...
        if (smartPortRxBytes < sizeof(smartPortPayload_t)) {
            ...
            if (!useChecksum && (smartPortRxBytes == sizeof(smartPortPayload_t))) {
                skipUntilStart = 
# 255 "./src/main/telemetry/smartport.c" 3 4
                                1
# 255 "./src/main/telemetry/smartport.c"
                                    ;
            ...
            skipUntilStart = 
# 260 "./src/main/telemetry/smartport.c" 3 4
                            1
# 260 "./src/main/telemetry/smartport.c"
                                ;
    ...
    return 
# 271 "./src/main/telemetry/smartport.c" 3 4
          ((void *)0)
# 271 "./src/main/telemetry/smartport.c"
              ;
}
...
void smartPortSendByte(uint8_t c, uint16_t *checksum, serialPort_t *port)
{
    ...
    if (checksum != 
# 284 "./src/main/telemetry/smartport.c" 3 4
                   ((void *)0)
# 284 "./src/main/telemetry/smartport.c"
                       ) {
        *checksum += c;
    }
}
...
# 289 "./src/main/telemetry/smartport.c" 3 4
_Bool 
# 289 "./src/main/telemetry/smartport.c"
    smartPortPayloadContainsMSP(const smartPortPayload_t *payload)
{
...
# 302 "./src/main/telemetry/smartport.c" 3 4
                                        ((void *)0)
# 302 "./src/main/telemetry/smartport.c"
                                            , port);
}
...
static void initSmartPortSensors(void)
{
    ...
    frSkyDataIdTableInfo.table[frSkyDataIdTableInfo.index++] = FSSP_DATAID_T1;
    frSkyDataIdTableInfo.table[frSkyDataIdTableInfo.index++] = FSSP_DATAID_T2;

    if (isBatteryVoltageConfigured()) {

        if (!feature(FEATURE_ESC_SENSOR) || !telemetryConfig()->smartport_use_extra_sensors) {

            frSkyDataIdTableInfo.table[frSkyDataIdTableInfo.index++] = FSSP_DATAID_VFAS;

        }

        frSkyDataIdTableInfo.table[frSkyDataIdTableInfo.index++] = FSSP_DATAID_A4;
    }
    ...
    if (isAmperageConfigured()) {
        ...
        if (!feature(FEATURE_ESC_SENSOR) || !telemetryConfig()->smartport_use_extra_sensors) {
            ...
            frSkyDataIdTableInfo.table[frSkyDataIdTableInfo.index++] = FSSP_DATAID_CURRENT;

        }

        frSkyDataIdTableInfo.table[frSkyDataIdTableInfo.index++] = FSSP_DATAID_FUEL;
    }

    if (sensors(SENSOR_ACC)) {
        frSkyDataIdTableInfo.table[frSkyDataIdTableInfo.index++] = FSSP_DATAID_HEADING;
        frSkyDataIdTableInfo.table[frSkyDataIdTableInfo.index++] = FSSP_DATAID_ACCX;
        frSkyDataIdTableInfo.table[frSkyDataIdTableInfo.index++] = FSSP_DATAID_ACCY;
        frSkyDataIdTableInfo.table[frSkyDataIdTableInfo.index++] = FSSP_DATAID_ACCZ;
    }

    if (sensors(SENSOR_BARO)) {
        frSkyDataIdTableInfo.table[frSkyDataIdTableInfo.index++] = FSSP_DATAID_ALTITUDE;
        frSkyDataIdTableInfo.table[frSkyDataIdTableInfo.index++] = FSSP_DATAID_VARIO;
    }


    if (feature(FEATURE_GPS)) {
        frSkyDataIdTableInfo.table[frSkyDataIdTableInfo.index++] = FSSP_DATAID_SPEED;
        frSkyDataIdTableInfo.table[frSkyDataIdTableInfo.index++] = FSSP_DATAID_LATLONG;
        frSkyDataIdTableInfo.table[frSkyDataIdTableInfo.index++] = FSSP_DATAID_LATLONG;
        frSkyDataIdTableInfo.table[frSkyDataIdTableInfo.index++] = FSSP_DATAID_HOME_DIST;
        frSkyDataIdTableInfo.table[frSkyDataIdTableInfo.index++] = FSSP_DATAID_GPS_ALT;
    }
    ...
    if (feature(FEATURE_ESC_SENSOR && telemetryConfig()->smartport_use_extra_sensors)) {
        frSkyEscDataIdTableInfo.size = ( sizeof(frSkyEscDataIdTable) / sizeof(uint16_t) );
    } else {
...
# 385 "./src/main/telemetry/smartport.c" 3 4
_Bool 
# 385 "./src/main/telemetry/smartport.c"
    initSmartPortTelemetry(void)
{
    if (telemetryState == TELEMETRY_STATE_UNINITIALIZED) {
        ...
        return 
# 399 "./src/main/telemetry/smartport.c" 3 4
              1
# 399 "./src/main/telemetry/smartport.c"
                  ;
    }

    return 
# 402 "./src/main/telemetry/smartport.c" 3 4
          0
# 402 "./src/main/telemetry/smartport.c"
               ;
}


# 405 "./src/main/telemetry/smartport.c" 3 4
_Bool 
# 405 "./src/main/telemetry/smartport.c"
    initSmartPortTelemetryExternal(smartPortWriteFrameFn *smartPortWriteFrameExternal)
{
    if (telemetryState == TELEMETRY_STATE_UNINITIALIZED) {
        ...
        return 
# 414 "./src/main/telemetry/smartport.c" 3 4
              1
# 414 "./src/main/telemetry/smartport.c"
                  ;
    }

    return 
# 417 "./src/main/telemetry/smartport.c" 3 4
          0
# 417 "./src/main/telemetry/smartport.c"
               ;
}
...
static void freeSmartPortTelemetryPort(void)
{
    ...
    smartPortSerialPort = 
# 423 "./src/main/telemetry/smartport.c" 3 4
                         ((void *)0)
# 423 "./src/main/telemetry/smartport.c"
                             ;
}
...
# 431 "./src/main/telemetry/smartport.c" 3 4
                                                                                                  ((void *)0)
# 431 "./src/main/telemetry/smartport.c"
                                                                                                      , 
# 431 "./src/main/telemetry/smartport.c" 3 4
                                                                                                        ((void *)0)
# 431 "./src/main/telemetry/smartport.c"
...
# 438 "./src/main/telemetry/smartport.c" 3 4
       _Bool 
# 438 "./src/main/telemetry/smartport.c"
...
void processSmartPortTelemetry(smartPortPayload_t *payload, volatile 
# 458 "./src/main/telemetry/smartport.c" 3 4
                                                                    _Bool 
# 458 "./src/main/telemetry/smartport.c"
...
# 479 "./src/main/telemetry/smartport.c" 3 4
   _Bool 
# 479 "./src/main/telemetry/smartport.c"
        doRun = 
# 479 "./src/main/telemetry/smartport.c" 3 4
                1
# 479 "./src/main/telemetry/smartport.c"
    ...
    while (doRun && *clearToSend) {
        ...
        if (requestTimeout) {
            if (millis() >= *requestTimeout) {
                *clearToSend = 
# 484 "./src/main/telemetry/smartport.c" 3 4
                              0
# 484 "./src/main/telemetry/smartport.c"
                                   ;
...
# 489 "./src/main/telemetry/smartport.c"
        ...
        if (smartPortMspReplyPending) {
            ...
            *clearToSend = 
# 495 "./src/main/telemetry/smartport.c" 3 4
                          0
# 495 "./src/main/telemetry/smartport.c"
                               ;
        ...
        if (smartPortIdCycleCnt >= 7) {

            tableInfo = &frSkyEscDataIdTableInfo;
            if (tableInfo->index == tableInfo->size) {
                tableInfo->index = 0;
                smartPortIdCycleCnt = 0;
                smartPortIdOffset++;
                if (smartPortIdOffset == getMotorCount() + 1) {
                    smartPortIdOffset = 0;
                }
            }
        }
        ...
        switch (id) {
            case FSSP_DATAID_VFAS :
                ...
                *clearToSend = 
# 553 "./src/main/telemetry/smartport.c" 3 4
                              0
# 553 "./src/main/telemetry/smartport.c"
                                   ;
                break;
            ...
            case FSSP_DATAID_VFAS8 :
                ...
                if (escData != 
# 565 "./src/main/telemetry/smartport.c" 3 4
                              ((void *)0)
# 565 "./src/main/telemetry/smartport.c"
                                  ) {
                    smartPortSendPackage(id, escData->voltage);
                    *clearToSend = 
# 567 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 567 "./src/main/telemetry/smartport.c"
                                       ;
                }
                break;
            ...
            case FSSP_DATAID_CURRENT :
                ...
                *clearToSend = 
# 573 "./src/main/telemetry/smartport.c" 3 4
                              0
# 573 "./src/main/telemetry/smartport.c"
                                   ;
                break;
            ...
            case FSSP_DATAID_CURRENT8 :
                ...
                if (escData != 
# 585 "./src/main/telemetry/smartport.c" 3 4
                              ((void *)0)
# 585 "./src/main/telemetry/smartport.c"
                                  ) {
                    smartPortSendPackage(id, escData->current);
                    *clearToSend = 
# 587 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 587 "./src/main/telemetry/smartport.c"
                                       ;
                }
                break;
            case FSSP_DATAID_RPM :
                ...
                if (escData != 
# 592 "./src/main/telemetry/smartport.c" 3 4
                              ((void *)0)
# 592 "./src/main/telemetry/smartport.c"
                                  ) {
                    smartPortSendPackage(id, calcEscRpm(escData->rpm));
                    *clearToSend = 
# 594 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 594 "./src/main/telemetry/smartport.c"
                                       ;
                }
                break;
            ...
            case FSSP_DATAID_RPM8 :
                ...
                if (escData != 
# 606 "./src/main/telemetry/smartport.c" 3 4
                              ((void *)0)
# 606 "./src/main/telemetry/smartport.c"
                                  ) {
                    smartPortSendPackage(id, calcEscRpm(escData->rpm));
                    *clearToSend = 
# 608 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 608 "./src/main/telemetry/smartport.c"
                                       ;
                }
                break;
            case FSSP_DATAID_TEMP :
                escData = getEscSensorData(255);
                if (escData != 
# 613 "./src/main/telemetry/smartport.c" 3 4
                              ((void *)0)
# 613 "./src/main/telemetry/smartport.c"
                                  ) {
                    smartPortSendPackage(id, escData->temperature);
                    *clearToSend = 
# 615 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 615 "./src/main/telemetry/smartport.c"
                                       ;
                }
                break;
            ...
            case FSSP_DATAID_TEMP8 :
                ...
                if (escData != 
# 627 "./src/main/telemetry/smartport.c" 3 4
                              ((void *)0)
# 627 "./src/main/telemetry/smartport.c"
                                  ) {
                    smartPortSendPackage(id, escData->temperature);
                    *clearToSend = 
# 629 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 629 "./src/main/telemetry/smartport.c"
                                       ;
                }
                break;
            ...
            case FSSP_DATAID_ALTITUDE :
                ...
                *clearToSend = 
# 635 "./src/main/telemetry/smartport.c" 3 4
                              0
# 635 "./src/main/telemetry/smartport.c"
                                   ;
                break;
            case FSSP_DATAID_FUEL :
                smartPortSendPackage(id, getMAhDrawn());
                *clearToSend = 
# 639 "./src/main/telemetry/smartport.c" 3 4
                              0
# 639 "./src/main/telemetry/smartport.c"
                                   ;
                break;
            case FSSP_DATAID_VARIO :
                smartPortSendPackage(id, getEstimatedVario());
                *clearToSend = 
# 643 "./src/main/telemetry/smartport.c" 3 4
                              0
# 643 "./src/main/telemetry/smartport.c"
                                   ;
                break;
            case FSSP_DATAID_HEADING :
                smartPortSendPackage(id, attitude.values.yaw * 10);
                *clearToSend = 
# 647 "./src/main/telemetry/smartport.c" 3 4
                              0
# 647 "./src/main/telemetry/smartport.c"
                                   ;
                break;
            case FSSP_DATAID_ACCX :
                smartPortSendPackage(id, lrintf(100 * acc.accADC[X] / acc.dev.acc_1G));
                *clearToSend = 
# 651 "./src/main/telemetry/smartport.c" 3 4
                              0
# 651 "./src/main/telemetry/smartport.c"
                                   ;
                break;
            case FSSP_DATAID_ACCY :
                smartPortSendPackage(id, lrintf(100 * acc.accADC[Y] / acc.dev.acc_1G));
                *clearToSend = 
# 655 "./src/main/telemetry/smartport.c" 3 4
                              0
# 655 "./src/main/telemetry/smartport.c"
                                   ;
                break;
            case FSSP_DATAID_ACCZ :
                smartPortSendPackage(id, lrintf(100 * acc.accADC[Z] / acc.dev.acc_1G));
                *clearToSend = 
# 659 "./src/main/telemetry/smartport.c" 3 4
                              0
# 659 "./src/main/telemetry/smartport.c"
                                   ;
                break;
            case FSSP_DATAID_T1 :
                ...
                *clearToSend = 
# 710 "./src/main/telemetry/smartport.c" 3 4
                              0
# 710 "./src/main/telemetry/smartport.c"
                                   ;
                break;
            case FSSP_DATAID_T2 :
                ...
                if (sensors(SENSOR_GPS)) {
                    ...
                    smartPortSendPackage(id, ((stateFlags & (GPS_FIX)) ? 1000 : 0) + ((stateFlags & (GPS_FIX_HOME)) ? 2000 : 0) + gpsSol.numSat);
                    *clearToSend = 
# 717 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 717 "./src/main/telemetry/smartport.c"
                                       ;
                } else if (feature(FEATURE_GPS)) {
                    smartPortSendPackage(id, 0);
                    *clearToSend = 
# 720 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 720 "./src/main/telemetry/smartport.c"
                                       ;
                } else
                ...
                if (telemetryConfig()->pidValuesAsTelemetry) {
                    ...
                    *clearToSend = 
# 752 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 752 "./src/main/telemetry/smartport.c"
                                       ;
                }
                break;
            ...
            case FSSP_DATAID_SPEED :
                if ((stateFlags & (GPS_FIX))) {
                    ...
                    *clearToSend = 
# 762 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 762 "./src/main/telemetry/smartport.c"
                                       ;
                }
                break;
...
# 782 "./src/main/telemetry/smartport.c"
            ...
            case FSSP_DATAID_HOME_DIST :
                if ((stateFlags & (GPS_FIX))) {
                     ...
                     *clearToSend = 
# 788 "./src/main/telemetry/smartport.c" 3 4
                                   0
# 788 "./src/main/telemetry/smartport.c"
                                        ;
                }
                break;
            case FSSP_DATAID_GPS_ALT :
                if ((stateFlags & (GPS_FIX))) {
                    smartPortSendPackage(id, gpsSol.llh.alt * 100);
                    *clearToSend = 
# 794 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 794 "./src/main/telemetry/smartport.c"
                                       ;
                }
                break;
            ...
            case FSSP_DATAID_A4 :
                cellCount = getBatteryCellCount();
                vfasVoltage = cellCount ? (getBatteryVoltage() * 10 / cellCount) : 0;
                smartPortSendPackage(id, vfasVoltage);
                *clearToSend = 
# 802 "./src/main/telemetry/smartport.c" 3 4
                              0
# 802 "./src/main/telemetry/smartport.c"
                                   ;
                break;
            default:
                break;
...
static 
# 811 "./src/main/telemetry/smartport.c" 3 4
      _Bool 
# 811 "./src/main/telemetry/smartport.c"
...
void handleSmartPortTelemetry(void)
{
    ...
    if (telemetryState == TELEMETRY_STATE_INITIALIZED_SERIAL && smartPortSerialPort) {
        smartPortPayload_t *payload = 
# 821 "./src/main/telemetry/smartport.c" 3 4
                                     ((void *)0)
# 821 "./src/main/telemetry/smartport.c"
                                         ;
        
# 822 "./src/main/telemetry/smartport.c" 3 4
       _Bool 
# 822 "./src/main/telemetry/smartport.c"
            clearToSend = 
# 822 "./src/main/telemetry/smartport.c" 3 4
                          0
# 822 "./src/main/telemetry/smartport.c"
...
# 825 "./src/main/telemetry/smartport.c" 3 4
                                                                                  1
# 825 "./src/main/telemetry/smartport.c"
                                                                                      );
        }
