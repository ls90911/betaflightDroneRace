...
# 24 "./src/main/telemetry/srxl.c" 2
...
# 26 "./src/main/telemetry/srxl.c" 2
...
# 32 "./src/main/telemetry/srxl.c" 2
...
# 41 "./src/main/telemetry/srxl.c" 2
...
# 44 "./src/main/telemetry/srxl.c" 2
...
# 54 "./src/main/telemetry/srxl.c" 2
...
# 56 "./src/main/rx/spektrum.h"
    srxlRxIsActive(void);
# 55 "./src/main/telemetry/srxl.c" 2
# 1 "./src/main/io/spektrum_vtx_control.h" 1
# 83 "./src/main/io/spektrum_vtx_control.h"
typedef struct
{
    uint8_t band;
    uint8_t channel;
...
extern const uint16_t SpektrumVtxfrequencyTable[5][8];
extern const uint8_t spek2commonBand[5];
extern const uint8_t vtxTrampPi[8];
extern const uint8_t vtxRTC6705Pi[8];
extern const uint8_t vtxSaPi[8];
extern uint8_t SpektrumRegion;

void spektrumHandleVtxControl(uint32_t vtxControl);
void spektrumVtxControl(void);
# 56 "./src/main/telemetry/srxl.c" 2
...
# 58 "./src/main/telemetry/srxl.c" 2
...
# 60 "./src/main/telemetry/srxl.c" 2
# 1 "./src/main/telemetry/srxl.h" 1
# 21 "./src/main/telemetry/srxl.h"
...
# 27 "./src/main/telemetry/srxl.h" 3 4
_Bool 
# 27 "./src/main/telemetry/srxl.h"
...
# 61 "./src/main/telemetry/srxl.c" 2
...
# 63 "./src/main/telemetry/srxl.c" 2
...
# 64 "./src/main/telemetry/srxl.c" 2
...
# 65 "./src/main/telemetry/srxl.c" 2
# 77 "./src/main/telemetry/srxl.c"
static 
# 77 "./src/main/telemetry/srxl.c" 3 4
      _Bool 
# 77 "./src/main/telemetry/srxl.c"
           srxlTelemetryEnabled;
static uint8_t srxlFrame[(16 + 5)];
static 
# 79 "./src/main/telemetry/srxl.c" 3 4
      _Bool 
# 79 "./src/main/telemetry/srxl.c"
           srxlTelemetryNow = 
# 79 "./src/main/telemetry/srxl.c" 3 4
                                0
# 79 "./src/main/telemetry/srxl.c"
...
{
    srxlTelemetryNow = 
# 83 "./src/main/telemetry/srxl.c" 3 4
                        1
# 83 "./src/main/telemetry/srxl.c"
                            ;
}
...
# 128 "./src/main/telemetry/srxl.c"

# 128 "./src/main/telemetry/srxl.c" 3 4
_Bool 
# 128 "./src/main/telemetry/srxl.c"
    srxlFrameQos(sbuf_t *dst, timeUs_t currentTimeUs)
{
    ...
    sbufFill(dst, 0xFF, 14);

    return 
# 137 "./src/main/telemetry/srxl.c" 3 4
          1
# 137 "./src/main/telemetry/srxl.c"
              ;
}
# 156 "./src/main/telemetry/srxl.c"

# 156 "./src/main/telemetry/srxl.c" 3 4
_Bool 
# 156 "./src/main/telemetry/srxl.c"
    srxlFrameRpm(sbuf_t *dst, timeUs_t currentTimeUs)
{
    ...
    sbufFill(dst, 0xFF, 8);
    return 
# 167 "./src/main/telemetry/srxl.c" 3 4
          1
# 167 "./src/main/telemetry/srxl.c"
              ;
}
# 187 "./src/main/telemetry/srxl.c"

# 187 "./src/main/telemetry/srxl.c" 3 4
_Bool 
# 187 "./src/main/telemetry/srxl.c"
    srxlFrameFlightPackCurrent(sbuf_t *dst, timeUs_t currentTimeUs)
{
    ...
    if ( (amps != sentAmps) || (mah != sentMah) ||
        ...
        return 
# 212 "./src/main/telemetry/srxl.c" 3 4
              1
# 212 "./src/main/telemetry/srxl.c"
                  ;
    }
    return 
# 214 "./src/main/telemetry/srxl.c" 3 4
          0
# 214 "./src/main/telemetry/srxl.c"
               ;
}
# 239 "./src/main/telemetry/srxl.c"
static char srxlTextBuff[(9)][(13)];
static 
# 240 "./src/main/telemetry/srxl.c" 3 4
      _Bool 
# 240 "./src/main/telemetry/srxl.c"
           lineSent[(9)];
...
int spektrumTmTextGenPutChar(uint8_t col, uint8_t row, char c)
{
    if (row < 9 && col < 12) {
        ...
        if (srxlTextBuff[row][col] != c) {
          ...
          lineSent[row] = 
# 251 "./src/main/telemetry/srxl.c" 3 4
                         0
# 251 "./src/main/telemetry/srxl.c"
                              ;
        }
    }
    return 0;
...
# 258 "./src/main/telemetry/srxl.c" 3 4
_Bool 
# 258 "./src/main/telemetry/srxl.c"
    srxlFrameText(sbuf_t *dst, timeUs_t currentTimeUs)
{
    ...
    lineSent[lineNo] = 
# 276 "./src/main/telemetry/srxl.c" 3 4
                      1
# 276 "./src/main/telemetry/srxl.c"
                          ;
    lineNo = (lineNo + 1) % (9);
    ...
    return 
# 282 "./src/main/telemetry/srxl.c" 3 4
          1
# 282 "./src/main/telemetry/srxl.c"
              ;
}
...
static void collectVtxTmData(spektrumVtx_t * vtx)
{
    ...
    if (vtxDevice == 
# 296 "./src/main/telemetry/srxl.c" 3 4
                    ((void *)0) 
# 296 "./src/main/telemetry/srxl.c"
                         || !(vtxCommonGetBandAndChannel(vtxDevice, &vtx->band, &vtx->channel) &&
...
static void convertVtxPower(spektrumVtx_t * vtx)
    {
        uint8_t const * powerIndexTable = 
# 317 "./src/main/telemetry/srxl.c" 3 4
                                         ((void *)0)
# 317 "./src/main/telemetry/srxl.c"
                                             ;
        ...
        case VTXDEV_TRAMP:
            ...
            vtx->powerValue = trampPowerTable[vtx->power -1];
            break;
...
# 341 "./src/main/telemetry/srxl.c"
        ...
        if (powerIndexTable != 
# 348 "./src/main/telemetry/srxl.c" 3 4
                              ((void *)0)
# 348 "./src/main/telemetry/srxl.c"
                                  ) {
            for (int i = 0; i < 8; i++)
...
# 392 "./src/main/telemetry/srxl.c"
static 
# 392 "./src/main/telemetry/srxl.c" 3 4
      _Bool 
# 392 "./src/main/telemetry/srxl.c"
           srxlFrameVTX(sbuf_t *dst, timeUs_t currentTimeUs)
{
    ...
    if ((vtxDeviceType != VTXDEV_UNKNOWN) && vtxDeviceType != VTXDEV_UNSUPPORTED) {
        ...
        if ((memcmp(&vtxSent, &vtx, sizeof(spektrumVtx_t)) != 0) ||
            ((currentTimeUs - lastTimeSentVtx) > 2000000) ) {

            sbufWriteU8(dst, 0x0D);
            sbufWriteU8(dst, 0x00);
            ...
            return 
# 419 "./src/main/telemetry/srxl.c" 3 4
                  1
# 419 "./src/main/telemetry/srxl.c"
                      ;
        }
    }
    return 
# 422 "./src/main/telemetry/srxl.c" 3 4
          0
# 422 "./src/main/telemetry/srxl.c"
               ;
}
# 452 "./src/main/telemetry/srxl.c"
typedef 
# 452 "./src/main/telemetry/srxl.c" 3 4
       _Bool 
# 452 "./src/main/telemetry/srxl.c"
            (*srxlScheduleFnPtr)(sbuf_t *dst, timeUs_t currentTimeUs);

const srxlScheduleFnPtr srxlScheduleFuncs[(2 + (1 + 1 + 1))] = {
...
static void processSrxl(timeUs_t currentTimeUs)
{
    ...
    if (srxlScheduleIndex < 2) {
        ...
        srxlScheduleUserIndex = (srxlScheduleUserIndex + 1) % (1 + 1 + 1);
...
# 510 "./src/main/telemetry/srxl.c" 3 4
_Bool 
# 510 "./src/main/telemetry/srxl.c"
    checkSrxlTelemetryState(void)
{
...
void handleSrxlTelemetry(timeUs_t currentTimeUs)
{
    ...
    srxlTelemetryNow = 
# 524 "./src/main/telemetry/srxl.c" 3 4
                        0
# 524 "./src/main/telemetry/srxl.c"
                             ;
