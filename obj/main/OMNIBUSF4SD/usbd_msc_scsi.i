# 1 "./lib/main/STM32_USB_Device_Library/Class/msc/src/usbd_msc_scsi.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./lib/main/STM32_USB_Device_Library/Class/msc/src/usbd_msc_scsi.c"
# 29 "./lib/main/STM32_USB_Device_Library/Class/msc/src/usbd_msc_scsi.c"
...
void MSC_BOT_CplClrFeature (USB_OTG_CORE_HANDLE *pdev,
                             uint8_t epnum);
# 30 "./lib/main/STM32_USB_Device_Library/Class/msc/src/usbd_msc_scsi.c" 2
...
void SCSI_SenseCode(uint8_t lun,
                    uint8_t sKey,
                    uint8_t ASC);
# 31 "./lib/main/STM32_USB_Device_Library/Class/msc/src/usbd_msc_scsi.c" 2
...
# 32 "./lib/main/STM32_USB_Device_Library/Class/msc/src/usbd_msc_scsi.c" 2
# 1 "./lib/main/STM32_USB_Device_Library/Class/msc/inc/usbd_msc_data.h" 1
# 78 "./lib/main/STM32_USB_Device_Library/Class/msc/inc/usbd_msc_data.h"
extern const uint8_t MSC_Page00_Inquiry_Data[];
extern const uint8_t MSC_Mode_Sense6_data[];
extern const uint8_t MSC_Mode_Sense10_data[] ;
# 33 "./lib/main/STM32_USB_Device_Library/Class/msc/src/usbd_msc_scsi.c" 2
# 77 "./lib/main/STM32_USB_Device_Library/Class/msc/src/usbd_msc_scsi.c"
SCSI_Sense_TypeDef SCSI_Sense [4];
...
# 96 "./lib/main/STM32_USB_Device_Library/Class/msc/src/usbd_msc_scsi.c"
...
# 131 "./lib/main/STM32_USB_Device_Library/Class/msc/src/usbd_msc_scsi.c"
int8_t SCSI_ProcessCmd(USB_OTG_CORE_HANDLE *pdev,
                           uint8_t lun,
                           uint8_t *params)
{
...
# 190 "./lib/main/STM32_USB_Device_Library/Class/msc/src/usbd_msc_scsi.c"
static int8_t SCSI_TestUnitReady(uint8_t lun, uint8_t *params)
{
  (void)(params);
...
# 220 "./lib/main/STM32_USB_Device_Library/Class/msc/src/usbd_msc_scsi.c"
static int8_t SCSI_Inquiry(uint8_t lun, uint8_t *params)
{
  uint8_t* pPage;
  uint16_t len;
  ...
  else
  {
    ...
    pPage = (uint8_t *)&USBD_STORAGE_fops->pInquiry[lun * 36];
    len = pPage[4] + 5;
...
# 258 "./lib/main/STM32_USB_Device_Library/Class/msc/src/usbd_msc_scsi.c"
static int8_t SCSI_ReadCapacity10(uint8_t lun, uint8_t *params)
{
  (void)(params);
...
# 357 "./lib/main/STM32_USB_Device_Library/Class/msc/src/usbd_msc_scsi.c"
static int8_t SCSI_ModeSense10 (uint8_t lun, uint8_t *params)
{
 (void)(params);
 (void)(lun);
...
# 381 "./lib/main/STM32_USB_Device_Library/Class/msc/src/usbd_msc_scsi.c"
static int8_t SCSI_RequestSense (uint8_t lun, uint8_t *params)
{
  (void)(lun);
  uint8_t i;
...
# 424 "./lib/main/STM32_USB_Device_Library/Class/msc/src/usbd_msc_scsi.c"
...
# 457 "./lib/main/STM32_USB_Device_Library/Class/msc/src/usbd_msc_scsi.c"
static int8_t SCSI_Read10(uint8_t lun , uint8_t *params)
{
  if(MSC_BOT_State == 0)
  {
  ...
  MSC_BOT_DataLen = 4096;

  return SCSI_ProcessRead(lun);
}
# 521 "./lib/main/STM32_USB_Device_Library/Class/msc/src/usbd_msc_scsi.c"
static int8_t SCSI_Write10 (uint8_t lun , uint8_t *params)
{
  if (MSC_BOT_State == 0)
  {
    ...
    DCD_EP_PrepareRx (cdev,
                      0x01,
                      MSC_BOT_Data,
                      (((SCSI_blk_len) < (4096)) ? (SCSI_blk_len) : (4096)));
  }
  else
  {
...
# 603 "./lib/main/STM32_USB_Device_Library/Class/msc/src/usbd_msc_scsi.c"
static int8_t SCSI_Verify10(uint8_t lun , uint8_t *params){
  if ((params[1]& 0x02) == 0x02)
  {
    SCSI_SenseCode (lun, 5, 0x24);
    return -1;
  }
...
static int8_t SCSI_ProcessRead (uint8_t lun)
{
  ...
  len = (((SCSI_blk_len) < (4096)) ? (SCSI_blk_len) : (4096));
...
# 693 "./lib/main/STM32_USB_Device_Library/Class/msc/src/usbd_msc_scsi.c"
static int8_t SCSI_ProcessWrite (uint8_t lun)
{
  uint32_t len;
