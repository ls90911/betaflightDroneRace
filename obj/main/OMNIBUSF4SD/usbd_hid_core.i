# 1 "./lib/main/STM32_USB_Device_Library/Class/hid/src/usbd_hid_core.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./lib/main/STM32_USB_Device_Library/Class/hid/src/usbd_hid_core.c"
# 50 "./lib/main/STM32_USB_Device_Library/Class/hid/src/usbd_hid_core.c"
# 1 "./lib/main/STM32_USB_Device_Library/Class/hid/inc/usbd_hid_core.h" 1
# 33 "./lib/main/STM32_USB_Device_Library/Class/hid/inc/usbd_hid_core.h"
...
uint16_t USBD_GetRxCount (USB_OTG_CORE_HANDLE *pdev ,
                           uint8_t epnum);
# 34 "./lib/main/STM32_USB_Device_Library/Class/hid/inc/usbd_hid_core.h" 2
...
# 51 "./lib/main/STM32_USB_Device_Library/Class/hid/src/usbd_hid_core.c" 2
...
# 52 "./lib/main/STM32_USB_Device_Library/Class/hid/src/usbd_hid_core.c" 2
...
# 53 "./lib/main/STM32_USB_Device_Library/Class/hid/src/usbd_hid_core.c" 2
...
# 55 "./lib/main/STM32_USB_Device_Library/Class/hid/src/usbd_hid_core.c" 2
# 99 "./lib/main/STM32_USB_Device_Library/Class/hid/src/usbd_hid_core.c"
...
# 119 "./lib/main/STM32_USB_Device_Library/Class/hid/src/usbd_hid_core.c"
...
# 124 "./lib/main/STM32_USB_Device_Library/Class/hid/src/usbd_hid_core.c" 3 4
 ((void *)0)
# 124 "./lib/main/STM32_USB_Device_Library/Class/hid/src/usbd_hid_core.c"
     ,
  
# 125 "./lib/main/STM32_USB_Device_Library/Class/hid/src/usbd_hid_core.c" 3 4
 ((void *)0)
# 125 "./lib/main/STM32_USB_Device_Library/Class/hid/src/usbd_hid_core.c"
     ,
  USBD_HID_DataIn,
  
# 127 "./lib/main/STM32_USB_Device_Library/Class/hid/src/usbd_hid_core.c" 3 4
 ((void *)0)
# 127 "./lib/main/STM32_USB_Device_Library/Class/hid/src/usbd_hid_core.c"
     ,
  
# 128 "./lib/main/STM32_USB_Device_Library/Class/hid/src/usbd_hid_core.c" 3 4
 ((void *)0)
# 128 "./lib/main/STM32_USB_Device_Library/Class/hid/src/usbd_hid_core.c"
     ,
  
# 129 "./lib/main/STM32_USB_Device_Library/Class/hid/src/usbd_hid_core.c" 3 4
 ((void *)0)
# 129 "./lib/main/STM32_USB_Device_Library/Class/hid/src/usbd_hid_core.c"
     ,
  
# 130 "./lib/main/STM32_USB_Device_Library/Class/hid/src/usbd_hid_core.c" 3 4
 ((void *)0)
# 130 "./lib/main/STM32_USB_Device_Library/Class/hid/src/usbd_hid_core.c"
     ,
  USBD_HID_GetCfgDesc,
...
# 239 "./lib/main/STM32_USB_Device_Library/Class/hid/src/usbd_hid_core.c"
 static uint8_t HID_MOUSE_ReportDesc[38] =
{
0x05, 0x01,
0x09, 0x05,
0xa1, 0x01,
...
# 278 "./lib/main/STM32_USB_Device_Library/Class/hid/src/usbd_hid_core.c"
uint8_t USBD_HID_Init (void *pdev,
                               uint8_t cfgidx)
{
...
# 299 "./lib/main/STM32_USB_Device_Library/Class/hid/src/usbd_hid_core.c"
uint8_t USBD_HID_DeInit (void *pdev,
                                 uint8_t cfgidx)
{
  (void)(cfgidx);

  DCD_EP_Close (pdev , 0x83);
  return USBD_OK;
}
# 315 "./lib/main/STM32_USB_Device_Library/Class/hid/src/usbd_hid_core.c"
uint8_t USBD_HID_Setup (void *pdev,
                         USB_SETUP_REQ *req)
{
  uint16_t len = 0;
  uint8_t *pbuf = 
# 319 "./lib/main/STM32_USB_Device_Library/Class/hid/src/usbd_hid_core.c" 3 4
                  ((void *)0)
# 319 "./lib/main/STM32_USB_Device_Library/Class/hid/src/usbd_hid_core.c"
                      ;
  ...
  case 0x00:
    ...
    case 0x06:
      ...
      {
        len = (((38) < (req->wLength)) ? (38) : (req->wLength));
      ...
      else if( req->wValue >> 8 == 0x21)
      {
        ...
        len = (((9) < (req->wLength)) ? (9) : (req->wLength));
      }
      else
      {
...
# 414 "./lib/main/STM32_USB_Device_Library/Class/hid/src/usbd_hid_core.c"
uint8_t USBD_HID_SendReport (USB_OTG_CORE_HANDLE *pdev,
                                 uint8_t *report,
                                 uint16_t len)
{
  ...
  {
    DCD_EP_Tx (pdev, 0x83, report, len);
  }
  return USBD_OK;
}
# 432 "./lib/main/STM32_USB_Device_Library/Class/hid/src/usbd_hid_core.c"
static uint8_t *USBD_HID_GetCfgDesc (uint8_t speed, uint16_t *length)
{
  (void)(speed);
...
# 446 "./lib/main/STM32_USB_Device_Library/Class/hid/src/usbd_hid_core.c"
...
uint32_t USBD_HID_GetPollingInterval (USB_OTG_CORE_HANDLE *pdev)
{
  ...
  if(pdev->cfg.speed == 0)
  {
    ...
    polling_interval = (((1 <<(0x07 - 1)))/8);
  }
  else
  {


    polling_interval = 0x0A;
  }
