...
# 24 "./src/main/io/displayport_srxl.c" 2
...
# 26 "./src/main/io/displayport_srxl.c" 2
...
# 32 "./src/main/io/displayport_srxl.c" 2
...
# 34 "./src/main/io/displayport_srxl.c" 2
...
static int srxlClearScreen(displayPort_t *displayPort)
{
    ...
    if ( displayPort->grabCount == 0 ) {
        srxlWriteString(displayPort, 0, 2, "MENU:THR MID");
        srxlWriteString(displayPort, 2, 3, "+ YAW LEFT");
        srxlWriteString(displayPort, 2, 4, "+ PITCH UP");
    }
    return 0;
}
           ...
           srxlIsTransferInProgress(const displayPort_t *displayPort)
{
    (void)(displayPort);
    return 
# 83 "./src/main/io/displayport_srxl.c" 3 4
          0
# 83 "./src/main/io/displayport_srxl.c"
               ;
}

static 
# 86 "./src/main/io/displayport_srxl.c" 3 4
      _Bool 
# 86 "./src/main/io/displayport_srxl.c"
           srxlIsSynced(const displayPort_t *displayPort)
{
    (void)(displayPort);
    return 
# 89 "./src/main/io/displayport_srxl.c" 3 4
          1
# 89 "./src/main/io/displayport_srxl.c"
              ;
}
...
static uint32_t srxlTxBytesFree(const displayPort_t *displayPort)
{
    (void)(displayPort);
    return 
# 106 "./src/main/io/displayport_srxl.c" 3 4
          (0xffffffffUL)
# 106 "./src/main/io/displayport_srxl.c"
                    ;
}
...
# 138 "./src/main/io/displayport_srxl.c" 3 4
                            ((void *)0)
# 138 "./src/main/io/displayport_srxl.c"
                                ;
