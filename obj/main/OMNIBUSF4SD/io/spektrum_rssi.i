...
# 1 "<command-line>"
# 1 "./src/main/io/spektrum_rssi.c"
# 21 "./src/main/io/spektrum_rssi.c"
...
# 22 "./src/main/io/spektrum_rssi.c" 2
...
# 26 "./src/main/io/spektrum_rssi.c" 2
...
# 33 "./src/main/io/spektrum_rssi.c" 2
...
# 35 "./src/main/io/spektrum_rssi.c" 2
...
# 56 "./src/main/rx/spektrum.h"
    srxlRxIsActive(void);
# 36 "./src/main/io/spektrum_rssi.c" 2
...
# 37 "./src/main/io/spektrum_rssi.c" 2




static 
# 41 "./src/main/io/spektrum_rssi.c" 3 4
      _Bool 
# 41 "./src/main/io/spektrum_rssi.c"
           spektrumSatInternal = 
# 41 "./src/main/io/spektrum_rssi.c" 3 4
                                 1
# 41 "./src/main/io/spektrum_rssi.c"
...
static const dbm_table_t dbmTable[] = {
    ...
    {-76, 63},
    {-77, 60},
# 88 "./src/main/io/spektrum_rssi.c"
    {(-92), 0}};
...

    {
        ...
        if (spektrumSatInternal) {
            ...
            if ( !( (system == 0x01) |
                    ...
                    (system == 0xb2) ) ){
                spektrumSatInternal =
# 168 "./src/main/io/spektrum_rssi.c" 3 4
                                    0
# 168 "./src/main/io/spektrum_rssi.c"
                                         ;
            }
        } else {
