...
# 70 "./src/main/io/vtx.c" 3 4
   _Bool 
# 70 "./src/main/io/vtx.c"
        settingsUpdated = 
# 70 "./src/main/io/vtx.c" 3 4
                          0
# 70 "./src/main/io/vtx.c"
    ...
    if (vtxSettingsConfig()->band && freq != vtxSettingsConfig()->freq) {
        ...
        settingsUpdated = 
# 76 "./src/main/io/vtx.c" 3 4
                         1
# 76 "./src/main/io/vtx.c"
                             ;
    }
    ...
    if (vtxSettingsConfig()->pitModeFreq) {
        ...
        if (constrainedPitModeFreq != vtxSettingsConfig()->pitModeFreq) {
            ...
            settingsUpdated = 
# 85 "./src/main/io/vtx.c" 3 4
                             1
# 85 "./src/main/io/vtx.c"
                                 ;
        }
    }
...
static vtxSettingsConfig_t vtxGetSettings(void)
{
    ...
    if (!(armingFlags & (ARMED)) && settings.lowPowerDisarm && !failsafeIsActive()) {
        settings.power = 1;
    }
...
static 
# 121 "./src/main/io/vtx.c" 3 4
      _Bool 
# 121 "./src/main/io/vtx.c"
    ...
    if(!(armingFlags & (ARMED))) {
        ...
        if (vtxCommonGetBandAndChannel(vtxDevice, &vtxBand, &vtxChan)) {
            ...
            if (vtxBand != settings.band || vtxChan != settings.channel) {
                ...
                return 
# 130 "./src/main/io/vtx.c" 3 4
                      1
# 130 "./src/main/io/vtx.c"
                          ;
            }
        }
    }
    return 
# 134 "./src/main/io/vtx.c" 3 4
          0
# 134 "./src/main/io/vtx.c"
               ;
}


static 
# 138 "./src/main/io/vtx.c" 3 4
      _Bool 
# 138 "./src/main/io/vtx.c"
    ...
    if(!(armingFlags & (ARMED))) {
        ...
        if (vtxCommonGetFrequency(vtxDevice, &vtxFreq)) {
            ...
            if (vtxFreq != settings.freq) {
                ...
                return 
# 146 "./src/main/io/vtx.c" 3 4
                      1
# 146 "./src/main/io/vtx.c"
                          ;
            }
        }
    }
    return 
# 150 "./src/main/io/vtx.c" 3 4
          0
# 150 "./src/main/io/vtx.c"
               ;
}
           ...
           vtxProcessPower(vtxDevice_t *vtxDevice)
{
    ...
    if (vtxCommonGetPowerIndex(vtxDevice, &vtxPower)) {
        ...
        if (vtxPower != settings.power) {
            ...
            return 
# 161 "./src/main/io/vtx.c" 3 4
                  1
# 161 "./src/main/io/vtx.c"
                      ;
        }
    }
    return 
    ...
    if (!(armingFlags & (ARMED)) && vtxCommonGetPitMode(vtxDevice, &pitOnOff)) {
        ...
        if (currPmSwitchState != prevPmSwitchState) {
            ...
            if (currPmSwitchState) {
                ...
                if (vtxSettingsConfig()->pitModeFreq) {
                    return 
# 183 "./src/main/io/vtx.c" 3 4
                          0
# 183 "./src/main/io/vtx.c"
                               ;
                }
...
# 188 "./src/main/io/vtx.c" 3 4
                                                      1
# 188 "./src/main/io/vtx.c"
                                                          );
                        return 
# 189 "./src/main/io/vtx.c" 3 4
                              1
# 189 "./src/main/io/vtx.c"
                                  ;
                    }
                }
            } else {
                if (pitOnOff) {
                    vtxCommonSetPitMode(vtxDevice, 
# 194 "./src/main/io/vtx.c" 3 4
                                                  0
# 194 "./src/main/io/vtx.c"
                                                       );
                    return 
# 195 "./src/main/io/vtx.c" 3 4
                          1
# 195 "./src/main/io/vtx.c"
                              ;
                }
            }
        }
...
static 
# 203 "./src/main/io/vtx.c" 3 4
      _Bool 
# 203 "./src/main/io/vtx.c"
           vtxProcessStateUpdate(vtxDevice_t *vtxDevice)
{
    ...
    return (
# 218 "./src/main/io/vtx.c" 3 4
           _Bool
# 218 "./src/main/io/vtx.c"
...
# 235 "./src/main/io/vtx.c" 3 4
       _Bool 
# 235 "./src/main/io/vtx.c"
            vtxUpdatePending = 
# 235 "./src/main/io/vtx.c" 3 4
                               0
# 235 "./src/main/io/vtx.c"
