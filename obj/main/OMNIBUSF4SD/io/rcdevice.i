...
static 
# 66 "./src/main/io/rcdevice.c" 3 4
      _Bool 
# 66 "./src/main/io/rcdevice.c"
           rcdeviceRespCtxQueuePushRespCtx(rcdeviceWaitingResponseQueue *queue, rcdeviceResponseParseContext_t *respCtx)
{
    if (queue == 
...
{
    if (queue == 
# 96 "./src/main/io/rcdevice.c" 3 4
                ((void *)0) 
# 96 "./src/main/io/rcdevice.c"
                     || queue->itemCount == 0) {
        return 
# 97 "./src/main/io/rcdevice.c" 3 4
              ((void *)0)
# 97 "./src/main/io/rcdevice.c"
                  ;
    }
...
# 180 "./src/main/io/rcdevice.c"
    ...
    device->isReady = 
# 189 "./src/main/io/rcdevice.c" 3 4
                     1
# 189 "./src/main/io/rcdevice.c"
                         ;
}
...
{
    runcamDeviceSendRequestAndWaitingResp(device, 0x00, 
# 196 "./src/main/io/rcdevice.c" 3 4
                                                                                            ((void *)0)
# 196 "./src/main/io/rcdevice.c"
                                                                                                , 0, rcdeviceConfig()->initDeviceAttemptInterval, rcdeviceConfig()->initDeviceAttempts, 
# 196 "./src/main/io/rcdevice.c" 3 4
                                                                                                                                                                                        ((void *)0)
# 196 "./src/main/io/rcdevice.c"
...
{
    device->isReady = 
# 205 "./src/main/io/rcdevice.c" 3 4
                     0
# 205 "./src/main/io/rcdevice.c"
                          ;
...
# 209 "./src/main/io/rcdevice.c" 3 4
                                                                           ((void *)0)
# 209 "./src/main/io/rcdevice.c"
                                                                               , 
# 209 "./src/main/io/rcdevice.c" 3 4
                                                                                 ((void *)0)
# 209 "./src/main/io/rcdevice.c"
        ...
        if (device->serialPort != 
# 211 "./src/main/io/rcdevice.c" 3 4
                                 ((void *)0)
# 211 "./src/main/io/rcdevice.c"
                                     ) {
...
# 219 "./src/main/io/rcdevice.c" 3 4
_Bool 
# 219 "./src/main/io/rcdevice.c"
    runcamDeviceSimulateCameraButton(runcamDevice_t *device, uint8_t operation)
{
    if (device->info.protocolVersion == RCDEVICE_PROTOCOL_VERSION_1_0) {
        ...
        return 
# 224 "./src/main/io/rcdevice.c" 3 4
              0
# 224 "./src/main/io/rcdevice.c"
                   ;
    }

    return 
# 227 "./src/main/io/rcdevice.c" 3 4
          1
# 227 "./src/main/io/rcdevice.c"
              ;
}
...
void runcamDeviceOpen5KeyOSDCableConnection(runcamDevice_t *device, rcdeviceRespParseFunc parseFunc)
{
    ...
    runcamDeviceSendRequestAndWaitingResp(device, 0x04, &operation, sizeof(uint8_t), 200, 0, 
# 235 "./src/main/io/rcdevice.c" 3 4
                                                                                                                                 ((void *)0)
# 235 "./src/main/io/rcdevice.c"
                                                                                                                                     , parseFunc);
}
...
void runcamDeviceClose5KeyOSDCableConnection(runcamDevice_t *device, rcdeviceRespParseFunc parseFunc)
{
    ...
    runcamDeviceSendRequestAndWaitingResp(device, 0x04, &operation, sizeof(uint8_t), 200, 0, 
# 243 "./src/main/io/rcdevice.c" 3 4
                                                                                                                                 ((void *)0)
# 243 "./src/main/io/rcdevice.c"
                                                                                                                                     , parseFunc);
}
...
void runcamDeviceSimulate5KeyOSDCableButtonPress(runcamDevice_t *device, uint8_t operation, rcdeviceRespParseFunc parseFunc)
{
    ...
    runcamDeviceSendRequestAndWaitingResp(device, 0x02, &operation, sizeof(uint8_t), 200, 0, 
# 253 "./src/main/io/rcdevice.c" 3 4
                                                                                                                                       ((void *)0)
# 253 "./src/main/io/rcdevice.c"
                                                                                                                                           , parseFunc);
}
...
void runcamDeviceSimulate5KeyOSDCableButtonRelease(runcamDevice_t *device, rcdeviceRespParseFunc parseFunc)
{
    runcamDeviceSendRequestAndWaitingResp(device, 0x03, 
...
static rcdeviceResponseParseContext_t* getWaitingResponse(timeMs_t currentTimeMs)
{
    ...
    while (respCtx != 
# 265 "./src/main/io/rcdevice.c" 3 4
                     ((void *)0) 
# 265 "./src/main/io/rcdevice.c"
                          && respCtx->timeoutTimestamp != 0 && currentTimeMs > respCtx->timeoutTimestamp) {
        if (respCtx->maxRetryTimes > 0) {
            ...
            respCtx = 
# 270 "./src/main/io/rcdevice.c" 3 4
                     ((void *)0)
# 270 "./src/main/io/rcdevice.c"
                         ;
            break;
        } else {
            respCtx->result = RCDEVICE_RESP_TIMEOUT;
            if (respCtx->parserFunc != 
# 274 "./src/main/io/rcdevice.c" 3 4
                                      ((void *)0)
# 274 "./src/main/io/rcdevice.c"
                                          ) {
...
{
    (void)(currentTimeUs);
    rcdeviceResponseParseContext_t *respCtx = 
# 290 "./src/main/io/rcdevice.c" 3 4
                                             ((void *)0)
# 290 "./src/main/io/rcdevice.c"
                                                 ;
    while ((respCtx = getWaitingResponse(millis())) != 
# 291 "./src/main/io/rcdevice.c" 3 4
                                                      ((void *)0) 
# 291 "./src/main/io/rcdevice.c"
