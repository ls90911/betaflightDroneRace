...
# 1 "<command-line>"
# 1 "./src/main/io/transponder_ir.c"
# 21 "./src/main/io/transponder_ir.c"
...
# 24 "./src/main/io/transponder_ir.c" 2
...
# 26 "./src/main/io/transponder_ir.c" 2
...
# 34 "./src/main/io/transponder_ir.c" 2
# 1 "./src/main/pg/pg_ids.h" 1
# 21 "./src/main/pg/pg_ids.h"
       
# 35 "./src/main/io/transponder_ir.c" 2
...
# 37 "./src/main/io/transponder_ir.c" 2
...
# 38 "./src/main/io/transponder_ir.c" 2
...
# 39 "./src/main/io/transponder_ir.c" 2
...
# 40 "./src/main/io/transponder_ir.c" 2
...
# 42 "./src/main/io/transponder_ir.c" 2
...
# 24 "./src/main/io/transponder_ir.h" 2
...
# 44 "./src/main/io/transponder_ir.c" 2

extern void pgResetFn_transponderConfig(transponderConfig_t *); transponderConfig_t transponderConfig_System; transponderConfig_t transponderConfig_Copy; extern const pgRegistry_t transponderConfig_Registry; const pgRegistry_t transponderConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 17 | (0 << 12), .size = sizeof(transponderConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&transponderConfig_System, .copy = (uint8_t*)&transponderConfig_Copy, .ptr = 0, .reset = {.fn = (pgResetFunc*)&pgResetFn_transponderConfig }, };

void pgResetFn_transponderConfig(transponderConfig_t *transponderConfig)
{
    *(transponderConfig) = (transponderConfig_t) { .provider = TRANSPONDER_ILAP, .reserved = 0, .data = { 0x12, 0x34, 0x56, 0x78, 0x9A, 0xBC, 0x0, 0x0, 0x0 }, .ioTag = 0 };
...
static 
# 64 "./src/main/io/transponder_ir.c" 3 4
      _Bool 
# 64 "./src/main/io/transponder_ir.c"
...
# 64 "./src/main/io/transponder_ir.c"
                                         ;
static 
# 65 "./src/main/io/transponder_ir.c" 3 4
      _Bool 
# 65 "./src/main/io/transponder_ir.c"
           transponderRepeat = 
# 65 "./src/main/io/transponder_ir.c" 3 4
                               0
# 65 "./src/main/io/transponder_ir.c"
...
const transponderRequirement_t transponderRequirements[3] = {
    {TRANSPONDER_ILAP, 6, 4500, 10000},
    {TRANSPONDER_ARCITIMER, 9, 4500, 10000},
    {TRANSPONDER_ERLT, 1, 22500, 5000}
};
...
void transponderUpdate(timeUs_t currentTimeUs)
{
    ...
    const 
# 87 "./src/main/io/transponder_ir.c" 3 4
         _Bool 
# 87 "./src/main/io/transponder_ir.c"
    ...
    if (jitterIndex >= (sizeof(jitterDurations) / sizeof(uint8_t))) {
        jitterIndex = 0;
    }

    nextUpdateAtUs = currentTimeUs + transponderRequirements[provider - 1].transmitDelay + jitter;
# 109 "./src/main/io/transponder_ir.c"
...
{
    transponderRepeat = 
# 124 "./src/main/io/transponder_ir.c" 3 4
                       0
# 124 "./src/main/io/transponder_ir.c"
                            ;
}
...
void transponderStartRepeating(void)
{
    ...
    transponderRepeat = 
# 133 "./src/main/io/transponder_ir.c" 3 4
                       1
# 133 "./src/main/io/transponder_ir.c"
                           ;
}
