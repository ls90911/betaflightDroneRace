...
# 21 "./src/main/drivers/display_ug2864hsweg01.h"
       
# 42 "./src/main/drivers/display_ug2864hsweg01.h"

# 42 "./src/main/drivers/display_ug2864hsweg01.h" 3 4
_Bool 
# 42 "./src/main/drivers/display_ug2864hsweg01.h"
...
# 21 "./src/main/io/displayport_oled.h"
...
# 65 "./src/main/sensors/compass.h"
    compassInit(void);
# 75 "./src/main/io/dashboard.c" 2
# 83 "./src/main/io/dashboard.c"
static busDevice_t *bus;

static uint32_t nextDisplayUpdateAt = 0;
static 
# 86 "./src/main/io/dashboard.c" 3 4
      _Bool 
# 86 "./src/main/io/dashboard.c"
           dashboardPresent = 
# 86 "./src/main/io/dashboard.c" 3 4
                              0
# 86 "./src/main/io/dashboard.c"
...
# 119 "./src/main/io/dashboard.c" 3 4
   _Bool 
# 119 "./src/main/io/dashboard.c"
        pageChanging;
...
static void showWelcomePage(void)
{
    ...
    tfp_sprintf(lineBuffer, "v%s (%s)", "3" "." "5" "." "0", shortGitRevision);
...
static void showGpsPage(void)
{
    ...
    i2c_OLED_set_xy(bus, __extension__ ({ __typeof__ (0) _a = (0); __typeof__ ((uint8_t)(((128 / (5 + 1)) - (sizeof(GPS_svinfo_cno) / sizeof(GPS_svinfo_cno[0]))) / 2)) _b = ((uint8_t)(((128 / (5 + 1)) - (sizeof(GPS_svinfo_cno) / sizeof(GPS_svinfo_cno[0]))) / 2)); _a > _b ? _a : _b; }), rowIndex++);
    ...
    for (index = 0; index < (sizeof(GPS_svinfo_cno) / sizeof(GPS_svinfo_cno[0])) && index < (128 / (5 + 1)); index++) {
        ...
        bargraphOffset = __extension__ ({ __typeof__ (bargraphOffset) _a = (bargraphOffset); __typeof__ (7 - 1) _b = (7 - 1); _a < _b ? _a : _b; });
        i2c_OLED_send_char(bus, (128 + 32) + bargraphOffset);
    }
    ...
    padHalfLineBuffer();
    i2c_OLED_set_xy(bus, ((128 / (5 + 1)) / 2), rowIndex++);
    i2c_OLED_send_string(bus, lineBuffer);
...
void dashboardUpdate(timeUs_t currentTimeUs)
{
    ...
    const 
# 609 "./src/main/io/dashboard.c" 3 4
         _Bool 
# 609 "./src/main/io/dashboard.c"
...
# 616 "./src/main/io/dashboard.c" 3 4
   _Bool 
# 616 "./src/main/io/dashboard.c"
...
# 617 "./src/main/io/dashboard.c" 3 4
   _Bool 
# 617 "./src/main/io/dashboard.c"
...
# 625 "./src/main/io/dashboard.c" 3 4
                                1
# 625 "./src/main/io/dashboard.c"
                                    ;
    } else {
        if (armedStateChanged) {
            pageState.pageFlags |= PAGE_STATE_FLAG_FORCE_PAGE_CHANGE;
