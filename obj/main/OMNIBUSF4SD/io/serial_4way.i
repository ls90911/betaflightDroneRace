...
# 27 "./src/main/io/serial_4way.c" 2
...
# 25 "./src/main/drivers/serial.h" 2
...
# 27 "./src/main/io/serial_4way_avrootloader.h"
...
# 24 "./src/main/io/serial_4way_stk500v2.h"
...
# 50 "./src/main/io/serial_4way.c" 2
# 93 "./src/main/io/serial_4way.c"
...
inline 
# 103 "./src/main/io/serial_4way.c" 3 4
      _Bool 
# 103 "./src/main/io/serial_4way.c"
           isMcuConnected(void)
{
...
inline 
# 112 "./src/main/io/serial_4way.c" 3 4
      _Bool 
# 112 "./src/main/io/serial_4way.c"
           isEscLo(uint8_t selEsc)
{
    return (IORead(escHardware[selEsc].io) == Bit_RESET);
}
...
# 439 "./src/main/io/serial_4way.c" 3 4
   _Bool 
# 439 "./src/main/io/serial_4way.c"
        isExitScheduled = 
# 439 "./src/main/io/serial_4way.c" 3 4
                          0
# 439 "./src/main/io/serial_4way.c"
    ...
    while (1) {
        ...
        ledSet(0, 
# 448 "./src/main/io/serial_4way.c" 3 4
       1
# 448 "./src/main/io/serial_4way.c"
       );
        ...
        ledSet(0, 
# 475 "./src/main/io/serial_4way.c" 3 4
       1
# 475 "./src/main/io/serial_4way.c"
       );
        ...
        if (ACK_OUT == 0x00)
        {
            ...
            switch (CMD) {
                ...
                {
                    isExitScheduled = 
# 545 "./src/main/io/serial_4way.c" 3 4
                                     1
# 545 "./src/main/io/serial_4way.c"
                                         ;
                    break;
                }
                case 0x3F:
        ...
        ledSet(0, 
# 868 "./src/main/io/serial_4way.c" 3 4
       0
# 868 "./src/main/io/serial_4way.c"
       );
        ...
        ledSet(0, 
# 891 "./src/main/io/serial_4way.c" 3 4
       0
# 891 "./src/main/io/serial_4way.c"
       );
        if (isExitScheduled) {
            esc4wayRelease();
            return;
