...
# 1 "<command-line>"
# 1 "./src/main/io/asyncfatfs/asyncfatfs.c"
# 36 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 37 "./src/main/io/asyncfatfs/asyncfatfs.c" 2
...
# 38 "./src/main/io/asyncfatfs/asyncfatfs.c" 2
...
# 39 "./src/main/io/asyncfatfs/asyncfatfs.c" 2
...
# 41 "./src/main/io/asyncfatfs/asyncfatfs.c" 2
...
# 25 "./src/main/io/asyncfatfs/asyncfatfs.h" 2
...
# 48 "./src/main/io/asyncfatfs/asyncfatfs.c" 2
...
# 51 "./src/main/io/asyncfatfs/asyncfatfs.c" 2
...
# 52 "./src/main/io/asyncfatfs/asyncfatfs.c" 2
...
# 53 "./src/main/io/asyncfatfs/asyncfatfs.c" 2
# 118 "./src/main/io/asyncfatfs/asyncfatfs.c"
typedef enum {
...
# 199 "./src/main/io/asyncfatfs/asyncfatfs.c"
    unsigned locked:1;
...
# 378 "./src/main/io/asyncfatfs/asyncfatfs.c"
    uint32_t logicalSize;
# 391 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 465 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
   _Bool 
# 465 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 479 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
   _Bool 
# 479 "./src/main/io/asyncfatfs/asyncfatfs.c"
        filesystemFull;
...
static 
# 527 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
      _Bool 
# 527 "./src/main/io/asyncfatfs/asyncfatfs.c"
           isPowerOfTwo(unsigned int x)
{
    return ((x != 0) && ((x & (~x + 1)) == x));
}
# 539 "./src/main/io/asyncfatfs/asyncfatfs.c"
static 
# 539 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
      _Bool 
# 539 "./src/main/io/asyncfatfs/asyncfatfs.c"
           afatfs_assert(
# 539 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
...
static 
# 554 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
      _Bool 
# 554 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 625 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                                                                                  _Bool 
# 625 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                                                                                       locked)
{
...
# 674 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                 0
# 674 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                      ;
    ...
    for (int i = 0; i < 8; i++) {
        ...
        if (afatfs.cacheDescriptor[i].sectorIndex == sectorIndex
            ...
            if (buffer == 
# 683 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                         ((void *)0)
# 683 "./src/main/io/asyncfatfs/asyncfatfs.c"
                             ) {
...
static void afatfs_cacheFlushSector(int cacheIndex)
{
    ...
    switch (sdcard_writeBlock(cacheDescriptor->sectorIndex, afatfs_cacheSectorGetMemory(cacheIndex), afatfs_sdcardWriteComplete, 0)) {
        case SDCARD_OPERATION_IN_PROGRESS:
            ...
            afatfs.cacheFlushInProgress = 
# 715 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                         1
# 715 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                             ;
            break;
...
static afatfsCacheBlockDescriptor_t* afatfs_findCacheSector(uint32_t sectorIndex)
{
    ...
    return 
# 743 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
          ((void *)0)
# 743 "./src/main/io/asyncfatfs/asyncfatfs.c"
              ;
}
# 757 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 822 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                                                                   0
# 822 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                                                                        );
    }
    ...
    afatfs_flush(void)
{
    if (afatfs.cacheDirtyEntries > 0) {
        ...
        if (earliestSectorIndex > -1) {
            ...
            return 
# 851 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  0
# 851 "./src/main/io/asyncfatfs/asyncfatfs.c"
                       ;
        }
    }

    return 
# 855 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
          1
# 855 "./src/main/io/asyncfatfs/asyncfatfs.c"
              ;
}
...
# 861 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
_Bool 
# 861 "./src/main/io/asyncfatfs/asyncfatfs.c"
    afatfs_isFull(void)
{
...
# 918 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 953 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                            (0xffff)
# 953 "./src/main/io/asyncfatfs/asyncfatfs.c"
                            ) _b = ((uint32_t)
# 953 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                            (0xffff)
# 953 "./src/main/io/asyncfatfs/asyncfatfs.c"
        ...
        default:
            ...
            afatfs_assert(
# 983 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                         0
# 983 "./src/main/io/asyncfatfs/asyncfatfs.c"
                              );
            return AFATFS_OPERATION_FAILURE;
    }
}
...
# 1011 "./src/main/io/asyncfatfs/asyncfatfs.c"
    ...
    return 
# 1015 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
          0
# 1015 "./src/main/io/asyncfatfs/asyncfatfs.c"
               ;
}

static 
# 1018 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
      _Bool 
# 1018 "./src/main/io/asyncfatfs/asyncfatfs.c"
           afatfs_parseVolumeID(const uint8_t *sector)
{
    ...
    if (volume->bytesPerSector != 512 || volume->numFATs != 2
        ...
        return 
# 1026 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              0
# 1026 "./src/main/io/asyncfatfs/asyncfatfs.c"
                   ;
    }
    ...
    if (afatfs.sectorsPerCluster < 1 || afatfs.sectorsPerCluster > 128 || !isPowerOfTwo(afatfs.sectorsPerCluster)) {
        return 
# 1033 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              0
# 1033 "./src/main/io/asyncfatfs/asyncfatfs.c"
                   ;
    }
    ...
    if (afatfs.numClusters <= 4084) {
        ...
        return 
# 1050 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              0
# 1050 "./src/main/io/asyncfatfs/asyncfatfs.c"
                   ;
    ...
    return 
# 1068 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
          1
# 1068 "./src/main/io/asyncfatfs/asyncfatfs.c"
              ;
}
...
static 
# 1089 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
      _Bool 
...
# 1111 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 1139 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 1206 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 1212 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
   _Bool 
# 1212 "./src/main/io/asyncfatfs/asyncfatfs.c"
    ...
    switch (condition) {
        ...
        default:
            afatfs_assert(
# 1233 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                         0
# 1233 "./src/main/io/asyncfatfs/asyncfatfs.c"
                              );
            return AFATFS_FIND_CLUSTER_FATAL;
    }
...
# 1310 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 1349 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 1391 "./src/main/io/asyncfatfs/asyncfatfs.c"
        switch (pattern) {
...
# 1450 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 1516 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 1592 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                   1
# 1592 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                       ;
            return AFATFS_OPERATION_FAILURE;
        break;
    }
...
# 1621 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 1658 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 1681 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 1746 "./src/main/io/asyncfatfs/asyncfatfs.c"
static afatfsOperationStatus_e afatfs_appendSupercluster(afatfsFilePtr_t file)
{
    ...
    if (afatfs.freeFile.logicalSize < superClusterSize) {
        afatfs.filesystemFull = 
# 1755 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                               1
# 1755 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                   ;
    }
...
static 
# 1798 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
      _Bool 
# 1798 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 1824 "./src/main/io/asyncfatfs/asyncfatfs.c"
        ...
        if (afatfs_isEndOfAllocatedFile(file)) {
            return 
# 1830 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  ((void *)0)
# 1830 "./src/main/io/asyncfatfs/asyncfatfs.c"
                      ;
        }
        ...
        if (status != AFATFS_OPERATION_SUCCESS) {
            ...
            return 
# 1844 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  ((void *)0)
# 1844 "./src/main/io/asyncfatfs/asyncfatfs.c"
                      ;
        }
...
static uint8_t* afatfs_fileLockCursorSectorForWrite(afatfsFilePtr_t file)
{
    ...
    if (file->writeLockedCacheIndex != -1) {
        ...
        if (!afatfs_assert(physicalSector == afatfs.cacheDescriptor[file->writeLockedCacheIndex].sectorIndex)) {
            return 
# 1869 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  ((void *)0)
# 1869 "./src/main/io/asyncfatfs/asyncfatfs.c"
                      ;
        }
        ...
        if (afatfs_isEndOfAllocatedFile(file) && afatfs_appendFreeCluster(file) != AFATFS_OPERATION_SUCCESS) {
            ...
            return 
# 1879 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  ((void *)0)
# 1879 "./src/main/io/asyncfatfs/asyncfatfs.c"
                      ;
        }
        ...
        if (status != AFATFS_OPERATION_SUCCESS) {
            ...
            return 
# 1917 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  ((void *)0)
# 1917 "./src/main/io/asyncfatfs/asyncfatfs.c"
                      ;
        }
...
# 1938 "./src/main/io/asyncfatfs/asyncfatfs.c"
static 
# 1938 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
      _Bool 
# 1938 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 1946 "./src/main/io/asyncfatfs/asyncfatfs.c"
    ...
    if (file->type == AFATFS_FILE_TYPE_FAT16_ROOT_DIRECTORY) {
        ...
        return 
# 1956 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              1
# 1956 "./src/main/io/asyncfatfs/asyncfatfs.c"
                  ;
    }
...
# 1966 "./src/main/io/asyncfatfs/asyncfatfs.c"
    ...
    if (newOffsetInCluster >= clusterSizeBytes) {
        ...
        if (status == AFATFS_OPERATION_SUCCESS) {
            ...
            return 
# 1986 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  0
# 1986 "./src/main/io/asyncfatfs/asyncfatfs.c"
                       ;
        }
    }
    ...
    return 
# 1995 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
          1
# 1995 "./src/main/io/asyncfatfs/asyncfatfs.c"
              ;
}
...
static 
# 2001 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
      _Bool 
# 2001 "./src/main/io/asyncfatfs/asyncfatfs.c"
           afatfs_fseekInternalContinue(afatfsFile_t *file)
{
    ...
    while (offsetInCluster + opState->seekOffset >= clusterSizeBytes && !afatfs_isEndOfAllocatedFile(file)) {
        ...
        if (status == AFATFS_OPERATION_SUCCESS) {
            ...
            return 
# 2027 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  0
# 2027 "./src/main/io/asyncfatfs/asyncfatfs.c"
                       ;
        }
    }
    ...
    return 
# 2044 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
          1
# 2044 "./src/main/io/asyncfatfs/asyncfatfs.c"
              ;
}
# 2058 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 2095 "./src/main/io/asyncfatfs/asyncfatfs.c"
afatfsOperationStatus_e afatfs_fseek(afatfsFilePtr_t file, int32_t offset, afatfsSeek_e whence)
{
...
# 2104 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                                                                                      ((void *)0)
# 2104 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                                                                                          );
            }
...
# 2133 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                                                                ((void *)0)
# 2133 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                                                                    );
}
...
# 2141 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
_Bool 
# 2141 "./src/main/io/asyncfatfs/asyncfatfs.c"
    afatfs_ftell(afatfsFilePtr_t file, uint32_t *position)
{
    if (afatfs_fileIsBusy(file)) {
        return 
# 2144 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              0
# 2144 "./src/main/io/asyncfatfs/asyncfatfs.c"
                   ;
    } else {
        *position = file->cursorOffset;
        return 
# 2147 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              1
# 2147 "./src/main/io/asyncfatfs/asyncfatfs.c"
                  ;
    }
}
# 2159 "./src/main/io/asyncfatfs/asyncfatfs.c"
afatfsOperationStatus_e afatfs_findNext(afatfsFilePtr_t directory, afatfsFinder_t *finder, fatDirectoryEntry_t **dirEntry)
{
    uint8_t *sector;
    ...
    if (sector) {
        ...
        *dirEntry = (fatDirectoryEntry_t*) sector + finder->entryIndex;
        ...
        if (afatfs_isEndOfAllocatedFile(directory)) {
            *dirEntry = 
# 2184 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                       ((void *)0)
# 2184 "./src/main/io/asyncfatfs/asyncfatfs.c"
                           ;
...
static afatfsOperationStatus_e afatfs_extendSubdirectoryContinue(afatfsFile_t *directory)
{
    ...
    switch (opState->phase) {
        ...
        case AFATFS_EXTEND_SUBDIRECTORY_PHASE_FAILURE:
            ...
            if (opState->callback) {
                opState->callback(
# 2292 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                 ((void *)0)
...
# 2312 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 2351 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 2369 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                                         ((void *)0)
# 2369 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                                             , 
# 2369 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                                               ((void *)0)
# 2369 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
static afatfsFilePtr_t afatfs_allocateFileHandle(void)
{
    ...
    return 
# 2396 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
          ((void *)0)
# 2396 "./src/main/io/asyncfatfs/asyncfatfs.c"
              ;
}
# 2406 "./src/main/io/asyncfatfs/asyncfatfs.c"
static afatfsOperationStatus_e afatfs_ftruncateContinue(afatfsFilePtr_t file, 
# 2406 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                                                             _Bool 
# 2406 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                                                                  markDeleted)
{
...
# 2513 "./src/main/io/asyncfatfs/asyncfatfs.c"

# 2513 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
_Bool 
# 2513 "./src/main/io/asyncfatfs/asyncfatfs.c"
    afatfs_ftruncate(afatfsFilePtr_t file, afatfsFileCallback_t callback)
{
    ...
    if (afatfs_fileIsBusy(file))
        return 
# 2518 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              0
# 2518 "./src/main/io/asyncfatfs/asyncfatfs.c"
                   ;
    ...
    return 
# 2546 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
          1
# 2546 "./src/main/io/asyncfatfs/asyncfatfs.c"
              ;
}
            ...
            do {
                ...
                switch (status) {
                    case AFATFS_OPERATION_SUCCESS:
                        ...
                        if (entry == 
# 2581 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                    ((void *)0) 
# 2581 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 2752 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
_Bool 
# 2752 "./src/main/io/asyncfatfs/asyncfatfs.c"
    afatfs_funlink(afatfsFilePtr_t file, afatfsCallback_t callback)
{
    afatfsUnlinkFile_t *opState = &file->operation.state.unlinkFile;
...
# 2766 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                               ((void *)0)
# 2766 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                   ))
        return 
# 2767 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              0
# 2767 "./src/main/io/asyncfatfs/asyncfatfs.c"
                   ;
    ...
    return 
# 2777 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
          1
# 2777 "./src/main/io/asyncfatfs/asyncfatfs.c"
              ;
}
# 2790 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 2845 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 2889 "./src/main/io/asyncfatfs/asyncfatfs.c"

# 2889 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
_Bool 
# 2889 "./src/main/io/asyncfatfs/asyncfatfs.c"
    afatfs_fclose(afatfsFilePtr_t file, afatfsCallback_t callback)
{
...
# 2892 "./src/main/io/asyncfatfs/asyncfatfs.c"
        ...
        return 
# 2894 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              0
# 2894 "./src/main/io/asyncfatfs/asyncfatfs.c"
                   ;
    } else {
        afatfs_fileUpdateFilesize(file);
        ...
        return 
# 2901 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              1
# 2901 "./src/main/io/asyncfatfs/asyncfatfs.c"
                  ;
    }
}
    ...
    afatfs_mkdir(const char *filename, afatfsFileCallback_t callback)
{
    ...
    if (file) {
        ...
        callback(
# 2919 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                ((void *)0)
# 2919 "./src/main/io/asyncfatfs/asyncfatfs.c"
                    );
    }

    return file != 
# 2922 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  ((void *)0)
# 2922 "./src/main/io/asyncfatfs/asyncfatfs.c"
                      ;
}
# 2932 "./src/main/io/asyncfatfs/asyncfatfs.c"

# 2932 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
_Bool 
# 2932 "./src/main/io/asyncfatfs/asyncfatfs.c"
    afatfs_chdir(afatfsFilePtr_t directory)
{
    if (afatfs_fileIsBusy(&afatfs.currentDirectory)) {
        return 
# 2935 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              0
# 2935 "./src/main/io/asyncfatfs/asyncfatfs.c"
                   ;
    }
    ...
    if (directory) {
        if (afatfs_fileIsBusy(directory)) {
            return 
# 2940 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  0
# 2940 "./src/main/io/asyncfatfs/asyncfatfs.c"
                       ;
        }

        memcpy(&afatfs.currentDirectory, directory, sizeof(*directory));
        return 
# 2944 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              1
# 2944 "./src/main/io/asyncfatfs/asyncfatfs.c"
                  ;
    } else {
        ...
        return 
# 2963 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              1
# 2963 "./src/main/io/asyncfatfs/asyncfatfs.c"
                  ;
    }
}
# 2993 "./src/main/io/asyncfatfs/asyncfatfs.c"

# 2993 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
_Bool 
# 2993 "./src/main/io/asyncfatfs/asyncfatfs.c"
    afatfs_fopen(const char *filename, const char *mode, afatfsFileCallback_t complete)
{
    ...
    if (file) {
        ...
        complete(
# 3030 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                ((void *)0)
# 3030 "./src/main/io/asyncfatfs/asyncfatfs.c"
                    );
    }

    return file != 
# 3033 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  ((void *)0)
# 3033 "./src/main/io/asyncfatfs/asyncfatfs.c"
                      ;
}
...
# 3070 "./src/main/io/asyncfatfs/asyncfatfs.c"
uint32_t afatfs_fwrite(afatfsFilePtr_t file, const uint8_t *buffer, uint32_t len)
{
    if ((file->mode & (4 | 2)) == 0) {
        return 0;
...
# 3107 "./src/main/io/asyncfatfs/asyncfatfs.c"
        if (afatfs_fseekInternal(file, bytesToWriteThisSector, 
# 3107 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                                              ((void *)0)
# 3107 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                                                  ) == AFATFS_OPERATION_IN_PROGRESS) {
            break;
...
# 3137 "./src/main/io/asyncfatfs/asyncfatfs.c"
uint32_t afatfs_fread(afatfsFilePtr_t file, uint8_t *buffer, uint32_t len)
{
    if ((file->mode & 1) == 0) {
        return 0;
...
# 3182 "./src/main/io/asyncfatfs/asyncfatfs.c"
        if (afatfs_fseekInternal(file, bytesToReadThisSector, 
# 3182 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                                             ((void *)0)
# 3182 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                                                 ) == AFATFS_OPERATION_IN_PROGRESS) {
            break;
...
# 3198 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
_Bool 
# 3198 "./src/main/io/asyncfatfs/asyncfatfs.c"
    afatfs_feof(afatfsFilePtr_t file)
{
...
# 3225 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                          0
# 3225 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                               );
        break;
...
# 3295 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 3400 "./src/main/io/asyncfatfs/asyncfatfs.c"
        ...
        case AFATFS_INITIALIZATION_READ_VOLUME_ID:
            if (afatfs_cacheSector(afatfs.partitionStartSector, &sector, 1 | 8, 0) == AFATFS_OPERATION_SUCCESS) {
                if (afatfs_parseVolumeID(sector)) {
                    ...
                    afatfs_chdir(
# 3426 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                ((void *)0)
# 3426 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                    );
        ...
        break;
# 3520 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 3593 "./src/main/io/asyncfatfs/asyncfatfs.c"
afatfsFilesystemState_e afatfs_getFilesystemState(void)
{
...
# 3641 "./src/main/io/asyncfatfs/asyncfatfs.c"
        if (afatfs.freeFile.type != AFATFS_FILE_TYPE_NONE) {
            afatfs_fclose(&afatfs.freeFile, 
# 3642 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                           ((void *)0)
# 3642 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                               );
            openFileCount++;
        }
...
# 3648 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                                   ((void *)0)
# 3648 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                                       );
            openFileCount++;
        }
        ...
        if (!afatfs_flush()) {
            return 
# 3655 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  0
# 3655 "./src/main/io/asyncfatfs/asyncfatfs.c"
                       ;
        }
...
# 3659 "./src/main/io/asyncfatfs/asyncfatfs.c"
        ...
        if (openFileCount > 0) {
            return 
# 3663 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  0
# 3663 "./src/main/io/asyncfatfs/asyncfatfs.c"
                       ;
        }
# 3674 "./src/main/io/asyncfatfs/asyncfatfs.c"
    }
    ...
    return 
# 3679 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
          1
# 3679 "./src/main/io/asyncfatfs/asyncfatfs.c"
              ;
}
