...
# 25 "./src/main/drivers/light_ws2811strip.h" 2
# 38 "./src/main/drivers/light_ws2811strip.h"
...
# 54 "./src/main/drivers/light_ws2811strip.h" 3 4
_Bool 
# 54 "./src/main/drivers/light_ws2811strip.h"
...
static 
# 80 "./src/main/io/ledstrip.c" 3 4
      _Bool 
# 80 "./src/main/io/ledstrip.c"
           ledStripInitialised = 
# 80 "./src/main/io/ledstrip.c" 3 4
                                 0
# 80 "./src/main/io/ledstrip.c"
                                      ;
static 
# 81 "./src/main/io/ledstrip.c" 3 4
      _Bool 
# 81 "./src/main/io/ledstrip.c"
           ledStripEnabled = 
# 81 "./src/main/io/ledstrip.c" 3 4
                             1
# 81 "./src/main/io/ledstrip.c"
...
# 675 "./src/main/io/ledstrip.c" 3 4
                                _Bool 
# 675 "./src/main/io/ledstrip.c"
                                     updateNow, timeUs_t *timer)
{
    static 
# 677 "./src/main/io/ledstrip.c" 3 4
          _Bool 
# 677 "./src/main/io/ledstrip.c"
               flash = 
# 677 "./src/main/io/ledstrip.c" 3 4
                       0
# 677 "./src/main/io/ledstrip.c"
    ...
    if (updateNow) {
        ...
        switch (getBatteryState()) {
            case BATTERY_OK:
                flash = 
# 685 "./src/main/io/ledstrip.c" 3 4
                       1
# 685 "./src/main/io/ledstrip.c"
                           ;
...
{
    static 
# 712 "./src/main/io/ledstrip.c" 3 4
          _Bool 
# 712 "./src/main/io/ledstrip.c"
               flash = 
# 712 "./src/main/io/ledstrip.c" 3 4
                       0
# 712 "./src/main/io/ledstrip.c"
    ...
    if (updateNow) {
        ...
        if (state > 50) {
            flash = 
# 720 "./src/main/io/ledstrip.c" 3 4
                   1
# 720 "./src/main/io/ledstrip.c"
                       ;
...
# 740 "./src/main/io/ledstrip.c" 3 4
                            _Bool 
# 740 "./src/main/io/ledstrip.c"
                                 updateNow, timeUs_t *timer)
{
...
# 780 "./src/main/io/ledstrip.c" 3 4
                                  _Bool 
# 780 "./src/main/io/ledstrip.c"
                                       updateNow, timeUs_t *timer)
{
    static 
# 782 "./src/main/io/ledstrip.c" 3 4
          _Bool 
# 782 "./src/main/io/ledstrip.c"
               flash = 0;
...
# 858 "./src/main/io/ledstrip.c" 3 4
           _Bool 
# 858 "./src/main/io/ledstrip.c"
                applyColor;
...
# 913 "./src/main/io/ledstrip.c" 3 4
                                   _Bool 
# 913 "./src/main/io/ledstrip.c"
                                        updateNow, timeUs_t *timer)
{
...
# 938 "./src/main/io/ledstrip.c" 3 4
                              _Bool 
# 938 "./src/main/io/ledstrip.c"
                                   updateNow, timeUs_t *timer)
{
...
# 951 "./src/main/io/ledstrip.c" 3 4
   _Bool 
# 951 "./src/main/io/ledstrip.c"
        ledOn = (blinkMask & 1);
    if (!ledOn) {
...
typedef char assert_failed_disabledTimerMask_too_small [(timTimerCount <= sizeof(disabledTimerMask) * 8) ? 1 : -1 ] __attribute__((unused));
...
# 1025 "./src/main/io/ledstrip.c" 3 4
                               _Bool 
# 1025 "./src/main/io/ledstrip.c"
                                    updateNow, timeUs_t *timer);
...
# 1046 "./src/main/io/ledstrip.c" 3 4
_Bool 
# 1046 "./src/main/io/ledstrip.c"
    isOverlayTypeUsed(ledOverlayId_e overlayType)
{
    for (int ledIndex = 0; ledIndex < ledCounts.count; ledIndex++) {
        const ledConfig_t *ledConfig = &ledStripConfig()->ledConfigs[ledIndex];
...
# 1051 "./src/main/io/ledstrip.c"
    ...
    return 
# 1054 "./src/main/io/ledstrip.c" 3 4
          0
# 1054 "./src/main/io/ledstrip.c"
               ;
}
...
void ledStripUpdate(timeUs_t currentTimeUs)
{
    ...
    if (IS_RC_MODE_ACTIVE(BOXLEDLOW) && !(ledStripConfig()->ledstrip_visual_beeper && isBeeperOn())) {
        if (ledStripEnabled) {
            ledStripDisable();
            ledStripEnabled = 
# 1078 "./src/main/io/ledstrip.c" 3 4
                             0
# 1078 "./src/main/io/ledstrip.c"
                                  ;
        }
        return;
    }
    ledStripEnabled = 
# 1082 "./src/main/io/ledstrip.c" 3 4
                     1
# 1082 "./src/main/io/ledstrip.c"
                         ;
...
# 1114 "./src/main/io/ledstrip.c" 3 4
       _Bool 
# 1114 "./src/main/io/ledstrip.c"
...
# 1120 "./src/main/io/ledstrip.c" 3 4
_Bool 
# 1120 "./src/main/io/ledstrip.c"
    parseColor(int index, const char *colorConfig)
{
...
# 1126 "./src/main/io/ledstrip.c"
    ...
    for (int componentIndex = 0; result && componentIndex < (HSV_VALUE + 1); componentIndex++) {
        ...
        if (val > hsv_limit[componentIndex]) {
            result = 
# 1135 "./src/main/io/ledstrip.c" 3 4
                    0
# 1135 "./src/main/io/ledstrip.c"
                         ;
            break;
        }
...
# 1169 "./src/main/io/ledstrip.c" 3 4
_Bool 
# 1169 "./src/main/io/ledstrip.c"
    setModeColor(ledModeIndex_e modeIndex, int modeColorIndex, int colorIndex)
{

    if (colorIndex < 0 || colorIndex >= 16)
        return 
# 1173 "./src/main/io/ledstrip.c" 3 4
              0
# 1173 "./src/main/io/ledstrip.c"
                   ;
    if (modeIndex < 6) {
        if (modeColorIndex < 0 || modeColorIndex >= 6)
            return 
# 1176 "./src/main/io/ledstrip.c" 3 4
                  0
# 1176 "./src/main/io/ledstrip.c"
                       ;
        ...
        if (modeColorIndex < 0 || modeColorIndex >= 11)
            return 
# 1180 "./src/main/io/ledstrip.c" 3 4
                  0
# 1180 "./src/main/io/ledstrip.c"
                       ;
        ...
        if (modeColorIndex < 0 || modeColorIndex >= 1)
            return 
# 1184 "./src/main/io/ledstrip.c" 3 4
                  0
# 1184 "./src/main/io/ledstrip.c"
                       ;
        ledStripConfigMutable()->ledstrip_aux_channel = colorIndex;
    } else {
        return 
# 1187 "./src/main/io/ledstrip.c" 3 4
              0
# 1187 "./src/main/io/ledstrip.c"
                   ;
    }
    return 
# 1189 "./src/main/io/ledstrip.c" 3 4
          1
# 1189 "./src/main/io/ledstrip.c"
              ;
}
...
void ledStripInit(void)
{
    ...
    ledStripInitialised = 
# 1197 "./src/main/io/ledstrip.c" 3 4
                         0
# 1197 "./src/main/io/ledstrip.c"
                              ;
}
...
void ledStripEnable(void)
{
    reevaluateLedConfig();
    ledStripInitialised = 
# 1203 "./src/main/io/ledstrip.c" 3 4
                         1
# 1203 "./src/main/io/ledstrip.c"
                             ;
