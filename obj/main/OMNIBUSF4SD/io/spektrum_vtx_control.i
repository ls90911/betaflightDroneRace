...
# 1 "<command-line>"
# 1 "./src/main/io/spektrum_vtx_control.c"
# 21 "./src/main/io/spektrum_vtx_control.c"
...
# 22 "./src/main/io/spektrum_vtx_control.c" 2
...
# 29 "./src/main/io/spektrum_vtx_control.c" 2
...
# 32 "./src/main/io/spektrum_vtx_control.c" 2
# 48 "./src/main/io/spektrum_vtx_control.c"
const uint8_t spek2commonBand[5]= {
    4,
    5,
    3,
    2,
...
# 90 "./src/main/io/spektrum_vtx_control.c"
const uint8_t vtxSaPi[8] = {
    0,
    0,
    1,
    1,
...
# 142 "./src/main/io/spektrum_vtx_control.c"
...
void spektrumVtxControl(void)
{
    ...
    if (vtxDevice) {
# 198 "./src/main/io/spektrum_vtx_control.c"
        const uint8_t band = spek2commonBand[vtx.band];
        const uint8_t channel = vtx.channel +1;
