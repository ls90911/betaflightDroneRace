...
# 21 "./src/main/config/config_reset.h"
...
# 22 "./src/main/flight/gps_rescue.h"
typedef enum {
    RESCUE_SANITY_OFF = 0,
    RESCUE_SANITY_ON,
...
__attribute__ ((section(".fastram_bss"), aligned(4))) uint32_t targetPidLooptime;
__attribute__ ((section(".fastram_bss"), aligned(4))) pidAxisData_t pidData[3];

static __attribute__ ((section(".fastram_bss"), aligned(4))) 
# 71 "./src/main/flight/pid.c" 3 4
                         _Bool 
# 71 "./src/main/flight/pid.c"
                              pidStabilisationEnabled;

static __attribute__ ((section(".fastram_bss"), aligned(4))) 
# 73 "./src/main/flight/pid.c" 3 4
                         _Bool 
# 73 "./src/main/flight/pid.c"
                              inCrashRecoveryMode = 
# 73 "./src/main/flight/pid.c" 3 4
                                                    0
# 73 "./src/main/flight/pid.c"
...
static __attribute__ ((section(".fastram_bss"), aligned(4))) float dT;
static __attribute__ ((section(".fastram_bss"), aligned(4))) float pidFrequency;

static __attribute__ ((section(".fastram_bss"), aligned(4))) uint8_t antiGravityMode;
static __attribute__ ((section(".fastram_bss"), aligned(4))) float antiGravityThrottleHpf;
static __attribute__ ((section(".fastram_bss"), aligned(4))) uint16_t itermAcceleratorGain;
static __attribute__ ((section(".fastram_data"), aligned(4))) float antiGravityOsdCutoff = 1.0f;
static __attribute__ ((section(".fastram_bss"), aligned(4))) 
# 82 "./src/main/flight/pid.c" 3 4
                         _Bool 
# 82 "./src/main/flight/pid.c"
                              antiGravityEnabled;
...
, .runaway_takeoff_deactivate_throttle = 25, .runaway_takeoff_deactivate_delay = 500 }
 ...
 ;
# 114 "./src/main/flight/pid.c"
extern void pgResetFn_pidProfiles(pidProfile_t *); pidProfile_t pidProfiles_SystemArray[3]; pidProfile_t pidProfiles_CopyArray[3]; extern const pgRegistry_t pidProfiles_Registry; const pgRegistry_t pidProfiles_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 14 | (5 << 12), .size = (sizeof(pidProfile_t) * 3) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&pidProfiles_SystemArray, .copy = (uint8_t*)&pidProfiles_CopyArray, .ptr = 0, .reset = {.fn = (pgResetFunc*)&pgResetFn_pidProfiles}, };

void resetPidProfile(pidProfile_t *pidProfile)
{
    static const pidProfile_t _reset_template_171 = { .pid = { [PID_ROLL] = { 46, 45, 25, 60 }, [PID_PITCH] = { 50, 50, 27, 60 }, [PID_YAW] = { 65, 45, 0 , 60 }, [PID_LEVEL] = { 50, 50, 75, 0 }, [PID_MAG] = { 40, 0, 0, 0 }, }, .pidSumLimit = 500, .pidSumLimitYaw = 400, .yaw_lowpass_hz = 0, .dterm_lowpass_hz = 100, .dterm_lowpass2_hz = 200, .dterm_notch_hz = 0, .dterm_notch_cutoff = 160, .dterm_filter_type = FILTER_PT1, .itermWindupPointPercent = 40, .vbatPidCompensation = 0, .pidAtMinThrottle = PID_STABILISATION_ON, .levelAngleLimit = 55, .feedForwardTransition = 0, .yawRateAccelLimit = 100, .rateAccelLimit = 0, .itermThrottleThreshold = 250, .itermAcceleratorGain = 5000, .crash_time = 500, .crash_delay = 0, .crash_recovery_angle = 10, .crash_recovery_rate = 100, .crash_dthreshold = 50, .crash_gthreshold = 400, .crash_setpoint_threshold = 350, .crash_recovery = PID_CRASH_RECOVERY_OFF, .horizon_tilt_effect = 75, .horizon_tilt_expert_mode = 
# 118 "./src/main/flight/pid.c" 3 4
   0
# 118 "./src/main/flight/pid.c"
   , .crash_limit_yaw = 200, .itermLimit = 150, .throttle_boost = 5, .throttle_boost_cutoff = 15, .iterm_rotation = 
# 118 "./src/main/flight/pid.c" 3 4
   1
# 118 "./src/main/flight/pid.c"
   , .smart_feedforward = 
# 118 "./src/main/flight/pid.c" 3 4
   0
# 118 "./src/main/flight/pid.c"
   , .iterm_relax = ITERM_RELAX_OFF, .iterm_relax_cutoff = 11, .iterm_relax_type = ITERM_RELAX_GYRO, .acro_trainer_angle_limit = 20, .acro_trainer_lookahead_ms = 50, .acro_trainer_debug_axis = FD_ROLL, .acro_trainer_gain = 75, .abs_control_gain = 0, .abs_control_limit = 90, .abs_control_error_limit = 20, .antiGravityMode = ANTI_GRAVITY_SMOOTH, }; memcpy((pidProfile), &_reset_template_171, sizeof(*(pidProfile)));
...
static __attribute__ ((section(".fastram_data"), aligned(4))) float itermAccelerator = 1.0f;
...
# 195 "./src/main/flight/pid.c" 3 4
_Bool 
# 195 "./src/main/flight/pid.c"
    pidOsdAntiGravityActive(void)
{
...
# 202 "./src/main/flight/pid.c" 3 4
                                                                            1 
# 202 "./src/main/flight/pid.c"
                                                                                 : 
# 202 "./src/main/flight/pid.c" 3 4
                                                                                   0
# 202 "./src/main/flight/pid.c"
...
static __attribute__ ((section(".fastram_bss"), aligned(4))) filterApplyFnPtr dtermNotchApplyFn;
static __attribute__ ((section(".fastram_bss"), aligned(4))) biquadFilter_t dtermNotch[3];
static __attribute__ ((section(".fastram_bss"), aligned(4))) filterApplyFnPtr dtermLowpassApplyFn;
static __attribute__ ((section(".fastram_bss"), aligned(4))) dtermLowpass_t dtermLowpass[3];
static __attribute__ ((section(".fastram_bss"), aligned(4))) filterApplyFnPtr dtermLowpass2ApplyFn;
static __attribute__ ((section(".fastram_bss"), aligned(4))) pt1Filter_t dtermLowpass2[3];
static __attribute__ ((section(".fastram_bss"), aligned(4))) filterApplyFnPtr ptermYawLowpassApplyFn;
static __attribute__ ((section(".fastram_bss"), aligned(4))) pt1Filter_t ptermYawLowpass;

static __attribute__ ((section(".fastram_bss"), aligned(4))) pt1Filter_t windupLpf[3];
static __attribute__ ((section(".fastram_bss"), aligned(4))) uint8_t itermRelax;
static __attribute__ ((section(".fastram_bss"), aligned(4))) uint8_t itermRelaxType;
static __attribute__ ((section(".fastram_bss"), aligned(4))) uint8_t itermRelaxCutoff;



static __attribute__ ((section(".fastram_bss"), aligned(4))) pt1Filter_t setpointDerivativePt1[3];
static __attribute__ ((section(".fastram_bss"), aligned(4))) biquadFilter_t setpointDerivativeBiquad[3];
static __attribute__ ((section(".fastram_bss"), aligned(4))) 
# 230 "./src/main/flight/pid.c" 3 4
                         _Bool 
# 230 "./src/main/flight/pid.c"
                              setpointDerivativeLpfInitialized;
static __attribute__ ((section(".fastram_bss"), aligned(4))) uint8_t rcSmoothingDebugAxis;
static __attribute__ ((section(".fastram_bss"), aligned(4))) uint8_t rcSmoothingFilterType;


static __attribute__ ((section(".fastram_bss"), aligned(4))) pt1Filter_t antiGravityThrottleLpf;
...
void pidInitFilters(const pidProfile_t *pidProfile)
{
    ...
    pt1FilterInit(&antiGravityThrottleLpf, pt1FilterGain(15, dT));
}
...
void pidInitSetpointDerivativeLpf(uint16_t filterCutoff, uint8_t debugAxis, uint8_t filterType)
{
    ...
    if ((filterCutoff > 0) && (rcSmoothingFilterType != RC_SMOOTHING_DERIVATIVE_OFF)) {
        setpointDerivativeLpfInitialized = 
# 331 "./src/main/flight/pid.c" 3 4
                                          1
# 331 "./src/main/flight/pid.c"
                                              ;
        for (int axis = FD_ROLL; axis <= FD_YAW; axis++) {
...
static __attribute__ ((section(".fastram_bss"), aligned(4))) pidCoefficient_t pidCoefficient[3];
static __attribute__ ((section(".fastram_bss"), aligned(4))) float maxVelocity[3];
static __attribute__ ((section(".fastram_bss"), aligned(4))) float feedForwardTransition;
static __attribute__ ((section(".fastram_bss"), aligned(4))) float levelGain, horizonGain, horizonTransition, horizonCutoffDegrees, horizonFactorRatio;
static __attribute__ ((section(".fastram_bss"), aligned(4))) float ITermWindupPointInv;
static __attribute__ ((section(".fastram_bss"), aligned(4))) uint8_t horizonTiltExpertMode;
static __attribute__ ((section(".fastram_bss"), aligned(4))) timeDelta_t crashTimeLimitUs;
static __attribute__ ((section(".fastram_bss"), aligned(4))) timeDelta_t crashTimeDelayUs;
static __attribute__ ((section(".fastram_bss"), aligned(4))) int32_t crashRecoveryAngleDeciDegrees;
static __attribute__ ((section(".fastram_bss"), aligned(4))) float crashRecoveryRate;
static __attribute__ ((section(".fastram_bss"), aligned(4))) float crashDtermThreshold;
static __attribute__ ((section(".fastram_bss"), aligned(4))) float crashGyroThreshold;
static __attribute__ ((section(".fastram_bss"), aligned(4))) float crashSetpointThreshold;
static __attribute__ ((section(".fastram_bss"), aligned(4))) float crashLimitYaw;
static __attribute__ ((section(".fastram_bss"), aligned(4))) float itermLimit;

__attribute__ ((section(".fastram_bss"), aligned(4))) float throttleBoost;
pt1Filter_t throttleLpf;

static __attribute__ ((section(".fastram_bss"), aligned(4))) 
# 388 "./src/main/flight/pid.c" 3 4
                         _Bool 
# 388 "./src/main/flight/pid.c"
                              itermRotation;


static __attribute__ ((section(".fastram_bss"), aligned(4))) 
# 391 "./src/main/flight/pid.c" 3 4
                         _Bool 
# 391 "./src/main/flight/pid.c"
                              smartFeedforward;


static __attribute__ ((section(".fastram_bss"), aligned(4))) float axisError[3];
static __attribute__ ((section(".fastram_bss"), aligned(4))) float acGain;
static __attribute__ ((section(".fastram_bss"), aligned(4))) float acLimit;
static __attribute__ ((section(".fastram_bss"), aligned(4))) float acErrorLimit;
...
static __attribute__ ((section(".fastram_bss"), aligned(4))) float acroTrainerAngleLimit;
static __attribute__ ((section(".fastram_bss"), aligned(4))) float acroTrainerLookaheadTime;
static __attribute__ ((section(".fastram_bss"), aligned(4))) uint8_t acroTrainerDebugAxis;
static __attribute__ ((section(".fastram_bss"), aligned(4))) 
# 414 "./src/main/flight/pid.c" 3 4
                         _Bool 
# 414 "./src/main/flight/pid.c"
                              acroTrainerActive;
static __attribute__ ((section(".fastram_bss"), aligned(4))) int acroTrainerAxisState[2];
static __attribute__ ((section(".fastram_bss"), aligned(4))) float acroTrainerGain;
...
void pidInitConfig(const pidProfile_t *pidProfile)
{
    ...
    for (int axis = FD_ROLL; axis <= FD_YAW; axis++) {
        pidCoefficient[axis].Kp = 0.032029f * pidProfile->pid[axis].P;
        pidCoefficient[axis].Ki = 0.244381f * pidProfile->pid[axis].I;
        pidCoefficient[axis].Kd = 0.000529f * pidProfile->pid[axis].D;
        pidCoefficient[axis].Kf = 0.013754f * (pidProfile->pid[axis].F / 100.0f);
    }
...
static float pidLevel(int axis, const pidProfile_t *pidProfile, const rollAndPitchTrims_t *angleTrim, float currentPidSetpoint) {
    ...
    if ((flightModeFlags & (ANGLE_MODE)) || (flightModeFlags & (GPS_RESCUE_MODE))) {
    ...
    const int axis, const timeUs_t currentTimeUs, const float gyroRate, float *currentPidSetpoint, float *errorRate)
{
    if (inCrashRecoveryMode && cmpTimeUs(currentTimeUs, crashDetectedAtUs) > crashTimeDelayUs) {
        if (crash_recovery == PID_CRASH_RECOVERY_BEEP) {
            systemBeep(
# 621 "./src/main/flight/pid.c" 3 4
           1
# 621 "./src/main/flight/pid.c"
           );
        }
        if (axis == FD_YAW) {
            ...
            if (sensors(SENSOR_ACC)) {
                ...
                if (__extension__ ({ __typeof__ (attitude.raw[FD_ROLL] - angleTrim->raw[FD_ROLL]) _x = (attitude.raw[FD_ROLL] - angleTrim->raw[FD_ROLL]); _x > 0 ? _x : -_x; }) < crashRecoveryAngleDeciDegrees
                   && __extension__ ({ __typeof__ (attitude.raw[FD_PITCH] - angleTrim->raw[FD_PITCH]) _x = (attitude.raw[FD_PITCH] - angleTrim->raw[FD_PITCH]); _x > 0 ? _x : -_x; }) < crashRecoveryAngleDeciDegrees) {
                    inCrashRecoveryMode = 
# 646 "./src/main/flight/pid.c" 3 4
                                         0
# 646 "./src/main/flight/pid.c"
                                              ;
                    systemBeep(
# 647 "./src/main/flight/pid.c" 3 4
                   0
# 647 "./src/main/flight/pid.c"
                   );
                }
            } else {
                inCrashRecoveryMode = 
# 650 "./src/main/flight/pid.c" 3 4
                                     0
# 650 "./src/main/flight/pid.c"
                                          ;
                systemBeep(
# 651 "./src/main/flight/pid.c" 3 4
               0
# 651 "./src/main/flight/pid.c"
               );
            }
        }
    }
    ...
    const timeUs_t currentTimeUs, const float delta, const float errorRate)
{
    ...
    if ((crash_recovery || (flightModeFlags & (GPS_RESCUE_MODE))) && !gyroOverflowDetected()) {
        if ((armingFlags & (ARMED))) {
            if (getMotorMixRange() >= 1.0f && !inCrashRecoveryMode
                ...
                inCrashRecoveryMode = 
# 669 "./src/main/flight/pid.c" 3 4
                                     1
# 669 "./src/main/flight/pid.c"
                                         ;
            ...
            if (inCrashRecoveryMode && cmpTimeUs(currentTimeUs, crashDetectedAtUs) < crashTimeDelayUs && (__extension__ ({ __typeof__ (errorRate) _x = (errorRate); _x > 0 ? _x : -_x; }) < crashGyroThreshold
                || __extension__ ({ __typeof__ (getSetpointRate(axis)) _x = (getSetpointRate(axis)); _x > 0 ? _x : -_x; }) > crashSetpointThreshold)) {
                inCrashRecoveryMode = 
# 674 "./src/main/flight/pid.c" 3 4
                                     0
# 674 "./src/main/flight/pid.c"
                                          ;
                systemBeep(
# 675 "./src/main/flight/pid.c" 3 4
               0
# 675 "./src/main/flight/pid.c"
               );
            }
        } else if (inCrashRecoveryMode) {
            inCrashRecoveryMode = 
# 678 "./src/main/flight/pid.c" 3 4
                                 0
# 678 "./src/main/flight/pid.c"
                                      ;
            systemBeep(
# 679 "./src/main/flight/pid.c" 3 4
           0
# 679 "./src/main/flight/pid.c"
           );
        }
    }
}
...
static void rotateITermAndAxisError()
{
    if (itermRotation
        ...
        const float gyroToAngle = dT * (3.14159265358979323846f / 180.0f);
...
# 750 "./src/main/flight/pid.c" 3 4
       _Bool 
# 750 "./src/main/flight/pid.c"
            resetIterm = 
# 750 "./src/main/flight/pid.c" 3 4
                         0
# 750 "./src/main/flight/pid.c"
        ...
        if ((acroTrainerAxisState[axis] != 0) && (acroTrainerAxisState[axis] != setpointSign)) {
        ...
        if ((fabsf(currentAngle) > acroTrainerAngleLimit) && (acroTrainerAxisState[axis] == 0)) {
            if (angleSign == setpointSign) {
                ...
                resetIterm = 
# 764 "./src/main/flight/pid.c" 3 4
                            1
# 764 "./src/main/flight/pid.c"
                                ;
            }
        }

        if (acroTrainerAxisState[axis] != 0) {
            ret = constrainf(((acroTrainerAngleLimit * angleSign) - currentAngle) * acroTrainerGain, -1000.0f, 1000.0f);
        } else {
            ...
            float checkInterval = constrainf(fabsf(gyro.gyroADCf[axis]) / 500.0f, 0.0f, 1.0f) * acroTrainerLookaheadTime;
            ...
            if ((fabsf(projectedAngle) > acroTrainerAngleLimit) && (projectedAngleSign == setpointSign)) {
                ...
                resetIterm = 
# 781 "./src/main/flight/pid.c" 3 4
                            1
# 781 "./src/main/flight/pid.c"
                                ;
            }
        }
        ...
        if (axis == acroTrainerDebugAxis) {
            ...
            {if (debugMode == (DEBUG_ACRO_TRAINER)) {debug[(1)] = (acroTrainerAxisState[axis]);}};
...
float applyRcSmoothingDerivativeFilter(int axis, float pidSetpointDelta)
{
...
void applySmartFeedforward(int axis)
{
    if (smartFeedforward) {
        if (pidData[axis].P * pidData[axis].F > 0) {
            if (__extension__ ({ __typeof__ (pidData[axis].F) _x = (pidData[axis].F); _x > 0 ? _x : -_x; }) > __extension__ ({ __typeof__ (pidData[axis].P) _x = (pidData[axis].P); _x > 0 ? _x : -_x; })) {
                pidData[axis].P = 0;
            } else {
                pidData[axis].F = 0;
            }
...
void pidController(const pidProfile_t *pidProfile, const rollAndPitchTrims_t *angleTrim, timeUs_t currentTimeUs)
{
    ...
    const 
# 851 "./src/main/flight/pid.c" 3 4
         _Bool 
# 851 "./src/main/flight/pid.c"
    ...
    if ((antiGravityMode == ANTI_GRAVITY_SMOOTH) && antiGravityEnabled) {
        ...
        {if (debugMode == (DEBUG_ANTI_GRAVITY)) {debug[(1)] = (lrintf(antiGravityThrottleHpf * 1000));}};
    }
    {if (debugMode == (DEBUG_ANTI_GRAVITY)) {debug[(0)] = (lrintf(itermAccelerator * 1000));}};

    const float dynCi = __extension__ ({ __typeof__ ((1.0f - motorMixRange) * ITermWindupPointInv) _a = ((1.0f - motorMixRange) * ITermWindupPointInv); __typeof__ (1.0f) _b = (1.0f); _a < _b ? _a : _b; }) * dT * itermAccelerator;
    ...
    for (int axis = FD_ROLL; axis <= FD_YAW; ++axis) {
        ...
        if (((flightModeFlags & (ANGLE_MODE)) || (flightModeFlags & (HORIZON_MODE)) || (flightModeFlags & (GPS_RESCUE_MODE))) && axis != FD_YAW) {
        ...
        if (itermRelax && (axis < FD_YAW || itermRelax == ITERM_RELAX_RPY || itermRelax == ITERM_RELAX_RPY_INC)) {
            ...
            const 
# 916 "./src/main/flight/pid.c" 3 4
                 _Bool 
# 916 "./src/main/flight/pid.c"
                      isDecreasingI = ((ITerm > 0) && (itermErrorRate < 0)) || ((ITerm < 0) && (itermErrorRate > 0));
        ...
        if (acGain > 0 && isAirmodeActivated()) {
            ...
            if (axis == FD_ROLL) {
                {if (debugMode == (DEBUG_ITERM_RELAX)) {debug[(3)] = (lrintf(axisError[axis] * 10));}};
            }
        }
        ...
        const 
# 988 "./src/main/flight/pid.c" 3 4
             _Bool 
# 988 "./src/main/flight/pid.c"
                  outputSaturated = mixerIsOutputSaturated(axis, errorRate);
        if (outputSaturated == 
# 989 "./src/main/flight/pid.c" 3 4
                              0 
# 989 "./src/main/flight/pid.c"
        ...
        if (feedforwardGain > 0) {
            ...
            float transition = feedForwardTransition > 0 ? __extension__ ({ __typeof__ (1.f) _a = (1.f); __typeof__ (getRcDeflectionAbs(axis) * feedForwardTransition) _b = (getRcDeflectionAbs(axis) * feedForwardTransition); _a < _b ? _a : _b; }) : 1;
...
# 1069 "./src/main/flight/pid.c" 3 4
_Bool 
# 1069 "./src/main/flight/pid.c"
    crashRecoveryModeActive(void)
{
...
void pidSetAcroTrainerState(
# 1075 "./src/main/flight/pid.c" 3 4
                           _Bool 
# 1075 "./src/main/flight/pid.c"
                                newState)
{
...
void pidSetAntiGravityState(
# 1086 "./src/main/flight/pid.c" 3 4
                           _Bool 
# 1086 "./src/main/flight/pid.c"
                                newState)
{
...
# 1095 "./src/main/flight/pid.c" 3 4
_Bool 
# 1095 "./src/main/flight/pid.c"
    pidAntiGravityEnabled(void)
{
