# 1 "./src/main/flight/gps_rescue.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/flight/gps_rescue.c"
# 18 "./src/main/flight/gps_rescue.c"
...
# 19 "./src/main/flight/gps_rescue.c" 2
...
# 6 "/home/jiahao/betaflight/tools/gcc-arm-none-eabi-7-2017-q4-major/arm-none-eabi/include/math.h" 2 3
...
# 7 "/home/jiahao/betaflight/tools/gcc-arm-none-eabi-7-2017-q4-major/arm-none-eabi/include/math.h" 2 3
# 1 "/home/jiahao/betaflight/tools/gcc-arm-none-eabi-7-2017-q4-major/arm-none-eabi/include/machine/ieeefp.h" 1 3
# 8 "/home/jiahao/betaflight/tools/gcc-arm-none-eabi-7-2017-q4-major/arm-none-eabi/include/math.h" 2 3
# 1 "/home/jiahao/betaflight/tools/gcc-arm-none-eabi-7-2017-q4-major/arm-none-eabi/include/_ansi.h" 1 3
# 9 "/home/jiahao/betaflight/tools/gcc-arm-none-eabi-7-2017-q4-major/arm-none-eabi/include/math.h" 2 3
...
# 20 "./src/main/flight/gps_rescue.c" 2
...
# 22 "./src/main/flight/gps_rescue.c" 2
...
# 26 "./src/main/flight/gps_rescue.c" 2
...
# 28 "./src/main/flight/gps_rescue.c" 2
...
# 29 "./src/main/flight/gps_rescue.c" 2
...
# 31 "./src/main/flight/gps_rescue.c" 2
...
# 33 "./src/main/flight/gps_rescue.c" 2
...
# 35 "./src/main/flight/gps_rescue.c" 2
...
# 36 "./src/main/flight/gps_rescue.c" 2
...
# 37 "./src/main/flight/gps_rescue.c" 2
...
# 38 "./src/main/flight/gps_rescue.c" 2
...
void mwDisarm(void);
# 39 "./src/main/flight/gps_rescue.c" 2
...
# 41 "./src/main/flight/gps_rescue.c" 2
...
# 42 "./src/main/flight/gps_rescue.c" 2
...
# 43 "./src/main/flight/gps_rescue.c" 2
...
# 44 "./src/main/flight/gps_rescue.c" 2


# 1 "./src/main/pg/pg_ids.h" 1
# 21 "./src/main/pg/pg_ids.h"
       
# 47 "./src/main/flight/gps_rescue.c" 2
...
# 49 "./src/main/flight/gps_rescue.c" 2
...
# 51 "./src/main/flight/gps_rescue.c" 2
...
# 53 "./src/main/flight/gps_rescue.c" 2




extern const gpsRescueConfig_t pgResetTemplate_gpsRescueConfig; gpsRescueConfig_t gpsRescueConfig_System; gpsRescueConfig_t gpsRescueConfig_Copy; extern const pgRegistry_t gpsRescueConfig_Registry; const pgRegistry_t gpsRescueConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 55 | (0 << 12), .size = sizeof(gpsRescueConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&gpsRescueConfig_System, .copy = (uint8_t*)&gpsRescueConfig_Copy, .ptr = 0, .reset = {.ptr = (void*)&pgResetTemplate_gpsRescueConfig}, };

const gpsRescueConfig_t pgResetTemplate_gpsRescueConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .angle = 32, .initialAltitude = 50, .descentDistance = 200, .rescueGroundspeed = 2000, .throttleP = 150, .throttleI = 20, .throttleD = 50, .velP = 80, .velI = 20, .velD = 15, .yawP = 40, .throttleMin = 1200, .throttleMax = 1600, .throttleHover = 1280, .sanityChecks = RESCUE_SANITY_ON, .minSats = 8 }
# 76 "./src/main/flight/gps_rescue.c"
 ;

static uint16_t rescueThrottle;
static float rescueYaw;

int32_t gpsRescueAngle[2] = { 0, 0 };
...
static 
# 87 "./src/main/flight/gps_rescue.c" 3 4
      _Bool 
# 87 "./src/main/flight/gps_rescue.c"
           newGPSData = 
# 87 "./src/main/flight/gps_rescue.c" 3 4
                        0
# 87 "./src/main/flight/gps_rescue.c"
...
void rescueNewGpsData(void)
{
 ...
 GPS_reset_home_position();
    newGPSData = 
# 99 "./src/main/flight/gps_rescue.c" 3 4
                1
# 99 "./src/main/flight/gps_rescue.c"
                    ;
}
...
void updateGPSRescueState(void)
{
    if (!(flightModeFlags & (GPS_RESCUE_MODE))) {
        rescueStop();
    } else if ((flightModeFlags & (GPS_RESCUE_MODE)) && rescueState.phase == RESCUE_IDLE) {
        rescueStart();
    }
    ...
    case RESCUE_INITIALIZE:
        ...
        if (rescueState.sensor.distanceToHome < 100) {
            ...
            if (rescueState.isFailsafe || !(armingFlags & (ARMED))) {
    ...
    case RESCUE_ATTAIN_ALT:
        ...
        if (__extension__ ({ __typeof__ (rescueState.intent.targetAltitude - rescueState.sensor.currentAltitude) _x = (rescueState.intent.targetAltitude - rescueState.sensor.currentAltitude); _x > 0 ? _x : -_x; }) < 1000) {
            rescueState.phase = RESCUE_CROSSTRACK;
        }

        rescueState.intent.targetGroundspeed = 500;
        rescueState.intent.targetAltitude = __extension__ ({ __typeof__ (gpsRescueConfig()->initialAltitude * 100) _a = (gpsRescueConfig()->initialAltitude * 100); __typeof__ (rescueState.sensor.maxAltitude + 1500) _b = (rescueState.sensor.maxAltitude + 1500); _a > _b ? _a : _b; });
        rescueState.intent.crosstrack = 
# 149 "./src/main/flight/gps_rescue.c" 3 4
                                       1
# 149 "./src/main/flight/gps_rescue.c"
                                           ;
    ...
    case RESCUE_CROSSTRACK:
        ...
        rescueState.intent.targetAltitude = __extension__ ({ __typeof__ (gpsRescueConfig()->initialAltitude * 100) _a = (gpsRescueConfig()->initialAltitude * 100); __typeof__ (rescueState.sensor.maxAltitude + 1500) _b = (rescueState.sensor.maxAltitude + 1500); _a > _b ? _a : _b; });
        rescueState.intent.crosstrack = 
# 162 "./src/main/flight/gps_rescue.c" 3 4
                                       1
# 162 "./src/main/flight/gps_rescue.c"
                                           ;
    ...
    case RESCUE_LANDING_APPROACH:
        ...
        rescueState.intent.crosstrack = 
# 178 "./src/main/flight/gps_rescue.c" 3 4
                                       1
# 178 "./src/main/flight/gps_rescue.c"
                                           ;
        rescueState.intent.minAngleDeg = 10;
    ...
    case RESCUE_LANDING:
        ...
        rescueState.intent.crosstrack = 
# 195 "./src/main/flight/gps_rescue.c" 3 4
                                       1
# 195 "./src/main/flight/gps_rescue.c"
                                           ;
    ...
    newGPSData = 
# 217 "./src/main/flight/gps_rescue.c" 3 4
                0
# 217 "./src/main/flight/gps_rescue.c"
                     ;
}
...
void sensorUpdate()
{
    ...
    if (newGPSData) {
        ...
        rescueState.sensor.accMagnitude = (float) sqrt(((acc.accADC[Z])*(acc.accADC[Z])) + ((acc.accADC[X])*(acc.accADC[X])) + ((acc.accADC[Y])*(acc.accADC[Y])) / ((acc.dev.acc_1G)*(acc.dev.acc_1G)));
...
void performSanityChecks()
{
    ...
    if (rescueState.failure != RESCUE_HEALTHY) {
        if (gpsRescueConfig()->sanityChecks == RESCUE_SANITY_ON
            || (gpsRescueConfig()->sanityChecks == RESCUE_SANITY_FS_ONLY && rescueState.isFailsafe == 
# 259 "./src/main/flight/gps_rescue.c" 3 4
                                                                                                     1
# 259 "./src/main/flight/gps_rescue.c"
                                                                                                         )) {
...
void idleTasks()
{
    ...
    rescueState.sensor.maxAltitude = __extension__ ({ __typeof__ (rescueState.sensor.currentAltitude) _a = (rescueState.sensor.currentAltitude); __typeof__ (rescueState.sensor.maxAltitude) _b = (rescueState.sensor.maxAltitude); _a > _b ? _a : _b; });

    rescueState.sensor.maxDistanceToHome = __extension__ ({ __typeof__ (rescueState.sensor.distanceToHome) _a = (rescueState.sensor.distanceToHome); __typeof__ (rescueState.sensor.maxDistanceToHome) _b = (rescueState.sensor.maxDistanceToHome); _a > _b ? _a : _b; });
...
void rescueAttainPosition()
{
    ...
    gpsRescueAngle[AI_PITCH] = constrain(gpsRescueAngle[AI_PITCH] + __extension__ ({ __typeof__ (angleAdjustment) _a = (angleAdjustment); __typeof__ (80) _b = (80); _a < _b ? _a : _b; }), rescueState.intent.minAngleDeg * 100, rescueState.intent.maxAngleDeg * 100);

    float ct = cos(((gpsRescueAngle[AI_PITCH] / 10) / 10.0f * 0.0174532925f));
    ...
    const int16_t altitudeError = (rescueState.intent.targetAltitude - rescueState.sensor.currentAltitude) / 100;
    const int16_t altitudeDerivative = altitudeError - previousAltitudeError;


    if (__extension__ ({ __typeof__ (altitudeError) _x = (altitudeError); _x > 0 ? _x : -_x; }) < 25) {
    ...
    {if (debugMode == (DEBUG_RTH)) {debug[(0)] = (rescueThrottle);}};
    {if (debugMode == (DEBUG_RTH)) {debug[(1)] = (gpsRescueAngle[AI_PITCH]);}};
    {if (debugMode == (DEBUG_RTH)) {debug[(2)] = (altitudeAdjustment);}};
    {if (debugMode == (DEBUG_RTH)) {debug[(3)] = (rescueState.failure);}};
}
...
void setBearing(int16_t desiredHeading)
{
    ...
    errorAngle *= -((rcControlsConfig()->yaw_control_reversed) ? -1 : 1);




    rescueYaw = -constrainf(errorAngle / 45 * 360, -360, 360);
}
...
float gpsRescueGetThrottle(void)
{
    ...
    float commandedThrottle = scaleRangef(rescueThrottle, __extension__ ({ __typeof__ (rxConfig()->mincheck) _a = (rxConfig()->mincheck); __typeof__ (1000) _b = (1000); _a > _b ? _a : _b; }), 2000, 0.0f, 1.0f);
...
# 452 "./src/main/flight/gps_rescue.c" 3 4
_Bool 
# 452 "./src/main/flight/gps_rescue.c"
    gpsRescueIsConfigured(void)
{
