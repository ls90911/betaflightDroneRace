                                ...
                                uint16_t len)
{
  ...
  if (pdev->cfg.dma_enable == 0)
  {
    ...
    {
      (*(volatile uint32_t *)(fifo) = (*((__attribute__ ((__packed__)) uint32_t *)src)));
      src+=4;
    }
  }
  return status;
                         ...
                         uint16_t len)
{
  ...
  for( i = 0; i < count32b; i++)
  {
    *(__attribute__ ((__packed__)) uint32_t *)dest = (*(volatile uint32_t *)(fifo));
    dest += 4 ;
  }
  return ((void *)dest);
}
...
# 322 "./lib/main/STM32_USB_OTG_Driver/src/usb_core.c" 2
# 330 "./lib/main/STM32_USB_OTG_Driver/src/usb_core.c"
USB_OTG_STS USB_OTG_CoreInit(USB_OTG_CORE_HANDLE *pdev)
{
  USB_OTG_STS status = USB_OTG_OK;
...
# 439 "./lib/main/STM32_USB_OTG_Driver/src/usb_core.c"
  return status;
}
...
# 465 "./lib/main/STM32_USB_OTG_Driver/src/usb_core.c"
USB_OTG_STS USB_OTG_DisableGlobalInt(USB_OTG_CORE_HANDLE *pdev)
{
  USB_OTG_STS status = USB_OTG_OK;
  USB_OTG_GAHBCFG_TypeDef ahbcfg;
...
# 482 "./lib/main/STM32_USB_OTG_Driver/src/usb_core.c"
USB_OTG_STS USB_OTG_FlushTxFifo (USB_OTG_CORE_HANDLE *pdev , uint32_t num )
{
  USB_OTG_STS status = USB_OTG_OK;
  volatile USB_OTG_GRSTCTL_TypeDef greset;
...
# 542 "./lib/main/STM32_USB_OTG_Driver/src/usb_core.c"
...
# 1211 "./lib/main/STM32_USB_OTG_Driver/src/usb_core.c"
void USB_OTG_InitDevSpeed(USB_OTG_CORE_HANDLE *pdev , uint8_t speed)
{
...
# 1227 "./lib/main/STM32_USB_OTG_Driver/src/usb_core.c"
USB_OTG_STS USB_OTG_CoreInitDev (USB_OTG_CORE_HANDLE *pdev)
{
  USB_OTG_STS status = USB_OTG_OK;
...
# 1339 "./lib/main/STM32_USB_OTG_Driver/src/usb_core.c"
...
# 1450 "./lib/main/STM32_USB_OTG_Driver/src/usb_core.c"
enum USB_OTG_SPEED USB_OTG_GetDeviceSpeed (USB_OTG_CORE_HANDLE *pdev)
{
...
# 1564 "./lib/main/STM32_USB_OTG_Driver/src/usb_core.c"
...
# 1749 "./lib/main/STM32_USB_OTG_Driver/src/usb_core.c"
USB_OTG_STS USB_OTG_EP0StartXfer(USB_OTG_CORE_HANDLE *pdev , USB_OTG_EP *ep)
{
  USB_OTG_STS status = USB_OTG_OK;
  USB_OTG_DEPCTL_TypeDef depctl;
...
# 1934 "./lib/main/STM32_USB_OTG_Driver/src/usb_core.c"
uint32_t USB_OTG_ReadDevOutEP_itr(USB_OTG_CORE_HANDLE *pdev , uint8_t epnum)
{
  uint32_t v;
...
# 2082 "./lib/main/STM32_USB_OTG_Driver/src/usb_core.c"
uint32_t USB_OTG_GetEPStatus(USB_OTG_CORE_HANDLE *pdev ,USB_OTG_EP *ep)
{
  USB_OTG_DEPCTL_TypeDef depctl;
  volatile uint32_t *depctl_addr;
...
# 2136 "./lib/main/STM32_USB_OTG_Driver/src/usb_core.c"
void USB_OTG_SetEPStatus (USB_OTG_CORE_HANDLE *pdev , USB_OTG_EP *ep , uint32_t Status)
{
  USB_OTG_DEPCTL_TypeDef depctl;
  volatile uint32_t *depctl_addr;
